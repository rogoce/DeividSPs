DROP PROCEDURE sp_pro18d; 
CREATE PROCEDURE "informix".sp_pro18d(a_compania CHAR(3),a_agencia CHAR(3),a_codsucursal CHAR(255) DEFAULT "*",a_codsubramo CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_periodo_desde CHAR(7),a_periodo_hasta CHAR(7))
         RETURNING CHAR(50),CHAR(3),CHAR(50),DEC(16,2),SMALLINT,
...
---  Ref. Power Builder - d_prod_sp_pro18d
--------------------------------------------
...
-----------------
       FOREACH
          SELECT y.cod_subramo,
		   ...
		   GROUP BY	y.cod_subramo
           ORDER BY y.cod_subramo
          ...
          RETURN v_descr_cia,v_cod_subramo,v_desc_subra,v_prima_suscrita,
