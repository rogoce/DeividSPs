-- Reporte de Incurrido Neto por Ajustador Interno
-- 
...
DROP PROCEDURE sp_rec01e;

CREATE PROCEDURE "informix".sp_rec01e(
a_compania  CHAR(3), 
a_agencia   CHAR(3), 
a_periodo1  CHAR(7), 
a_periodo2  CHAR(7), 
...
FOREACH 
 SELECT no_reclamo,		
  ...
  ORDER BY ajust_interno, cod_ramo, periodo, numrecla
