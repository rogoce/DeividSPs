...
returning char(20),  --_no_documento	1
       	  date,		 --vig ini			2
       	  date,		 --vig fin		    3
	      char(3),	 --cod_ramo			4
	      smallint,  --estatus poliza	5
	      char(7),	 --periodo			6
	      char(3),	 --cod subramo		7
	      char(1),	 --gestion			8
		  char(50),  --ramo nombre		9
		  char(50),	 --subramo nombre	10
		  DEC(16,2), --apagar			11
		  DEC(16,2), --saldo			12
		  DEC(16,2), --exigible			13
		  DEC(16,2), --corriente 		14
		  DEC(16,2), --monto30			15
		  DEC(16,2), --monto60			16
		  DEC(16,2), --monto90			17
		  char(10),	 --no_poliza		18
		  DEC(16,2), --por vencer		19
		  char(100), --asegurado		20
		  smallint,  --seleccionar		21
		  char(50),	 --					22
  		  DEC(16,2), --prima orig		23
		  char(50),  --agente			24
		  DEC(16,2), --exigible2		25
		  integer,   --ramosis			26
		  char(50),	 --no-renov			27
		  char(10),  --cod_campana		28
		  char(50);	 --forma de pago	29
