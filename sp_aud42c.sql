...
DROP procedure sp_aud42c;
CREATE procedure "informix".sp_aud42c(a_periodo1 CHAR(07))
RETURNING int,
          int,
		  char(4),
		  char(2),
...
{           select count(*)
 ...
 --			 group by b.cod_cober_reas;
           ...
           select nombre
            ...
            LET v_prima_suscrita = v_prima_suscrita * _porc_partic_agt / 100;

            LET v_comision     = v_prima_suscrita * v_porc_comis / 100;

           let _diferencia = _diferencia + v_prima_suscrita;
