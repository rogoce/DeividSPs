...
drop procedure sp_corregir5;

create procedure "informix".sp_corregir5()
returning integer;
...
define _usuario_cobros_f  char(8);
...
foreach
	...
	select no_poliza,
	 ...
	 where ((user_added = _usuario_cobros
		...
		OR (user_added = _usuario_cobros_f
	    or user_cobros = _usuario_cobros_f))
