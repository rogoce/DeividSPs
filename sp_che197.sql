-- Genera Cheque ACH Reporte de Pendiente
-- Creado    : 17/08/2023 - Autor: Amado Perez M
-- SIS v.2.0 - DEIVID, S.A.	
-- execute procedure sp_che123('2',0)

DROP PROCEDURE sp_che197;
CREATE PROCEDURE sp_che197() 
...
FOREACH
  SELECT chqchmae.cod_cliente,
   ...
   WHERE ( cliclien.cod_cliente = chqchmae.cod_cliente ) and
         ...
         ( ( chqchmae.origen_cheque = '1' ) AND
		 ( chqchmae.cod_banco = '001' ) AND
         ( chqchmae.cod_chequera = '001' ) AND
