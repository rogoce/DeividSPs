...
foreach
	...
	{foreach
		select (b.prima_neta * c.porc_partic_prima /100) * c.porc_proporcion /100
		  into _prima_neta_sin
		  from cobredet b, cobreaco c , reacomae r
		 where b.no_remesa = c.no_remesa
		   and b.renglon   = c.renglon
		   and c.cod_contrato = r.cod_contrato
		   and r.tipo_contrato not in(3)		--No facultativos
		   and b.no_remesa = _no_remesa
