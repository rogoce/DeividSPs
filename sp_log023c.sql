...
-- Modificado: 16/11/2022 - Autor: Henry Giron SD#5034JEPEREZ
-- SIS v.2.0 - DEIVID, S.A. 
Drop procedure sp_log023c;
Create procedure sp_log023c(a_no_poliza char(10), a_no_endoso char(10), a_user char(10), a_tipo smallint)
RETURNING integer, 
          varchar(50);
...
--8--2-3  [5-3] * REIMPRESION
	...
	if a_tipo = 4  then -- eliminar
		...
		let _no_poliza2 = trim(a_no_poliza);
	...
	if _status_flag = 0 then	---SD#5434 JEPEREZ Mantiene el estado
		Update endpool0
