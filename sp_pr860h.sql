...
------------------------------------------------
--execute procedure sp_pr860_h('001','001','2015-01','2015-03',"*","*","*","*","001,003,006,008,010,011,012,013,014,021,022;","*","2019,2018,2017,2016,2015,2014,2013,2012,2011,2010,2009,2008;",'01','*')

drop procedure sp_pr860h;
create procedure sp_pr860h(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
...
drop table if exists temp_informe;
create temp table temp_informe(
cod_coasegur		char(3),
cod_ramo			char(3),
cod_contrato		char(5),
cobertura			char(3),
...
if a_periodo2 >= '2013-07' then
	...
	call sp_pr860c1_h(a_compania,a_agencia,_periodo1,a_periodo2,a_codsucursal,a_codgrupo,a_codagente,a_codusuario,
...
call sp_pro307_h(a_compania,a_agencia,a_periodo1,a_periodo2,a_codsucursal,a_codgrupo,   --crea tabla temp_det (temporal)
...
if a_serie = '*' then
		...
		foreach
			select cod_coasegur,
			 ...
			 where anio      = _anio_reas
			   ...
			   and borderaux in(_borderaux)
			   and cod_contrato in (select codigo from tmp_codigos) 
			 group by cod_coasegur,cod_ramo,cod_contrato,cod_cobertura,p_partic,desc_contrato
	...
	--    modifico: 14/05/2010 solicitado: Omar Wong - Para dividir 7-Vida Individual 8-Colectivo de Vida
			...
			if _porc_cont_partic = 100 and v_cod_ramo not in ("004","019","008","016") then
				let v_cobertura = "3";
			end if
