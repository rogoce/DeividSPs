...
-- execute procedure sp_sac147b('01','26605','%','2009','01','2009','02','sac','26605')

DROP PROCEDURE sp_sac147b;
CREATE PROCEDURE sp_sac147b(a_tipo char(2),a_cuenta char(12),a_ccosto char(3),a_anio char(4),a_mes char(2), a_anio2 char(4),a_mes2 char(2),a_db CHAR(18),a_cuenta2 char(12)) 
