...
-- Execute Procedure sp_pro1023("001","001",'23/10/2018',"*","001,003;","*","00035;","*","*","*","*")
DROP procedure sp_pro1023;
CREATE procedure "informix".sp_pro1023(a_cia CHAR(03),a_agencia CHAR(3),a_fecha DATE,a_codsucursal CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_agente CHAR(255) DEFAULT "*",a_usuario CHAR(255) DEFAULT "*", a_cod_cliente CHAR(255) DEFAULT "*", a_acreedor CHAR(255) DEFAULT "*", a_no_documento CHAR(1255) DEFAULT "*")
RETURNING 
CHAR(3) as cia, 
