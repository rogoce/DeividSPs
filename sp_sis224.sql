-- Procedimiento que Realiza la Busqueda de la firma de las cartas de salud

-- Creado    : 05/04/2016 - Autor: Amado Perez  
-- Modificado: 05/04/2016 - Autor: Amado Perez 

drop procedure sp_sis224;

create procedure "informix".sp_sis224()
