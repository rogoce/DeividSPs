...
drop procedure sp_sis245f;

create procedure sp_sis245f()
...
foreach
	select distinct a.no_poliza,
	 ...
	 where a.no_documento = b.no_documento
	   ...
	   and b.prima_neta <> 0
	   and b.no_documento = '0218-12638-47'
	--   and b.no_documento = '0223-00967-10'
	   --and b.recargo > 8 
	 --  and b.no_documento in (
	--   '0219-02553-09','0223-00806-03','0223-04665-09','0219-00630-03','0223-00403-02','0219-00458-10','0219-00429-11','0210-01082-01')
...
--	No contemplar los siguientes productos: se agregaron nuevos por Bonizuth 31-07-2024
