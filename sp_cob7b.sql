...
-- SIS v.2.0 - d_cobr_sp_cob07b_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_cob7b;

CREATE PROCEDURE "informix".sp_cob7b(
a_compania   CHAR(3), 
a_agencia    CHAR(3), 
a_periodo    DATE,
...
FOREACH
 SELECT	cod_ramo,
  ...
  WHERE monto_90 <> 0
    AND seleccionado = 1
  GROUP BY cod_ramo
  ORDER BY cod_ramo, nombre_cliente, doc_poliza, vigencia_inic
