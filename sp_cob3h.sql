-- Morosidad por Agente - Totales  por Ramo
-- 
-- Creado    : 14/05/2001 - Autor: Marquelda Valdelamar

--
-- SIS v.2.0 - d_cobr_sp_cob03b_dw2 - DEIVID, S.A.

--DROP PROCEDURE sp_cob03h;

CREATE PROCEDURE "informix".sp_cob03h(
a_compania   CHAR(3), 
a_agencia    CHAR(3), 
a_periodo    DATE,
a_sucursal   CHAR(255),
...
FOREACH
 SELECT	nombre_agente,
   ...
   FROM	tmp_moros
  WHERE seleccionado = 1
  GROUP BY nombre_agente, cod_ramo
  ORDER BY nombre_agente, cod_ramo
