-- Procedimiento que Aviso de Pago Siniestro Coaseguro
-- 
...
DROP PROCEDURE sp_rec20;
--DROP TABLE tmp_arreglo;
CREATE PROCEDURE "informix".sp_rec20(a_compania CHAR(3), a_agencia CHAR(3), a_no_reclamo CHAR(10), a_no_tranrec CHAR(10), a_firma CHAR(50), a_cargo CHAR(50)) 
			RETURNING   CHAR(50),
			            CHAR(50),
						CHAR(100),
		    	        CHAR(20),
