-- Polizas Sin Pagos por Cobrador - Detallado
-- 
-- Creado    : 12/09/2000 - Autor: Demetrio Hurtado Almanza 
-- Modificado: 20/09/2000 - Autor: Demetrio Hurtado Almanza
--
-- SIS v.2.0 - d_cobr_sp_cob11a_dw1 - DEIVID, S.A.

--DROP PROCEDURE sp_cob11a;

CREATE PROCEDURE "informix".sp_cob11a(
a_compania    CHAR(3), 
a_agencia     CHAR(3), 
a_fecha       DATE,
...
a_nunca		  CHAR(1)	 DEFAULT '1',
a_dias        INTEGER    DEFAULT 100,
a_acreedor    CHAR(5)    DEFAULT '*',
a_coasegur    CHAR(3)    DEFAULT '*',
a_incobrable  INTEGER	 DEFAULT 1,
