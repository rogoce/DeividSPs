...
-- SIS v.2.0 - DEIVID, S.A.  -- execute procedure sp_cob750_00927('02000','983153','MCONCEPC','GISELA','MCONCEPC','GISELA',0,'MCONCEPC','GISELA')

--DROP PROCEDURE sp_cob750_00927;
CREATE PROCEDURE sp_cob750_00927(a_aviso CHAR(15), a_poliza CHAR(10),a_nombre_firma1 CHAR(50),a_nombre_firma2 CHAR(50),a_cargo1 CHAR(50),a_cargo2 CHAR(50),a_callcenter INTEGER,a_usuario1 CHAR(10),a_usuario2 CHAR(10))
 ...
 SELECT tipo_agente
  ...
  WHERE cod_agente = _cod_agente;
   ...
   --Seleccion de Campos de tabla de polizas
    ...
    --let _leasing = 1; -- solo a manera de ejemplo
