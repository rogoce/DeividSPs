...
drop procedure sp_pro1112c;

create procedure sp_pro1112c(a_no_documento char(20))
...
let _e_mail = "";  
  ...
  let v_e_mail = trim(v_e_mail) || "vhenriquez@asegurancon.com;fasprilla@asegurancon.com;movalle@asegurancon.com;mlouis@asegurancon.com;";
   let v_e_mail = trim(v_e_mail) || "renovaciones@gtseguros.com.pa;alossada@gtseguros.com.pa;hgonzalez@asegurancon.com;"; --SD8539 JEPEREZ
