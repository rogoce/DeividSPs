...
CREATE INDEX idx1_tmp_produccion2 ON tmp_produccion2(cod_ramo);
CREATE INDEX idx2_tmp_produccion2 ON tmp_produccion2(cod_subramo);
CREATE INDEX idx3_tmp_produccion2 ON tmp_produccion2(cod_origen);
CREATE INDEX idx4_tmp_produccion2 ON tmp_produccion2(cod_contrato);
CREATE INDEX idx5_tmp_produccion2 ON tmp_produccion2(cod_cobertura);
CREATE INDEX idx6_tmp_produccion2 ON tmp_produccion2(desc_cob);
CREATE INDEX idx7_tmp_produccion2 ON tmp_produccion2(no_poliza);
CREATE INDEX idx8_tmp_produccion2 ON tmp_produccion2(serie);
CREATE INDEX idx9_tmp_produccion2 ON tmp_produccion2(cod_coasegur);
