...
foreach
	...
	begin work;
		insert into fis_che115a(no_documento, pri_can_ap, tipo)
		values (_no_documento, _monto, 8);
	commit work;
end foreach	 
--**********************************
...
foreach
	...
	if _cod_ramo = '023' then
		...
		let _monto_90_aa = _monto_90_aa * (70 / 100);	--Quitar los riesgos catastroficos
	end if
	...
	foreach
		...
		let _prima_cobrada   = _monto_90_aa * (_porc_partic / 100);
