...
DROP PROCEDURE sp_che115_carga2021;
CREATE PROCEDURE sp_che115_carga2021(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
foreach
	...
	let _valor = sp_sis101a(_no_documento,'01/01/2021',_fecha_aa, my_sessionid);
	call sp_dev06f_renta(_no_documento,_fecha_aa,'01/01/2021',_fecha_aa) returning _valor,_mensaje,_pri_devengada;
...
foreach	with hold
	...
	let _valor = sp_sis101a(_no_documento,'01/01/2020',_fecha_ap,my_sessionid);
	foreach
		select cod_agente,
		       porcentaje
		  into _cod_agente,
