...
DROP PROCEDURE sp_proe05bk3;
CREATE PROCEDURE "informix".sp_proe05bk3(a_poliza CHAR(10), a_unidad CHAR(5), a_ruta CHAR(5), a_suma DECIMAL(16,2), a_endoso CHAR(5))
...
--	call sp_sis188(a_poliza) returning _error,_mensaje;
	...
	call sp_sis188b(a_poliza,a_endoso,a_unidad) returning _error,_mensaje;
