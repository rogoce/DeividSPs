...
drop procedure sp_web10;

create procedure "informix".sp_web10(a_no_documento char(20), a_cod_reclamante varchar(10), a_periodo varchar(7))
returning char(20),
varchar(20),
varchar(20),
varchar(20),
...
-- busqueda por no_poliza si en valor de cod_reclamante es distinto de nulo 
...
foreach
             ...
             and rectrmae.periodo >= a_periodo
...
if _cod_tipopago = '003' or _estatus = "Declinado" then
   return         _fecha_factura,
		          ...
		          _gasto_eleg, 
				  _cod_tipopago,
				  _wf_pagado,_no_requis
				  with resume;

end if
end foreach

-- si no quiere decir que la busqueda es por poliza
else
 let _no_requis = 0;
 	foreach
