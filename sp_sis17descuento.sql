...
CREATE PROCEDURE "informix".sp_demetrio(a_no_poliza CHAR(10))
--}
...
define _vig_i				date;
define _monto_desc          decimal(16,2);
...
-- Armando Moreno.
if _nueva_renov in('N','R') and
   _cod_ramo     = "020"  and
   _cod_formapag <> "008"  and
   _no_recibo    is null then
	return 5;
end if
...
let _monto_desc = 0;
if _cod_formapag in('003','005') then	--si es forma de pago ach/tcr, hacer endoso de pronto pago
