...
DROP PROCEDURE sp_pro1123;
CREATE PROCEDURE sp_pro1123(a_no_documento CHAR(20), a_emails lvarchar(500), a_enviado_a smallint default 0, a_enviado smallint default 0)
