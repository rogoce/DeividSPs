...
drop procedure sp_par319;

create procedure "informix".sp_par319(a_envio_correo smallint default 0) 
...
--		   and secuencia in (6251870)
		...
		if _cod_tipo not in ('00005', '00001', '00017', '00018', '00020', '00006', '00016') and a_envio_correo = 0 and  _adjunto = 0 then
			continue foreach;
		end if
		...
		if _cod_tipo in ('00017','00018','00006','00001','00020') and _date_added < "30/01/2021"  then
			continue foreach;
		end if
		...
		elif _cod_tipo in ('00038','00039','00037') then
			select no_remesa
			  into _no_poliza
			  from parmailcomp
			 where mail_secuencia = _secuencia;
