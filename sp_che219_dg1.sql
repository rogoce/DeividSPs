...
--ESTE ES EL SRIPT QUE SE USA PARA LA IMPRESION DE CHEQUES EN DEIVID GESTION.
--AMM, 11/06/2019

DROP PROCEDURE sp_che219;
CREATE PROCEDURE "informix".sp_che219(a_compania CHAR(3), a_agencia CHAR(3), a_usuario CHAR(8), a_cod_banco CHAR(3), a_cod_chequera CHAR(3), a_no_requis CHAR(10) DEFAULT '*') 
RETURNING   DATE,
			VARCHAR(100),
		    DECIMAL(16,2), 
			CHAR(250),
