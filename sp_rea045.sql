...
DROP PROCEDURE sp_rea045;
CREATE PROCEDURE sp_rea045(a_cod_contrato CHAR(5),a_db char(18))
...
FOREACH 
     SELECT cobredet.no_remesa,cobredet.renglon
	  ...
	  group by cobredet.no_remesa,cobredet.renglon
	  order by cobredet.no_remesa,cobredet.renglon
