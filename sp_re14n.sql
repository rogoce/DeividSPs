-- Siniestralidad por Grupo
-- 
-- Creado    : 30/08/2000 - Autor: Demetrio Hurtado Almanza 
-- Modificado: 16/09/2000 - Autor: Demetrio Hurtado Almanza
-- Modificado: 28/01/2002 -Adicion del filtro por Grupo - Autor:Amado Perez
--
-- SIS v.2.0 - d_recl_sp_rec14e_dw5 - DEIVID, S.A.

DROP PROCEDURE sp_rec14n;

CREATE PROCEDURE "informix".sp_rec14n(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_periodo1 CHAR(7),
a_periodo2 CHAR(7),
