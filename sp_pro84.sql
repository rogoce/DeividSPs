...
DROP procedure sp_pro84;

CREATE procedure "informix".sp_pro84(a_cia CHAR(3),a_agencia CHAR(3),a_codsucursal CHAR(255) DEFAULT "*",a_periodo1 CHAR(7),a_periodo2 CHAR(7))
