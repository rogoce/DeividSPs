...
drop procedure sp_sis248emirepo;

create procedure sp_sis248emirepo()
...
select distinct a.no_poliza,
 	  ...
 	  into _no_poliza,
		   _no_documento
     from emirepo a, emipomae c, emipomae d
...
{	select distinct a.no_poliza,
	  ...
	  into _no_poliza,
	       _no_poliza_n,
		   _no_documento
      from emirepo a,  deivid_tmp:renov_recar_202408 b, emipomae c, hemirepo d
