...
-- Modificado: 15/10/2002 eliminar tipo de produccion y comentar montos <>90
--                        en el dw se elimino el grupo tipo_produccion agrupado por pag.


DROP PROCEDURE sp_cob05n;

CREATE PROCEDURE "informix".sp_cob05n(
a_compania   CHAR(3), 
a_agencia    CHAR(3), 
a_periodo    DATE,
