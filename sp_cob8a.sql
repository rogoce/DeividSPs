-- Cobros por Cobrador - Detallado
-- 
-- Creado    : 11/09/2000 - Autor: Demetrio Hurtado Almanza 
-- Modificado: 19/09/2000 - Autor: Demetrio Hurtado Almanza
-- Modificado: 17/06/2003 - Autor: Amado Perez - Se agrega el filtro de incobrables
--
-- SIS v.2.0 - d_cobr_sp_cob08a_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_cob08a;

CREATE PROCEDURE "informix".sp_cob08a(
a_compania  CHAR(3), 
a_agencia   CHAR(3), 
a_periodo1  CHAR(7),
a_periodo2  CHAR(7),
