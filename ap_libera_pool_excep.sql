...
-- Creado    : 15/05/2009 - Autor: Amado Perez.

DROP PROCEDURE ap_libera_pool_excep;
CREATE PROCEDURE ap_libera_pool_excep()
	...
	foreach
	  SELECT no_poliza,   
		...
		INTO _no_poliza,
			 ...
			 _cod_agente  
		FROM emirepo  
	   WHERE user_added IN ('MJARAMIL','YARIOS','MRGONZAL')
	     and estatus = 2
