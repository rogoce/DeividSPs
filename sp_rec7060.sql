--execute procedure sp_rec7060('001','001','2025-11','2025-11',"*","*","001,003;","2009;","*","*")

drop procedure sp_rec7060;
create procedure sp_rec7060(
	a_compania	char(3),
	a_agencia	char(3),
	a_periodo1	char(7),
	a_periodo2	char(7),
	...
	foreach 
		...
		foreach
			...
			foreach
				...
				if _flag = 1 and a_periodo2 < '2017-02' then
...
foreach
	...
	--let _res_ret = 0;
	let _res_cont = _cp_res + _exc_res + _res_cp_rc + _res_cp_casco ; --v_reserva_cedido - _reserva_neto;
