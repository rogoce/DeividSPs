...
--execute procedure sp_rec193dd('001','001','2011-01','2011-03',"*","*","*","*","*","*","*","*",'*')
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_rec193dd;
CREATE PROCEDURE "informix".sp_rec193dd(
		a_compania  CHAR(3),
		a_agencia   CHAR(3),
		a_periodo1  CHAR(7),
		a_periodo2  CHAR(7),
	...
	select no_reclamo,
	 ...
	 order by no_reclamo,periodo
       ...
       ON EXCEPTION IN(-239)
		...
		if _periodo = '2011-03' then

			update tmp_salida
			   set pagado_t110 = pagado_t110 + _incurrido_total
			 where no_reclamo = _no_reclamo;
		end if

		if _periodo = '2011-06' then

			update tmp_salida
			   set pagado_t210 = pagado_t210 + _incurrido_total
			 where no_reclamo = _no_reclamo;
		end if
		...
		if _periodo = '2011-09' then
			...
			update tmp_salida
			   set pagado_t310 = pagado_t310 + _incurrido_total
			 where no_reclamo = _no_reclamo;
		end if
		...
		if _periodo = '2011-12' then
			...
			update tmp_salida
			   set pagado_t410 = pagado_t410 + _incurrido_total
			 where no_reclamo = _no_reclamo;
		end if
		...
		if _periodo = '2012-03' then
			...
			update tmp_salida
			   set pagado_t111 = pagado_t111 + _incurrido_total
			 where no_reclamo = _no_reclamo;
		end if
		...
		if _periodo = '2012-06' then
			...
			update tmp_salida
			   set pagado_t211 = pagado_t211 + _incurrido_total
			 where no_reclamo = _no_reclamo;
		end if
		...
		if _periodo = '2012-09' then
			...
			update tmp_salida
			   set pagado_t311 = pagado_t311 + _incurrido_total
			 where no_reclamo = _no_reclamo;
		end if
		...
		if _periodo = '2012-12' then
			...
			update tmp_salida
			   set pagado_t411 = pagado_t411 + _incurrido_total
			 where no_reclamo = _no_reclamo;
		end if
       ...
       END EXCEPTION
		...
		if a_periodo1 = "2011-03" then
			let _pagado_t110 = _incurrido_total;
		end if

		if a_periodo1 = "2011-06" then
			let _pagado_t210 = _incurrido_total;
		end if

		if a_periodo1 = "2011-09" then
			let _pagado_t310 = _incurrido_total;
		end if

		if a_periodo1 = "2011-12" then
			let _pagado_t410 = _incurrido_total;
		end if

		--**--

	   	if a_periodo1 = "2012-03" then
			let _pagado_t111 = _incurrido_total;
		end if

		if a_periodo1 = "2012-06" then
			let _pagado_t211 = _incurrido_total;
		end if

		if a_periodo1 = "2012-09" then
			let _pagado_t311 = _incurrido_total;
		end if

		if a_periodo1 = "2012-12" then
			let _pagado_t411 = _incurrido_total;
		end if
