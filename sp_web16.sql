-- Obtener el listado de vencimineto de un acreedor.

-- Creado    : 27/06/2012 - Autor: Federico Coronado

-- SIS - Pagina Web

drop procedure sp_web16;

create procedure "informix".sp_web16(a_cod_acreedor char(5), a_mes integer, a_year integer)
returning char(50),
char(15),
char(5),
char(15),
		...
		foreach
			/* if a_cod_ramo <> 0 then*/
				...
				into _cod_contratante,
					 ...
					 _cod_no_renov,
					 _no_poliza
                from emipoacr inner join emipouni on emipoacr.no_poliza = emipouni.no_poliza
				...
				and cod_contratante not in('120970','252627','253668','394603')
				group by 1,2,3,4,5,6,7,8
				order by no_documento, emipoacr.no_unidad, emipomae.vigencia_inic asc
			/* end if*/	
