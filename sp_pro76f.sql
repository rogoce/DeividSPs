-- Cartas para levantar exclusiones a los asegurados.
-- Creado por: Marquelda Valdelamar Fecha: 21/11/2001


DROP PROCEDURE "informix".sp_pr76f;
CREATE PROCEDURE "informix".sp_pr76f(
a_compania      CHAR(50),
a_sucursal      CHAR(50),
a_fecha         DATE,
a_periodo       CHAR(7)
...
DEFINE _cod_procedimiento_ase CHAR(5);
...
FOREACH
 SELECT a.cod_procedimiento,
		...
		a.no_poliza,
		b.cod_asegurado
   INTO _cod_procedimiento_ase,
     	_fecha_revision,
		_no_poliza,
		_cod_asegurado
   FROM emipreas a, emipouni b 
  WHERE fecha       = a_fecha
  ...
  SELECT nombre
	...
	FROM emiproce
   WHERE cod_procedimiento = _cod_procedimiento_ase;

 LET _aplica = _nombre_asegurado;
