--***********************************************************************************
-- Procedimiento que genera la Bonificacion de Rentabilidad 2 de 2017 para corredores
--***********************************************************************************
-- Este es el procedimiento genera requisicion d rentabilidad2
-- execute procedure sp_che222("001","001","2016-02","HGIRON")
-- Creado    : 19/04/2016 - Autor: Henry Giron
-- Ultima Modificacion: 19/04/2016 - Autor: Henry Giron
...
if a_periodo_anio <= v_periodo_ap_anio then
   return 1,'Bonificacion de Rentabilidad 2 ya fue Generado.',v_periodo_ap;
end if
...
delete from chqrentaii where periodo  = a_periodo;
...
if _error <> 0 then
	return _error,'Error de pase de tablas de chqrentaii.'||_error_desc,a_periodo;
end if 
...
--	   and cod_agente in('00218','02040','00875','00473')
	 GROUP BY cod_agente
	 ORDER BY cod_agente
