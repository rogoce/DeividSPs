...
DROP PROCEDURE sp_co51c_bk;

CREATE PROCEDURE "informix".sp_co51c_bk(
a_compania	  CHAR(3),
a_sucursal	  CHAR(3),
...
-- Datos de la Poliza
	...
	CALL sp_sis39(a_fecha_hasta) Returning _periodo;
--Morosidad Total
CALL sp_cob01(_no_poliza,_periodo,a_fecha_desde) 
