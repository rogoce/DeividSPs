...
drop procedure sp_aud44bk;		

create procedure "informix".sp_aud44bk(a_periodo_desde char(7), a_periodo_hasta char(7), _dup_reg smallint, _reg1 integer, _reg2 integer, _reg3 integer )
returning	integer,
			varchar(100); 
...
--SET DEBUG FILE TO "sp_aud44bk.trc";
--trace on;
...
--call sp_ttc08(a_periodo_hasta,3) returning _dup_reg, _reg1,_reg2,_reg3 ;
