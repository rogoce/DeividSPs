...
DROP PROCEDURE sp_rec491;

CREATE PROCEDURE "informix".sp_rec491(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_periodo1 CHAR(7),
a_periodo2 CHAR(7),
...
FOREACH 
 SELECT x.prima_suscrita,		
  ...
  WHERE x.cod_compania = a_compania
	...
	AND y.periodo <= '2002-02'
	AND y.no_documento[3,4] >= a_periodo1[3,4]
	AND y.no_documento[3,4] <= '02'
	AND x.no_endoso = '00000'

--	AND y.fecha_suscripcion <= '28/02/2002'
...
DEFINE _monto_90, _monto_90_agt, _saldo_tot_agt, _saldo_tot DECIMAL(16,2);
...
--		END IF
		...
		LET _saldo_tot_agt = _saldo_tot * _porc_partic_agt / 100;        
