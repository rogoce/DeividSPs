-- Procedimiento que genera las cancelaciones por perdida total
-- 
...
drop procedure sp_par278;

create procedure sp_par278(
a_no_poliza		char(10),
a_usuario		char(8),
a_saldo			dec(16,2),
...
--set debug file to "sp_par278.trc";
--trace on
...
let _cod_tipocan  = "008";          -- Perdida Total
...
call sp_par327(a_no_poliza, _no_endoso, _no_unidad, _cod_endomov) returning _error, _descripcion;
