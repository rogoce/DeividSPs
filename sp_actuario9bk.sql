 DROP procedure sp_actuario9bk;

 CREATE procedure "informix".sp_actuario9bk(a_periodo1 char(7), a_periodo2 char(7))
   RETURNING char(20),decimal(16,2),char(50),char(7);
 
--------------------------------------------
--- ESTE SACA LA PRIMA DEL TITULAR, CAMBIO SOLICITADO POR VICENTE, 07/09/2012  
---  Armando Moreno M.
--------------------------------------------
 ...
 BEGIN
	...
	define _prima_titular                     dec(16,2);
		    ...
		    foreach
				...
				SELECT no_factura,
				 ...
				 WHERE cod_compania  = '001'
				  ...
				  let _prima_titular = abs(_prima) - abs(_prima_depen);
				  let _prima_titular = abs(_prima_titular); 
...
foreach
    ...
    return v_no_documento,_prima_titular,_n_producto,_periodo with resume;
