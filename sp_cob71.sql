-- Informe de polizas que sin motivo que estan en el rutero-- 
-- Creado    : 16/07/2001 - Autor: Armando Moreno
-- Modificado: 16/07/2001 - Autor: Armando Moreno
--

DROP PROCEDURE sp_cob71;

CREATE PROCEDURE "informix".sp_cob71(a_compania CHAR(3), a_sucursal CHAR(3), a_fecha DATE, a_cobrador CHAR(3))
			RETURNING 	CHAR(100),	
				  	  	CHAR(20),		
		    	  	  	DATE,     	
		    	  		DATE,     	
