...
DROP procedure sp_pro95c_tp;
CREATE procedure "informix".sp_pro95c_tp(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codramo CHAR(255), a_reaseguro CHAR(255)  DEFAULT "*", a_origen CHAR(3) default "%")
