...
drop procedure sp_sis171_det;

create procedure "informix".sp_sis171_det()
...
foreach
	...
	if _no_poliza = '766313' then
		let _no_poliza = '774716';
	elif _no_poliza = '829622' then
		let _no_poliza = '748853';
	end if
	...
	-- Contratos
	call sp_sis188_det(_no_poliza) returning _error,_mensaje;
	...
	select count(*)
	 ...
	 where cobreaco.no_remesa     = _no_remesa
