...
DROP PROCEDURE sp_che167b;

CREATE PROCEDURE sp_che167b(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo CHAR(7), a_verif_tipo_pago SMALLINT DEFAULT 0) 
RETURNING CHAR(10), CHAR(5), CHAR(50), CHAR(50),CHAR(40),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),CHAR(5),CHAR(50),CHAR(20);		
