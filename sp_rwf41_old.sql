CREATE PROCEDURE "informix".sp_rwf41(a_no_reclamo CHAR(10), a_incidente INTEGER, a_user_name_ajust CHAR(8), a_monto DEC(16,2), a_cod_cobertura CHAR(5), a_genera_cheque SMALLINT DEFAULT 0, a_deducible DEC(16,2) DEFAULT 0.00, a_inc_padre INT DEFAULT NULL) 
