-- Procedimiento que determina el codigo de corredor de acuerdo al periodo del concurso

drop procedure sp_sis101a_prueba;
create procedure sp_sis101a_prueba(a_no_documento char(20),a_fecha_desde date, a_fecha_hasta date)
returning smallint;
...
define a_sesid,my_sessionid              integer;
