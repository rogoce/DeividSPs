...
--*****************************************************************************************
DROP PROCEDURE sp_che86_aa_JB;
CREATE PROCEDURE sp_che86_aa_JB(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
-- Diciembre
let _per_fin_dic    = "2019-09" --_per_ini[1,4] || "-09"; --2018-12 -- se cambio el 12 por 09 para colocar hasta el periodo final de concurso
...
--**********************************************************************************************
-- Prima Pagada Anno Pasado periodo del concurso 2017-10 A 2018-09
--**********************************************************************************************
--eliminado este trozo de codigo JB
--**********************************************************************************************
...
foreach 
	 select no_reclamo,		
	  ...
	  where cod_compania = a_compania
		and periodo      <= _per_fin_dic 	--2018-12
		and actualizado  = 1
	  group by no_reclamo
