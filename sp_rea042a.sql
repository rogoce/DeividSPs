...
--DROP PROCEDURE sp_rea042a;

CREATE PROCEDURE "informix".sp_rea042a(a_compania  CHAR(3),a_agencia   CHAR(3),a_periodo1  CHAR(7),a_periodo2  CHAR(7),a_sucursal  CHAR(255) DEFAULT "*",a_grupo CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_agente CHAR(255) DEFAULT "*",a_ajustador CHAR(255) DEFAULT "*",a_evento CHAR(255) DEFAULT "*",a_suceso CHAR(255) DEFAULT "*",a_subramo CHAR(255) DEFAULT "*", a_cod_contrato char(5))
RETURNING CHAR(255);
