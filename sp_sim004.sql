...
--drop procedure sp_sim004;

create procedure "informix".sp_sim004(a_no_registro char(10))
returning integer,
		  char(100);
...
delete from sac999:sreacompasiau where no_registro = a_no_registro;
delete from sac999:sreacompasie	 where no_registro = a_no_registro;
...
--				and orden		   = _orden   se quito por que generaba error para los facultativos 22/04/2010 Armando/Demetrio
				...
				if _monto <> 0.00 then
					...
					call sp_sim005(a_no_registro, _cuenta, _debito, _credito, _tipo_comp, _periodo, _centro_costo, _fecha);
				...
				if _monto3 <> 0.00 then
					...
					call sp_sim005(a_no_registro, _cuenta, _debito, _credito, _tipo_comp, _periodo, _centro_costo, _fecha);
				   	...
				   	call sp_sac65(_cod_coasegur) returning _error, _error_desc, _cod_auxiliar;		  -- NO ESTOY SEGURO

					if _error <> 0 then
						return _error, _error_desc;
					end if
					
					call sp_sim006(a_no_registro, _cuenta, _debito, _credito, _tipo_comp, _cod_auxiliar, _periodo, _centro_costo, _fecha);
