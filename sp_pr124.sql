...
-- 		FACULTATIVO
-- 		PRIMA COBRADA
-- execute PROCEDURE sp_pr124 ("001","001","2009-10","2009-12","*","*","*","*",
-- "001,003,002,010,011,012,013,014;","*","*","*",0)
---------------------------------------------------------------------------------
DROP PROCEDURE sp_pr124;
CREATE PROCEDURE sp_pr124(	a_compania    CHAR(03),
		a_agencia     CHAR(03),
		a_periodo1    CHAR(07),
		a_periodo2    CHAR(07),
...
{		SELECT sum(t.pagado_neto)  -- sum(reserva_neto) 	
		INTO _siniestro	
		FROM tmp_sinis t, reacomae r,  reccoas c
		where t.cod_ramo = v_cod_ramo	
		and r.cod_contrato = t.cod_contrato 
        and c.no_reclamo   = t.no_reclamo
