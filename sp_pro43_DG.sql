...
--if _no_doc <> '1819-99900-01' then
--	RETURN 1, 'No Puede Actualizar este Endoso.';
--end if
...
if _cnt > 0 and _cod_endomov not in('015','024','032','033','034') and a_no_poliza <> '001187729' and _no_doc <> '2317-00087-01' and _no_doc <> '2315-00106-01' 
            and _no_doc <> '2318-00076-01' and _no_doc <> '0213-04421-01' and _no_doc <> '0213-04424-01' and _no_doc <> '2319-00077-01' then --015=endoso descriptivo
...
--		if _cod_ramo <> "018" then Amado 9-2-2021 Asistencia en Viaje DGestion
			FOREACH 
