...
FOREACH
	...
	into    _tipo_persona ,
            ...
            _no_poliza,
            _fmenos3mes			
	from cliclien a left join clivip b on (a.cod_cliente = b.cod_cliente) -- 
	...
	where (cedula is null or fecha_aniversario is null or direccion_1 is null or (telefono1 is null and telefono2 is null and telefono3 is null and celular is null) or e_mail is null)
	  ...
	  --and  (((a_fecha1 -  3 units month) <  a.date_changed)  )  )  --no funciono
	  
		  if _date_changed is null then
		  else
		  
		   if _date_changed > _fmenos3mes then
				continue foreach;
			end if
