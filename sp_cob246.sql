-- Procedimiento que Genera la Morosidad para un Documento utilizando la prima neta
-- 
-- Creado    : 30/12/2009 - Autor: Demetrio Hurtado Almanza
-- 
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_cob246;

CREATE PROCEDURE "informix".sp_cob246(
a_compania     CHAR(3), 
a_sucursal     CHAR(3), 
	...
	-- FIN Cambio de Distribución de Morosidad por Facturas en Positivo
		...
		FOR _ciclo = 1 TO _no_pagos
			...
			ELIF _dias > 120 AND _dias <= 150 THEN
		        LET v_monto_120 = v_monto_120   + _prima_neta;
			ELIF _dias > 150 AND _dias <= 180 THEN
		        LET v_monto_150 = v_monto_150   + _prima_neta;
			ELSE
		        LET v_monto_180 = v_monto_180   + _prima_neta;
			END IF
