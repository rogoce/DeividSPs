...
--execute procedure sp_rea10('001','001','01/07/2017',"*","001,003;","*","*","*","*","*","*","30/06/2017")

drop procedure sp_rea10;
...
foreach with hold
	select y.no_documento,
	 ...
	 where y.seleccionado = 1
	  --and  y.no_documento in ('0115-00444-01','0116-00661-01','0116-00749-01')
	  --and y.no_documento in ('0112-00124-01') 
