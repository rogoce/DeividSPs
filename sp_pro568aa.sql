...
DROP procedure sp_pro568aa;
CREATE procedure "informix".sp_pro568aa(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codramo CHAR(255), a_reaseguro CHAR(255)  DEFAULT "*", a_origen CHAR(3) default "%")
       ...
       ELSE
          FOREACH WITH HOLD
              ...
              SELECT d.no_poliza,d.no_documento,d.no_factura,d.sucursal_origen,
                     ...
                     d.user_added,d.suma_asegurada,d.nueva_renov
                INTO _no_poliza,_no_documento,_no_factura,v_cod_sucursal,
                     ...
                     v_usuario,v_suma_asegurada,_nueva_renov
                 FROM emipomae d
                WHERE d.cod_compania = a_cia
			      AND d.cod_origen like a_origen
                  AND (d.vigencia_final >= a_periodo
