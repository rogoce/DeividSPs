-- Insertando los valores de las cartas de Salud en emicartasal6
...
drop procedure sp_pro1120;
create procedure sp_pro1120(a_no_documento char(20))
...
let _e_mail = "";  
  ...
  let v_e_mail = trim(v_e_mail) || "atencionalcliente@asegurancon.com";  --"departamentopersonas@asegurancon.com;";

  --let v_e_mail = "rgordon@asegurancon.com;";
