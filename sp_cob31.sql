-- Procedimiento que Genera la Morosidad para una Poliza y retorna el no_poliza para la 
-- consulta de saldos. Morosidad. 																						
-- Creado    : 07/09/2000 - Autor: Demetrio Hurtado Almanza 
-- Modificado: 22/11/2000 - Autor: Marquelda Valdelamar
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_cob31;

CREATE PROCEDURE "informix".sp_cob31(a_no_poliza CHAR(10),a_periodo CHAR(7),a_fecha DATE) 
...
--SET DEBUG FILE TO "\\NEMESIS\Ancon\Store Procedures\Debug\sp_cob31.trc";
...
SELECT SUM(monto)
  INTO _monto_recibo
  FROM cobredet
 WHERE no_poliza    = a_no_poliza	-- Recibos de la Poliza
