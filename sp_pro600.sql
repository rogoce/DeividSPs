...
-- Procedimiento para insertar el endoso de cambio de acreedor MULTIBANK
-- Amado Perez M - 13/04/2023

drop procedure sp_pro600;

create procedure sp_pro600(a_no_documento char(20)) 
returning	smallint,
		    char(5),
			char(100);
...
let a_no_poliza = sp_sis21(a_no_documento);
...
foreach
    ...
    select a_no_poliza,
           ...
           descripcion
      from endedde2
     where no_poliza = '0001881051' and no_endoso = '00002';	  
end foreach       	
