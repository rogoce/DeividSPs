...
--   if v_poliza = "685225" and v_endoso = '00002' then
--		let v_factor = 0.570375;
--   end if
...
if (v_tipocalc = "006" or v_tipocalc = "004") and _ramo_sis <> 5 Then
	...
	if r_prima_anual <> 0 then
	    ...
	    --	else
			...
			if v_poliza <> '667286' And v_poliza <> '802216' And v_poliza <> '729057' And v_poliza <> '791631' And v_poliza <> '810978' then
				if r_prima_anual > 0 then
		...
		foreach
			...
			if r_prima_neta <> r_prima_unidad then
				...
				{if r_prima_neta > 0 then
					if r_prima_unidad > r_prima_neta then
						let r_prima_anual = r_prima_neta - r_prima_unidad;
					else
						let r_prima_anual = r_prima_neta - r_prima_unidad;
					end if
					...
					if r_prima_unidad > r_prima_neta then
						let r_prima_anual = r_prima_unidad - r_prima_neta;
					else
						let r_prima_anual = r_prima_neta - r_prima_unidad;
					end if
				end if}
