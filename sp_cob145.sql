-- Procedimiento que Genera la Morosidad de Cartera para polizas estatus de por cancelar
-- 
...
--DROP PROCEDURE sp_cob145;		

CREATE PROCEDURE "informix".sp_cob145(
a_compania   CHAR(3),
a_agencia    CHAR(3),
a_fecha      DATE,   
...
FOREACH 
 SELECT no_documento
  ...
  WHERE cod_compania       = a_compania		   -- Seleccion por Compania
	...
	AND cobra_poliza       = "P"			   -- Estatus por cancelar
