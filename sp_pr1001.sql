...
DROP PROCEDURE sp_pr1001;
CREATE PROCEDURE "informix".sp_pr1001(a_desde DATE,a_hasta DATE,a_sucursal CHAR(255))
...
--- se anexo al pool endoso de cancelacion falta de pago sin avisos de cancelacion tipo = 'E'
foreach
	 SELECT no_documento,
			 no_poliza,
			 fecha_added, 
		...
		where cod_endomov = '002'		
		   ...
		   and fecha_imprimio >= a_desde  
		   and fecha_imprimio <= a_hasta  			 
