...
Drop Procedure sp_cob265_new1;

Create Procedure 'informix'.sp_cob265_new1(a_cod_agente char(5), a_compania char(3), a_sucursal char(3))
...
/*************************************************************************************************************************************/
	select count(*)
	 ...
	 if _cnt_uni > 1 then
		...
		select placa
		  into _placa
		  from emiauto a inner join emivehic b on a.no_motor = b.no_motor
...
--				_monto_180,
	...
	let _celular2 = replace(_celular2,'-','');
