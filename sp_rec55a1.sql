...
drop procedure sp_rec55a1;

create procedure sp_rec55a1(
a_compania			char(3), 
...
foreach
	...
	select p.deducible_local,p.deducible_fuera, p.coaseguro_hasta, p.coaseguro_fuera
	  into _ded_local,_ded_fuera, _coaseguro_hasta, _coaseguro_fuera
