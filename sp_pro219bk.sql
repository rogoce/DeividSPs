...
DROP PROCEDURE sp_pro219bk;

CREATE PROCEDURE "informix".sp_pro219bk(a_compania CHAR(03), a_terremoto SMALLINT, a_fecha DATE)
  ...
  FOREACH WITH HOLD
	  ...
	  SELECT cod_ubica,
		...
		INTO _cod_ubica,
			 ...
			 _no_poliza  
	   FROM temp_ubica
	 -- GROUP BY cod_ubica,tipo_incendio
	 ...
	 if v_suma_asegurada = 0 then
			 ...
			 {update emicupol
			    set suma_incendio  = suma_incendio * -1,
					suma_terremoto = suma_terremoto	* -1
			  where no_poliza      = _no_poliza;
