...
drop procedure sp_rea24dprueba;
create procedure 'informix'.sp_rea24dprueba(a_compania char(3), a_sucursal char(3), a_periodo char(7), a_flag smallint)
returning	integer,		--1
			varchar(100);	--2
...
foreach with hold
	select no_documento,
	 ...
	 where periodo = a_periodo
	   and saldo_pxc <> 0
	   and no_documento in ('0212-00185-02')
