...
--Proedure similar al sp_pro550 utilizado paras las pre-renovaciones y renovaciones automáticas, este es despues de creado en prdpreren

drop procedure sp_sis470c;
create procedure sp_sis470c(
