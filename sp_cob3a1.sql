...
DROP PROCEDURE sp_cob03a1;

CREATE PROCEDURE "informix".sp_cob03a1(
a_compania     CHAR(3), 
a_agencia      CHAR(3), 
a_periodo      DATE,    
...
DEFINE v_compania_nombre, v_nombre_prod, v_nombre_cobrador   CHAR(50);

DEFINE _cod_vendedor,v_saber, _cod_cobrador CHAR(3);
...
FOREACH
 ...
 SELECT	nombre_agente,       
   ...
   FROM	tmp_moros
  WHERE seleccionado = 1
  GROUP BY nombre_agente,cod_cobrador
  ORDER BY nombre_agente,cod_cobrador
