...
drop procedure sp_cob101bk3a;

create procedure sp_cob101bk3a(
a_compania 		CHAR(3),
a_agencia  		CHAR(3),
a_cobrador 		CHAR(3),
...
foreach
		...
		if _procesado is null then
			...
			values (a_cobrador, _fecha_hoy, 1, _cantidad, 0, _cantidad - _cant_proc, 0, _cantidad);
		 ...
		 select	cod_gestion,
		  ...
		  where	cod_cliente = _cod_cliente
			...
			update cascliente set cod_cobrador = a_cobrador where cod_cliente = _cod_cliente;
