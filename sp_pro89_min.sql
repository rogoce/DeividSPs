...
-- Modificado: 10/06/2012 - Autor: Henry Giron - Cambio de Coaseguro Minoritario
-- SIS v.2.0 - uo_prod_endoso (ue_salvar) - DEIVID, S.A.

drop procedure sp_pro89_min;
create procedure sp_pro89_min(
a_no_poliza	char(10),
a_no_endoso	char(5)
) returning smallint,
			char(100);
