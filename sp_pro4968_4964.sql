		...
		FOREACH WITH HOLD
			...
			WHERE no_documento = _no_documento
			 ...
			 order by prioridad
			  ...
			  IF a_periodo <> a_periodo2 THEN
				LET _suma_asegurada = 0; --_suma_asegurada ; -- 
			  END IF
...
FOREACH
	...
	IF a_periodo = a_periodo2 THEN			
		INSERT INTO tmp_rpt_dif (
			...
			SELECT  _orden,
					_descripcion,
					auto_co_p_cant - _auto_co_p_cant,
					auto_co_p_monto - _auto_co_p_monto,
					auto_co_c_cant - _auto_co_c_cant,
					auto_co_c_monto - _auto_co_c_monto,
					auto_rc_p_cant - _auto_rc_p_cant,
					auto_rc_p_monto - _auto_rc_p_monto,
					auto_rc_c_cant - _auto_rc_c_cant,
					auto_rc_c_monto - _auto_rc_c_monto,
					soda_co_p_cant - _soda_co_p_cant,
					soda_co_p_monto - _soda_co_p_monto,
					soda_co_c_cant - _soda_co_c_cant,
					soda_co_c_monto - _soda_co_c_monto,
					sub_p_tot_cant - _sub_p_tot_cant,
					sub_p_tot_monto - _sub_p_tot_monto,
					sub_c_tot_cant - _sub_c_tot_cant,
					sub_c_tot_monto - _sub_c_tot_monto,
					tot_cant - _tot_cant,
					tot_monto - _tot_monto
			FROM esttrp
		   WHERE periodo = a_periodo2
		     AND orden = _orden;
	ELSE	 	 	 
...
FOREACH
	...
	UPDATE tmp_rpt SET
			auto_co_p_cant = auto_co_p_cant + _auto_co_p_cant,
			auto_co_p_monto = auto_co_p_monto + _auto_co_p_monto,
			auto_co_c_cant = auto_co_c_cant + _auto_co_c_cant,
			auto_co_c_monto = auto_co_c_monto + _auto_co_c_monto,
			auto_rc_p_cant = auto_rc_p_cant + _auto_rc_p_cant,
			auto_rc_p_monto = auto_rc_p_monto + _auto_rc_p_monto,
