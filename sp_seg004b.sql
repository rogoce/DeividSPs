...
drop procedure sp_seg004b;
create procedure "informix".sp_seg004b()
...
DEFINE a_chg_user				CHAR(8);
DEFINE a_registro				integer;
...
--SET DEBUG FILE TO "sp_seg004b.trc"; 
--TRACE ON;
...
foreach
  select cargo				,							   
    ...
    into _cargo				,							  
		 ...
		 a_usuario
    from cambio_user  
   where status = 'C'  --"R";       -- Modificacion -> despues de haber actualizado, tiene que volver a imprimir el preliminar.
     and fecha_cambio <= today
