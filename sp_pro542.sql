...
drop procedure sp_pro542;
create procedure sp_pro542(a_dias_vencida smallint)
...
on exception set _error, _error_isam, _error_desc
	...
	return '',_error_desc,_error,'01/01/1900','01/01/1900','01/01/1900',0,0.00,0.00,_error_isam,0,0,'',0;
end exception
...
foreach
	...
	if _saldo <> _monto_pen then
		...
		if _error <> 0 then
			return '',_error_desc,_error,'01/01/1900','01/01/1900','01/01/1900',0,0.00,0.00,0,0,0,'',0;
		else
			select no_documento
			  into _no_documento
			  from emipomae
