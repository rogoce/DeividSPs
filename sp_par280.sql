-- Procedimiento que genera las eliminaciones de unidades por perdida total
-- 
-- Creado     : 21/01/2008 - Autor: Demetrio Hurtado Almanza
-- Modificado : 01/03/2012 - Autor: Amado Perez M. --> Se agrego lo de la insercion de la descripcion
--
-- SIS v.2.0 - DEIVID, S.A.

drop procedure sp_par280;

create procedure sp_par280(
a_no_poliza		char(10),
a_no_unidad		char(5),
a_usuario		char(8),
a_saldo			dec(16,2),
a_cod_tipocalc	char(3) default "005"
) returning integer,
            char(50),
            char(5);
...
let _cod_endomov  = "005"; 			-- Eliminacion de Unidades
let _cod_tipocan  = null;           --  
let _cod_tipocalc = a_cod_tipocalc; -- Perdida
...
call sp_pro463(a_no_poliza, _no_endoso, a_no_unidad, _cant_dias, 1) returning _error, 
                                                                              _descripcion, 
                                                                              _prima, 
                                                                              _descuento, 
                                                                              _recargo, 
...
-- Insertando descripcion al endoso

call sp_par327(a_no_poliza, _no_endoso, a_no_unidad, _cod_endomov) returning _error, _descripcion;
...
--{
let _error = sp_sis61d(a_no_poliza);
