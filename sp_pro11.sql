 DROP procedure sp_pro11;
CREATE procedure "informix".sp_pro11(a_cia CHAR(3),a_agencia char(3),a_periodo1 CHAR(7))
...
--------------------------------------------
 ...
 BEGIN
    ...
    DEFINE v_suma_terremoto,v_suma_retencion,v_prima_retencion,
           v_suma_facultativo,v_prima_terremoto,v_prima_facult,
           v_suma_excedente,v_prima_excedente,v_suma_retenida      DEC(16,2);
    DEFINE v_porc_suma,v_porc_prima                                DEC(9,6);
    DEFINE prom_terremoto,prom_retencion,prom_facultativo,prom_excedente
           DEC(10,2);
             ...
             --Suma Asegurada Retencion
                SELECT d.porc_partic_suma,
                 ...
                 WHERE d.no_poliza = v_nopoliza
                   ...
                   AND d.cod_cober_reas = "001"

                LET v_suma_terremoto = 0;
                LET v_suma_retencion = 0;
                LET v_suma_facultativo = 0;
                LET v_suma_excedente   = 0;
                LET v_prima_terremoto  = 0;
                ...
                SELECT tipo_contrato
                 ...
                 WHERE cod_contrato = v_cod_contrato;
                  ...
                  IF v_tipo_contrato = 1 THEN
                      LET v_suma_retencion = v_suma_terremoto*v_porc_suma;
                      LET v_prima_retencion = v_suma_terremoto*v_porc_prima;
                  END IF;

                  --Suma Asegurada Facultativo
                  IF v_tipo_contrato = 3 THEN
                      LET v_suma_facultativo = v_suma_terremoto*v_porc_suma;
                      LET v_prima_facult = v_suma_terremoto*v_porc_prima;
                  END IF;

                  -- Excedente
                  IF v_tipo_contrato <>  1 THEN
                     IF v_tipo_contrato <> 3 THEN
                      LET v_tipo_contrato = 4;
                      LET v_suma_excedente  = v_suma_terremoto*v_porc_suma;
                      LET v_prima_excedente = v_suma_terremoto*v_porc_prima;
                     END IF;
                  END IF;
                ...
                BEGIN
                  ON EXCEPTION IN (-239)
                    UPDATE tmp_cumulos
                      SET suma_terremoto = suma_terremoto + v_suma_terremoto,
                          prima_terremoto = prima_terremoto + v_prima_terremoto,
    ...
    FOREACH WITH HOLD
       ...
       SELECT x.cod_ubica,x.suma_terremoto/1000,
              x.suma_retencion/1000,x.suma_facultativo/1000,
              x.suma_excedente/1000,x.prima_terremoto/1000,
              x.prima_retencion/1000,x.prima_facult/1000,
              x.prima_excedente/1000
              INTO v_cod_ubica,v_suma_terremoto,v_suma_retenida,
                   v_suma_facultativo,v_suma_excedente,v_prima_terremoto,
     ...
     GROUP BY cod_ubica;
       ...
       LET prom_terremoto   = v_suma_terremoto/cant_poliza1;
       ...
       SELECT z.nombre
         ...
         RETURN v_descr_cia,v_cod_ubica,v_desc_ubica,v_suma_terremoto,
                v_suma_retenida,v_suma_facultativo,v_suma_excedente,
                v_prima_terremoto,v_prima_retencion,v_prima_facult,
                v_prima_excedente,prom_terremoto,prom_retencion,
