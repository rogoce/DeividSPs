...
if _cod_sucursal = _sucursal_web then -- sucursal web ?  --and _cod_ramo <> '003'
	...
	if _nueva_renov = 'N' then
		...
		call sp_par380(_cod_contratante, _fecha_suscripcion) returning _error, _cedula, _nombre_pagad, _ponderacion; -- Verificación del perfil del contratante # 6906 -- Amado 23/06/2023
		if _error = 0 then
			return 11;
		end if
	end if
