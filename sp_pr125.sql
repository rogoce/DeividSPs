...
--- Modificado por Armando Moreno 19/01/2002; -- la parte de los tipo de contratos sp_pr860
------------------------------------------------
DROP PROCEDURE sp_pr125;
CREATE PROCEDURE sp_pr125(a_compania CHAR(03),a_agencia CHAR(03),a_periodo1 CHAR(07),a_periodo2 CHAR(07),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo  CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codusuario CHAR(255) DEFAULT "*",a_codramo  CHAR(255) DEFAULT "*",a_reaseguro   CHAR(255) DEFAULT "*"	)
...
--   Set debug file to "sp_pr125.trc"; 
