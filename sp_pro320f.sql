...
drop procedure sp_pro320f;
create procedure sp_pro320f(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10))
...
elif _cod_prod in ('07287','07377','08462','02699') then	
	-- Pueden proceder con la facturación, por favor actualizar los descriptivos (ya actualizados en los productos) de los siguientes productos: -- Bonizuth 10-09-2024
	-- 07287 FERIA - RICARDO PEREZ
	-- 07377 EXTRA-PLUS - CAJA DE AHORRO MEDICOS
	-- 08462 PRODUCTO FERIA - EXTRA PLUS
	-- 02699 AUTO COMPLETA (TU CHOFER PRIVADO)
	FOREACH
		select descripcion
		  into _texto
		  from prddesc
...
elif _cod_rammo in ('002','023','020') then
	foreach
...
if _ramo_sis = 1 then
	if _cod_rammo <> '024' then
		if _cod_rammo = '020' then
			...
			let _valor = sp_pro321d(v_poliza_nuevo,v_poliza);
