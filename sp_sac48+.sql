DROP PROCEDURE sp_cglr13;

CREATE PROCEDURE sp_cglr13(a_concepto CHAR(03) DEFAULT "*",a_comprobante CHAR(8) DEFAULT "*",a_notrx integer ,a_fecha_ini DATE ,a_fecha_fin DATE ,a_usuario CHAR(15) DEFAULT "*") RETURNING  char(3),
	       char(30),
               date,
               integer,
               char(8),
           ...
           IF l_auxiliar = "S" THEN 
              ...
              FOREACH 
                SELECT trx3_linea,trx3_cuenta,trx3_auxiliar,trx3_debito,trx3_credito
                  INTO d_linea,d_cuenta,d_auxiliar,d_debito,d_credito
                  FROM cgltrx3
