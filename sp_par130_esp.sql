...
drop procedure sp_par130_esp;
create procedure sp_par130_esp(
a_no_poliza		char(10),
a_usuario		char(8),
a_saldo			dec(16,2)
) returning integer,
...
let _cod_tipocan  = "005"; -- Cancelacion sol de Acrredor Hipotecario
let _cod_tipocalc = "006"; -- Manual
let _null		  = null;  -- Para campos null

--let _cod_tipocalc = "004"; -- Por Saldo
...
if a_no_poliza = "94372" then
	let _no_endoso_int = 2;
elif a_no_poliza = "194748" then
	let _no_endoso_int = 4;
elif a_no_poliza = "360302" then
	let _no_endoso_int = 5;
elif a_no_poliza = "415477" then
	let _no_endoso_int = 7;
elif a_no_poliza = "312927" then
	let _no_endoso_int = 4;
elif a_no_poliza = "353064" then
	let _no_endoso_int = 5;
elif a_no_poliza = "1135571" then
	let _no_endoso_int = 3;
elif a_no_poliza = "874412" then
	let _no_endoso_int = 12;
elif a_no_poliza = "1710141" then
	let _no_endoso_int = 3;	
end if
