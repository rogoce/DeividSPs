...
--execute procedure sp_che81b("001","001","2010-02","informix")

DROP PROCEDURE sp_che81b;

CREATE PROCEDURE sp_che81b
(
a_compania          CHAR(3),
a_sucursal          CHAR(3),
a_periodo		    CHAR(7),
