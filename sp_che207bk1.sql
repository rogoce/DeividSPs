...
--DROP PROCEDURE sp_che207bk1;

CREATE PROCEDURE sp_che207bk1(a_compania CHAR(3))
RETURNING SMALLINT;
...
FOREACH
	select cod_agente, categoria
	 ...
	 {   if _cod_agente in ("01769","00030","00620","00226","00124","00119","01901","01417","00708","01669","00081","00833","01642","01583","01959","00863","00809","02040","00811","00208","01436","00874","00470","00244","01618") then
		   let _categoria = 2;
		   update tropical2
		 ...
		 let _no_poliza = sp_sis21(_no_documento);
		   ...
		   select count(*)
			...
			foreach
				...
				-- De acuero a memo del 7 de sep de 2012
				-- Demetrio Hurtado
...
foreach
	...
	-- Unificar Lideres en seguros A lideres en seg santiago
	if _cod_agente IN ("01009") then  
		let _cod_agente = "01990";													
	end if
	-- Unificar B&G insurance group, s.a. A B&G insurance group chitre
	if _cod_agente IN ("01670") then  
		let _cod_agente = "02103";													
	end if
