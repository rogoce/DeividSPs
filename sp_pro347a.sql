	...
	Select no_poliza,
	 ...
	 where seleccionado = 1
		...
		foreach
			...
			Select count(*)
			  into _cant_reg
			  from deivid_bo:atttauto
			 where no_documento = _no_documento
			   and no_unidad	= _no_unidad
			
			if _cant_reg = 0 then
				insert into deivid_bo:atttauto(aseguradora_cod,
											   poliza_num,
											   id_unico,
											   accion,
											   poliza_fecha_expedida,
											   poliza_estado,
											   persona_tipo,
											   acreedor_nombre,
											   tipo_documento,
											   ...
											   fecha_etl,
											   fecha_etl_modificacion)
									   	values('8',						
									   		   _no_documento,			
									   		   _no_unidad,				
									   		   'I',						
									   		   _fecha_suscripcion_char,	
									   		   _status,					
									   		   _tipo_persona,			
									   		   _nom_acreedor,			
									   		   _tipo_id,				
									   		   ...
									   		   _no_chasis,				
									   		   _vin,					
									   		   _fecha_extraccion_char,	
									   		   _fecha_cancelacion_char,	
									   		   '',
									   		   _user_added,		  		
									   		   '',	  	
									   		   _fecha_registro_char,	
									   		   '');			 
			else
				update deivid_bo:atttauto set aseguradora_cod			= '8',										  				
											  accion					= _accion,						
											  poliza_fecha_expedida		= _fecha_suscripcion_char,
											  poliza_estado				= _status,					
											  persona_tipo				= _tipo_persona,			
											  acreedor_nombre			= _nom_acreedor,			
											  tipo_documento			= _tipo_id,				
											  asegurado_id				= _aseg_id,				
											  asegurado_nombre			= _aseg_nombre,			
											  asegurado_nombre2			= _aseg_seg_nombre,		
											  asegurado_apellido		= _aseg_apellido,			
											  asegurado_apellido2		= _aseg_seg_apellido,		
											  asegurado_apellido_casada	= _aseg_apellido_cas,		
											  auto_placa				= _placa,					
											  auto_marca				= _nom_marca,				
											  auto_modelo				= _nom_modelo,				
											  auto_tipo					= _nom_tipo_veh,			
											  auto_anio					= _ano_auto,				
											  auto_motor				= _no_motor,				
											  auto_chasis				= _no_chasis,				
											  auto_vin					= _vin,					
											  fecha_extraccion			= _fecha_extraccion_char,	
											  fecha_cancelacion			= _fecha_cancelacion_char,
											  fecha_modificacion		= '',
											  usuario_creacion			= _user_added,		  		
											  usuario_modificacion		= _user_modificacion,	  	
											  fecha_etl					= '',	
											  fecha_etl_modificacion	= _fecha_registro_char; 				
				  									
  {

			return '8',						  --1id_aseg,			 			 aseguradora_cod
				   _no_documento,			  --2_no_documento		 			 poliza_num
				   _no_unidad,				  --no_unidad			 			 id_unico
				   'I',												 			 accion
				   _fecha_suscripcion_char,	  --3_fecha_suscripcion	 			 poliza_fecha_expedida
				   _status,					  --4_status			 			 poliza_estado
				   _tipo_persona,			  --5_tipo_persona		 			 persona_tipo
				   _nom_acreedor,			  --6_nom_acreedor					 acreedor_nombre
				   _tipo_id,				  --7_tipo_id						 tipo_documento
				   _aseg_id,				  --8_aseg_id						 asegurado_id
				   _aseg_nombre,			  --9_aseg_nombre					 asegurado_nombre
				   _aseg_seg_nombre,		  --10_aseg_seg_nombre				 asegurado_nombre2
				   _aseg_apellido,			  --11_aseg_apellido				 asegurado_apellido
				   _aseg_seg_apellido,		  --12_aseg_seg_apellido			 asegurado_apellido2
				   _aseg_apellido_cas,		  --13_aseg_apellido_cas			 asegurado_apellido_casada
				   _placa,					  --14_placa						 auto_placa
				   _nom_marca,				  --15_nom_marca					 auto_marca
				   _nom_modelo,				  --16_nom_modelo					 auto_modelo
				   _nom_tipo_veh,			  --17_nom_tipo_veh					 auto_tipo
				   _ano_auto,				  --18_ano_auto						 auto_anio
				   _no_motor,				  --19_no_motor						 auto_motor
				   _no_chasis,				  --20_no_chasis					 auto_chasis
				   _vin,					  --21_vin							 auto_vin
				   _fecha_extraccion_char,	  --22_fecha_extraccion				 fecha_extraccion
				   _fecha_cancelacion_char,	  --23_fecha_cancelacion			 fecha_cancelacion
				   _fecha_modificacion_char,  --24_fecha_modificacion			 fecha_modificacion
				   _user_added,		  		  --25_user_added					 usuario_creacion
				   _user_modificacion,	  	  --26_user_modificacion			 usuario_modificacion
				   _fecha_registro_char,	  --27_fecha_etl					 fecha_etl
				   _fecha_hoy_datetime_char	  --28_fecha_hoy_datetime_char		 fecha_etl_modificacion
				   with resume;	    }
