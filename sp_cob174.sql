-- Procedimiento que Obtiene el saldo de una poliza
-- 
-- Creado    : 27/12/2004 - Autor: Demetrio Hurtado Almanza
-- 
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_cob174;

CREATE PROCEDURE "informix".sp_cob174(
