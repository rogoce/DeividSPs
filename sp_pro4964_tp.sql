DROP procedure sp_pro4964_tp;
   CREATE procedure "informix".sp_pro4964_tp(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7), a_periodo2 CHAR(7), a_origen CHAR(3) DEFAULT '%')
	  ...
	  END IF  	  	  
       ...
       FOREACH 
		SELECT 	no_unidad,          		 
          ...
          SELECT uso_auto,
				 cod_tipoveh-- C - Comercial o P - Particular
            INTO _uso_auto,
				 _cod_tipoveh
            FROM emiauto
           WHERE no_poliza = _no_poliza
