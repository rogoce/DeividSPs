...
on exception set _error, _error_isam, _error_desc
	...
	drop table if exists tmp_asientos;
...
--Verificación de Montos en Pago de Comisiones de Corredor
foreach
	select c.no_requis,
		   c.cod_banco,
		   c.cod_chequera,
	  ...
	  into _no_requis,
		   ...
		   _cta_chequera,
		   _periodo2
	  from chqchmae c, chqbanco b
	 where c.cod_banco = b.cod_banco
	   and c.origen_cheque in ('2','8','I')
	   and c.pagado = 1
	   and c.anulado = 0
	   and c.fecha_impresion >= '01/01/2025'
	--   and c.no_requis not in ('819585','825199','827685','827952','826443','825201','833661','884965','906835','906837','908202','908203','909861','909961','911516','911517','913040')

	-- Cuenta del Banco
	if _cod_origen = '001' then
		if _cta_chequera = 1 then
			let _cuenta = sp_sis15('BACHEQL', '02', _cod_banco, _cod_chequera); -- Chequera Bancos Locales
		else
	...
	if (_monto_cheque + _monto2) <> 0 then   
		return _no_requis,
			   _cuenta,
			   _monto_cheque,
			   _monto2,
			   (_monto2 + _monto_cheque),
			   "",
			   _periodo2,
			   "COM"	
			   with resume;
