--Reportes de detalle de RRC y Partcipacion saldo Acumulado
--Armando Moreno M.    23/07/2025

drop procedure sp_reserva_riesgo1;
create procedure sp_reserva_riesgo1(a_periodo char(7))
...
define _rrc_cedida,_rrc_100,_db,_cr dec(16,2);
