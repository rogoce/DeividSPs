...
--			end if			
			...
			if _xnivel = '001' then
				...
				LET v_prima70 = v_prima50 * 0.70 ;
				LET v_prima30 =	v_prima50 * 0.30 ;

				LET _comision70 = v_prima70 * 0.42 ;
				LET _comision30 = v_prima30 * 0.225 ;

				LET _impuesto70 = v_prima70 * 0.02 ;
				LET _impuesto30 = v_prima30 * 0.02 ;

				LET _por_pagar70 = v_prima70 - _comision70 - _impuesto70 ;
				LET _por_pagar30 = v_prima30 - _comision30 - _impuesto30 ;

				LET _siniestro70 = _siniestro50 * 1 ;
				LET _siniestro30 = _siniestro50 * 0 ;	 				

				BEGIN
				ON EXCEPTION IN(-239)
					UPDATE reacoest									--reacoret
