...
FOREACH
       SELECT r.serie,t.cod_ramo,sum(t.pagado_neto)
        ...
        where r.cod_contrato = t.cod_contrato
          ...
          and r.serie >= 2008  
          and t.cod_ramo in ("010","011","012","013","014","001","003")
     group by r.serie,t.cod_ramo
     order by r.serie,t.cod_ramo

		if (as_cod_ramo = "010" or as_cod_ramo = "011" or as_cod_ramo = "012" or as_cod_ramo = "013"  or as_cod_ramo = "014" or as_cod_ramo = "001"  or as_cod_ramo = "003") then 
		else
			continue foreach;
		end if
