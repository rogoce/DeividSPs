--Procedimiento para realizar la carga en Rentabilidad2 para BONO DE RENTABILIDAD OPCION 2
--Creado 25/01/2016	Armando Moreno M.

DROP PROCEDURE sp_che222b;
CREATE PROCEDURE sp_che222b(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
let a_periodo   = '2016-02';  --****PONER COMENTARIO CUANDO CORRE ANUAL
