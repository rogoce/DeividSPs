...
DROP PROCEDURE sp_sis11a;

CREATE PROCEDURE "informix".sp_sis11a(neto DECIMAL(16,2))
...
--Condicion para poder calcular Centavos
  IF val_tem = 0 THEN
     ...
     LET val_let = "CERO BALBOAS CON " || val_tem || "/100";
     RETURN (val_let);
  END IF
  LET total = val_tem;
...
--         END IF
 ...
 IF var_centavo = 0 THEN
   ...
   ELSE
    LET val_let = TRIM(val_let) || " BALBOAS CON " || TRIM(centavo) || "/100";
   END IF
 ELSE
