...
drop procedure sp_pr850_tamm;
create procedure sp_pr850_tamm(a_compania char(03),a_agencia char(03),a_periodo1 char(07),a_periodo2 char(07),a_codsucursal char(255)	default '*',a_codgrupo char(255) default '*',
...
let _borderaux = '11';	    -- bouquet -- prima suscrita
let _nom_contrato = '';
select tipo 
  into _tipo2
  from reacontr
...
--rop table if exists temp_produccion;
