...
drop procedure msp_imp06;
create procedure "informix".msp_imp06(a_poliza char(10), a_endoso char(5))
...
foreach	
    ...
    if _cod_cobertura in('01299') then
		let _prima = 22902.99;
	elif _cod_cobertura in('01307') then
		let _prima = 64207.97;
	elif _cod_cobertura in('01304') then
		let _prima = 51468.49;
	end if
