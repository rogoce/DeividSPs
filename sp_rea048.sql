-- Simulacion COBROS
-- Creado    : 14/09/2012 - Autor: Armando Moreno

DROP PROCEDURE sp_rea048;
CREATE PROCEDURE sp_rea048(a_cod_contrato CHAR(5),a_db char(18))
