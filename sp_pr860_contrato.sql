...
foreach
	select serie,
	  ...
	  into _serie,
		   ...
		   v_prima 
	  from temphg
	 where cod_coasegur in ('153','050','063','076','042','036','089','128','117','134','136','141','146','147','149','077') 
	   and anio      = _anio_reas
	   and trimestre = _trim_reas
	...
	foreach 
		select distinct cod_coasegur,
		  ...
		  from temphg
		 Where serie         = _serie
		   and cod_coasegur in  ('050','063','076','042','036','089','128','117','134','136','141','146','147','149','153','077')
