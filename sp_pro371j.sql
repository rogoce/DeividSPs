...
--
-- Copia del sp_pro371g
-- Creado: 04/10/2022 - Autor: HGIRON#4652
-- 2.	TXT para código -02904- Unity Willis Towers Watson
-- a.	Debe generar data de cartera que pertenezca a los siguientes grupos:
-- b.	1122 GRUPO DUCRUET-BANISI
-- c.	77960 BANISI COLECTIVOS DESGRAVAMEN
-- d.	TRASPASO ASA GENERALI BANISI

-- sis v.2.0 - deivid, s.a.

drop procedure sp_pro371j;
create procedure "informix".sp_pro371j(a_periodo char(7))
...
foreach
	select trim(no_documento),   
	 ...
	 where periodo = a_periodo
	   ...
	   and cod_grupo in ('1122','77850','77960')   -- SD#4652 04/10/2022 
	  --and prima_lesiones_corp <> 0 and cod_grupo in ('1122','77850','77857','77960')   -- SD#3010 77960  11/04/2022 10:00
...
{
	update emirenduc
	   set enviado = 9  ---para no afectar la prueba
