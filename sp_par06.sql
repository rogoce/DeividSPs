-- Reporte de Clientes creados para un dia dado.

-- Creado    : 13/06/2001 - Autor: Armando Moreno M.
-- Modificado: 13/06/2001 - Autor: Armando Moreno M.

-- SIS v.2.0 - d_para_sp_par06_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_par06;

CREATE PROCEDURE sp_par06(a_compania CHAR(3), a_sucursal CHAR(3), a_fecha DATE)
