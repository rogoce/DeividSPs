--***********************************************************************************
-- Procedimiento que genera la tabla cooler para consurso arma tu cooler
--***********************************************************************************

-- Creado    : 24/02/2014 - Autor: Armando Moreno M.
-- Modificado: 24/02/2014 - Autor: Armando Moreno M.

-- SIS v.2.0 - DEIVID, S.A.

--DROP PROCEDURE sp_pro868;

CREATE PROCEDURE sp_pro868(
a_compania          CHAR(3),
a_sucursal          CHAR(3))
RETURNING SMALLINT;
...
let _fecha_aa_ini = "15/01/2014";
let _fecha_aa_fin = "28/02/2014";
...
--Periodo de Clasificacion: Del 15 de enero. de 2014 al  28 de feb del 2014
--Metas: 
--Ducruet:00035/Semusa:00270/Tecnica de Seguros:00180/Uniseguros:00141 = 60,000 Primas Suscrita Nueva
--Individual: B/.    5,000  Primas Suscrita Nueva
--Brokers :   B/.   25,000  Primas Suscrita Nueva
--*****************************
-- Polizas Nuevas
--*****************************
foreach
  ...
  where cod_compania  = a_compania
   ...
   { select count(*)
	...
	if _nueva_renov = "N" then
		insert into tmp_caribe(no_documento,pri_sus)
...
foreach
	 ...
	 foreach
		...
		if _cod_agente in('00035','00270','00180','00141') then   --Ducruet:00035/Semusa:00270/Tecnica de Seguros:00180/Uniseguros:00141 = 60,000
			let _valor = 60000;
			let _nombre_tipo = "DUC.-SEM.-TEC.-UNI.";
		end if

		let _dif = 0; --_valor - _pri_pag;
