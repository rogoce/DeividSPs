...
drop procedure sp_atc29;
create procedure sp_atc29(a_fecha1 date, a_fecha2 date)
RETURNING char(20), char(10), VARCHAR(100), SMALLINT, SMALLINT, SMALLINT, SMALLINT, char(8), CHAR(3), DATE, char(5), CHAR(30), char(100);
...
ON EXCEPTION SET r_error, r_error_isam, r_descripcion
 	RETURN r_error, r_error, r_descripcion, 0,0,0,0,null,null,null,null,null,null;
END EXCEPTION
...
FOREACH
	select no_boleto,
	  ...
	  into v_no_boleto,
		   ...
		   v_date_changed	
	  from atcacbdd
	 where date_changed >= a_fecha1  
	   and date_changed <= a_fecha2
