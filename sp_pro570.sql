...
------------------------------------------------
drop procedure sp_pro570;
create procedure sp_pro570(a_periodo char(7),
                            a_opcion smallint,
...
let _cust_qry4 = " and a.no_documento like ?) and (a.tipo_cambio = 0 or a.tipo_cambio = 3) and (b.estatus_poliza not in (2,4)) ";
