...
RETURNING CHAR(10) 	as NEMP,
 ...
 BEGIN
	...
	create temp table tmp_pro1106(
			...
			n_grupo			char(30),
			sexo            char(1),
			forma_pago      char(1), primary key (no_documento, n_asegurado, tipo_aseg)
			) with no log;
   ...
   -- trace on;
	...
	CALL sp_sis04('01822,01823,01824,01825,01826,01827,01828,01829,01830,01831,01840,01853,01857,01863,01867,01868,01899;') returning _filtros;	
