...
-- Modificado: HGIRON Fecha: 14042020
--  execute procedure sp_rec148_1("103222") 
...
define _reclamante	         char(100);                     --3 -- 1.1  Nombre del Reclamante
define _cod_hospital     	 char(10);						--4 -- 2	Cod	del Cliente	Hospital/Proveedor
...
define _deducible_local		 decimal(16,2);
define _deducible_fuera      decimal(16,2);
define _coaseguro_hasta      decimal(16,2);
define _coaseguro_fuera      decimal(16,2);
...
define _dtotal_local      	 decimal(16,2);
define _dtotal_int	         decimal(16,2);
define _stotal_local         decimal(16,2);
define _stotal_int     		 decimal(16,2);

SET ISOLATION TO DIRTY READ;
--if a_aprob = '105603' then
		...
		SELECT  no_aprobacion,      		 --	 1
		 ...
		 select cod_producto, 
		  ...
		  SELECT recacuan.monto_deducible, 
				 ...
				 recacuan.monto_coaseguro, 
				 recacuan.monto_coaseguro2
           ...
           WHERE ( recacuan.no_documento = _no_documento ) 
			 ...
			 AND (recacuan.no_unidad = _no_unidad) 
			 and (ano = year(_fecha_autorizacion));
	    --ORDER BY recacuan.ano ASC;

			let _dtotal_local		= _deducible_local - _monto_deducible; 
			let _dtotal_int	        = _deducible_fuera	- _monto_deducible2;
			let _stotal_local  		= _coaseguro_hasta  - _monto_coaseguro;     
			let _stotal_int     	= _coaseguro_fuera - _monto_coaseguro2;		 
