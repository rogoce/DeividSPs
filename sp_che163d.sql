...
DROP PROCEDURE sp_che163d;

CREATE PROCEDURE sp_che163d(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo CHAR(7), a_verif_tipo_pago SMALLINT DEFAULT 0) 
...
LET _fecha_desde = "29/12/2021";
LET _fecha_hasta = "27/09/2022";
