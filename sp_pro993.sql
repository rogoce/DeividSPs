...
-- SIS v.2.0 - d_prod_sp_pro993_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_pro993;
CREATE PROCEDURE "informix".sp_pro993(a_sucursal char(3), a_mes smallint, a_codramo char(255))
...
--set debug file to "sp_pro993.trc";	  	  	  	
--trace on;
