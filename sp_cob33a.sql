-- Procedimiento que Genera la Morosidad para un Documento pero hasta 180 dias
-- usado en reporte de cobros por seccion.
-- 
-- Creado    : 08/06/2004 - Autor: Armando Moreno M.
-- modificado: 08/06/2004 - Autor: Armando Moreno M.
-- 
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_cob33a;

CREATE PROCEDURE "informix".sp_cob33a(
a_compania     CHAR(3), 
a_sucursal     CHAR(3), 
