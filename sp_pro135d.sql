...
DROP PROCEDURE sp_pro135d;

CREATE PROCEDURE "informix".sp_pro135d(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_fecha1   DATE  
)
...
DEFINE _cod_agente, _no_endoso CHAR(5); 
...
LET v_filtros = sp_pro135b(
 ...
 FOREACH
    ...
    FOREACH 
		SELECT a.porc_partic_suma,
		       a.porc_partic_prima
		  INTO _porc_partic_suma,
		       _porc_partic_prima
		  FROM recreaco a, reacomae b
		 WHERE a.no_reclamo = _no_reclamo
		   AND a.cod_contrato = b.cod_contrato
		   AND b.tipo_contrato = 5

        LET _incurrido_bruto = _incurrido_bruto * _porc_partic_suma / 100;
        LET _siniestro_pagado = _siniestro_pagado * _porc_partic_suma / 100;
