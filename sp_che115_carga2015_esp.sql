...
DROP PROCEDURE sp_che115_carga2015_esp;
CREATE PROCEDURE sp_che115_carga2015_esp(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
delete from rentabilidad9 where periodo = a_periodo;
