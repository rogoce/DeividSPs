...
--DROP PROCEDURE sp_rea036;

CREATE PROCEDURE "informix".sp_rea036(a_compania  CHAR(3),a_agencia   CHAR(3),a_periodo1  CHAR(7),a_periodo2  CHAR(7),a_sucursal  CHAR(255) DEFAULT "*",a_grupo CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_agente CHAR(255) DEFAULT "*",a_ajustador CHAR(255) DEFAULT "*",a_evento CHAR(255) DEFAULT "*",a_suceso CHAR(255) DEFAULT "*",a_subramo CHAR(255) DEFAULT "*") RETURNING CHAR(255);
...
DEFINE _posible_recobro,_cnt INT;
...
FOREACH
 SELECT a.no_reclamo,
  ...
  WHERE a.cod_compania = a_compania
	...
	SELECT no_poliza,
     ...
     SELECT count(*)
      ...
      WHERE (endedmae.periodo    >= a_periodo1
		...
		AND endedmae.cod_endomov  = "017"     --Cambio de Reaseguro Indiv.
    ...
    FOREACH
	SELECT sum(recreaco.porc_partic_suma)
	  INTO _porc_reas
