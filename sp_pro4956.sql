...
------------------------------------------------
drop procedure sp_pro4956;
create procedure sp_pro4956(a_periodo char(7),
...
drop table if exists temp_carta2012;
	...
	/*Verifica si la poliza cambio de corredor ducruet tipo cambio 3*/
	--call sp_pro4956a('161216');
