...
DROP procedure sp_pro02b;
CREATE procedure "informix".sp_pro02b(a_compania CHAR(3),a_agencia CHAR(03) DEFAULT "*",a_periodo DATE,a_codsucursal  CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*")
   RETURNING DEC(16,2),DEC(16,2),SMALLINT,DEC(16,2),DEC(16,2),
 ...
 BEGIN
    ...
    DEFINE v_desc_ramo,descr_cia        VARCHAR(45);
...
--          CONTINUE FOREACH;
       ...
       BEGIN
          ON EXCEPTION IN(-239)
             UPDATE temp_civil
                    SET suma_excedente  = suma_excedente  + v_excedente,
                        prima_excedente = prima_excedente + v_prima_excedente,
						suma_retenida   = suma_retenida   + v_retencion,
                        prima_retenida  = prima_retenida  + v_prima_retencion,
