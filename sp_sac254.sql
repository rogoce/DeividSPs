...
-- Procedimiento que busca diferencias entre la requisición vs el mayor, cuenta del banco
-- Creado    : 29/12/2008 - Autor: Henry Girón
-- SIS v.2.0 - DEIVID, S.A.	
-- execute procedure sp_sac155('121020402','COB12091','18/12/2009')

drop procedure sp_sac254;
create procedure sp_sac254(a_fecha date, a_fecha2 date) 
