...
drop procedure sp_pro320amm;
create procedure sp_pro320amm(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10))
...
define _suma_asegurada,my_sessionid integer;
...
set debug file to "sp_pro320amm.trc";
trace on;

insert into deivid_tmp:emipomae_f
select *,my_sessionid
  from deivid_tmp:emipomae
 where no_poliza = '00003';
...
select anos_pagador,
       ...
       saldo_por_unidad,
       cod_ramo,
       no_documento,carta_aviso_canc,fecha_aviso_canc,no_renovar
  Into r_anos,
       _vigencia_final,
       _saldo_unidad,
	   _cod_rammo,
	   _no_documento,_carta_aviso_canc,_fecha_aviso_canc,_no_ren_pol
  from deivid_tmp:emipomae_f
 where no_poliza = '00003'
   and sessionid = my_sessionid;

let v_poliza_nuevo = '0000785';
...
insert into deivid_tmp:emipomae
