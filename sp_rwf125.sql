...
drop procedure sp_rwf125;

create procedure sp_rwf125(a_no_reclamo char(10), a_opcion smallint, a_monto dec(16,2), a_user_name_ajust CHAR(20), a_cod_cobertura CHAR(5)) 
  returning integer,
            char(50),
            char(10);
