...
----------------------------------------------------------
drop procedure sp_sis452;
create procedure sp_sis452(a_no_poliza char(10), a_no_endoso char(10), a_cod_coasegur char(3))
returning	date;
...
if _cod_perfac is null or  _cod_perfac = '' then
...
if a_no_poliza = '0001193464' then
	let _mes = _dia_garantia/30;
	let _fecha_pago = _fecha_primer_pago + _mes units month; 
elif a_no_poliza in ('1292187', '1292444','1295718', '1311476', '1335956') then
	let _fecha_pago = _fecha_primer_pago;
else
--	let _fecha_pago = _fecha_primer_pago + _dia_garantia units day; ojo
end if

--let _fecha_primer_pago = _fecha_pago;  ojo
