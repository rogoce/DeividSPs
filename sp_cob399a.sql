...
drop procedure sp_cob399a;
create procedure sp_cob399a()
...
let _cod_campana = '01089';
let _cod_gestion = '045';
...
foreach
	select tmp.no_documento,
	  ...
	  inner join emipomae emi on emi.no_documento = tmp.no_documento
	  where tmp.vigencia_inic between '01/03/2026' and '31/03/2026'
