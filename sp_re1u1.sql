...
DROP PROCEDURE sp_rec01u1;

CREATE PROCEDURE "informix".sp_rec01u1(
		a_compania  CHAR(3),
		a_agencia   CHAR(3),
		a_periodo1  CHAR(7),
		a_periodo2  CHAR(7),
...
{FOREACH
	...
	LET _incurrido_abierto = _reserva_bruto + _pagado_bruto;

	UPDATE tmp_sinis
   	   SET incurrido_abierto = _incurrido_abierto
	 WHERE no_reclamo = v_no_reclamo;
