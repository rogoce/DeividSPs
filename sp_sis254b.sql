...
drop procedure sp_sis254b;

create procedure sp_sis254b(a_periodo char(7), a_tipo_ren smallint default 0)
...
foreach
	select distinct no_documento
	 ...
	 where periodo = a_periodo 
	   ...
	   and prima_neta <> 0
	   and pre_renovado = 1
	--   and no_documento not in ('0223-07705-09')
	--   and cod_producto in ('00313','00318','07159')
...
foreach
	select distinct a.no_poliza,
	 ...
	 --  and b.no_documento = '0213-00130-10'
    union
	select a.no_poliza,
	   b.no_documento,
	   a.saldo
