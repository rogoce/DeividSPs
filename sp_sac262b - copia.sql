...
-- es copia del sp_che02

DROP PROCEDURE sp_sac262b;
CREATE PROCEDURE sp_sac262b(
a_compania          CHAR(3),
a_sucursal          CHAR(3),
a_fecha_desde       DATE,   
a_fecha_hasta       DATE,   
...
FOREACH 
 SELECT a.no_requis,
  ...
  WHERE a.fecha_impresion >= a_fecha_desde
...
FOREACH 
 SELECT a.no_requis,
   ...
   INTO _no_requis,
		...
		_porc_comis
   FROM chqchmae a, chqchpol b, chqchpoa c
  WHERE a.fecha_anulado >= a_fecha_desde
