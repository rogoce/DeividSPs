drop procedure sp_grupo_poliza_rev_a;

create procedure "informix".sp_grupo_poliza_rev_a() 
...
foreach
	SELECT no_documento,   
      ...
      into _no_documento,   
      	   ...
      	   _cod_pagador_cas        
      FROM cascliente_rev
     where no_documento  in ('0209-00075-04','0210-00312-01','0210-01096-01','0304-00188-01','0208-00747-02','0601-00040-01','0101-00128-01','0201-01256-01','0210-00718-01','1807-00669-01','0207-01597-01','0609-00005-03')
	  call sp_sis21(_no_documento) returning _no_poliza;
	  
	  select cod_correcto
	    into _cod_pagador_orig
	    from clidepur
	   where cod_errado = _cod_pagador_orig;																		
