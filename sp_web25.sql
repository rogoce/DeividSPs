...
-- Creado    : 16/10/2000 - Autor: Enocjahaziel CARRASCO

-- SIS v.2.0 - d_prod_sp_pro30a_dw1 - DEIVID, S.A.
					   
DROP PROCEDURE sp_web25;
CREATE PROCEDURE sp_web25(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo CHAR(7),a_no_poliza char(10), a_no_factura char(10) ) 
RETURNING CHAR(10),
		  CHAR(5),
		  CHAR(100),
		  CHAR(1),
...
CALL sp_web24(a_compania,a_sucursal,a_periodo, a_no_poliza, a_no_factura);
