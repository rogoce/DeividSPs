--DROP PROCEDURE sp_rea035;

CREATE PROCEDURE "informix".sp_rea035(a_compania CHAR(3),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(255) DEFAULT "*",a_contrato CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_serie CHAR(255) DEFAULT "*") 
...
LET v_filtros = sp_rea036(a_compania,a_agencia, a_periodo1,a_periodo2,a_sucursal,'*', a_ramo,'*','*','*','*','*'); 
...
FOREACH 
 SELECT no_reclamo,		
   ...
   INTO	_no_reclamo, 		
	    ...
	    _incurrido_neto	
   FROM tmp_sinis 
  WHERE seleccionado = 1  --and  no_reclamo =  '240046'
   GROUP BY no_reclamo,		
 		no_poliza,	
		cod_ramo,		
		periodo,
