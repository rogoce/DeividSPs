...
-- Creado    : 29/03/2011 - Autor: Henry Giron
-- SIS v.2.0 - DEIVID, S.A.

DROP procedure sp_pro849b;
CREATE procedure "informix".sp_pro849b(a_compania CHAR(03),a_agencia CHAR(3),a_periodo1 CHAR(07),a_periodo2 CHAR(7),a_codramo CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_codcoasegur CHAR(255) DEFAULT "*",a_useradd CHAR(255) DEFAULT "*",a_reaseguro CHAR(255) DEFAULT "*",a_cod_cliente CHAR(255) DEFAULT "*",a_no_documento CHAR(255) DEFAULT "*",a_fronting SMALLINT DEFAULT 0)
RETURNING CHAR(50),
		  CHAR(03),
		  CHAR(50),
		  CHAR(03),
   ...
   BEGIN
      ...
      CREATE INDEX iend1_tmp_pro849b ON tmp_pro849b(cod_grupo);
      CREATE INDEX iend2_tmp_pro849b ON tmp_pro849b(cod_ramo);
      CREATE INDEX iend3_tmp_pro849b ON tmp_pro849b(cod_coasegur);
      CREATE INDEX iend4_tmp_pro849b ON tmp_pro849b(cod_sucursal);
      CREATE INDEX iend5_tmp_pro849b ON tmp_pro849b(tipo_produccion);
      CREATE INDEX iend6_tmp_pro849b ON tmp_pro849b(cod_coasegur,cod_ramo,no_documento);
