...
drop procedure sp_cob232;

create procedure sp_cob232(a_no_caja char(10))
returning char(10),
          char(1),
          char(30),
          char(50),
...
--SET DEBUG FILE TO "sp_cob232.trc";
--trace on;
...
*/
        if (_no_remesa in ('1503659','1503287') and _renglon = 2) then--or _no_remesa in ('1820105') then
		else		
