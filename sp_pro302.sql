...
--------------------------------------------
		...
		------------------------------ DROP procedure sp_pro95;  -- NUevo procedimiento sp_pro302.sql

-- DROP procedure sp_pro302;

CREATE procedure "informix".sp_pro302(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codramo CHAR(255), a_reaseguro CHAR(255)  DEFAULT "*")
