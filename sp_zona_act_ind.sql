...
-- 
--
DROP PROCEDURE sp_zona_act_ind;

CREATE PROCEDURE "informix".sp_zona_act_ind(a_zona CHAR(03), a_poliza char(20), a_zona_poner char(3))
...
FOREACH
		 ...
		 SELECT	e.cod_ubica,
		   ...
		   INTO _cod_ubica,
		        _no_unidad,
				_no_poliza
		   FROM	endcuend e, emipomae d
		  WHERE e.no_poliza = d.no_poliza
            and d.no_documento = a_poliza
            and e.cod_ubica = a_zona
