DROP PROCEDURE sp_pro342;
CREATE PROCEDURE sp_pro342()
RETURNING 
CHAR(20)	as poliza,   --1 no_documento
char(10)	as no_poliza,	--2 no_poliza
char(5)		as endoso,	--3 no_endoso
char(5)		as unidad,	--4 no_unidad
dec(16,2)	as monto_endedmae,	--5 endedmae
dec(16,2)	as monto_endeduni,	--6 endeduni
dec(16,2)	as monto_emifacon,  --7 emifacon
char(7)		as periodo;	--8 periodo
...
--**************************
call sp_sis212a(a_periodo2,a_periodo2,"018;") returning _error,_mensaje;
END
END PROCEDURE; 