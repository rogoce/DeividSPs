...
DROP PROCEDURE sp_atc03;

CREATE PROCEDURE "informix".sp_atc03(a_compania CHAR(3),a_sucursal CHAR(3),a_agente CHAR(10),a_ano integer, a_usuario CHAR(10), a_membrete SMALLINT DEFAULT 0)
RETURNING	CHAR(20),
			VARCHAR(100), -- PAGADOR
			DEC(16,2),    -- SALDO
			VARCHAR(30),  -- CEDULA
