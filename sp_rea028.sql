...
FOREACH
	select distinct c.fecha,
	 ...
	 from sac999:reacompasie b, sac999:reacomp c,
          ...
          deivid:temp_produccion f,cobredet r
	where b.no_registro   = c.no_registro
	  and c.tipo_registro = "2"
	  and d.no_registro   = b.no_registro
	  and d.cod_auxiliar  = t.ter_codigo
	  and f.seleccionado  = 1        
      and f.no_poliza     = r.no_poliza        
      and f.no_recibo     = r.no_recibo        
      and c.no_poliza     = f.no_poliza        
      and r.no_remesa     = c.no_remesa        
      and r.doc_remesa    = c.no_documento	        		
