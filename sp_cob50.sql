...
drop procedure sp_cob50;

create procedure sp_cob50(
a_compania		char(3),
a_sucursal		char(3),
a_user			char(8),
a_tipo          char(1))
...
foreach with hold
	...
	--Procedimiento para determinar el numero interno de poliza para las polizas de Vida (019), para el resto de los ramos usa el sp_sis21
	--que se encuentra adentro del sp_sis250
...
{   -- NSOLIS:01/08/2022 se solicita cambio de Inhabilitar este cambio  -HGIRON
...
if a_tipo = "A" then  --american
	...
	if cnt_flag < 1 then
		return 1,'No se encontraron los días pendientes a procesar.',null;
	end if
