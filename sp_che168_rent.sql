-- Procedimiento Unifica Agente para Rentabilidad 2018
-- creado: 23/03/2018 - Autor: Armanod Moreno M.

DROP PROCEDURE sp_che168_rent;
CREATE PROCEDURE "informix".sp_che168_rent(a_agente CHAR(8))
...
if _cod_agente in('02311','02901') then --Unificar Platinum Isurance y Total Seguros
...
--Unificar a JUAN CARLOS Sanchez CON S&D INSURANCE
if _cod_agente in('01315','01834') then
