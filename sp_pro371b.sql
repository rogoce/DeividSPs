...
drop procedure sp_pro371b;
create procedure "informix".sp_pro371b(a_no_poliza char(10),a_cod_agente char(5))
returning   integer,
			char(100);   -- _error
...
if _cod_ramo not in ('002','020','023') or _flag_agt = 0 then
