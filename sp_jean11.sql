...
DROP procedure sp_jean11;
CREATE procedure sp_jean11(a_sac_notrx integer, a_cuenta char(25),a_noregistro integer, a_comprobante char(15))
...
foreach
	...
	and b.cuenta[1,3] = '600' -- Cuenta de Planilla
