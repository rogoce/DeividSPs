--************************************************************
-- Procedimiento que Carga las Bonificaciones de cobranza 2016
--************************************************************
...
--drop procedure sp_che81sim;
create procedure sp_che81sim(
a_compania          char(3),
a_sucursal          char(3),
a_periodo		    char(7),
a_usuario           char(8))
