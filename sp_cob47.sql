...
--Proceso de Cobros ElectrÃ³nicos por DÃ­a
...
foreach
	select no_tarjeta,
	  ...
	  into _no_tarjeta,
		   ...
		   _fecha_inicio
	  from tmp_procesar
	 --where no_documento = '1907-00454-01'
...
foreach
	...
	let _no_poliza = sp_sis21(_no_documento);
	let _ult_pago = 0;
	--se puso en comentario por que ya no aplica el decuento de pago electronico en la ultima letra. Armando 13/03/2019
