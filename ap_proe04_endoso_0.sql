...
drop procedure ap_proe04_endoso_0;
create procedure ap_proe04_endoso_0(a_poliza	char(10),a_unidad	char(5),a_suma		dec(16,2),a_cia		char(3))
...
if ls_ramo in('002','023') then
	call ap_sis188_endoso_0(a_poliza) returning _error,_mensaje;
end if
