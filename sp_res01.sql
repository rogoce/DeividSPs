...
drop procedure sp_res01;
create procedure "informix".sp_res01(a_compania char(3), a_agencia	char(3), a_periodo1	char(7), a_periodo2	char(7), a_sucursal	char(255) default "*", a_ramo char(255) default "*")
returning	char(50),char(18),char(5),char(20),date,date,varchar(50),char(7),char(50),char(3),char(50),char(3),char(50),decimal(16,2),decimal(16,2),decimal(16,2),varchar(255);
...
foreach
	...
	return v_compania_nombre,v_doc_reclamo,_no_unidad,_no_documento,_fecha_reclamo,_fecha_siniestro,_n_evento,_periodo,_n_sucursal,_cod_ramo,v_ramo_nombre,_cod_subramo,_n_subramo,_reserva_bruto,_pagado,_reserva_bruto_f,v_filtros with resume;
