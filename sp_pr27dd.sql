...
-- Reporte de Total de Produccion de Reaseguro por Agente
-- 
...
-- SIS v.2.0 d_- DEIVID, S.A.
 ...
 --DROP PROCEDURE sp_pro27dd;
CREATE PROCEDURE "informix".sp_pro27dd(a_compania CHAR(3), a_agencia CHAR(3), a_periodo1 CHAR(7), a_periodo2 CHAR(7),a_sucursal CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_grupo    CHAR(255) DEFAULT "*", a_usuario  CHAR(255) DEFAULT "*", a_reaseguro CHAR(255) DEFAULT "*", a_agente CHAR(255) DEFAULT "*")
		RETURNING CHAR(50),
		          DECIMAL(16,2), 
		          DECIMAL(16,2), 
		          DECIMAL(16,2), 
...
FOREACH WITH HOLD
 SELECT cod_agente,
  ...
  select estatus_licencia into _estatus_lic from agtagent where cod_agente = _cod_agente;
...
--Selecciona los nombres de Agentes
    BEGIN
          ON EXCEPTION IN(-239)
             UPDATE tmp_prod2 
