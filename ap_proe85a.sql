...
drop procedure ap_proe85a;
 
create procedure ap_proe85a(a_poliza CHAR(10), a_unidad CHAR(5))
returning dec(16,2);
...
--let _ano_tarifa = _ano_tarifa + 1; --Esto no va Amado 04/06/2022 según Jean Carlos
...
--let _ano_tarifa = year(_vigencia_fin) - _ano_auto + 1; --Esto no va Amado 04/06/2022 según Jean Carlos
