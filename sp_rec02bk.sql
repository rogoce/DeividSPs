...
drop procedure sp_rec02bk;

create procedure "informix".sp_rec02bk(
a_compania		char(3), 
a_agencia		char(3), 
a_periodo		char(7),
...
foreach 
	select no_reclamo,
	 ...
	 where cod_compania	= a_compania
	   ...
	   and actualizado  	= 1
	   and no_reclamo in (select distinct m.no_reclamo from recasien a, rectrmae m where a.no_tranrec = m.no_tranrec and a.cuenta = '222020103' and m.periodo = '2016-03')
	 group by no_reclamo
