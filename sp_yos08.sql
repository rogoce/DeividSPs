...
DROP PROCEDURE sp_yos08;
CREATE PROCEDURE "informix".sp_yos08(a_no_tranrec CHAR(10), a_tipo_orden CHAR(1), a_deducible DEC(16,2) DEFAULT 0.00, a_monto DEC(16,2) DEFAULT 0.00, a_hoy DATETIME YEAR TO FRACTION (5), a_cotizacion VARCHAR(10) DEFAULT NULL) 
