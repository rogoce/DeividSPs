...
DROP PROCEDURE sp_cob750a;

CREATE PROCEDURE sp_cob750a(a_aviso CHAR(15), a_renglon SMALLINT)
...
DEFINE _saldo_leg 		  DECIMAL(16,2);
...
let _n_acreedor      = "";
let _nn_acree        = "";
--, a_poliza CHAR(10),a_nombre_firma1 CHAR(50),a_nombre_firma2 CHAR(50),a_cargo1 CHAR(50),a_cargo2 CHAR(50),a_callcenter INTEGER,a_usuario1 CHAR(10),a_usuario2 CHAR(10))
...
FOREACH
 SELECT no_poliza,
  ...
  WHERE no_aviso  = a_aviso
    AND renglon = a_renglon   --     AND no_poliza = a_poliza
--	AND impreso    = 0
...
{	  select saldo
	  ...
	  if  _saldo_leg = 0 then
	  else
	      let _saldo_c = _saldo_leg;
	  end if }
