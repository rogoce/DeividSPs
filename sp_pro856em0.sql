...
drop procedure sp_pro856em0;

create procedure "informix".sp_pro856em0(a_sucursal char(350), a_estatus smallint,a_desde date,a_hasta date)
...
select distinct nom_acreedor,
	...
	order by nom_acreedor
		...
		if _cnt = 0 then
	     ...
	     call sp_log033('00044',_cod_acreedor,_email ,a_desde,a_hasta) returning _error, _descripcion;
