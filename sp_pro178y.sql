   DROP procedure sp_pro178y;
   CREATE procedure "informix".sp_pro178y(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7))
...
{ ruben
 ...
 --    IF _cod_ramo = "002" Or _cod_ramo = "020" THEN  ruben
	   IF _cod_ramo = "020" THEN
