...
DROP procedure sp_pro586c;
CREATE procedure "informix".sp_pro586c(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codramo CHAR(255), a_reaseguro CHAR(255)  DEFAULT "*", a_origen CHAR(3) default "%")
	   ...
	   FOREACH WITH HOLD
          SELECT  d.no_poliza,
            ...
            WHERE d.no_poliza = e.no_poliza
              ...
              AND d.actualizado = 1			
              AND e.cod_agente in (select cod_agente from agtagent where no_licencia[1,3] = "OAL")			  
