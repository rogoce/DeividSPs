DROP procedure sp_rec06_p;
CREATE procedure "informix".sp_rec06_p(a_compania CHAR(3),a_agencia CHAR(03),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codsubramo CHAR(255) DEFAULT "*",a_codtipoveh CHAR(255) DEFAULT "*")
...
--------------------------------------------
    ...
    DEFINE v_incurrido_bruto,v_incurrido_neto 	DECIMAL(16,2);
    ...
    FOREACH
       ...
       SELECT no_poliza,no_reclamo,cod_ramo,cod_subramo,cod_grupo,
              incurrido_bruto,incurrido_neto
              INTO v_nopoliza,v_noreclamo,v_cod_ramo,v_cod_subramo,v_cod_grupo,
