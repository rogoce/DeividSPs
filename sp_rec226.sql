...
drop procedure sp_rec226;

create procedure sp_rec226(
...
if _fecha_max_tr < "01/12/2013" then
	let _fecha_no_server = "04/12/2013";
end if

if _fecha_max_tr >= "30/12/2013" then
	let _fecha_no_server = "30/12/2013";
end if

if _fecha_max_tr >= "01/12/2013" and _fecha_max_tr < "30/12/2013" then
	let _fecha_no_server = _fecha_max_tr + 1 units day;
end if
