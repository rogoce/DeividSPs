...
-- 
-- Creado    : 20/06/2001 - Autor:  Amado Perez
-- Modificado: 
--
-- SIS v.2.0 - d_sp_rec01a_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_rec01s;

CREATE PROCEDURE "informix".sp_rec01s(a_compania CHAR(3),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7), a_sucursal CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_ajustador CHAR(255) DEFAULT "*") 
RETURNING CHAR(18), 
  		    CHAR(100), 
  		    CHAR(20),
  		    DATE,
...
FOREACH 
 SELECT no_reclamo,		
  ...
  ORDER BY cod_ramo,cod_subramo,numrecla
