...
drop procedure sp_che160;

create procedure sp_che160(a_periodo CHAR(7))
...
define _mes1, _mes2,_mes,_ano2, _ano1,_orden, _meses, _semana1, _semana2, _semana3, _dia_sem, _semana12, _semana22, _semana32   SMALLINT;
...
--SET DEBUG FILE TO "sp_che160.trc"; 
--trace on;
	...
	for _contador3 = 1 to 3
		...
		if _contador2 = 1 then
			if _contador3 = 1 then
				...
				LET _dia_sem = WEEKDAY(MDY(_mes1,_contador,_ano1));
				end
				
				if _dia_sem = 1 then
					if _semana1 <> 0 then
						let _semana1 = _semana1 + 1;
					end if
				end if
...
{	select dia,
	...
	select dia,
	  ...
	  into _contador,
		 ...
		 _monto23
	 from temp_presu_sal
	group by dia, mes11, mes12, mes13, mes21, mes22, mes23
    order by dia, mes11, mes12
