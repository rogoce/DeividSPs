...
drop procedure sp_che71b;

create procedure "informix".sp_che71b() 
returning char(10),
          dec(16,2),
          dec(16,2);
...
foreach
 select no_requis,
  ...
  where origen_cheque = 3
	...
	and anulado = 0
	and periodo >= "2010-01"
	and no_requis not in("342565","352640","372864","377847")	 --se coloco provisional por investigacion Armando 16/12/2010
  order by no_requis
