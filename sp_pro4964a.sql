DROP procedure sp_pro4964a;
   CREATE procedure "informix".sp_pro4964a(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7), a_periodo2 CHAR(7), a_origen CHAR(3) DEFAULT '%')
...
SELECT  cnt_autos_p,cnt_autos_c,tot_polizas, tot_prima, sum(cnt_reclamo), sum(incurrido_bruto) --cnt_polizas,cnt_autos,cnt_reclamo,prima_suscrita,incurrido_bruto
  FROM ssrpestm3
 WHERE cod_ramo in ( '002','020','023')  and  periodo = '2019-03'  and cod_subramo = '001'
 group by 1,2,3,4	
