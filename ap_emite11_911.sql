...
drop procedure ap_emite11_911;
create procedure "informix".ap_emite11_911() 
...
{		-- Insertar Unidad
		...
		if _ramo_sis = 1 then
			...
			if _cod_producto in ('08753') then	--LIVIANO
		...
		delete from emipocob where no_poliza = _no_poliza and no_unidad = _no_unidad;
		...
		update emipocob
		 ...
		 where no_poliza = _no_poliza
		   and no_unidad = _no_unidad
		   and cod_cobertura = '01892'; --MUERTE NATURAL
						
		update emipocob
		   set limite_1 = _limite_lesiones2,
		       prima_anual = _prima_naviera,
			   prima = _prima_naviera,
			   prima_neta = _prima_naviera
		 where no_poliza = _no_poliza
		   and no_unidad = _no_unidad
		   and cod_cobertura = '01893'; -- MUERTE ACCIDENTAL O RELACIONADA CON EL TRABAJO
		...
		update emipocob
		 ...
		 where no_poliza = _no_poliza
		   and no_unidad = _no_unidad
		   and cod_cobertura = '01894'; -- INCAPACIDAD PARCIAL Y TOTAL
