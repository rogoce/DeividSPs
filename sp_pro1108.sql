...
------------------------------------------------
drop procedure sp_pro1108;
create procedure sp_pro1108(a_periodo char(7),
...
let _cust_qry4 = " and a.no_documento like ?) and (b.estatus_poliza not in (2,4)) and (b.renovada = 0) ";
