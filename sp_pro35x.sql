 DROP procedure sp_pro35x;
 CREATE procedure "informix".sp_pro35x(a_compania CHAR(3),a_agencia CHAR(3),a_no_poliza CHAR(20))
   RETURNING CHAR(5),CHAR(30),CHAR(30),CHAR(30),CHAR(30),
             SMALLINT,CHAR(10),CHAR(50),CHAR(100),CHAR(20),
             CHAR(03),CHAR(50),CHAR(50),CHAR(50);
       ...
       FOREACH WITH HOLD
		...
		select nombre
         ...
         RETURN v_no_unidad,v_nom_marca,v_nom_modelo,v_no_motor,
                ...
                v_descr_cia,v_nom_subramo,_n_acreedor
                WITH RESUME;
