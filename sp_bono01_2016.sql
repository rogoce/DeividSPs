...
return 0; --se detuvo la corrida 16/01/2017 Armando
...
--TRACE ON;
--Buscar los corredores marcados para este Bono
--cod_agente in('00547','01440','00189','02316','02242','01928','02134','00721','00037','00026','01669','00920','02015','01479','01480','01545')
foreach
	select cod_agente
	  into _cod_agente
	  from agtagent
	...
	foreach
			 ...
			 select e.no_documento,e.no_poliza
			  ...
			  where e.no_poliza         = t.no_poliza
				...
				and e.actualizado       = 1
				and e.nueva_renov       = "N"
				and e.fecha_suscripcion >= "01/01/2016"  
				and e.fecha_suscripcion <= "31/12/2016"	
			...
			select count(*)
			 ...
			 where no_poliza     = _no_poliza
			   ...
			   and fecha_emision >= '01/01/2016'
			   and fecha_emision <= '31/12/2016';
