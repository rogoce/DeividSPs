...
DROP PROCEDURE sp_rec14b; 
CREATE PROCEDURE sp_rec14b(a_compania CHAR(3),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(255),a_ramo CHAR(255),a_grupo CHAR(255),a_agente CHAR(255),a_cliente  CHAR(255) DEFAULT '*', a_poliza char(20) default '*', a_producto CHAR(255) DEFAULT '*', a_subramo CHAR(255) DEFAULT '*',a_codvend CHAR(255) DEFAULT '*') 
