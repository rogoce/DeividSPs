...
--DROP PROCEDURE sp_che95aa;
CREATE PROCEDURE sp_che95aa(a_cia CHAR(3),a_cod_agente CHAR(5) default "*",a_periodo char(7))
RETURNING CHAR(50),CHAR(100), CHAR(100),DEC(16,2),CHAR(50),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2); 
	...
	select trim(cod_agente),
	 ...
	 order by 1,2,3,4 desc
			...
			let _nombre_agente = trim(_n_agente)||" "||_cod_agente;
				...
				select trim(name_tipo),prim_suscrita_min
				  into _nombre_tipo,_ProducMin
				  from prdrenttipo 
			     where periodo  = a_periodo
			...
			FOREACH
				select nombre_ramo,
				 ...
				 insert into tmpche95a(cia,agente,categoria,susc_minima,nombre_ramo,prima_ant,prima_act,crecimiento,porc_crecimiento,sini_inc)
				 values (v_nombre_cia,_nombre_agente,_nombre_tipo,_ProducMin,_nombre_ramo,_ProdAntRam,_ProdActRam,_crecimiento,_Porc_crec,_sini_inc);
...
FOREACH
	select cia,agente,categoria,susc_minima,nombre_ramo,prima_ant,prima_act,crecimiento,porc_crecimiento,sini_inc 
	  into v_nombre_cia,_nombre_agente,_nombre_tipo,_ProducMin,_nombre_ramo,_ProdAntRam,_ProdActRam,_crecimiento,_Porc_crec,_sini_inc
	  from tmpche95a 
	 order by 1,2,3,5
	...
	RETURN v_nombre_cia,
	       ...
	       _ProdActRam,
	       _crecimiento,
	       _Porc_crec,_sini_inc WITH RESUME;	
