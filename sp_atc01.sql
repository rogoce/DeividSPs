-- Modificación 20-01-2023 se agrega el tipo de reclamo para buscar los reclamos de 1. Asegurado, 2. Dependientes o 3. Ambos

DROP PROCEDURE sp_atc01;
create procedure "informix".sp_atc01(
a_compania		char(3),
a_sucursal		char(3),
...
--AUTOMÃƒÆ’Ã¢â‚¬Å“VIL SABISH CASTILLO
--OTROS LMORENO
let v_cedula_cartas = '';
let v_firma_cartas = '';
...
if _ramo_sis in (5,6,7,9) then
	...
	if _ramo_sis in (1,4) then
	 ...
	 -- SegÃƒÆ’Ã‚Âºn ultima modificaciÃƒÆ’Ã‚Â³n por team de JEPEREZ 02/10/2020
		else --2,8,3
