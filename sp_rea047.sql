-- Simulacion de aseintos provenientes de un contrato especifico, Produccion

-- Asientos sumarizados
-- Creado    : 13/09/2012 - Autor: Armando Moreno
-- SIS v.2.0 - DEIVID, S.A.	

DROP PROCEDURE sp_rea047;
CREATE PROCEDURE sp_rea047(a_db char(18),a_cod_contrato char(5))
	...
	FOREACH	
		select b.cuenta,
		  ...
		  into i_cuenta,
			   ...
			   i_no_tranrec,
			   i_notrx
		  from sac999:sreacompasie b, sac999:sreacomp c
...
let _n_contrato = trim(a_cod_contrato) || " " || trim(_n_contrato);
	...
	RETURN i_cuenta,			
		   ...
		   select a.cod_auxiliar,
			 ...
			 into r_cod_auxiliar,
				  ...
				  r_credito,
				  r_desc_rea
			 from sac999:sreacompasiau a ,tmp_cglterceros t	 
