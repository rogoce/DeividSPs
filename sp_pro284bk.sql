...
--Crea tabla temp_ramo   sp_pr94a
CALL sp_pr285();

--trae cant. de polizas vig. temp_perfil   sp_pro95
CALL sp_pro286(
a_cia,
a_agencia,
_fecha2,
...
--trae primas suscritas del mes. tmp_prod   sp_pro178b
CALL sp_pro303(
a_cia,
a_agencia,
a_periodo,
...
--Trae los siniestros brutos incurridos   sp_pro178d
...
--Trae la cant. de reclamos por ramo   sp_rec03
CALL sp_rec289(
a_cia, 
a_periodo, 
a_periodo
...
FOREACH
   ...
   LET _vig_fin_vida = _vigencia_inic + 1 UNITS YEAR;
    ...
    END IF
	   ...
	   ---  Martes 31 de Julio 8:30 de la mañana
