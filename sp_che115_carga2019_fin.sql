...
DROP PROCEDURE sp_che115_carga2019_fin;
CREATE PROCEDURE sp_che115_carga2019_fin(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
foreach
	select distinct cod_agente
     ...
     where no_documento in(
           select no_documento from pol_fac)
