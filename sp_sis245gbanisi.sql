...
drop procedure sp_sis245gbanisi;

create procedure sp_sis245gbanisi()
...
--set debug file to "sp_sis245gbanisi.trc";
--trace on;
...
foreach
	select distinct a.no_poliza,
	 ...
	 where a.no_documento = b.no_documento
	   ...
	   and b.prima_neta <> 0
--	   and b.no_documento = '0223-08629-09'
...
--  Van todas aunque tenga saldo -- Boni 16-09-2024
...
-- Solo se renovarán las que tengan estos productos
...
-- Renovacion de noviembre 2024
--	Excluir de la facturación los productos:
...
--03812 PETROAUTOS / BANISI (CAMIONETA Y PICK UP)
	...
	select count(*)
	  ...
	  from emipouni
	 where no_poliza = _no_poliza
	   and cod_producto in ('07755','03810','07754','07215','08278'); --,'02282','02283','03811','03812'
