...
Let  _html_body1 = trim(_html_body1) ||'        	Estimado cliente, Aseguradora Anc&oacute;n le informa que su reclamo ha sido recibido e ';
Let  _html_body1 = trim(_html_body1) ||'            ingresado en nuestro sistema. Su n&uacute;mero de Tramite es: '||v_no_tramite||'. Muy pronto ser&aacute;';
Let  _html_body1 = trim(_html_body1) ||'            atendido por personal del Departamento de Reclamos de Autom&oacute;vil.';	  
...
Let  _html_body2 = trim(_html_body2) ||'        	<p>';
Let  _html_body2 = trim(_html_body2) ||'        	 	Adjunto encontrar&aacute; una gu&iacute;a para conocer los documentos necesarios para el tr&aacute;mite';
Let  _html_body2 = trim(_html_body2) ||'             	de su reclamo sea m&aacute;s expedito seg&uacute;n la cobertura afectada.';
Let  _html_body2 = trim(_html_body2) ||'            </p>';
Let  _html_body2 = trim(_html_body2) ||'            <p>';
Let  _html_body2 = trim(_html_body2) ||'            	En caso que aplique pago a deducible Ud. podr&aacute; realizarlo a trav&eacute;s de nuestras oficinas';
Let  _html_body2 = trim(_html_body2) ||'				a nivel nacional, as&iacute; como tambi&eacute;n en los diferentes centros de pago, recuerde';
Let  _html_body2 = trim(_html_body2) ||'            	presentar el slip al momento de presentarse en algunas de nuestras oficinas.';
Let  _html_body2 = trim(_html_body2) ||'            </p>';
Let  _html_body2 = trim(_html_body2) ||'            <p>';
Let  _html_body2 = trim(_html_body2) ||'               Si usted desea solicitar el servicio de Asistencia Legal es necesario completar y firmar';
Let  _html_body2 = trim(_html_body2) ||'               en original el Poder Legal que encontrar&aacute; adunto, el mismo podr&aacute; enviarlo a trav&eacute;s de su';
Let  _html_body2 = trim(_html_body2) ||'               corredor de seguros o dejarlo en algunas de nuestras oficinas a nivel nacional.';
Let  _html_body2 = trim(_html_body2) ||'			</p>';
Let  _html_body2 = trim(_html_body2) ||'            <p>';
Let  _html_body2 = trim(_html_body2) ||'            	Si desea informaci&oacute;n referente a sus p&oacute;lizas, reclamos, actualizaci&oacute;n de datos u';
Let  _html_body2 = trim(_html_body2) ||'				otras consultas puede realizarlas a trav&eacute;s de nuestra Web: www.asegurancon.com,';
Let  _html_body2 = trim(_html_body2) ||'                opci&oacute;n SERVICIO EN LINEA/ANCON ONLINE o llamarnos a nuestra central telef&oacute;nica';
Let  _html_body2 = trim(_html_body2) ||'                210-8787 o escribanos a info@asegurancon.com que con gusto nuestros agentes';
Let  _html_body2 = trim(_html_body2) ||'                le estar&aacute;n atendiendo.';
Let  _html_body2 = trim(_html_body2) ||'            </p>';
Let  _html_body2 = trim(_html_body2) ||'            <p>&nbsp;</p>';
Let  _html_body2 = trim(_html_body2) ||'            <p>&nbsp;</p>';
Let  _html_body2 = trim(_html_body2) ||'            <p>&iexcl;Gracias por preferirnos!<br>';
Let  _html_body2 = trim(_html_body2) ||'            Nota: Este correo es generado de forma autom&aacute;tica por la Intranet Corporativa. Por favor no responder al remitente.';
Let  _html_body2 = trim(_html_body2) ||'            </p>';
Let  _html_body2 = trim(_html_body2) ||'            ';
Let  _html_body2 = trim(_html_body2) ||'        </td>';
Let  _html_body2 = trim(_html_body2) ||'    </tr>';
Let  _html_body2 = trim(_html_body2) ||'	<tr>';
--Let  _html_body2 = trim(_html_body2) ||'    	<td colspan="2"><img src="https:app.asegurancon.com/imagen/cintillo2.jpg" width="800"></td>';
Let  _html_body2 = trim(_html_body2) ||'    </tr>';
