DROP PROCEDURE sp_sis601_t;
create procedure sp_sis601_t(a_cod_manzana char(255) default '*', a_poliza char(20) DEFAULT '*', a_estatus_poliza smallint default 1)
...
--set debug file to "sp_sis601_t.trc";
--trace on;
	   ...
	   SELECT descripcion
		...
		foreach
		   ...
		   SELECT referencia
			...
			insert into temp_sis600
			values(_no_poliza,_no_unidad,_no_documento, v_asegurado, _cod_manzana, _referencia, _suc_origen, _n_suc_origen, _suma_asegurada, _tipo_incendio, _vig_ini,
				   _vig_fin, _suma_ret, _est_pol, _nombre_ag_acum, _suma_fac, _suma_exc, _ret_porc, _fac_porc, _exc_porc, _prima_suscrita, _coaseguro);
		end foreach
	END FOREACH
end if
