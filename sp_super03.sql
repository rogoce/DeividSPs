...
--Actualizando cantidad de contratantes
foreach
	select code_prov,
...
--Actualizando cantidad de polizas y prima suscrita de contratantes a las zonas geograficas
let _cantidad       = 0;
let _prima_suscrita = 0;
		...
		foreach
			...
			if _cod_prov = '01' then	--Bocas
				update prov_zona
				 ...
				 where code_provincia = '08';
			end if
			if _cod_prov = '02' then	--cocle
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
				       bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '03';
			end if
			if _cod_prov = '03' then	--colon
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
				       bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '02';
			end if
			if _cod_prov = '04' then	--chiriqui
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
				       bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '05';
			end if
			if _cod_prov = '05' then	--darien
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
				       bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '07';
			end if
			if _cod_prov = '06' then	--herrera
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
	                   bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '04';
			end if
			if _cod_prov = '07' then	--Los Santos
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
				       bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '06';
			end if
			if _cod_prov = '08' then	--panama
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
				       bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '01';
			end if
			if _cod_prov = '09' then	--veraguas
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
				       bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '09';
			end if
			if _cod_prov = '13' then	--pma oeste
				update prov_zona
				   set bien_cnt_cont  = bien_cnt_cont + _contador_cli,
				       bien_cnt_pol   = bien_cnt_pol + 1
				 where code_provincia = '10';				 
			end if
			let _contador_cli = 0;
		end foreach
	end foreach
