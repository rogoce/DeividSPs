...
drop procedure sp_niif13;
create procedure sp_niif13(a_no_poliza char(10),a_no_reclamo char(10),a_no_tranrec char(10),a_tipo smallint)
...
--trace on;
	...
	if _cod_ramo = '020' then
		...
		let _segm_triangulo = 'OTRO RAMO';
	elif _cod_ramo in ('015','026','027') then
