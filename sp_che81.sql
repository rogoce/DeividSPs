--************************************************************
-- Procedimiento que Carga las Bonificaciones de cobranza 2026
--************************************************************

-- Creado    : 04/02/2026 - Autor: Armando Moreno M.
...
define _monto_fac,_prima_cob10,_prima_cob32 dec(16,2);
...
select sum(prima_cobrada)
   into _prima_cob32
   from chqboagt							
  where cod_agente in('00041','03205','03250');
...
foreach
	...
	if _cod_agente in('00041','03205','03250') then
		let _prima_cobrada = _prima_cob32;
	end if
