-- Procedimiento que Genera las Polizas Vencidas con Saldo
-- 
...
--DROP PROCEDURE sp_cob10;

CREATE PROCEDURE "informix".sp_cob10(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_fecha    DATE
)
...
FOREACH 
 SELECT no_documento
  ...
  WHERE cod_compania       = a_compania		   -- Seleccion por Compania
	...
	AND vigencia_final     < a_fecha		   -- Polizas Vencidas
...
--Datos de la Poliza
 SELECT cod_contratante,
  ...
  WHERE no_poliza = _no_poliza;
	...
	-- Si la poliza fue pagada en la fecha seleccionada
	-- no se debe tomar en cuenta
