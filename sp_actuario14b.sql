--reserva matematica, sacar las polizas vigentes que no tengan endoso de cancelacion

 DROP procedure sp_actuario14b;

 CREATE procedure "informix".sp_actuario14b()
	RETURNING char(20),
			  date,
			  char(12),	   
			  date,	   
 ...
 BEGIN
	...
	define _fumador,_estatus_termino		  char(1);
...
FOREACH WITH HOLD
	   ...
	   select max(no_poliza * 1) 
	     into _no_poliza_int
	     from emipomae
		where no_documento = v_no_documento
		  and actualizado  = 1;

		let v_no_poliza = _no_poliza_int;
