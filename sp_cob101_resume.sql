...
drop procedure sp_cob101_resume;

create procedure sp_cob101_resume(
a_compania 		char(3),
a_agencia  		char(3),
a_cobrador 		char(3),
...
if a_cod_cliente <> "*" then
	...
	CALL sp_sis233 (a_cod_cliente) returning _cliente_vip, _msg_vip; 
