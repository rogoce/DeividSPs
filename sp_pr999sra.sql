...
--------------------------------------------
--execute procedure sp_pr999sra('001','001','2025-12','2025-12',"*","*","*","*","002,020,023;","*","*","2025,2024,2023,2022,2021,2020,2019,2018,2017,2016,2015;","*")
...
foreach
	...
	foreach					 -- se desglosa por tipo, buscar primero si es bouquet
		...
		let v_prima_tipo = 0;
		let v_prima2     = 0;
		let _prima_total = v_prima_1 + v_prima_bq + v_prima_3 + v_prima_ot + _sum_fac_car + _ret_casco + _cob_otros + _ret_var + _bouquet_rc + _bouquet_otros + _bouquet_casco;
		foreach
			select cod_sub_tipo,
				   porcentaje
			  into v_cod_tipo,
				...
				on exception in(-239)
				   update tmp_tabla
					  set cant_polizas   = cant_polizas   + 1,
						  ...
						  p_ret_var      = p_ret_var      + _ret_var * v_porcentaje/100,
