...
define _prima_cob         decimal(16,2);
...
if a_trimestre = 1 then
	Let _fecha_ini = '01/01/2023';
	Let _fecha_fin = '31/03/2023';
elif a_trimestre = 2 then
	Let _fecha_ini = '01/04/2023';
	Let _fecha_fin = '30/06/2023';
elif a_trimestre = 3 then
	Let _fecha_ini = '01/07/2023';
	Let _fecha_fin = '30/09/2023';
else
	Let _fecha_ini = '01/10/2023';
	Let _fecha_fin = '31/12/2023';
end if
