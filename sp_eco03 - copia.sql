...
CREATE PROCEDURE sp_eco03(a_fecha1 date, a_fecha2 date) 
	...
	FOREACH
		select mae.no_poliza
		  ...
		  into _no_poliza,
			   ...
			   _cod_cobertura
		  from endedmae mae
		 inner join emipomae emi on (emi.no_poliza = mae.no_poliza and mae.actualizado = 1 and mae.fecha_emision >= a_fecha1 and mae.fecha_emision <= a_fecha2)
		 inner join emipoliza pol on (pol.no_poliza = mae.no_poliza and pol.cod_agente = _cod_agente_i)
