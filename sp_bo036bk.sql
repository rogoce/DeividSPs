...
drop procedure sp_bo036bk;
create procedure sp_bo036bk(
a_fecha_desde datetime year to minute,
a_fecha_hasta datetime year to minute
) returning dec(16,2),char(11),interval day(4) to minute,dec(16,2),dec(16,2),dec(16,2);
...
set debug file to "sp_bo036bk.trc";
trace on;
...
return 0,_tiempo_char,_tiempo_usado,_dias_usados,_hora_usados,_minu_usados;
