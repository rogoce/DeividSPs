...
drop procedure ap_pool05b;

create procedure "informix".ap_pool05b()
returning char(20),char(10),char(7),date,char(8),integer;
...
foreach
    ...
    if _cnt >= 1 then
		...
		foreach	  
		   ...
		   let _serie = sp_sis61d(_no_poliza2);
		   ...
		   return _no_documento,_no_poliza2, _periodo, _fecha, _user_added, _serie with resume;
		end foreach	  
	end if
