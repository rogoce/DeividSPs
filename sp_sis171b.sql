...
--drop PROCEDURE sp_sis171b;

CREATE PROCEDURE "informix".sp_sis171b(a_no_remesa CHAR(10))
...
DELETE FROM cobreafa WHERE no_remesa = a_no_remesa;
DELETE FROM cobreaco WHERE no_remesa = a_no_remesa;
