...
DROP PROCEDURE sp_sis17a;

CREATE PROCEDURE "informix".sp_sis17a(a_no_poliza CHAR(10))
--}
RETURNING INTEGER;
...
--SET DEBUG FILE TO "sp_sis17s.trc";
--TRACE ON;                                                                 
...
if _cod_sucursal = _sucursal_web then -- sucursal web ?
