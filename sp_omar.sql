...
--------------------------------------------
--execute procedure sp_omar('001',"001",'10/06/2013', "*", "008;", "2013,2012,2011,2010,2009,2008;","002,003,004,015,016,017,018,019,020;" )
DROP procedure sp_omar;
CREATE procedure "informix".sp_omar(a_compania CHAR(3), a_agencia  CHAR(03) DEFAULT "*", a_periodo DATE, a_codsucursal  CHAR(255) DEFAULT "*", a_codramo CHAR(255) DEFAULT "*", a_serie char(255) default "*", a_subramo CHAR(255) DEFAULT "*" ) 
RETURNING DEC(16,2),
		  DEC(16,2),
		  SMALLINT,
		  DEC(16,2),
