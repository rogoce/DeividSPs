...
drop procedure sp_sis119d;
create procedure "informix".sp_sis119d()
...
foreach --with hold
	select r.no_reclamo,
	 ...
	 where t.no_reclamo = r.no_reclamo
	   ...
	   and e.cod_ramo = '002'
	   and t.periodo = _periodo_verifica
	...
	if _no_cambio is null then
		...
		--return _mensaje,'','01/01/1900','','01/01/1900' with resume;
		--rollback work;
		continue foreach;
	end if
