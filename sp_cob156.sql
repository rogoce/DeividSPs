-- Procedimiento que Genera la Morosidad de Cartera para el call center.

-- Creado    : 28/07/2004 - Autor: Armando Moreno
-- Modificado: 02/08/2004 - Autor: Armando Moreno

-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_cob156;

CREATE PROCEDURE "informix".sp_cob156(
a_compania   CHAR(3),
a_agencia    CHAR(3),
a_fecha      DATE,   
...
CREATE TEMP TABLE tmp_moros(
		...
		PRIMARY KEY (cod_agente, no_poliza, cod_cobrador)
		) WITH NO LOG;
