...
CREATE PROCEDURE "informix".sp_rec14a_JB(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_periodo1 CHAR(7),
a_periodo2 CHAR(7),
...
--DROP TABLE tmp_sinis;
 DELETE from tmp_siniestros_ramos
...
FOREACH
 SELECT cod_ramo,
  ...
  ORDER BY cod_ramo
	...
	-- agregado JB
	insert into tmp_Siniestros_Ramos (
	        Ramo ,	   -- Ramo
			PrimaSuscrita , -- Prima Suscrita
			ComPrimaSuscrita , -- Comision de Prima Suscrita
			PorcComPrimaSuscrita  , -- % Comision de Prima Suscrita
			IncurridoBruto , -- Incurrido Bruto
			PorcSiniestralidad , -- % Siniestralidad
			PrimaPagada , -- Prima Pagada
			ComPrimaPagada , -- Comision de Prima Pagada
			PorcComPrimaPagada , -- % Comision de Prima Pagada
			SiniestrosPagados , -- Sinestros Pagados
			PorcPagadoCobrado, -- % Pagado/Cobrado
			Compania,	   -- Compania
			Filtros)
	values (
	       TRIM(v_ramo_nombre),
