	...
	foreach
	 select no_poliza,
	  ...
	  where no_requis = a_no_requis
		...
		let _renglon = _renglon + 1 ;
		--let _cuenta  = sp_sis15('PGCOMCO', "04", _cod_origen, _cod_ramo, _cod_subramo); SE QUITA POR CORREO DE ZULEYKA 19/10/2023
...
--		let _cuenta  = "1500503";	 -- Solicitud del Sr.Arturo Naranjo
	...
	{foreach
	 select bono,cod_ramo 
	   into _monto, _cod_ramo 
	   from chqbono019e
	  where no_requis = a_no_requis}
	...
	foreach
		...
		let _renglon = _renglon + 1 ;
		--let _cuenta  = "1500503";	 -- Solicitud del Sr.Arturo Naranjo   se pone en comentario, caso Zuleyka 3396
		--let _cuenta  = sp_sis15('PGCOMCO', "04", _cod_origen, _cod_ramo, _cod_subramo);
	...
	foreach
		...
		let _renglon = _renglon + 1 ;
--		let _cuenta  = "1500503";	 -- Solicitud del Sr.Arturo Naranjo. Se pone en comentario por Instr. de Zuleyka caso 3396
--		let _cuenta  = sp_sis15('PGCOMCO', "04", _cod_origen, _cod_ramo, _cod_subramo);
		let _cuenta  = sp_sis15('INSRIE', "04", _cod_origen, _cod_ramo, _cod_subramo);
...
elif a_origen_cheque = 'G' then -- Bonificacion por Rentabilidad 2
