...
foreach
	select cod_tipo,
	  ...
	  into _cod_tipo,
		   ...
		   _grupo_trans
	  from parmailtipo
     where cod_tipo in ('00019') --envio_jango = 1
...
--	end if
	...
	foreach
     ...
     --  let _email = 'aperez@asegurancon.com;jeperez@asegurancon.com'; --contabilidad@asegurancon.com; ;rgordon@asegurancon.com;
	...
	--   let _sender_send = 'jeperez@asegurancon.com';
		...
		if _cod_tipo not in ('00050','00051','00052','00053','00019') then
