...
DROP PROCEDURE amado_usuarios_c2;

CREATE PROCEDURE amado_usuarios_c2()
RETURNING char(8),							   
          char(30),							   
          char(3),							   
		  char(30),							   
...
foreach	
	SELECT a.usuario, a.codigo_perfil, a.descripcion, a.cia_depto, a.status,
		   a.fecha_inicio      	 , 
		   a.dias_password     	 , 
		   a.hora_inicio       	 , 
		   a.hora_final        	 , 
		   ...
		   a.ubicacion_print2  	 , 
		   a.emis_firma_aut    	  
	  INTO _usuario, _codigo_perfil, _descripcion, _cia_depto, _status_u,
		   _fecha_inicio      	 , 
		   _dias_password     	 , 
		   _hora_inicio       	 , 
		   _hora_final        	 , 
		   ...
		   _emis_firma_aut    
	  FROM insuser a
	 WHERE a.status  = "I" AND fvac_out is null AND fvac_duein is null

	foreach
	    SELECT codigo_compania, codigo_agencia
		  INTO _cia, _suc
		  FROM insusco
