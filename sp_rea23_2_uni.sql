...
--execute procedure sp_rea23_2_uni('001','001','2025-05','2025-12','*','*','*','*','001,003;','*','*','*','*')
drop procedure sp_rea23_2_uni;

create procedure sp_rea23_2_uni(
a_compania		char(3),
a_agencia		char(3),
a_periodo1		char(7),
a_periodo2		char(7),
...
--SET DEBUG FILE TO "sp_rea23.trc"; 
--trace on;
...
--Prima Cobrada
call sp_rea23a_uni2v2(a_compania,a_agencia, a_periodo1, a_periodo2, a_codsucursal, a_codgrupo, a_codagente, a_codusuario, a_codramo, a_reaseguro, a_contrato, a_serie, a_subramo) returning v_return22a;--('001','001','2011-03','2011-03','*','*','*','*','001;','*','*','*','*')
