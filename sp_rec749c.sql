...
DROP PROCEDURE sp_rec749c;
CREATE PROCEDURE "informix".sp_rec749c(
a_compania	CHAR(3),
a_agencia	CHAR(3),
a_periodo1	CHAR(7),
a_periodo2	CHAR(7),
...
{		  select count(*)
		...
		{	if _cod_tipopago = '003' then
			...
			let _tipo_linea = '0';
			if _cod_cobertura in('00102','01299','01021','00123','01309','01073','00113','00671','01304','01022','01306','00606','00118','00104','00122','01155','01154','01481','01536','00904','00107','01535','00117','01301','00907','01028','01310','01323','01302','01650','01651','00106','01338','00108','01074','01303','01115','01305','00109') then --coberturas de responsabilidad --,'01650','01651','01657'
				let _tipo_linea = '3';
			...
			if _cod_cobertura in('00119','00121','01307','01145','01315','01677', '01657', '01841') then --Colision
				...
				let _cobertura = 'LE';
			elif _cod_cobertura in('00123','01309','01073','00109') then --Muerte
				let _cobertura = 'MU';
			elif _cod_cobertura in('00113','00671','01304','01022','01651') then --Daños ,'01651'
				let _cobertura = 'DA';
			elif _cod_cobertura in('01306','00606','00118','00104','00122','01155','01154','01481','01536','00904','00107','01535','00117','01301','00907','01115','01310','01323','01302','01338','01305') and _tipo_pago = "A" then --Comprensivo --,'00104','00904','00107'
				let _cobertura = 'CM';
			elif _cod_cobertura in('01306','00606','00118','00104','00122','01155','01154','01481','01536','00904','00107','01535','00117','01301','00907','01115','01310','01323','01302','01338','01305') and _tipo_pago = "T" then --Comprensivo --,'00104','00904','00107'
				let _cobertura = 'LE';
...
FOREACH -- Casos cerrados automovil
	select r.no_reclamo, 
	 ...
	 where e.no_poliza = r.no_poliza
	   ...
	   or t.cerrar_rec = 1)	   
--	   and t.user_added <> 'DEIVID'
--	   and e.cod_origen = '001'
	   and e.cod_ramo in ('002','020','023')
	 group by r.no_reclamo, r.no_motor, t.periodo
...
{		if _cod_tipopago = '003' then
	...
	let _tipo_linea = '0';
	if _cod_cobertura in('00102','01299','01021','00123','01309','01073','00113','00671','01304','01022','01306','00606','00118','00104','00122','01155','01154','01481','01536','00904','00107','01535','00117','01301','00907','01028','01310','01323','01302','01650','01651','00106','01338','00108','01074','01303','01305','00109') then --coberturas de responsabilidad --,'01650','01651','01657'
		let _tipo_linea = '3';
	elif _perd_total = 1 AND _cod_cobertura in('00119','00121','01307','00103','00901','01300','01311','01233','00120','00902','01146','01308','01312','01145','01315','01677','01657', '01841') then --perdida total
		let _tipo_linea = '2';
	{else
	...
	if _cod_cobertura in('00119','00121','01307','01145','01315','01677', '01657', '01841') then --Colision
		...
		let _cobertura = 'DA';
	elif _cod_cobertura in('01306','00606','00118','00104','00122','01481','01536','00904','00107','01155','01154','01481','01536','00904','00107','01535','00117','01301','00907','01115','01310','01323','01302','01338','01305') and _tipo_pago = "A" then --Comprensivo
		let _cobertura = 'CM';
	elif _cod_cobertura in('01306','00606','00118','00104','00122','01481','01536','00904','00107','01155','01154','01481','01536','00904','00107','01535','00117','01301','00907','01115','01310','01323','01302','01338','01305') and _tipo_pago = "T" then --Comprensivo
		let _cobertura = 'LE';
	elif _cod_cobertura = '01075' then
		let _cobertura = 'GM';
	else
			...
			if _tipo_linea = '2' then
				if _cobertura = 'CO' then
					update sinsuperxtipo
					 ...
					 where fila = 9 and grupo = _grupo;
			    elif _cobertura = 'RO' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 10 and grupo = _grupo;
			    elif _cobertura = 'IN' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 11 and grupo = _grupo;
			    elif _cobertura = 'I' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 12 and grupo = _grupo;
				end if
				...
				if _cobertura = 'LE' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 14 and grupo = _grupo;
			    elif _cobertura = 'MU' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 15 and grupo = _grupo;
			    elif _cobertura = 'DA' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 16 and grupo = _grupo;
			    elif _cobertura = 'CM' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 6 and grupo = _grupo;
				end if
			else
				if _cobertura = 'CO' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 2 and grupo = _grupo;
			    elif _cobertura = 'RO' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 3 and grupo = _grupo;
			    elif _cobertura = 'IN' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 5 and grupo = _grupo;
			    elif _cobertura = 'I' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 4 and grupo = _grupo;
			    elif _cobertura = 'OT' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 17 and grupo = _grupo;
			    elif _cobertura = 'GM' then
					update sinsuperxtipo
					   set a_caso_p = a_caso_p + _casos_cerrados,
					       a_monto_p = a_monto_p + _monto_pagado
					 where fila = 7 and grupo = _grupo;
				end if
			end if
...
foreach
	select sum(a_caso_p),sum(a_monto_p),sum(a_caso_c),sum(a_monto_c),sum(t_caso_p),sum(t_monto_p),sum(t_caso_c),sum(t_monto_c),sum(so_caso_p),sum(so_monto_p),sum(so_caso_c),sum(so_monto_c), grupo
	  into _a_caso_p,_a_monto_p,_a_caso_c,_a_monto_c,_t_caso_p,_t_monto_p,_t_caso_c,_t_monto_c,_so_caso_p,_so_monto_p,_so_caso_c,_so_monto_c, _grupo
	  from sinsuperxtipo
	 group by grupo
...
foreach
	...
	update sinsuperxtipo
		set a_caso_p  = _a_caso_p,
			...
			so_caso_c  = _so_caso_c,
			so_monto_c = _so_monto_c
		where fila = 13 and grupo = _grupo;
end foreach
