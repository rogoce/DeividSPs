--Procedimiento para realizar la carga en Rentabilidad1 para bono de RENTABILIDAD con prima suscrita devengada
...
foreach
	...
	--************************************************
		...
		pri_susc_ap,  		
		pri_susc_dev_aa,  	
		pri_susc_dev_ap,   --PRIMA SUSCRITA DEVENGADA
		pri_dev_max_aa,
		pri_dev_max_ap,
		sini_inc,  			
		...
		_pri_sus_ap_tmp,  		
		_pri_susc_dev_aa,  	
		_pri_susc_dev_ap,  --PRIMA SUSCRITA DEVENGADA
		_pri_dev_max_aa,
		_pri_dev_max_ap,
		_sini_incu, 
		_prima_cobrada,
