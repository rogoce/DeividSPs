...
drop procedure sp_pro320dSimu;
create procedure sp_pro320dSimu(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10))
...
--if _cod_prod = '00313' then	--esto segun correo de Maryelis 12/12/2018 lo quité Amado 07-06-2025
--	update deivid_tmp:emiunide_f
...
if _ramo_sis = 1 then
	if _cod_rammo <> '024' then
		if _cod_rammo = '020' then
			...
			let _valor = sp_pro321cSimu(v_poliza_nuevo,v_poliza);
			if _valor <> 0 then
				return _valor,'';
			end if
