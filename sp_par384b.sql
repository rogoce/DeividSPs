...
DROP PROCEDURE sp_par384b;
CREATE PROCEDURE "informix".sp_par384b(a_flag smallint, a_periodo_desde char(7), a_periodo_hasta char(7))
	...
	delete from MigrarPolizas;
		...
		select distinct  fac.no_poliza
		 ...
		 inner join endedmae fac
				...
				and (fac.periodo between a_periodo_desde and a_periodo_hasta or fac.no_poliza in (select no_poliza from deivid_tmp:tmp_mig_poliza))
