...
------------------------------------------------
--execute procedure sp_pr860bk1('001','001','2012-07','2012-07',"*","*","*","*","001;","*","*")
DROP PROCEDURE sp_pr860bk1;
CREATE PROCEDURE sp_pr860bk1(a_compania CHAR(03),a_agencia CHAR(03),a_periodo1 CHAR(07),a_periodo2 CHAR(07),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo  CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codusuario CHAR(255) DEFAULT "*",a_codramo  CHAR(255) DEFAULT "*",a_reaseguro   CHAR(255) DEFAULT "*",a_serie char(255) default "*")
				   ...
				   and borderaux     = _borderaux 
					...
					if _porc_cont_partic < 100 then 
			  		...
			  		if v_clase = '002' then
						...
						if v_cobertura = '021' or v_cobertura = '022' then	--terremoto-inc, terremoto-multi
						...
						if 	_cod_coasegur = '042' then	   --SWISS
