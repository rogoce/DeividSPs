...
drop procedure sp_cas022;

create procedure "informix".sp_cas022(a_no_poliza char(10))
returning smallint;
...
--se asigna suc 001 si es colon y chiriqui, para que sean trabajdos por gestores de casa matriz. armando 18/11/2008
