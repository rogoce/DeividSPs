-- Siniestralidad por Corredor
-- 
-- Creado    : 31/08/2000 - Autor: Demetrio Hurtado Almanza 
-- Modificado: 11/07/2001 - Autor: Armando Moreno M.
--
-- SIS v.2.0 - d_recl_sp_rec16a_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_rec16a;

CREATE PROCEDURE "informix".sp_rec16a(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_periodo1 CHAR(7),
a_periodo2 CHAR(7),
