-- Polizas Vencidas con saldo por Cobrador - Detallado
-- 
-- Creado    : 12/09/2000 - Autor: Demetrio Hurtado Almanza 
-- Modificado: 20/09/2000 - Autor: Demetrio Hurtado Almanza
--
-- SIS v.2.0 - d_cobr_sp_cob10a_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_cob10a;

CREATE PROCEDURE "informix".sp_cob10a(
a_compania CHAR(3), 
a_agencia  CHAR(3), 
a_periodo  DATE,
a_sucursal CHAR(255),
...
FOREACH
 SELECT	nombre_cliente, 
   ...
   FROM	tmp_moros
  WHERE seleccionado = 1
  ORDER BY cod_cobrador, nombre_agente, nombre_cliente, no_documento, vigencia_inic
