-- Morosidad por Acreedor - Detallado
-- 
...
--
-- SIS v.2.0 - d_cobr_sp_cob03f_dw6 - DEIVID, S.A.

DROP PROCEDURE sp_cob03f;

CREATE PROCEDURE "informix".sp_cob03f(
a_compania   CHAR(3), 
a_agencia    CHAR(3), 
a_periodo    DATE,
a_sucursal   CHAR(255),
...
a_gestion    CHAR(255) DEFAULT '*' 
			...
			CHAR(30),  -- Cedula del asegurado
			CHAR(255), -- Filtros
			CHAR(1); -- gestion

DEFINE v_filtros           CHAR(255);
DEFINE _tipo,_gestion      CHAR(1);
...
DEFINE v_cod_cliente,v_codigo     CHAR(10);
...
FOREACH
 SELECT	nombre_cliente, 
   ...
   FROM	tmp_moros
  WHERE seleccionado = 1
  ORDER BY nombre_acreedor, nombre_agente, nombre_cliente, doc_poliza, vigencia_inic
