...
--DROP procedure sp_pro997z;
CREATE PROCEDURE sp_pro997z(a_cia CHAR(3), a_agencia   CHAR(3), a_periodo1  DATE, a_subramo CHAR(255) DEFAULT "*")
RETURNING CHAR(3),
 		  CHAR(50),
 		  CHAR(20),
          DATE,
 ...
 BEGIN
    ...
    FOREACH
       ...
       RETURN   v_codsubramo,v_desc_subr,v_documento,a_periodo1,_cant_ase,_dependientes, v_desc_contratante, v_vigencia_inic, _edadcal_tot/_cant_ase  WITH RESUME;
