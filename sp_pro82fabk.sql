...
drop procedure sp_pro82fabk;
CREATE PROCEDURE "informix".sp_pro82fabk(a_poliza CHAR(10), a_unidad CHAR(5), a_suma DECIMAL(16,2), a_cia CHAR(3), a_opcion integer default 0)
