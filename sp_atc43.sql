...
DROP PROCEDURE sp_atc43;
CREATE PROCEDURE sp_atc43(a_cia CHAR(3), a_agencia CHAR(3), a_fecha date, a_tipo_persona CHAR(1))
...
FOREACH
	SELECT distinct a.cod_contratante
	  INTO _cod_contratante
	  FROM temp_perfil a inner join emipomae b on a.no_poliza = b.no_poliza
	 WHERE seleccionado = 1 and estatus_poliza = 1
