-- Consulta de Movimientos de Auxiliar Sac x Transaccion de reclamos
-- Creado    : 06/08/2010 - Autor: Armando Moreno
-- SIS v.2.0 - DEIVID, S.A.	

DROP PROCEDURE sp_sac188;
CREATE PROCEDURE sp_sac188(a_cuenta char(12), a_comp CHAR(15), a_fecha DATE, a_aux char(5)) 
		...
		FOREACH
			select no_tranrec,
			  ...
			  into  d_tranrec,
			        d_debito,
			        d_credito
			  from deivid:recasiau
			 where cuenta       = a_cuenta
			   and cod_auxiliar = a_aux
			   and fecha        = a_fecha
			 group by no_tranrec
			 order by no_tranrec
