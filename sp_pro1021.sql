...
-- execute procedure sp_pro1021("001","001","2011-01","2011-01","001,003;")

DROP PROCEDURE sp_pro1021;
CREATE PROCEDURE "informix".sp_pro1021(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_periodo1 CHAR(7),
a_periodo2 CHAR(7),
...
FOREACH 
 SELECT prima,		
  ...
  WHERE seleccionado = 1
   ...
   select periodo,no_documento,cod_ramo, cod_subramo
	 into _periodo, _no_documento,_cod_ramo, _cod_subramo
	 from emipomae
	...
	no_poliza, no_documento,cod_ramo,cod_subramo,
	periodo,          
	prima_suscrita,
	tipo,
	cant_unidades,
	...
	VALUES(
	_no_poliza,_no_documento,_cod_ramo,_cod_subramo,
	_periodo,
	_prima_suscrita,
	"1",
	_cant_unidades,
...
FOREACH 
 SELECT SUM(prima_suscrita),
   ...
   INTO	_prima_suscrita,
		...
		_cod_subramo
   FROM tmp_datos6
  GROUP BY periodo,cod_ramo, cod_subramo
  ORDER BY cod_ramo asc,periodo
	...
	SELECT nombre
 	...
 	return _periodo,_cant_poliza,_prima_suscrita,_incurrido_bruto,_cant_unidades,_cant_sin_pagado,a_periodo2[1,4],_cod_ramo,_cod_subramo,v_ramo_nombre,v_subramo_nombre with resume;  	
