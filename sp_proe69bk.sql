...
{if _cod_tipoprod = "001" then
 ...
 FOREACH
	   ...
	   --	let v_prima1 = v_prima1 * (_porc_coaseguro / 100);
		 ...
		 ORDER BY cod_contrato,cod_cobertura,tipo,cod_coasegur,serie  
				...
				Select facilidad_car
				 ...
				 Where cod_contrato = v_cod_contrato;
				  ...
				  IF _flag = 1 THEN
					  if _facilidad_car = 1 then --v_cod_contrato = "00614" or v_cod_contrato = "00574" or v_cod_contrato = "00584" or v_cod_contrato = "00594" or v_cod_contrato = "00604" then
