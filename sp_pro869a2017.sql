--***********************************************************************************
-- Procedimiento que genera el Reporte Concurso Bogotá 2017
--***********************************************************************************
...
foreach
	...
	select cod_agente,
		   ...
		   n_agente,
		   sum(prima_sus_nva),
		   sum(prima_cobrada)        -- prima suscrita 2016 
	  into _cod_agente,
		   _nombre_tipo,
		   _nombre,
		   _prima_suscrita,
	...
	let _flag_1 = 0;
	if _nombre_tipo = 'Grupo I' and _prima_suscrita >= 800000 and _prima_sus_ramo >= 25000 then
		let _flag_1 = 1;
	elif _nombre_tipo = 'Grupo II' and _prima_suscrita >= 50000 and _prima_sus_ramo >= 15000 then
		let _flag_1 = 1;
	elif _nombre_tipo = 'Grupo III' and _prima_suscrita >= 35000 and _prima_sus_ramo >= 10000 then
		let _flag_1 = 1;
	elif _nombre_tipo = 'Grupo IV' and _prima_suscrita >= 25000 and _prima_sus_ramo >= 7500 then
		let _flag_1 = 1;
	elif _nombre_tipo = 'Grupo V' and _prima_suscrita >= 15000 and _prima_sus_ramo >= 5000 then
		let _flag_1 = 1;
	end if	
