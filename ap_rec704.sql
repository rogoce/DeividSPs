...
DROP PROCEDURE ap_rec704;
CREATE PROCEDURE ap_rec704(a_compania  CHAR(3),a_agencia   CHAR(3),a_periodo1  CHAR(7),a_periodo2  CHAR(7),
                           a_sucursal  CHAR(255) DEFAULT "*",a_grupo CHAR(255) DEFAULT "*",
						   a_ramo CHAR(255) DEFAULT "*",a_agente CHAR(255) DEFAULT "*",a_ajustador CHAR(255) DEFAULT "*",
						   a_evento CHAR(255) DEFAULT "*",a_suceso CHAR(255) DEFAULT "*",a_subramo CHAR(255) DEFAULT "*")
RETURNING CHAR(255);
  ...
  WHERE a.cod_compania = a_compania
	...
	SELECT count(*)
	 ...
	 WHERE a.no_poliza = b.no_poliza
	   ...
	   AND d.cod_tipoauto not in (select cod_tipoauto from emitiaut WHERE nombre like '%BUS%' or nombre like 'COASTER%');
