...
foreach
 SELECT no_poliza,
  ...
  WHERE cod_ramo              = "018"	               -- Salud
	...
	and cod_subramo           in ("007", "008", "009") -- Panama y Panama Plus -- 2007 se incluye Global
	...
	foreach
	 select cod_asegurado,
	  ...
	  where no_poliza = _no_poliza
		...
		let _cod_producto = sp_pro30d(_no_poliza, _cod_producto);  -- Buscando producto nuevo
		...
		if _por_edad = 0 Then --Se excluyen si el cambio no es por edad
		 --	CONTINUE FOREACH;
		end if
