...
-- Creado    : 24/03/2008 - Autor: Jaime Chevalier

-- SIS v.2.0 - d_cheq_sp_che03_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_che214a;

CREATE PROCEDURE sp_che214a(a_compania CHAR(3), a_cod_agente CHAR(255) default '*', a_periodo char(7),a_tipo_pago smallint) 
