...
drop procedure sp_pro320d_seraf;
create procedure sp_pro320d_seraf(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10))
...
if _cod_prod in ('08257','08258','08259','08261') then
	if _cod_prod = '08257' then
		let _cod_producto = '09531';
	elif _cod_prod = '08258' then
		let _cod_producto = '09532';
	elif _cod_prod = '08259' then
		let _cod_producto = '09533';
	elif _cod_prod = '08261' then
		let _cod_producto = '09534';
	end if
else
	let _cod_producto = _cod_prod;
end if
