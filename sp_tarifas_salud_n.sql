...
--execute procedure sp_tarifas_salud_n()

drop procedure sp_tarifas_salud_n;
create procedure sp_tarifas_salud_n(a_periodo char(7))
returning char(20)		as poliza,				
		char(5)			as unidad,				
		char(10)		as cod_asegurado,				
		varchar(50)		as asegurado,  
		date			as fecha_aniv_uni,  
		dec(16,2)		as prima_neta_tot,  
		date			as vigencia_inic,  
		date			as vigencia_final,  
		char(3)			as cod_recargo,
		varchar(30)		as recargo_uni,
		dec(16,2)		as porc_recarg_uni,  
		char(3)			as cod_perpago,
		char(20)		as periodo_pago,				
		smallint		as meses,  
		char(10)		as cod_dependiente,				
		varchar(50)		as dependiente,  
		date			as fecha_aniv_dep,  
		dec(16,2)		as prima_dependiente,  
		varchar(30)		as recargo_dep,
		dec(16,2)		as porc_recarg_dep,  
		dec(16,2)		as prima_neta_pol,  
		char(5)			as cod_producto,				
		dec(16,2)		as prima_desde,  
		dec(16,2)		as prima_hasta,
		dec(16,2)		as prima_desde_dep,  
		dec(16,2)		as prima_hasta_dep,
		varchar(150)	as corredor,
		varchar(150)	as zona_venta;
...
--set debug file to "sp_tarifas_salud_n.trc";
--trace on;
...
foreach                                           
	select emi.no_documento,               
	 ...
	 where emi.cod_compania   = '001'
	   ...
	   --and emi.no_documento not in ('1899-00172-01','1898-00012-01')
	   --and dep.cod_cliente is null
	   and month(emi.vigencia_inic) = _mes_periodo
	   --and month(emi.vigencia_inic) > 6
	...
	select agt.nombre,
	 ...
	 where pol.no_poliza = _no_poliza;
	*/
