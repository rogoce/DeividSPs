...
FOREACH 
 SELECT no_reclamo,		
  ...
  ORDER BY cod_ramo,numrecla
  	  ...
  	  IF _cod_ramo = '023' OR _cod_ramo = '020' THEN 
		LET _cod_ramo = '002';
	  END IF
   ...
   --        and pagos > 0
	...
	let _monto_pagado = 0;
   	foreach
		...
		let _tipo_linea = '0';
		if _cod_cobertura in('00102','01299','01021','00123','01309','01073','00113','00671','01304','01022','01306','00606','00118') then --coberturas de responsabilidad
			let _tipo_linea = '3';
	    ...
	    if _cod_cobertura in('00119','00121','01307') then --Colision
			...
			let _cobertura = 'DA';
		elif _cod_cobertura in('01306','00606','00118') then --Comprensivo
			let _cobertura = 'CM';
		else
