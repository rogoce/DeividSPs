...
DROP PROCEDURE sp_rec41b;

CREATE PROCEDURE "informix".sp_rec41b(a_compania CHAR(3),a_agencia  CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(255) DEFAULT "*",a_subramo CHAR(255) DEFAULT "*",a_tipo_veh CHAR(255) DEFAULT "*",a_grupo CHAR(255) DEFAULT "*",a_agente CHAR(255) DEFAULT "*") 
