...
DROP PROCEDURE sp_che115_carga2017sim3fac;
CREATE PROCEDURE sp_che115_carga2017sim3fac(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
foreach
	select no_documento,
	  ...
	  into _no_documento,
		   ...
		   _pri_susc_ap
	  from fis_che115a
	 where no_documento in('0617-00106-01','0617-00112-01','0617-00159-01','0617-00172-01','1414-00026-01','1415-00015-01','1415-00016-01','1415-00020-01',
'1415-00021-01',
'1415-00031-01',
'1416-00026-01',
'1417-00042-01',
	  ...
	  SELECT cod_agente,
	   ...
	   --*****************************************************
		...
		update rentabilidad4
		   set pri_susc_aa     = _pri_sus_aa_tmp,
		       pri_susc_ap     = _pri_sus_ap_tmp,
			   pri_susc_dev_aa = _pri_susc_dev_aa,
			   pri_susc_dev_ap = _pri_susc_dev_ap,
			   pri_dev_max_aa  = _pri_dev_max_aa,
			   pri_dev_max_ap  = _pri_dev_max_ap,
 	   		   por_incremento  = _incremento_psp,
		       por_crecimiento = _crecimiento,
		       por_siniestro   = _siniestralidad
		 where periodo = '2017-12'
