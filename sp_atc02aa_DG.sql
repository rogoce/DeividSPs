...
-- Modificado Hgiron 04/03/2020  adiciona #ruc y #no_unidad
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_atc02aa;
CREATE PROCEDURE "informix".sp_atc02aa(a_compania CHAR(3),a_sucursal CHAR(3),a_no_documento CHAR(20),a_ano integer, a_usuario CHAR(10), a_unidad CHAR(255) DEFAULT '*', a_membrete SMALLINT DEFAULT 0, a_monto_uni CHAR(255) DEFAULT '*')
RETURNING	CHAR(20),
			VARCHAR(100), -- PAGADOR
			VARCHAR(30),  -- CEDULA
...
--trace on;
 ...
 SELECT nombre, cedula , digito_ver
  ...
  let _periodo_fijo = '1 de abril al 31 de diciembre de 2019';
