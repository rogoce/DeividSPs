--***********************************************************************************
-- Procedimiento que genera la tabla mundial para concurso VIVE EL FUTBOL CON ANCON
--***********************************************************************************
...
--DROP PROCEDURE sp_atc25;

CREATE PROCEDURE sp_atc25(
a_compania          CHAR(3),
a_sucursal          CHAR(3))
RETURNING SMALLINT;
...
--Periodo de Clasificacion: Del 01 de junio de 2014 al  15 de jul del 2014
--Metas: 
...
--Brokers :   B/.   15,000  Primas Suscrita Nueva
--*****************************
-- Polizas Nuevas
--*****************************
foreach
