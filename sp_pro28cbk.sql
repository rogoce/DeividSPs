--drop procedure sp_pro28cbk;

create procedure "informix".sp_pro28cbk(v_periodo char(7), a_no_documento char(20) default "*")
returning integer;
...
--SET DEBUG FILE TO "sp_pro28c.trc"; 
--TRACE ON;                                                                
...
if a_no_documento <> "*" then
 ...
 {if (year(_vig_inic_ult) = v_periodo[1,4]) and (_vig_final >= today) then
 	return 1;
 end if}
