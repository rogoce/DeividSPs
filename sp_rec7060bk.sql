DROP PROCEDURE sp_rec7060bk;

CREATE PROCEDURE "informix".sp_rec7060bk(a_compania CHAR(3),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(255) DEFAULT "*",a_contrato CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_serie CHAR(255) DEFAULT "*") 
...
--execute procedure sp_rec7060bk('001','001','2012-12','2012-12',"*","*","001,003;","2013,2012,2011,2010,2009,2008;")
...
CREATE TEMP TABLE tmp_contrato1(
		...
		incurrido_neto       DEC(16,2) default 0 NOT NULL,
		cp_pag 		         DEC(16,2),
		exc_pag    			 DEC(16,2),
		cp_res 		         DEC(16,2),
		exc_res    			 DEC(16,2),
		cod_sucursal         CHAR(3)   default 'a' NOT NULL,
		serie                SMALLINT,
		ret_pag 		     DEC(16,2) default 0,
		fac_pag    			 DEC(16,2) default 0,
		cont_pag    		 DEC(16,2) default 0,
		ret_res 		     DEC(16,2) default 0,
		fac_res    			 DEC(16,2) default 0,
		cont_res    		 DEC(16,2) default 0,
		fac_car_1 	         dec(16,2) default 0,
		fac_car_2 	         dec(16,2) default 0,
		fac_car_3 	         dec(16,2) default 0,
		seleccionado         SMALLINT  DEFAULT 1 NOT NULL,
		cod_coasegur         char(3)   default '1',
...
FOREACH
	SELECT cod_contrato,
	  ...
	  FROM tmp_contrato1
	 WHERE seleccionado = 1
	 group by cod_contrato,no_reclamo,transaccion,no_poliza,cod_ramo,periodo,numrecla,pagado_bruto,reserva_bruto,incurrido_bruto,serie,pagado_neto,reserva_neto,incurrido_neto
