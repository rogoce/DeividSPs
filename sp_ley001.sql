...
--
drop procedure sp_ley001;
create procedure sp_ley001(a_no_documento char(20), a_fecha_verifica date)
...
foreach
	...
	return 1,'SUSPENSION DE COBERTURA EN FECHA DE SINIESTRO',_fecha_suspension;
end foreach
