...
-- Se desactivo la carga de Madrid.  Era hasta el 21 de octubre de 2011
-- Demetrio Hurtado
...
let _fecha_aa     = "21/10/2011";

let _fecha_ap     = sp_sis36(_per_fin_ap);
let _fecha_ap     = "21/10/2010";
  ...
  let _no_poliza = sp_sis21(_no_documento);
   ...
   select count(*)
    ...
    where no_poliza     = _no_poliza
      ...
      and fecha_emision >= '01/10/2010'
      and fecha_emision <= '21/10/2011';	--'30/09/2011';
	 ...
	 select cod_agente
	  ...
	  where no_poliza = _no_poliza
	   ...
	   --3 Doulos Insurance Consultants  (DICSA)(01048,01837) ,Logos Insurance(01569,01838), Juan Carlos Sanchez(01315,01834), Chung Wai Chun(00623,01836), Katia Mariza Dam de Spagnuolo(01575,01835)
		...
		if _cod_agente = "00874" then  -- Ser Company, cambiar a individual, correo 7/10/2011 leticia
			let _tipo_persona = "N";
		end if
