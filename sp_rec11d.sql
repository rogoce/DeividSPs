...
DROP PROCEDURE sp_rec11d;
CREATE PROCEDURE sp_rec11d(a_compania CHAR(3), a_agencia CHAR(3), a_fecha DATE, a_abogado CHAR(255) DEFAULT "*", a_forma_pago CHAR(255) DEFAULT "*" ) 
			RETURNING   CHAR(5),
						CHAR(100),
		    	        CHAR(18),
		            	CHAR(15),
...
FOREACH
	SELECT numrecla,
      ...
      FROM recrcmae
     WHERE actualizado = 1
	   AND year(fecha_reclamo) = year(a_fecha)
