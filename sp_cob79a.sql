-- Generacion del Archivo para Hsbc

-- Creado    : 07/03/2007 - Autor: Armando Moreno M.
-- Modificado: 07/03/2007 - Autor: Armando Moreno M.

-- SIS v.2.0 - DEIVID, S.A.

--DROP PROCEDURE sp_cob79a;

CREATE PROCEDURE "informix".sp_cob79a(
a_compania		CHAR(3),
a_sucursal		CHAR(3),
a_periodo		CHAR(1)
) RETURNING SMALLINT,
...
ON EXCEPTION SET _error_code 
 	RETURN _error_code, 'Error al Actualizar Archivo';
END EXCEPTION           
...
FOREACH
 SELECT h.no_cuenta
  ...
  END IF
  LET _once_blanks = '           ';
  LET _campo = _cedula || _nombre_pagador || _once_blanks;
