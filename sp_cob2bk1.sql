...
--DROP PROCEDURE sp_cob2bk1;

CREATE PROCEDURE "informix".sp_cob2bk1(
a_compania   CHAR(3), 
a_agencia    CHAR(3), 
a_periodo    DATE,
...
DEFINE v_nombre_coasegur,v_desc   CHAR(50);
