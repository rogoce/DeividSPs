-- Procedimiento que aumenta la reserva del reclamo

-- Creado    : 04/04/2014 - Autor: Amado Perez M 

--drop procedure sp_rwf121;

create procedure sp_rwf121(a_no_reclamo char(10), a_usuario char(8)) 
	returning integer,
              char(50);
...
let _reserva_cob = sp_rwf67(a_no_reclamo);
...
update recrcmae
   set reserva_actual  = _reserva_cob
 where no_reclamo      = a_no_reclamo;
