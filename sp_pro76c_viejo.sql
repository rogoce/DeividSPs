...
DROP PROCEDURE "informix".sp_pro76c_viejo;
CREATE PROCEDURE "informix".sp_pro76c_viejo(
a_compania      CHAR(50),
a_sucursal      CHAR(50),
a_fecha         DATE,
a_periodo       CHAR(7),
...
define _inserta,_est_pol        smallint;
...
--if a_documento = '1810-00866-01' then 
...
FOREACH    
	SELECT no_poliza,
	 ...
	 WHERE cod_ramo        = _cod_ramo 	 
	   AND vigencia_final >= v_fecha_ini
...
--	   and activo = 1;
	...
	CALL sp_proe22(_no_poliza, _no_unidad, _prima) RETURNING ld_recargo;

    LET _prima = _prima + ld_recargo;	
