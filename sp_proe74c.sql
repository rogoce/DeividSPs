...
drop procedure sp_proe74c;
 
create procedure sp_proe74c(a_poliza CHAR(10), a_unidad CHAR(5), a_producto CHAR(5), a_cobertura CHAR(5)) returning DECIMAL(5,2);
...
if _tipo_descuento = 1 then	--> Descuento RC igual para Sedan, Suv, Pick Up
	...
	end if	*/  --Puesto en Comentario RGORDON 27/04/2022
	--
