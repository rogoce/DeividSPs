...
DROP PROCEDURE sp_pro51e;
CREATE PROCEDURE "informix".sp_pro51e(a_poliza CHAR(10), a_producto CHAR(5), a_ramo CHAR(3), a_unidad CHAR(5), a_cobertura CHAR(5), a_suma DECIMAL(16,2))
