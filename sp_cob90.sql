...
DROP PROCEDURE sp_cob90;

CREATE PROCEDURE "informix".sp_cob90(a_compania CHAR(3), a_periodo1 CHAR(7), a_periodo2 CHAR(7))
...
--	   AND cuenta[1,3] IN ("144", "131") -- Produccion Directa
	   AND cuenta[1,3] IN ("141") -- Reaseguro Asumido
