...
--************************************************************************************
-- execute procedure sp_aud23("001","001")
-- Creado    : 28/03/2011 - Autor: Henry Giron
-- Este es un Anexo ya que no se contemplo colectivo de vida
-- Se ejecutara la categoria persona D sin afectar las demas.
-- Realizar pago Extraordinario. Sr. Arturo
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_aud23;

CREATE PROCEDURE sp_aud23(
a_compania          CHAR(3),
a_sucursal          CHAR(3)
) RETURNING SMALLINT;
...
foreach
 select no_documento,
   ...
   into _no_documento,
		...
		_prima_suscrita_ap
   from tmp_che115
  where no_documento[1,2] = "16"	  -- Solo las polizas de colectivo
...
foreach
	select tipo,
	 ...
	 where periodo    = a_periodo
	   and tipo = "D"   -- no_documento[1,2] in ("16","04","19")
--	   and monto_90   = 0
