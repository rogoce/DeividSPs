-- Cheques Pagados a Aseg. y afectados

-- Creado    : 11/02/2001 - Autor: Armando Moreno M.
-- Modificado: 11/02/2001 - Autor: Armando Moreno M.

-- SIS v.2.0 - d_cheq_sp_che11_dw1 - DEIVID, S.A.

--DROP PROCEDURE sp_che23;

CREATE PROCEDURE sp_che23(
a_compania    CHAR(3),
a_sucursal    CHAR(3),
a_fecha_desde DATE,   
a_fecha_hasta DATE,
...
--		IF _cod_asegurado <> _cod_cliente THEN
