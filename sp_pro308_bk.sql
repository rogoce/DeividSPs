...
--------------------------------------------
DROP PROCEDURE sp_pro308;

CREATE PROCEDURE sp_pro308(
		a_compania    CHAR(03),
		a_agencia     CHAR(03),
		a_periodo1    CHAR(07),
		a_periodo2    CHAR(07),
...
FOREACH
     SELECT cod_ramo,
       ...
       INTO v_cod_ramo,
			...
			_por_pagar
         FROM temp_produccion
     GROUP BY cod_ramo, cod_subramo, cod_origen, cod_contrato, desc_contrato, cod_cobertura, tipo, desc_cob
     ORDER BY cod_ramo, cod_subramo, cod_origen, cod_contrato, desc_contrato, cod_cobertura, tipo, desc_cob
