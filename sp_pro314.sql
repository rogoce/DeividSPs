...
DROP procedure sp_pro314;

CREATE procedure "informix".sp_pro314(
a_compania     CHAR(03),
a_agencia      CHAR(03),
a_periodo1     CHAR(07),
a_periodo2     CHAR(07),
...
CREATE TEMP TABLE temp_det1
      ...
      CREATE INDEX id1_temp_det1 ON temp_det1(cod_sucursal);
      CREATE INDEX id2_temp_det1 ON temp_det1(cod_grupo);
      CREATE INDEX id3_temp_det1 ON temp_det1(cod_agente);
      CREATE INDEX id4_temp_det1 ON temp_det1(cod_usuario);
      CREATE INDEX id5_temp_det1 ON temp_det1(cod_ramo);
      CREATE INDEX id6_temp_det1 ON temp_det1(cod_tipoprod);
	  CREATE INDEX id7_temp_det1 ON temp_det1(cod_contratante);
      ...
      FOREACH
         SELECT endedmae.no_poliza,
           ...
           INTO v_nopoliza,
                ...
                v_vigencia_inic
           FROM endedmae
          WHERE (endedmae.periodo    >= a_periodo1
            AND endedmae.periodo     <= a_periodo2)
			AND endedmae.actualizado  = 1
			AND endedmae.cod_compania = a_compania
--			AND endedmae.prima_suscrita <> 0.00
--			AND endedmae.cod_endomov  = "017"	
