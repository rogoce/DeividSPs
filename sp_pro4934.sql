...
-- Copia de sp_pro4934 modificar que solo lea las retenciones Solicitud: Demetrio  Fecha: 30/07/2010
-- executable sp_pro4934("001","001","2010-06")

drop procedure sp_pro4934;

create procedure "informix".sp_pro4934(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo CHAR(7))
returning CHAR(3),
		  varchar(50),
		  char(3),
		  varchar(50),
...
foreach
 SELECT no_documento
   INTO	_doc_poliza
   FROM emipoliza
--  where no_documento = "0105-00280-01"
...
--		   let _prima_ret = 0;
--		   let _prima_ret = v_saldo * _porc_partic_prima / 100;
			continue foreach;
		else
