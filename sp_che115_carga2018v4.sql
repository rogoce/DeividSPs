...
--DROP PROCEDURE sp_che115_carga2018v4;
CREATE PROCEDURE sp_che115_carga2018v4(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
foreach
	select no_documento,
	  ...
	  into _no_documento,
		   ...
		   _pri_dev_aa
	  from fis_che115a
	 where cod_agente in('02532','02531') 
