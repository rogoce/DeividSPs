...
drop procedure sp_che54aa;

create procedure sp_che54aa(a_fecha date)
 returning char(100),char(10),char(10),char(7),char(10),char(10),date,smallint,char(100);
...
foreach
	select cod_cliente,
	 ...
	 where actualizado    = 1
	   ...
	   and generar_cheque = 1
	   and cod_tipotran   = "004"	 --pago
	   and periodo        between "2008-02" and "2008-09"
	   and no_requis is not null
	  ...
	  if _cod_cliente <> _cod_cliente_ch then
			...
			return _n_cliente_trx,_transaccion,_no_requis,_periodo,_cod_cliente,_cod_cliente_ch,_fecha_impresion,_pagado,_n_cliente_chq with resume;
