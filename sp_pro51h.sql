...
DROP PROCEDURE sp_pro51h;

CREATE PROCEDURE "informix".sp_pro51h(a_poliza CHAR(10), a_producto CHAR(5), a_ramo CHAR(3), a_unidad CHAR(5), a_cobertura CHAR(5), a_marca CHAR(5), a_suma DECIMAL(16,2), a_tarifa DECIMAL(16,2), a_uso_auto CHAR(1))
...
if a_cobertura = '00119' and a_poliza = 'S2772244' then
set debug file to "sp_pro51h.trc"; 
trace on;    
end if 
...
IF a_uso_auto = "P" THEN
   --Colision
    IF a_cobertura IN ("00119", "00121", "01307") THEN
      LET _ld_prima_act = sp_pro51i(a_poliza, a_producto, a_ramo, a_unidad, a_cobertura, a_suma);
   ...
   --Comprensivo
    IF a_cobertura IN ("00118", "00606", "00120", "00103", "01306", "01308", "01300") THEN
	  ...
	  IF a_ramo = '002' THEN
		LET _ld_prima_act = sp_pro51i(a_poliza, a_producto, a_ramo, a_unidad, "00118", a_suma);
	  ELIF a_ramo = '023' THEN
		LET _ld_prima_act = sp_pro51i(a_poliza, a_producto, a_ramo, a_unidad, "01306", a_suma);
	  END IF
