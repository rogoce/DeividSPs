...
drop PROCEDURE sp_sis18am;
CREATE PROCEDURE sp_sis18am(a_no_reclamo CHAR(10))
...
if  _no_poliza = '952507' and _no_unidad = '00386' then
	let _no_cambio = 0;
end if
if  _no_poliza = '1856966' then
	let _no_cambio = 2;
end if
