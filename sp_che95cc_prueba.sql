...
DROP PROCEDURE sp_che95cc_prueba;
CREATE PROCEDURE sp_che95cc_prueba(a_cia CHAR(3),a_cod_agente CHAR(5) default "*",a_periodo char(7))
RETURNING CHAR(50),CHAR(100),CHAR(5),CHAR(50),CHAR(1),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,2),DEC(16,4),DEC(16,2),CHAR(7),CHAR(1),DEC(16,2),DEC(16,2);
 -- v_nombre_cia,
 -- nombre_agente,
 -- cod_agente,
 -- nombre_tipo,
