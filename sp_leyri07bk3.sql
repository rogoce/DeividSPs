...
drop procedure sp_leyri07bk3;
create procedure "informix".sp_leyri07bk3(a_fecha1 date, a_fecha2 date)
returning   char(10),
			varchar(50),
			char(20),
			char(10),
...
define _db_pro			dec(16,2);
define _no_requis       char(10);
define _cr_pro			dec(16,2);
...
let _cr_pro	= 0.00;
 ...
 CREATE TEMP TABLE tmp_cgl
           (cod_agente       CHAR(5),
			...
			porc_partic_agt  decimal(5,2) not null,
			no_requis        char(10)
			) WITH NO LOG;
...
foreach
   ...
   return _cod_agente,_n_agente,_no_documento,_no_poliza,_res_comprobante,_res_notrx,_res_db,_res_cr,_tipo_agente,_no_requis with resume;
