...
DROP procedure sp_aud42;
CREATE procedure "informix".sp_aud42(a_periodo1 CHAR(07))
RETURNING int,
          int,
		  char(4),
		  char(2),
   ...
   BEGIN
	  ...
	  define _cantcobertura					 smallint;
        ...
        SELECT porc_comis_agt, porc_partic_agt
		 ...
		 foreach 
		  select no_unidad, suma_asegurada, prima_suscrita
		    into _no_unidad, v_suma_asegurada, _prima_suscrita
			from endeduni
		   where no_poliza = v_nopoliza
			 and no_endoso = v_noendoso	
