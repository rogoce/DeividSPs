...
--
-- SIS v.2.0 - d_recl_sp_rec14m_dw13_prueba - DEIVID, S.A.

drop procedure sp_rec14m_prueba;
create procedure sp_rec14m_prueba(
a_compania char(3),
a_agencia  char(3),
a_periodo1 char(7),
a_periodo2 char(7),
...
returning	char(20)		as poliza,				-- poliza
			...
			char(7) as periodo1,
			char(7) as periodo2, char(4) as anio;
...
--call sp_rec14_prueba(a_compania,a_agencia,a_periodo1,a_periodo2,'%',a_poliza)  returning _error ;
call sp_rec14_prueba2(a_compania,a_agencia,a_periodo1,a_periodo2,'%',a_poliza)  returning _error ;
...
foreach
	select no_poliza,
	  ...
	  into _no_poliza,
		   ...
		   v_siniestro_pagado,
		   v_prima_pagada,
		   _cod_cliente,_periodo1,_periodo2
	  from tmp_siniest
	 where seleccionado = 1
	 group by no_poliza, doc_poliza, cod_ramo, cod_grupo, cod_cliente, periodo1, periodo2
	 order by cod_cliente, doc_poliza, periodo1
	...
	return v_doc_poliza,
		   ...
		   v_vigencia_inic,
		   v_vigencia_final,
		   v_filtros,_periodo1,_periodo2,_anio
		   with resume;
end foreach
