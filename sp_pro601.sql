...
-- Procedimiento para insertar el endoso de cambio de acreedor BANISI
-- Amado Perez M - 13/04/2023

drop procedure sp_pro601;

create procedure sp_pro601(a_no_documento char(20)) 
returning	smallint,
		    char(5),
			char(100);
...
foreach
    ...
    select a_no_poliza,
           ...
           descripcion
      from endedde2
     where no_poliza = '1876652' and no_endoso = '00002';	  
end foreach       	
