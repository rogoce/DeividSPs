drop procedure sp_pro4953b;
create procedure sp_pro4953b(a_periodo char(7),
...
--	trace on;
	...
	/*Verifica si la poliza cambio de corredor*/
	call sp_pro4953a(a_periodo) RETURNING _verifica;
...
foreach
  select distinct emicartasal2.nombre_cliente,   
   ...
   where (emicartasal2.no_documento	= emipomae.no_documento ) and  
         ...
         ((emicartasal2.fecha_aniv	>= _fecha_desde and  emicartasal2.fecha_aniv <= _fecha_hasta) and  
         ...
         emicartasal2.cod_subramo in ('007','009','016') and  
         emicartasal2.no_documento	like a_poliza ) and
         (emicartasal2.tipo_cambio = 0)	and
         (emipomae.estatus_poliza not in (2,4))		 
