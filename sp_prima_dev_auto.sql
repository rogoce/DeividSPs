...
drop procedure sp_prima_dev_auto;

create procedure "informix".sp_prima_dev_auto()
returning char(20),
		  dec(16,2),
		  CHAR(7),
		  CHAR(1);
...
foreach
 select no_documento,
  ...
  group by no_documento
   ...
   if _cantidad > 5 then --Es colectivo
	  let _colectivo = 'C';
   end if

  return _no_documento,_pri_dev_aa,v_grupo,_colectivo with resume;
