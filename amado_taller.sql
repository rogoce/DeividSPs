...
DROP PROCEDURE amado_taller;

CREATE PROCEDURE "informix".amado_taller(a_no_tranrec CHAR(10), a_deducible DEC(16,2) DEFAULT 0.00, a_cotizacion VARCHAR(10) DEFAULT NULL) 
