--***********************************************************************************
-- Procedimiento que genera el Reporte para consurso a serie del caribe en venezuela
--***********************************************************************************
...
DROP PROCEDURE sp_pro865;

CREATE PROCEDURE sp_pro865()
RETURNING char(50),DEC(16,2),char(15),DEC(16,2),date,date;
