...
drop procedure sp_proe72abk;
 
create procedure sp_proe72abk(a_poliza CHAR(10), a_unidad CHAR(5))
returning dec(16,2);
...
if _grupo is null or _grupo = '' then
	...
	let _porc_desc = sp_proe85a(a_poliza,a_unidad);
	return _porc_desc;
end if
