...
--------------------------------------------
   ...
   BEGIN
      ...
      CALL sp_pro34(a_compania,a_agencia,a_periodo1,
                    ...
                    a_codusuario,a_codramo,a_codtipoprod,"*")
                    RETURNING v_filtros;

      SET ISOLATION TO DIRTY READ;
      FOREACH WITH HOLD
         SELECT x.no_factura,x.no_documento,x.no_poliza,x.no_endoso,
                x.cod_contratante
                INTO v_nofactura,v_nodocumento,v_nopoliza,v_noendoso,
                     v_cod_contratante
                FROM temp_det x
