...
drop procedure sp_pro320e;
create procedure sp_pro320e(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10), v_no_unidad char(5))
...
if _porc_especial is null then
	let _porc_especial = 0;
end if

let _porc_especial = _porc_especial * (-1);
...
if _cnt_descu > 0 then   
	update deivid_tmp:emiunide_f
	   set porc_descuento = porc_descuento + _porc_especial
     where no_poliza = v_poliza_nuevo
       and no_unidad = v_no_unidad
       and cod_descuen = '001';
else
