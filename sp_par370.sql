...
Drop procedure sp_par370; 
CREATE PROCEDURE "informix".sp_par370(  
a_secuencia	INTEGER 
)returning	references text,
            Lvarchar(max),
            Lvarchar(max); 

Define _html_body1	 references text; -- char(512); 
...
Let  _html_body1 = trim(_html_body1) ||'    	<td colspan="2">';
Let  _html_body1 = trim(_html_body1) ||'        	<p>';
Let  _html_body1 = trim(_html_body1) ||'        	 	Adjunto encontrar&aacute; una gu&iacute;a para conocer los documentos necesarios para el tr&aacute;mite';
Let  _html_body1 = trim(_html_body1) ||'             	de su reclamo sea m&aacute;s expedito seg&uacute;n la cobertura afectada.';
Let  _html_body1 = trim(_html_body1) ||'            </p>';
Let  _html_body1 = trim(_html_body1) ||'            <p>';
Let  _html_body1 = trim(_html_body1) ||'            	En caso que aplique pago a deducible Ud. podr&aacute; realizarlo a trav&eacute;s de nuestras oficinas';
Let  _html_body1 = trim(_html_body1) ||'				a nivel nacional, as&iacute; como tambi&eacute;n en los diferentes centros de pago, recuerde';
Let  _html_body1 = trim(_html_body1) ||'            	presentar el slip al momento de presentarse en algunas de nuestras oficinas.';
Let  _html_body1 = trim(_html_body1) ||'            </p>';
Let  _html_body1 = trim(_html_body1) ||'            <p>';
Let  _html_body1 = trim(_html_body1) ||'               Si usted desea solicitar el servicio de Asistencia Legal es necesario completar y firmar';
Let  _html_body1 = trim(_html_body1) ||'               en original el Poder Legal que encontrar&aacute; adunto, el mismo podr&aacute; enviarlo a trav&eacute;s de su';
Let  _html_body1 = trim(_html_body1) ||'               corredor de seguros o dejarlo en algunas de nuestras oficinas a nivel nacional.';
Let  _html_body1 = trim(_html_body1) ||'			</p>';
Let  _html_body1 = trim(_html_body1) ||'            <p>';
Let  _html_body1 = trim(_html_body1) ||'            	Si desea informaci&oacute;n referente a sus p&oacute;lizas, reclamos, actualizaci&oacute;n de datos u';
Let  _html_body1 = trim(_html_body1) ||'				otras consultas puede realizarlas a trav&eacute;s de nuestra Web: www.asegurancon.com,';
Let  _html_body1 = trim(_html_body1) ||'                opci&oacute;n SERVICIO EN LINEA/ANCON ONLINE o llamarnos a nuestra central telef&oacute;nica';
Let  _html_body1 = trim(_html_body1) ||'                210-8787 o escribanos a info@asegurancon.com que con gusto nuestros agentes';
Let  _html_body1 = trim(_html_body1) ||'                le estar&aacute;n atendiendo.';
Let  _html_body1 = trim(_html_body1) ||'            </p>';
Let  _html_body1 = trim(_html_body1) ||'            <p>&nbsp;</p>';
Let  _html_body1 = trim(_html_body1) ||'            <p>&nbsp;</p>';
Let  _html_body1 = trim(_html_body1) ||'            <p>&iexcl;Gracias por preferirnos!<br>';
Let  _html_body1 = trim(_html_body1) ||'            Nota: Este correo es generado de forma autom&aacute;tica por la Intranet Corporativa. Por favor no responder al remitente.';
Let  _html_body1 = trim(_html_body1) ||'            </p>';
...
END FOREACH;
return _html_body1,_html_body2,_html_body3;
--trace off;
END PROCEDURE
