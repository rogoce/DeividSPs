...
-- execute procedure sp_che94_1("001","001","2011-12","HGIRON")
-- Creado    : 28/01/2009 - Autor: Henry Giron
-- Ultima Modificacion: 23/01/2012 - Autor: Henry Giron
-- SIS v.2.0 - DEIVID, S.A.
DROP PROCEDURE sp_che94_pase2011;
CREATE PROCEDURE sp_che94_pase2011(
a_cia               CHAR(3),
a_sucursal          CHAR(3),
a_periodo           CHAR(7),  
a_usuario           CHAR(8))
...
FOREACH
	select trim(cod_agente),
	 ...
	 where periodo = a_periodo
	   and monto_90 = 0
--	   and cod_agente in ('01068','01653','01654','01655','01656','01657','01658','01659','01660','01661','01662','01663','01664','01807','01839','02041')
		...
		foreach
			select cod_ramo,nombre_ramo,
			 ...
			 order by beneficio , cod_ramo , nombre_ramo
				   ...
				   LET _prima_aplica_ramo 	= _pri_susc_aa_2 - _reserva_aa_ramo + _liberacion_ap_ramo;
			...
			VALUES (_cod_agente,_prima_aplica_ramo,_valor_prima_2,_nombre_agente,0,a_periodo,current,_cod_ramo_2,
