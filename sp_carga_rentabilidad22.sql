...
--DROP PROCEDURE sp_carga_rentabilidad22;
CREATE PROCEDURE sp_carga_rentabilidad22(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
let a_periodo   = '2016-04';  --****PONER COMENTARIO CUANDO CORRE ANUAL
