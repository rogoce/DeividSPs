...
create procedure sp_cob381a(a_numero char(10), a_recibo_susp char(30))
returning	integer,
			varchar(100);
...
{let _no_remesa_agt = '11258';
call sp_cob212('001','001','MCONCEPC',_no_remesa_agt,a_recibo_susp) returning _error,_error_desc,_no_remesa;
