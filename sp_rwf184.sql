-- buscar ajustador para los reclamos de automovil -- copia del sp_rwf86

-- Creado: 15/01/2025 - Autor: Amado Perez Mendoza
--
drop procedure sp_rwf184;

create procedure "informix".sp_rwf184(a_sucursal CHAR(3), a_no_poliza CHAR(10) DEFAULT NULL, a_tipo_rec CHAR(1), a_cobertura CHAR(1))
returning  char(3),
           varchar(8), 
           varchar(40),
           varchar(30),
...
if a_no_poliza = '0002423566' then
  SET DEBUG FILE TO "sp_rwf184.trc"; 
  trace on;
end if
...
select count(*)
  into _cantidad
  from recajust a, recasigwf b
 where a.cod_ajustador = b.cod_ajustador
   and a.activo     = 1
   and a.dist_equitativa = 1
   and b.tipo_reclamante = a_tipo_rec
   and b.sucursal = _sucursal
   and b.categoria_cob = a_cobertura;
