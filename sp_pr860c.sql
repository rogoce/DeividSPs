...
foreach
	select serie,
	  ...
	  into _serie,
		   ...
		   v_prima 
	  from tmp_temphg
	 where cod_coasegur in ('050','063','076','042','036','089','128','117')
	   and anio      = _anio_reas
	   and trimestre = _trim_reas
	...
	foreach 
		select distinct cod_coasegur,
		  ...
		  from tmp_temphg
		 Where serie         = _serie
		   and cod_coasegur in  ('050','063','076','042','036','089','128','117')
		...
		end if			if v_cod_ramo = '016' then --Col. de Vida
