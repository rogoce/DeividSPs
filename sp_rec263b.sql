...
DROP PROCEDURE sp_rec263b;
--DROP TABLE tmp_arreglo;
CREATE PROCEDURE "informix".sp_rec263b(a_compania CHAR(3), a_agencia CHAR(3), a_tranrec CHAR(10))
			RETURNING   CHAR(18),
						VARCHAR(100),
						VARCHAR(30),
						DEC(16,2),
