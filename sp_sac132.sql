-- Procedure que verifica que cuadre SAC Vs Deivid en Reclamos

-- Creado    : 13/09/2007 - Autor: Demetrio Hurtado Almanza

-- SIS v.2.0 - DEIVID, S.A.

drop procedure sp_sac132;
...
--	and no_tranrec   = "1376185"
	...
	if _notrx = 0 then
       ...
       if _no_tranrec not in ('2461372') then
			return 4,
				   _no_tranrec,
				   _monto1,
				   0,
...
--		let _monto_neto    = _monto_neto    + _var_cob_neto;
		let _monto_neto    = _monto_neto    + _var_cob_bruto;
	...
	if _monto2 <> _monto_neto then
		...
		if _no_tranrec not in ('1873244','1847897','2401633','2414666','2402422','2414739','2461372') then
	...
	if _monto2 <> _monto_bruto then
		...
		if _no_tranrec not in ('2401633','2414666','2402422','2414739','2461372') then
