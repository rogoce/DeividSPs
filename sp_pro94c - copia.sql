   ...
   CREATE procedure "informix".sp_pro94c(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7),a_origen CHAR(3) DEFAULT '%')
   RETURNING CHAR(50),INT,DECIMAL(16,2),CHAR(50),CHAR(45),INT,SMALLINT,DECIMAL(16,2),INTEGER,DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),integer,CHAR(8);
--------------------------------------------
---  APADEA
