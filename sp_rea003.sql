...
drop procedure sp_rea003;

create procedure sp_rea003(a_periodo1 char(7), a_periodo2 char(7))
		...
		foreach
		 select cod_coasegur,
	      ...
	      where cod_contrato   = _cod_contrato
			...
			values (_cod_coasegur, _cod_ramo, 0.00, 0.00, 000, 0.00, 0.00, _por_pagar, _no_documento);
