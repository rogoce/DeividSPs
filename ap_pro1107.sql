-- Insertando los valores de cambios de productos de las cartas de Salud en emicartasal5. Martillo para febrero
-- Creado    : 26/01/2010 - Autor: Amado Perez.
-- 
-- SIS v.2.0 -  - DEIVID, S.A.	  copia del sp_pro497.

drop procedure ap_pro1107;
create procedure ap_pro1107(
    a_periodo		char(7),
...
--	   and month(vigencia_inic) = month(_fecha_desde)
	   ...
	   and cod_grupo = '77942'
	   and no_documento in (
	   select no_documento from tmp_faesfeb)
