...
-- 		FACILIDAD PROVINCIAL -INCENDIO  HENRY
-- 		PRIMA COBRADA
-- execute PROCEDURE sp_pr118 ("001","001","2009-10","2009-12","*","*","*","*",
-- "001,003,002,010,011,012,013,014;","*","*","*")
---------------------------------------------------------------------------------
DROP PROCEDURE sp_pr118;
CREATE PROCEDURE sp_pr118(	a_compania    CHAR(03),
		a_agencia     CHAR(03),
		a_periodo1    CHAR(07),
		a_periodo2    CHAR(07),
...
--     set debug file to "sp_pr118.trc";	  	  	  	
