...
drop procedure sp_rwf135a;

create procedure sp_rwf135a(a_no_reclamo char(10), a_opcion smallint, 
                            a_monto dec(16,2), a_user_name_ajust CHAR(20), 
							a_cod_cobertura CHAR(5),a_no_demanda CHAR(10)) 
  returning integer,
            char(50),
            char(10);
...
define _descripcion_leg    varchar(60);
...
if a_opcion = 1 then			 -- Aumento 
	...
	LET _descripcion_leg = "AUMENTO DESDE EL CONTROL DE RESERVAS ";
	...
	LET _descripcion_leg = "DISMINUCION DESDE EL CONTROL DE RESERVAS ";
	...
	LET _descripcion_leg = "CIERRE DESDE EL CONTROL DE RESERVAS ";
...
-- Insertando LEGDEMANDAS
LET _hoy = CURRENT;
LET _hoy = _hoy + 1 units second;
CALL sp_leg06(a_no_demanda,_hoy, _descripcion_leg || ", SUBIO A APROBACION",_user_added) returning _error, _error_desc;
IF _error <> 0 THEN
	RETURN  _error, _error_desc, null;
END IF
