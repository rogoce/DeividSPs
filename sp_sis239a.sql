...
drop procedure sp_sis239a;
create procedure "informix".sp_sis239a() 
returning	smallint,
			char(100),
			char(10);
...
let _motivo_rechazo = "DEVOLUCION COBRO DUPLICADO 260218";
...
foreach
	select e.no_documento,
	  ...
	  into _no_documento,
		   _monto_recibo
	  from cobtatrabk t, cobtatrabk e
	 where t.no_tarjeta = e.no_tarjeta
	   and t.no_documento = e.no_documento
	   and date(t.date_added) = '26/02/2018'
	   and date(e.date_added) = '27/02/2018'
	   and t.procesar = 1
	   and e.procesar = 1
	   and e.no_documento <> '0216-00283-12'
...
let _saldo =  _monto_cob * -1; --(_monto_cob - _monto_descontado); 
