...
DROP PROCEDURE sp_che117amm;
CREATE PROCEDURE sp_che117amm(a_origen char(1), a_pagado  smallint) 
...
FOREACH
	SELECT chqchmae.cod_agente,
	 ...
	 WHERE ( agtagent.cod_agente = chqchmae.cod_agente ) and
		   ...
		   ( chqchmae.no_requis = '1212227') and
  ...
  order by	5,2 Desc
    ...
    if a_origen = '8' and _cod_agente = '01829' then	--Bonificacion de cobranza, caso especial Lizsenell Bernal	correo de Nadhyaly 21/11/2023
		let _tipo_cuenta = 'S';
