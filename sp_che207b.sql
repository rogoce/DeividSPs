--*******************************************************************************************
-- Procedimiento que Actualiza las primas cobradas nuevas pero 2010
--*******************************************************************************************
...
--DROP PROCEDURE sp_che207b;

CREATE PROCEDURE sp_che207b(a_compania CHAR(3))
RETURNING SMALLINT;
	 ...
	 foreach
		 ...
		 select e.no_documento
		  ...
		  where e.no_poliza         = t.no_poliza
		    ...
		    and e.actualizado       = 1
			and e.nueva_renov       = "N"
		    and e.fecha_suscripcion >= "15/03/2010"
			and e.fecha_suscripcion <= "15/07/2010"
		 ...
		 let _no_poliza = sp_sis21(_no_documento);
		   ...
		   select count(*)
		    ...
		    where no_poliza   = _no_poliza
		      ...
		      and fecha_emision >= '15/03/2010'
		      and fecha_emision <= '15/07/2010';
			...
			foreach
				 ...
				 SELECT	d.no_remesa,
				  ...
				  WHERE	d.no_remesa    = m.no_remesa
					...
					AND d.fecha        >= "15/03/2010"
					AND d.fecha        <= "15/07/2010"
