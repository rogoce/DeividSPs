-- Procedimiento que Genera la Remesa de Suspensos
-- 
...
DROP PROCEDURE sp_cob187;

CREATE PROCEDURE "informix".sp_cob187()
RETURNING INTEGER,
		  CHAR(50);
...
--set debug file to "sp_cob187.trc";
--trace on;
...
FOREACH
 SELECT v_doc_suspenso,
        v_monto
   INTO _no_documento,
        _saldo
   FROM suspe0511

	-- Documento en Suspenso
    ...
    LET _estoy = "COBREDET " ||_no_documento;
...
let _no_documento = "0503-00026-01";	
