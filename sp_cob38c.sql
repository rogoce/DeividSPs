...
DROP PROCEDURE sp_cob38c;
CREATE PROCEDURE "informix".sp_cob38c(a_compania CHAR(3), a_agencia CHAR(3), a_periodo1 CHAR(7), a_periodo2 CHAR(7),a_ramo CHAR(255) DEFAULT "*")
		RETURNING smallint;
