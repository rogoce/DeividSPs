...
-- execute procedure sp_rea004c("2010-04","2010-04")
-- SIS v.2.0 - DEIVID, S.A.
  
drop procedure sp_rea004c;

create procedure sp_rea004c(a_periodo1 char(7), a_periodo2 char(7)) 
returning char(3),
		  char(50),
		  dec(16,2),
		  dec(16,2),
...
foreach
 select serie,
  ...
  order by 1, 2, 3, 4
		...
		if _grupo = 1 then
			let _nombre_grupo = "CONTRATOS BOUQUET";
		end if
		if _grupo = 2 then
