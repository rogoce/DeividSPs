...
DROP PROCEDURE sp_atc02aabk;

CREATE PROCEDURE "informix".sp_atc02aabk(a_compania CHAR(3),a_sucursal CHAR(3),a_no_documento CHAR(20),a_ano integer, a_usuario CHAR(10), a_unidad CHAR(255) DEFAULT '*', a_membrete SMALLINT DEFAULT 0, a_monto_uni CHAR(255) DEFAULT '*')
RETURNING	CHAR(20),
			VARCHAR(100), -- PAGADOR
			VARCHAR(30),  -- CEDULA
