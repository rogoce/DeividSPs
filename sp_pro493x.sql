...
drop procedure sp_pro493x;

create procedure "informix".sp_pro493x(
v_poliza char(10),
v_endoso char(5),
...
if v_tipocalc = "002" Then -- Manual
   ...
   let v_saldo2 = v_saldo;
   let v_saldo  = v_saldo * v_factor;
   let v_saldo  = v_saldo2 - v_saldo;
...
--	END IF
   ...
   foreach
	  ...
	  if v_tipocalc = "005" Or v_tipocalc = "002" Then
...

{
   ...
   select sum(x.prima), sum(x.prima), SUM(x.descuento), SUM(x.recargo), SUM(x.prima_neta)
    ...
    where x.no_poliza = v_poliza
	  ...
	  if  v_tipocalc = "002" and v_tipo_mov = "2"  Then
...
if (v_tipocalc = "002" or v_tipocalc = "004") and _ramo_sis <> 5 Then
