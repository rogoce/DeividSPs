-- Ajuste de las letras de pago de las polizas por nueva ley de seguros cuando la poliza tiene devolución de prima.
-- Creado    : 13/11/2014 - Autor: Román Gordón
-- SIS v.2.0 - DEIVID, S.A.
  
drop procedure sp_che161;
create procedure sp_che161(a_no_poliza char(10), a_no_requis char(10))
returning	int,
			char(50);
...
on exception set _error, _error_isam, _error_desc
	let _error_desc = trim(_error_desc) || 'no_poliza: ' || trim(a_no_poliza) || ' no_requis: ' || trim(a_no_requis);
