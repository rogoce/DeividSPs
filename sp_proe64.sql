...
DROP PROCEDURE sp_proe64;
CREATE PROCEDURE "informix".sp_proe64(a_carta CHAR(1) DEFAULT "1", a_desde DATE, a_hasta DATE, a_user  CHAR(15))
...
DEFINE _f_aniversario			 DATE;
DEFINE _f_aviso_hipot			 DATE;
