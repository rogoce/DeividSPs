...
RETURNING CHAR(3),CHAR(3),CHAR(5),CHAR(3),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),CHAR(50),CHAR(50), CHAR(50);
   BEGIN 
		...
		define _ramo_sis,_tipo					Smallint;

		SET ISOLATION TO DIRTY READ;
		LET _borderaux = "02";	    -- Run Off -- Prima suscrita
		select tipo into _tipo from reatrim where cod_contrato = _borderaux;
...
--		DELETE FROM reacoprs;
--		DELETE FROM temphg1;	  	  	-- temphg2 se cambio por temphg1
...
--  FOREACH
-- select serie,cod_ramo,cod_contrato,tipo_contrato,porc_comision,porc_impuesto,sum(prima)
--   into _serie,v_cod_ramo,v_cod_contrato,v_tipo_contrato,_porc_comision,_porc_impuesto,v_prima1
FOREACH
 select serie,cod_ramo,cod_contrato,tipo_contrato,sum(prima)
  ...
  group by cod_ramo,serie,cod_contrato,tipo_contrato
  order by cod_ramo,serie,cod_contrato,tipo_contrato

--  group by 1,2,3,4,5,6 -- cod_ramo,serie,cod_contrato,tipo_contrato
--  order by 1,2,3,4,5,6 -- cod_ramo,serie,cod_contrato,tipo_contrato
...
--				into  _cod_coasegur,_porc_cont_partic
			FOREACH
				...
				from temphg1
		      Where serie <= 2007 and cod_coasegur in ("030","051","072","042","034","063",'036')  and cod_ramo = v_cod_ramo --and porc_comision = _porc_comision and porc_impuesto = _porc_impuesto
		        and cod_contrato = v_cod_contrato and tipo_contrato = v_tipo_contrato
				and anio      = _anio_reas
				and trimestre = _trim_reas
				and borderaux = _borderaux 
...
--					let _porc_comision = _porc_comision/100;
