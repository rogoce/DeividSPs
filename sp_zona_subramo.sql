...
-- 
--
DROP PROCEDURE sp_zona_subramo;

CREATE PROCEDURE "informix".sp_zona_subramo(a_zona CHAR(03))
...
FOREACH
	  ...
	  foreach
		...
		if _cod_ubica = '007' then
			continue foreach;
		else
		end if
--		return 'RESTO DEL PAIS',_n_prov,_no_poliza, _no_unidad,_no_documento,_estatus_poliza with resume;

       if _cod_provincia in('01','04','09','06','07','02') then --Provincias oeste
				return 'PROVINCIAS OESTE',_n_prov,_no_poliza, _no_unidad,_no_documento,_estatus_poliza,_n_ubica with resume;
	   elif _cod_provincia = '05' then --Darien
			return 'DARIEN',_n_prov,_no_poliza, _no_unidad,_no_documento,_estatus_poliza,_n_ubica with resume;
	   elif _cod_provincia = '08' then --Pma
			return 'PANAMA',_n_prov,_no_poliza, _no_unidad,_no_documento,_estatus_poliza,_n_ubica with resume;
	   else
			return 'COLON',_n_prov,_no_poliza, _no_unidad,_no_documento,_estatus_poliza,_n_ubica with resume;
...
--	return _n_ubica, _n_prov ,_no_poliza, _no_unidad,_no_documento,_estatus_poliza with resume;
