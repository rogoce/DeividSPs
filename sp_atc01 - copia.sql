...
if a_no_documento = '1811-00009-03' then
...
if _ramo_sis <> 5 then		--si no es salud
	...
	foreach
		...
		{elif _cod_tipotran = '013' and _cod_cliente = _cod_contratante then
			...
			if _cod_tipotran = '013' and _cod_cliente <> _cod_asegurado then --Declinar Reclamo Otros
				let _inc_prov =  _pago_prov + _ahorro + _monto_no_cubierto;
			elif _cod_tipotran = '013' and _cod_cliente = _cod_asegurado then --Declinar Reclamo Asegurado
