...
-- modificado por:	Henry Giron		     29/10/2020  se adiciona celular, origen F9:35888
-- sis v.2.0 - deivid, s.a.
-- Amado Perez M. DRN CASO 4850 Se busca al asegurado para que salga en el estado de cuenta 25-10-2022

drop procedure sp_co51;

create procedure "informix".sp_co51(
a_compania		char(3), 
a_sucursal		char(3), 
...
-- agente de la poliza
	...
	return
		...
		_compania,
		_aseg_lider,   --
		_celular,  -- F9:35888 USER: JEPEREZ 
		_asegurado
	   	with resume;
