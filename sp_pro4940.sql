...
drop procedure sp_pro4940;
create procedure sp_pro4940(
...
--set debug file to "sp_pro4940.trc";
--trace on;
...
on exception set _error 
	if _error = -268 or _error = -239 then 
	   let _cod_producto_new =  sp_pro4941(_no_poliza, _cod_producto, a_periodo);
