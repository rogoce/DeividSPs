--Procedimiento para realizar la carga en Rentabilidad1 para bono de RENTABILIDAD 2024
--Usando prima neta cobrada devengada
--Creado 26/01/2024	Armando Moreno M.

DROP PROCEDURE sp_che115_carga2024_02705;
CREATE PROCEDURE sp_che115_carga2024_02705(a_compania CHAR(3), a_sucursal CHAR(3),a_cod_agente char(5))
RETURNING SMALLINT;
...
delete from rentabilidad1 where periodo = a_periodo and cod_agente = a_cod_agente;
...
let _fec_aa_ini     = "01/01/2024";	--para sacar cancelada o anulada en el periodo
let _per_ini        = "2024-01";
let _per_ini_ap     = "2023-01";
let _ano            = a_periodo[1,4];
let _ano            = _ano - 1;
let _per_fin_ap     = _ano || a_periodo[5,7];

let _per_fin_dic    = "2023-12";         
...
foreach
	...
	let _valor = sp_sis101a(_no_documento,'01/01/2024',_fecha_aa, my_sessionid);
	...
	call sp_dev06f_renta(_no_documento,_fecha_aa,'01/01/2024',_fecha_aa) returning _valor,_mensaje,_pri_devengada;
...
foreach	with hold
	...
	let _valor = sp_sis101a(_no_documento,'01/01/2023',_fecha_ap,my_sessionid);
	foreach
		select cod_agente,
		       porcentaje
		  into _cod_agente,
...
foreach
	...
	if _cod_ramo = '001' then	--se excluyen el ramo de incendio.
		continue foreach;
	end if
    ...
    if _cod_ramo in("018","002","020","023","016","004","012","014","017","010","022","013","003","006","015","005","011","021","009","007") then
	else
		continue foreach;
    end if
