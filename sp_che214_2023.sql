...
FOREACH
    SELECT emipoagt.cod_agente,
	 ...
	 WHERE emipomae.cod_sucursal = '009'
	   ...
	   AND emipoagt.cod_agente not in('00180','02917','02354','02831')    --No incluye a Tecnica de seguros, Kam y asociados talleres
	   AND emipomae.no_poliza <> ""
	   and emipomae.periodo >= '2023-01'
	   and emipomae.periodo <= '2023-12'			  
	   AND agtagent.tipo_agente <> 'O'	  --No incluye a Corredores de oficina.
		...
		if _cod_agente in('02917','02569','02656','02111','02531','02830') then	--se excluyen estos corredores por instr. Analisa, correo del 09/07/2019
			continue foreach;
		end if
...
foreach
	select cod_agente
	  ...
	  from chqweb
     where periodo = a_periodo
	   and cod_agente not in('02319', '02302', '02354', '02531', '02825', '02830', '02831') --Estos código no se les debe pagar automaticamente por caso 5921, enviado por Zule 17/03/2023
	 group by cod_agente
	 order by cod_agente
