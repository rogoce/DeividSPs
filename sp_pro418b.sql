...
drop procedure sp_pro418b;
create procedure sp_pro418b() 
...
FOREACH with hold
	select periodo,
	  ...
	  from polcovid
	 where procesado = 1
	   and no_documento in ('0219-02355-01','0219-01081-01','0219-01554-09','0219-13774-47','0219-02176-09','0219-01753-09',
							'0219-14943-47','0219-01991-09','0218-00424-03','0218-00239-10','0213-16950-47','0219-00772-01')
	...
	call sp_pro417a(_periodo,_no_poliza,_descuento,'034') returning _error,_no_endoso,_error_desc;
