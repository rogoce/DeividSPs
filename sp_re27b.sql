DROP PROCEDURE sp_rec27b;

CREATE PROCEDURE "informix".sp_rec27b(v_no_tranrec CHAR(10))
 RETURNING char(50), char(10), char(50), char(10), date, date, char(20), decimal(16,2),
			decimal(16,2), decimal(16,2), decimal(16,2), char(18), char(10), date,
			decimal(16,2), decimal(16,2), decimal(16,2), decimal(16,2), char(10), 
			date, decimal(16,2), char(10), date, char(10), char(10), char(10);
...
DEFINE v_nombre_de    CHAR(50);
DEFINE v_asegurado    CHAR(50);
DEFINE v_reclamante   CHAR(50);
...
foreach
   ...
   select MAX(no_tranrec)
     into _tran_ant
     from rectrmae
    where rectrmae.no_reclamo  = v_reclamo
      and rectrmae.no_tranrec  < v_no_tranrec
	  and rectrmae.actualizado = 1;
   ...
   END IF
	...
	LET v_incurrido_tr = v_incurrido;
	LET v_reserva_tr   = v_reserva;
...
return v_nombre_cia, v_transaccion, v_tipo_trans, v_periodos, v_impresa,
       v_elaborada, v_poliza, v_monto_total, v_variacion, v_incurrido_tr, v_reserva_tr,
       v_numrecla, v_estatus, v_fecha, v_reserva, v_pagado,
       v_recuperos, v_incurrido, v_accion, v_siniestro, v_deducible,
       v_tr_ant_no, v_tr_ant_fecha, v_reclamo, v_duplicado, v_no_recibo
       with resume;
