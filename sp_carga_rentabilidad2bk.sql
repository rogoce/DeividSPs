...
DROP PROCEDURE sp_carga_rentabilidad2bk;
CREATE PROCEDURE sp_carga_rentabilidad2bk(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT,char(7),char(7),char(7);
...
let a_periodo   = '2016-01';  --****PONER COMENTARIO CUANDO CORRE ANUAL
...
pri_sus_pag   	  DECIMAL(16,2) DEFAULT 0,	--prima pagada AA
pri_pag  		  DECIMAL(16,2) DEFAULT 0,
pri_can  		  DECIMAL(16,2) DEFAULT 0,
pri_dev  		  DECIMAL(16,2) DEFAULT 0,
sin_pag_aa 		  DECIMAL(16,2) DEFAULT 0, --siniestros pagados AA
sin_pen_aa 		  DECIMAL(16,2) DEFAULT 0, --siniestros pendientes AA
sin_pen_ap 		  DECIMAL(16,2) DEFAULT 0, --siniestros pendientes diciembre
...
pri_sus_pag_ap    DECIMAL(16,2) DEFAULT 0, --prima pagada AP
...
foreach
	...
	foreach
		...
		-- Prima Pagada Devengada	Año Actual 2016
		...
		-- Prima Pagada Devengada	Año Pasado 2015
		...
		let _pri_dev_max_aa	 = _pri_susc_dev_aa * (15/100);
		let _pri_dev_max_ap	 = _pri_susc_dev_ap * (15/100);
	...
	select cod_agente,
	 ...
	 order by cod_agente
		...
		if _pri_susc_aa >= 50000 And _crecimiento >= 10 then
			...
			let _porcentaje = 0; 
			let _bono = (_pri_dev_max_aa * (55/100)) - _sini_incu;
...
return 0,a_periodo,_per_ini_ap,_per_fin_ap;
