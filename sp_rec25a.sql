...
DROP PROCEDURE sp_rec25a;
CREATE PROCEDURE sp_rec25a(a_compania CHAR(3), a_agencia CHAR(3), a_tranrec CHAR(10))
			RETURNING   CHAR(18),
						CHAR(100),
						CHAR(30),
						DEC(16,2),
...
FOREACH WITH HOLD
 SELECT no_poliza,
   ...
   FROM tmp_arreglo
    ...
    Let _monto_letras = sp_sis11(v_monto);
	RETURN v_numrecla,
		   v_asegurado,
		   v_cedula, 
		   v_monto,
