-- Reporte para las requisiciones de Reclamos de personas por imprimir

-- Creado    : 12/07/2006 - Autor: Amado Perez

drop procedure sp_che226;
create procedure sp_che226()
 returning char(10),
		   char(10),
		   char(100),
		   dec(16,2),
 ...
 group by cod_banco, cod_chequera
	...
	--		and autorizado    = 1
	   ...
	   --	 let _user_added   = "";
		 ...
		 if _numrecla[1,2] not in ('16', '04', '19') then
			continue foreach;
		 end if
