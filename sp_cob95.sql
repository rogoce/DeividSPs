-- Procedimiento que Genera la Morosidad Total por Ramo	polizas vencidas
-- 
...
DROP PROCEDURE sp_cob95;

CREATE PROCEDURE "informix".sp_cob95(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_fecha    DATE,
...
FOREACH 
 SELECT no_documento
  ...
  GROUP BY no_documento
	...
	IF _vigencia_final >= a_fecha THEN
		CONTINUE FOREACH;
	END IF
