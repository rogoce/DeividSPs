--VERIFICAR UNA POLIZA INDIVIDUAL

DROP PROCEDURE sp_pro342bk1;
CREATE PROCEDURE sp_pro342bk1(a_no_documento char(20))
RETURNING 
...
--     verificar con endedmae - endeduni
	...
	foreach
		...
		if _prima <> _prima_unidad then
			   	...
			   	--call sp_pro342a() returning _valor;
