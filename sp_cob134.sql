...
drop procedure sp_cob134;
create procedure sp_cob134(
a_periodo char(7),
...
on exception set _error, _error_isam, _error_desc 
	let _error_desc = 'sp_cob134 ' || trim(_no_documento) || ' ' || trim(_error_desc);
...
foreach --with hold
	select no_documento
	  into _no_documento
	  from emipoliza
  --where no_documento = '0909-00051-01'
	...
	if _no_documento = '0210-00387-06' And _saldo_pxc = 0 then  --Se coloca por diferencia técnica, 04/03/2020
		let _saldo_pxc = -4185.65;
	end if
