...
drop procedure sp_rea24d_doc;
create procedure 'informix'.sp_rea24d_doc(a_compania char(3), a_sucursal char(3), a_periodo char(7), a_flag smallint, a_documento char(20))
returning	integer,		--1
			varchar(100);	--2
