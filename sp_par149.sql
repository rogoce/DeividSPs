...
--DROP PROCEDURE sp_par149;		

CREATE PROCEDURE "informix".sp_par149(a_periodo char(7))
...
create temp table reasxpag(
no_poliza		char(10),
no_endoso		char(5),
reas_cedido		dec(16,2),		
reas_impuesto	dec(16,2),
reas_comision	dec(16,2),
reas_por_pagar	dec(16,2)
) with no log;
