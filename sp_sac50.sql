...
define _cta_auxiliar,_origen_cheque	char(1);
...
foreach
	...
	if _origen_cheque in('D','H','L','8','F','I') then	--Es Rentabildad,BONO CCP o Ramos Genrales, no debe inserta auxiliar, puesto que ya esta insertado. Armando 05/10/2023
		continue foreach;
	end if
	foreach
	 select cuenta,
...
foreach
	...
	if _origen_cheque = 'D' then	--Es Rentabildad, no debe inserta auxiliar, puesto que ya esta insertado. Armando 05/10/2023
		continue foreach;
	end if
