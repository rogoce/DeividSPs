...
-- 		ALLIED - HENRY
-- 		PRIMA SUSCRITA
-- execute PROCEDURE sp_pr121 ("001","001","2009-10","2009-12","*","*","*","*",
-- "001,003,002,010,011,012,013,014;","*","*","*")
---------------------------------------------------------------------------------
--DROP PROCEDURE sp_pr121;
CREATE PROCEDURE sp_pr121(
		a_compania    CHAR(03),
		a_agencia     CHAR(03),
		a_periodo1    CHAR(07),
		a_periodo2    CHAR(07),
...
--	  set debug file to "sp_pr121.trc";	 																						 
...
FOREACH 
	...
	where seleccionado = 1
		...
		if v_cod_contrato =  "00544" or v_cod_contrato =  "00562" or v_cod_contrato =  "00570"  or v_cod_contrato =  "00580" then  -- Contrato Allied  2006,2007,2008,2009  
			LET _seleccionado = 1;
		end if
...
FOREACH
   ...
   group by serie,tipo_contrato,porc_cont_partic,porc_comision,porc_impuesto,cod_ramo,cod_contrato,cod_cobertura
		...
		if v_tipo_contrato <> 5 then  -- Cuota parte
			continue foreach;
		end if 
