-- Procedimiento para la inserción campaña de Cese de Cobertura
-- Creado    : 26/09/2019 - Autor: Henry Giron
--execute procedure sp_cas085('0213-02377-09','312191','','01621','VGARCIA')

drop procedure sp_cas085;
create procedure sp_cas085(a_no_documento char(20), a_cod_pagador char(10),a_cod_gestion char(3),a_no_aviso char(10), a_usuario char(8))
returning	integer,
			varchar(255);
...
call sp_ley003(a_no_documento,1) returning _error,_mensaje;
...
let _desc_gestion = 'SE ADICIONA A CAMPANA "'|| trim(_cod_campana)||'" DE CESE DE COBERTURA, No. Aviso '|| ' - Ref.: ' || trim(a_no_aviso);
