...
DROP PROCEDURE sp_cob115c;

CREATE PROCEDURE "informix".sp_cob115c(
a_compania 		CHAR(3),
a_sucursal 		CHAR(3),
		...
		FOREACH
			SELECT prima_bruta
			 ...
			 WHERE no_poliza   = _no_poliza
			   ...
			   AND prima_bruta <> 0
			   AND activa = 1
			   AND ( (endedmae.vigencia_inic < v_fecha_serv) OR no_endoso <> "00000" )
