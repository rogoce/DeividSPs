-- Procedimiento que Genera el Cheque de Bono Ramo:019 - Nuevas
-- Creado    : 23/01/2018 - Autor: Henry Girón
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_che166;
CREATE PROCEDURE sp_che166(
a_compania       CHAR(3),
a_sucursal       CHAR(3),
a_cod_agente     CHAR(5),
a_usuario        CHAR(8),
...
SELECT cod_origen,
 ...
 WHERE cod_banco = a_banco;
	...
	LET _descripcion = 'PAGO BONO VIDA INDIVIDUAL(POL.NUEVA) DE: ' || _nombre_mes || " DEL " || a_periodo[1,4];
