...
--Creado 18/06/2015	Armando Moreno M.


DROP PROCEDURE sp_che115_carga2015;
CREATE PROCEDURE sp_che115_carga2015(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
let a_periodo   = '2015-12';  --****PONER COMENTARIO CUANDO CORRE ANUAL

update parparam
   set agt_per_fidel = a_periodo;

let _fec_aa_ini     = "01/01/2015";	--para sacar cancelada o anulada en el periodo
let _per_ini        = "2015-01";
let _per_ini_ap     = "2014-01";
let _ano            = a_periodo[1,4];  --2014
let _ano            = _ano - 1;		   --2013
let _per_fin_ap     = _ano || a_periodo[5,7]; --2013-12

let _per_fin_dic    = "2014-12";         
