...
--DROP PROCEDURE sp_che115_carga2014_prueba;
CREATE PROCEDURE sp_che115_carga2014_prueba(
a_compania          CHAR(3),
a_sucursal          CHAR(3)
) RETURNING SMALLINT;
...
delete from bkrentabilidad1 where periodo = a_periodo;
