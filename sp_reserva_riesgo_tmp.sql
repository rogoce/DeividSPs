--Carga tabla deivid_ttcorp:reserva_riesgo_c
--Armando Moreno M.		10/02/2025
--***********************************************

drop procedure sp_reserva_riesgo_tmp;
create procedure sp_reserva_riesgo_tmp(a_periodo char(7))
...
delete from deivid_ttcorp:reserva_riesgo_c
		...
		foreach
			...
			foreach
		      ...
		      having sum(t.prima_rea) <> 0
				...
				insert into deivid_ttcorp:reserva_riesgo_c(
						id_mov_tecnico,                        
						cod_ramo,
						cod_ramo_reas,
						id_poliza,
...
--Call sp_reserva_riesgo_act_tmp(a_periodo) returning _error,_mensaje;
