-- Reporte de Listado de Casos con Posible Recobro
-- 
-- Creado    : 15/08/2000 - Autor: Amado Perez Mendoza 
-- Modificado: 15/08/2000 - Autor: Amado Perez Mendoza
--
-- SIS v.2.0 - d_sp_rec01h_dw8 - DEIVID, S.A.

DROP PROCEDURE sp_rec01h;

CREATE PROCEDURE "informix".sp_rec01h(
a_compania  CHAR(3), 
a_agencia   CHAR(3), 
a_periodo1  CHAR(7), 
a_periodo2  CHAR(7), 
