...
--DROP PROCEDURE sp_che168lb;
CREATE PROCEDURE "informix".sp_che168lb(a_agente CHAR(8))
...
on exception set _error
	return _error,_error_mess;  
		...
		if _cod_agente in('02302','02354','02531') then --Unificar LIZSENELL GIONELLA BERNAL RAMIREZ, correo 24/03/17 Alicia. Se quita unificacion correo Analisa 19/02/2018
