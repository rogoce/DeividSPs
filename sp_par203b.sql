...
drop procedure sp_par203b;

create procedure "informix".sp_par203b(a_no_remesa char(10))
returning integer,
		  char(100);
...
--set debug file to "sp_par203b.trc";
--trace on;
...
delete from cobasiau where no_remesa = a_no_remesa and renglon = 722;
delete from cobasien where no_remesa = a_no_remesa and renglon = 722;
