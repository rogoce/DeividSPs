...
let v_html = '<!doctype html><html><head><meta charset="utf-8"><title>Carta</title></head><body style="font-family:Arial; font-size:14px; text-align:justify;"><table width="800"><tr><td><img src="https://app.asegurancon.com/imagen/mem_carta.png"></td></tr><tr><td><p style="margin:1px; padding:1px;">Estimada(o) Asegurada(o) %asegurado%</p></td></tr><tr><td><p style="margin:1px; padding:1px;">Adjunto se env&iacute;a carta de renovaci&oacute;n de su p&oacute;liza de salud la cual detalla el incremento aplicado en su prima.</p></td></tr><tr><td><p>El mismo se ha dado a la renovaci&oacute;n, en funci&oacute;n de una insuficiencia en la prima por la alta siniestralidad del grupo.</p></td></tr><tr><td><p>Cualquier consulta a la orden.</p></td></tr><tr><td><p>Departamento de Ramos de Personas.</p></td></tr><tr><td><img src="https://app.asegurancon.com/imagen/mem_pie_carta.jpg" width="800"></td></tr></table></body></html>';  
