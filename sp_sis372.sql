...
drop procedure sp_sis372;

create procedure "informix".sp_sis372(
...
if ls_telefono1 is not null or trim(ls_telefono1) <> '' Then
   let ls_telefono1 = trim(ls_telefono1);
   let ls_telefono1 = ls_telefono1[1,3]||"-"||ls_telefono1[4,7];
end if

if ls_telefono2 is not null or trim(ls_telefono2) <> '' Then
   let ls_telefono2 = trim(ls_telefono2);
   let ls_telefono2 = ls_telefono2[1,3]||"-"||ls_telefono2[4,7];
end if

if ls_celular is not null or trim(ls_celular) <> '' Then
