...
BEGIN
	...
	let _porc_cien      = a_porc_depre_pol;
	...
	if _porc_cien = 100.00 then
		let _suma_asegurada = 0.00;
	elif _porc_cien = 0.00	 then
		let _suma_asegurada = a_suma;
	end if	
	
	return _suma_asegurada, _cant;
END
end procedure;
