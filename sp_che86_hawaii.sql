...
--**********************************************************************************************
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando a Ciclo Prima Pagada este año...1.', CURRENT,CURRENT);
foreach
	select doc_remesa,
		   sum(prima_neta)
	  into _no_documento,
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Saliendo del Ciclo Prima Pagada este año...1.', CURRENT,CURRENT);
--**********************************************************************************************
-- Prima Pagada AÑO PASADO a la fecha
--**********************************************************************************************
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando a Ciclo Prima Pagada año pasado...2.', CURRENT,CURRENT);
foreach
	 select no_poliza,
			sum(prima_neta)
	   into _no_poliza,
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Saliendo del Ciclo Prima Pagada año pasado...2.', CURRENT,CURRENT);
--**********************************************************************************************
-- Prima Suscrita ACTUAL periodo del concurso  2017-10 A 2018-09
--**********************************************************************************************
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando al Ciclo Prima Suscrita Actual del concurso...3.', CURRENT,CURRENT);
foreach
	select no_poliza,
		   no_endoso,
		   no_documento,
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Saliendo del Ciclo Prima Suscrita Actual del concurso...3.', CURRENT,CURRENT);
--*************************************************************************************************
-- PRIMA SUSCRITA AÑO PASADO PERIODO DEL CONCURSO AL MES ACTUAL
--*************************************************************************************************
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando al Ciclo Prima Suscrita año pasado...4.', CURRENT,CURRENT);
foreach
 select no_poliza,
		no_endoso,
		no_documento,
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Saliendo del Ciclo Prima Suscrita año pasado...4.', CURRENT,CURRENT);
--**********************************************************************************************
-- Siniestros Pagados AÑO ACTUAL
--**********************************************************************************************
call sp_rec01(a_compania, a_sucursal, _per_ini, a_periodo) returning _filtros;

INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando al Ciclo Siniestros pagados año actual...5.', CURRENT,CURRENT);
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Saliendo del Ciclo Siniestros pagados año actual...5.', CURRENT,CURRENT);
--**********************************************************************************************
-- Siniestros Pendientes AÑO ACTUAL
--**********************************************************************************************
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando al Ciclo Siniestros pendientes año actual...6.', CURRENT,CURRENT);
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Saliendo del Ciclo Siniestros pendientes año actual...6.', CURRENT,CURRENT);
--**********************************************************************************************
...
--let _fecha_ap = '30/09/2017'; --se coloca para cantidad año pasado hasta el final del concurso. se puso el 13/07/2018.
call sp_bo077(_fecha_ap_ini, _fecha_ap) returning _error, _error_desc;	-- 01/10/2016   A 30/09/2017	Se pone como estaba, 02/08/2018

INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando al Ciclo Nuevas y Renovadas año pasado...7.', CURRENT,CURRENT);
foreach
		select no_documento,
			   sum(no_pol_nueva),
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Saliendo del Ciclo Nuevas y Renovadas año pasado...7.', CURRENT,CURRENT);
----**********************************************************************************************
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando al Ciclo Nuevas y Renovadas año actual...8.', CURRENT,CURRENT);
foreach
		select no_documento,
			   sum(no_pol_nueva),
			   sum(no_pol_renov),
...
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Saliendo del Ciclo Nuevas y Renovadas año actual...8.', CURRENT,CURRENT);
INSERT INTO log_jb (mensaje, hora,hora_real) values ('Entrando al Ciclo Group by Fis_Concurso...9.', CURRENT,CURRENT);
