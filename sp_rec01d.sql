...
CREATE TEMP TABLE tmp_incurrido(
		...
		salvamento_bruto     DEC(16,2) DEFAULT 0 NOT NULL,
 		recupero_bruto		 DEC(16,2) DEFAULT 0 NOT NULL,
...
CREATE TEMP TABLE tmp_sinis(
		...
		salvamento_bruto	 DEC(16,2) NOT NULL,
     	recupero_bruto		 DEC(16,2) NOT NULL,
...
FOREACH 
	SELECT no_reclamo,
	  ...
	  INTO _no_reclamo,	
		   ...
		   _incurrido_abierto
	  FROM tmp_incurrido
	 GROUP BY no_reclamo,no_tranrec
