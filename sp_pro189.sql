   ...
   BEGIN
      ...
      CREATE TEMP TABLE temp_detalle
               (cod_sucursal     CHAR(3),
				...
				edad             SMALLINT,
				cont_edad        SMALLINT,
				cont_asegurados  SMALLINT DEFAULT 1,
				no_poliza        CHAR(10),
				no_unidad        CHAR(5),
				no_endoso        CHAR(5),
				tipo_fac         SMALLINT,
...
FOREACH
    SELECT cod_contrato,   
	 ...
	 -- Principal para tomar el nombre del contratante de la poliza
     SELECT nombre
       INTO v_desc_nombre
       FROM cliclien
