--Reporte para el Cuadre de las cuentas de Prima Suscrita por Ramo
--Creado    : 28/12/2015 - Autor: Román Gordón

drop procedure sp_pro34e;
create procedure "informix".sp_pro34e(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
...
call sp_pro34(a_compania,a_agencia,a_periodo1,a_periodo2,'*','*','*','*','*','*','1')
returning v_filtros;
...
foreach with hold
	select tmp.cod_ramo,
	 ...
	 where mae.fecha_emision < today
	   and mae.actualizado = 1
	   and tmp.seleccionado = 1
	 order by tmp.cod_ramo,tmp.no_factura
