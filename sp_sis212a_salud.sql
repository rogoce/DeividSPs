...
drop procedure sp_sis212a_salud;
create procedure sp_sis212a_salud(a_periodo_desde char(7),a_periodo_hasta char(7), a_codramo varchar(100))
returning	integer,
			varchar(250);
...
if a_periodo_desde < '2025-01' then
...
foreach with hold
	...
	select distinct mae.no_poliza,  --first 2 
		   mae.no_endoso
	  into _no_poliza,
		   _no_endoso
	  from endedmae mae
