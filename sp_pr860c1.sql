...
------------------------------------------------
--execute procedure sp_pr860c1('001','001','2013-07','2013-09',"*","*","*","*","001,003,006,008,010,011,012,013,014,021,022;","*","2013,2012,2011,2010,2009,2008;")

drop procedure sp_pr860c1;
create procedure sp_pr860c1(
	a_compania		char(03),
	a_agencia		char(03),
	a_periodo1		char(07),
	a_periodo2		char(07),
