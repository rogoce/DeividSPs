...
-- execute procedure sp_sac219('2012','01',2,'sac','6000%','*')

drop procedure sp_sac219;
create procedure "informix".sp_sac219(
a_ano 	  char(4), 
a_mes 	  smallint,
a_nivel	  smallint,
a_db      char(18),
...
execute procedure sp_sac220(a_ano, a_mes, a_nivel, a_db, a_cta_gts, a_ccosto);
