...
drop procedure sp_co25a;

create procedure "informix".sp_co25a(
a_compania 		char(3), 
a_sucursal 		char(3), 
		...
		if v_cod_endomov = '011' then
			if _nueva_renov = 'N' then
		     ...
		     select nombre
 		     ...
 		     if v_cod_endomov = '004' or v_cod_endomov = '005' or v_cod_endomov = '006'then
 		       Select count(*)
			     into _cant_uni
				 from endeduni
