					...
					let _porc_inun = 0.00;
			  		...
			  		if v_clase = '002' then
						...
						if v_cobertura = '021' or v_cobertura = '022' then
							...
							FOREACH
								select distinct porc_comision,porc_cont_partic
								  into _porc_comision4,_porc_cont_partic
								  from reacoase
								 where cod_contrato   = v_cod_contrato
