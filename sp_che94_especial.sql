...
-- Para calcular bonificaciones especial. Armando
				...
				if  _cod_tipo = 'E' then 
				  ...
				  group by cod_ramo
						...
						if 	_cod_agente  not in ("00211","00769","00237") then
							...
							INSERT INTO chqrenta5(cod_agente,no_poliza,prima_neta,comision,nombre,no_documento,no_licencia,seleccionado,periodo,fecha_genera,cod_ramo,
