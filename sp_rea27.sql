...
--execute procedure sp_rea27('001','001','2016-07','2017-06','*','*','*','*','008;','*','*','*','*')
--------------------------------------------
...
if a_periodo2 >= '2013-07' then		--Proceso de Devolución de Prima
	...
	select cod_ramo,cod_contrato,cod_cobertura,sum(prima) as prima,tipo,serie,seleccionado,no_poliza from temp_produccion where seleccionado = 1
	 group by cod_ramo,cod_contrato,cod_cobertura,tipo,serie,seleccionado,no_poliza;
...
no_poliza			char(10),
primary key (no_poliza,vigencia_ini,vigencia_fin,cod_ramo)) with no log;
