...
drop procedure sp_atc17;
create procedure sp_atc17(a_numrecla char(18))
returning char(10),	  
		  char(100),
		  char(30), 
		  char(10), 
...
foreach
	select distinct no_poliza
	  into _poliza
	  from recrcmae
	 where trim(numrecla) = trim(a_numrecla)
	 order by no_poliza
