...
DROP PROCEDURE sp_pro206a;

CREATE PROCEDURE "informix".sp_pro206a(a_fecha1 date, a_fecha2 date)
...
foreach					  
	...
	elif _decicion in(4,5,9,7,2,10) then
		let _decicion = 3;
...
foreach					  
    ...
    if _dec2 = 4 then
	  ...
	  let _n_decicion = "EVALUACION MEDICA";
	end if
