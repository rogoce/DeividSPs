...
DROP PROCEDURE sp_rec749;
CREATE PROCEDURE "informix".sp_rec749(
a_compania	CHAR(3),
a_agencia	CHAR(3),
a_periodo1	CHAR(7),
a_periodo2	CHAR(7),
...
{		if _cod_tipopago = '003' then
	...
	if _cod_cobertura in('00119','00121','01307','01145','01315','01677', '01657', '01841') then --Colision
		...
		let _cobertura = 'DA';
	elif _cod_cobertura in('01306','00606','00118','00104','00122','01481','01536','00903','00107','01155','01154','01481','01536','00904','00107','01535','00117','01301','00907','01115','01310','01323','01302','01338','01305') and _tipo_pago = "A" then --Comprensivo
		let _cobertura = 'CM';
	elif _cod_cobertura in('01306','00606','00118','00104','00122','01481','01536','00903','00107','01155','01154','01481','01536','00904','00107','01535','00117','01301','00907','01115','01310','01323','01302','01338','01305') and _tipo_pago = "T" then --Comprensivo
		let _cobertura = 'LE';
	elif _cod_cobertura = '01075' then
		let _cobertura = 'GM';
	else
