-- Procedimiento que Genera los Cobros por Cobrador	Coaseg. Minoritario
-- 
-- Creado    : 24/09/2000 - Autor: Amado Perez 
-- Modificado: 24/09/2000 - Autor: Amado Perez
--
-- SIS v.2.0 - DEIVID, S.A.

--DROP PROCEDURE sp_cob73;

CREATE PROCEDURE "informix".sp_cob73(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_periodo1 CHAR(7),
a_periodo2 CHAR(7)
...
{                            
  ...
  END IF                     
	...
	IF _tipo_produccion <> 3 THEN	 -- Reaseguro Asumido
		CONTINUE FOREACH;
	END IF
