-- Procedimiento que aumenta la reserva	para terceros yo seguros

-- Creado    : 18/06/2014 - Autor: Amado Perez M. 

--drop procedure sp_rwf120;
drop procedure sp_rwf160;

create procedure sp_rwf160(a_no_reclamo char(10), a_cod_tercero char(10)) 
  returning integer,
            char(50),
            char(10),
            char(10);
...
--set debug file to "sp_rwf160.trc";
--trace on;
...
return 0, "Actualizacion Exitosa", _no_tranrec_char, _no_tran_char ;
