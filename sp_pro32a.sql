...
-- SIS v.2.0 - DEIVID, S.A.
   ...
   DROP procedure sp_pro32a;
   CREATE procedure "informix".sp_pro32a(a_cia CHAR(03),a_agencia CHAR(3),a_fecha DATE,a_codsucursal CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_agente CHAR(255) DEFAULT "*",a_usuario CHAR(255) DEFAULT "*", a_cod_cliente CHAR(255) DEFAULT "*", a_acreedor CHAR(255) DEFAULT "*", a_no_documento CHAR(255) DEFAULT "*")

   RETURNING CHAR(3),CHAR(50),CHAR(20),CHAR(45),DATE,DATE,
             CHAR(40),DECIMAL(16,2),DECIMAL(16,2),
             CHAR(255),CHAR(50), integer, date;
   ...
   IF a_no_documento <> "*" and a_no_documento <> "" THEN
    ...
    FOREACH WITH HOLD
       ...
       SELECT y.no_documento,y.cod_ramo,y.cod_contratante,y.vigencia_inic,
              y.vigencia_final,y.cod_grupo,y.suma_asegurada,y.prima_suscrita
     ...
     ORDER BY y.cod_ramo,y.no_documento
       ...
       SELECT nombre
		...
		let _edad = year(a_fecha) - year(_fecha_nac);

		if month(a_fecha) = month(_fecha_nac) then
			if day(a_fecha) < day(_fecha_nac) then 
				let _edad = _edad - 1;
			end if
		end if
       ...
       RETURN v_cod_ramo,v_desc_ramo,no_documento,
              ...
              v_filtros,v_descr_cia, _edad, _fecha_nac
               WITH RESUME;
    END FOREACH
