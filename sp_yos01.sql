...
drop procedure sp_yos01;

create procedure "informix".sp_yos01()
	...
	foreach
		select no_requis,
		 ...
		 where autorizado		= 1
		   and pagado			= 0
		   and anulado			= 0
		   and origen_cheque	in ("3","G","S") --,"K" Por este lado no se irá a firma la devolucion por poliza cancelada -- ahora es desde cobros que se pasa
		   and cod_banco		= _cod_banco
		   and cod_chequera		= _cod_chequera
		   and en_firma			in (0, 4)
		   and monto			> 0.00
--		   and no_requis        = '821546' 
 ...
 --		and no_requis = '821545'
       ...
       let _cnt_reg = _cnt_reg + 1;
	   
	   if _cnt_reg > 150 then
			exit foreach;
	   end if
