...
drop procedure sp_pro321eSimB;

create procedure sp_pro321eSimB(a_no_poliza char(10), a_no_poliza_ant char(10))
returning  integer;
...
{		let _cnt_lote = 0;
		...
		foreach
            ...
            --if _cnt_lote > 0 and _incremento = 0 then			
				...
				{if _cod_prod in ('02282','02283') then --DRN # 13869 -- Amado 31-05-2025  No va porque ya está en el producto
