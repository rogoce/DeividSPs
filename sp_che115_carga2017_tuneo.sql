...
DROP PROCEDURE sp_che115_carga2017_tuneo;
CREATE PROCEDURE sp_che115_carga2017_tuneo(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
--delete from rent1 where periodo = a_periodo;
