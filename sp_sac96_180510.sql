...
-- execute procedure sp_sac96('01','26605','%','2009','01','2009','02')
-- se adicionara por rango de cuenta...Sr.Demetrio

DROP PROCEDURE sp_sac96;
CREATE PROCEDURE sp_sac96(a_tipo char(2),a_cuenta char(12),a_ccosto char(3),a_anio char(4),a_mes char(2), a_anio2 char(4),a_mes2 char(2)) 
...
--	group by res_fechatrx, res_comprobante, res_tipcomp, res_descripcion, res_origen
--	order by res_fechatrx, res_comprobante, res_tipcomp, res_descripcion, res_origen
--	and res_comprobante = 'COB01101'
--	order by res_comprobante,res_fechatrx,res_tipcomp,res_descripcion,res_origen
