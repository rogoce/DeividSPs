...
drop procedure sp_che180b;
create procedure sp_che180b(a_cod_agente char(5))
...
create temp table tmp_det(
	...
	saldo_comis     dec(16,2)) with no log;
...
foreach
	...
	foreach
		...
		let _saldo_comis = _comision_pagada - _comis_devengada;
