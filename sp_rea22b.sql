...
define v_noendoso,_cod_grupo char(5);			 
...
--SET DEBUG FILE TO "sp_rea22b.trc"; 
--trace on;
...
foreach 
	...
	select cod_grupo into _cod_grupo from emipomae
...
foreach
	...
	foreach
		...
		let v_prima = _pag_ret + v_prima_3 + v_prima_Ot + _fac_car_1 + v_prima_bq;
			...
			ON EXCEPTION IN(-239)
			   UPDATE tmp_tabla_rea
				  SET cant_polizas1   = cant_polizas1   + 1,
					  ...
					  p_retenida1     = p_retenida1     + _pag_ret * v_porcentaje/100,	
