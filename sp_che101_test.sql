...
drop procedure sp_che101_test;

create procedure "informix".sp_che101_test(a_compania char(3), a_agencia char(3), a_usuario char(8), a_cod_banco char(3), a_cod_chequera char(3), a_no_requis char(10)) 
returning   date,
			varchar(100),
		    decimal(16,2), 
			char(250),
