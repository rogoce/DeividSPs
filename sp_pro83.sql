...
DROP procedure sp_pro83;
CREATE procedure "informix".sp_pro83(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codramo CHAR(255))
...
RETURNING CHAR(255);
    ...
    DEFINE v_vigencia_inic,v_vigencia_final,v_fecha_suscrip,v_fecha_cancel   DATE;
    ...
    IF a_codramo <> "*" THEN
       ...
       IF _tipo <> "E" THEN -- Incluir los Registros
          FOREACH WITH HOLD
		      ...
		      LET _fecha_emision = null;
 --			  AND v_fecha_cancel IS NOT NULL
		      IF v_fecha_cancel <= a_periodo  THEN
			     FOREACH
					SELECT fecha_emision
					  INTO _fecha_emision
          ...
          FOREACH WITH HOLD
              ...
              SELECT d.no_poliza,d.no_documento,d.no_factura,d.sucursal_origen,
                ...
                INTO _no_poliza,_no_documento,_no_factura,v_cod_sucursal,
                     ...
                     v_usuario,v_suma_asegurada,v_fecha_cancel,_no_endoso
                 FROM emipomae d, endedmae b
                WHERE d.cod_compania = a_cia
                  AND (d.vigencia_final >= a_periodo
			   	   OR d.vigencia_final IS NULL)
