...
drop procedure sp_pro368_esp;
create procedure "informix".sp_pro368_esp(a_cod_agente char(5), a_num_carga char(10), a_renglon smallint, a_poliza char(10), a_no_unidad char(5))
...
foreach
	...
	if a_poliza = '924670' and _no_unidad = '00001' then
		continue foreach;
	end if
	...
	foreach
		...
		if _cnt_cober > 0 then		
			...
			let _sql_where		= "cod_agente = " || a_cod_agente || "and num_carga = " || a_num_carga || " and renglon = " || trim(cast(a_renglon as char(4)));
