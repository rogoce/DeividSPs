...
DROP PROCEDURE sp_web15bk;

CREATE PROCEDURE sp_web15bk(a_poliza CHAR(10), a_skip smallint, a_skip2 smallint, a_alfa char(1) default null, a_cod_cliente char(10) default null)
...
-- UNIDADES DE ENDEDUNI
	FOREACH
		 ...
		 SELECT	SKIP a_skip FIRST a_skip2 y.no_unidad,
				y.suma_asegurada,
				y.cod_asegurado
		   INTO	v_unidad,
				v_suma_aseg,
				v_contratante
		   FROM	emipouni y inner join cliclien x on y.cod_asegurado = x.cod_cliente
