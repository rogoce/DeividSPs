...
DROP PROCEDURE sp_pr26;

CREATE PROCEDURE "informix".sp_pr26(
		a_compania  CHAR(3),
		a_agencia   CHAR(3),
		a_periodo1  CHAR(7),
		a_periodo2  CHAR(7),
...
--		if year(_vigencia_final_end) > year(_vigencia_inic_pol) then -- Amado 28-04-2017
--			if month(_vigencia_final_end) = month(_vigencia_inic_pol) then
--				LET _cnt_prima_ren = 1;		
--			end if
--		end if
