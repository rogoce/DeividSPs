...
drop procedure sp_arregla_cobadeco2;

create procedure 'informix'.sp_arregla_cobadeco2()
...
foreach
	select cod_agente,
	  ...
	  into _cod_agente,
		   ...
		   _porc_partic_adeco
	  from cobadeco
	 where no_documento in ('0208-00593-03','0214-00012-03','0207-01988-01','0110-00378-01','0313-00079-01','0209-02100-01','0208-00548-03','0208-00549-03','0212-00593-03','0213-00910-03','0213-00914-03','0213-01165-03','0213-01219-03',
							'0213-01482-03','0214-00377-03','0913-00046-03','0913-00047-03','2213-00024-03','1913-00023-05','1914-00020-01','1813-00196-01')
	...
	--if abs(_saldo_comis_calc - _comis_saldo_adec) > 0 then
		{update cobadeco
