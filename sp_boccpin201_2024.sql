...
{if a_ano <> 2021 then
	return 0,'','REPORTE NO PARAMETRIZADO AUN.','','',0,0,0,0,0;
end if}
--******************************************************
...
if a_trimestre = 1 then
	Let _fecha_ini = '01/01/2024';
	Let _fecha_fin = '31/03/2024';
elif a_trimestre = 2 then
	Let _fecha_ini = '01/04/2024';
	Let _fecha_fin = '30/06/2024';
elif a_trimestre = 3 then
	Let _fecha_ini = '01/07/2024';
	Let _fecha_fin = '30/09/2024';
else
	Let _fecha_ini = '01/10/2024';
	Let _fecha_fin = '31/12/2024';
end if
...
foreach
	select sum(prima_suscrita),
	  ...
	  into _prima_sus_ant,
           _cod_agente	  
      from deivid_tmp:prisusapccp_24
     group by cod_agente
