...
drop procedure sp_rec206a;		
create procedure "informix".sp_rec206a(a_tipo_siniestro integer, a_cod_ramo char(3), a_cod_producto varchar(10), a_no_poliza varchar(10), a_no_unidad varchar(5))
