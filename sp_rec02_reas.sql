...
drop procedure sp_rec02_reas;

create procedure "informix".sp_rec02_reas(
a_compania		char(3), 
a_agencia		char(3), 
a_periodo		char(7),
...
-- seleccion del codigo de la compania lider y del contrato de retencion
