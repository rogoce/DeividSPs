...
drop procedure sp_pro320d;
create procedure sp_pro320d(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10))
...
--drop table if exists prueba; -- Se puso en comentario por problemas con la BD Amado 27-01-2023
...
if _no_documento = '0220-00436-02' then
