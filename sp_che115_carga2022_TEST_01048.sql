DROP PROCEDURE sp_che115_carga2022_TEST_01048;
CREATE PROCEDURE sp_che115_carga2022_TEST_01048(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
define _pri_dev_aa_new      DEC(16,2);
...
foreach
	select no_documento,
	  ...
	  into _no_documento,
		   ...
		   _pri_dev_aa
	  from fis_che115a
	--  where cod_agente in ('01315','01834')
	...
	if _cod_ramo = '023' then
		...
		let _pri_dev_aa_new = _pri_dev_aa ;
...
let a_periodo = '2021-12';
    ...
    if _cod_agente not in ('01315','01834','01048') then
			continue foreach;
	end if
