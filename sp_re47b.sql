...
--DROP PROCEDURE sp_rec47b;

CREATE PROCEDURE sp_rec47b(a_compania CHAR(3),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(255),a_ramo CHAR(255),a_grupo CHAR(255),a_agente CHAR(255)) 
...
FOREACH
 SELECT cod_ramo,
   ...
   FROM	tmp_siniest
  WHERE seleccionado = 1
  GROUP BY cod_ramo, periodo, no_poliza
  ORDER BY cod_ramo, periodo, no_poliza
