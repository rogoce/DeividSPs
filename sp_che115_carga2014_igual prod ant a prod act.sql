...
CREATE PROCEDURE sp_che115_carga2014(
a_compania          CHAR(3),
a_sucursal          CHAR(3)
) RETURNING SMALLINT;
...
let a_periodo   = '2014-06';  --****PONER COMENTARIO CUANDO CORRE ANUAL
...
let _per_fin_ap     = '2013-06';  --****PONER COMENTARIO CUANDO CORRE ANUAL
...
let _fecha_ap       = sp_sis36(_per_fin_ap); --30/06/2013
