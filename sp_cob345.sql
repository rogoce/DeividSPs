...
drop procedure sp_cob345;
create procedure "informix".sp_cob345(a_periodo char(7) default "*") 
returning	char(20),
            dec(16,2),
            dec(16,2),
            dec(16,2),
...
create temp table tmp_cuadre_pxc2(
tipo			char(20),
saldo_ant		dec(16,2) default 0,
saldo_act		dec(16,2) default 0,
saldo_dif		dec(16,2) default 0,
...
foreach
 select no_documento,
  ...
  order by 1
	...
	insert into tmp_cuadre_pxc2
	(tipo,saldo_ant,saldo_act,saldo_dif,produccion,cobros,cheq_pag,cheq_anu)
	values(_tipo_prod_c,_saldo_ant,_saldo_act,_saldo_dif,_produccion,_cobros,_cheq_pag,_cheq_anu);
