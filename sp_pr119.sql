...
-- 		FASCILIDAD CAR - MAPFRE  HENRY
-- 		PRIMA SUSCRITA
-- execute PROCEDURE sp_pr119 ("001","001","2009-10","2009-12","*","*","*","*",
-- "001,003,002,010,011,012,013,014;","*","*","*")
---------------------------------------------------------------------------------
DROP PROCEDURE sp_pr119;
CREATE PROCEDURE sp_pr119(
		a_compania    CHAR(03),
		a_agencia     CHAR(03),
		a_periodo1    CHAR(07),
		a_periodo2    CHAR(07),
...
--	  set debug file to "sp_pr119.trc";	 																						 
      ...
      FOREACH WITH HOLD
         ...
         FOREACH
				...
				if _facilidad_car = 0 then
					--if v_cod_contrato <> "00614" and v_cod_contrato <>  "00584" and v_cod_contrato <>  "00574"  and v_cod_contrato <>  "00594"  and v_cod_contrato <>  "00604" then  -- Contrato Provincial  2009,2008
					CONTINUE FOREACH;
				end if
...
-- CARACTERISTICAS : del 2007 hasta la fecha, contrato = '00584','00576'
