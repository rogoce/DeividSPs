...
drop procedure sp_proe85;
 
create procedure sp_proe85(a_poliza CHAR(10), a_unidad CHAR(5))
returning dec(16,2);
...
--set debug file to "sp_proe85.trc";
--trace on;

set isolation to dirty read;
let _cod_grupo 		= null;

-- Fecha inicial de uso de la tabla emivecla1 para Pólizas Nuevas
