...
DROP PROCEDURE sp_sac148;
CREATE PROCEDURE sp_sac148(a_tipo char(2),a_cuenta char(12),a_ccosto char(3),a_anio char(4),a_mes char(2), a_anio2 char(4),a_mes2 char(2),a_db CHAR(18)) 
...
--DROP TABLE tmp_saldosac148;
CREATE TEMP TABLE tmp_saldosac148(
