...
--DROP PROCEDURE sp_che95cprueba1;
CREATE PROCEDURE sp_che95cprueba1(a_cia CHAR(3),a_cod_agente CHAR(5) default "*",a_periodo char(7))
...
FOREACH
	...
	if _porcentaje >= 0 then
		...
		--let _valor_prima = _prima_aplica * ( _porcentaje / 100);	-- prima aplica tiene la prima neta cobrada devengada.
		--let _valor_prima = _prima_cobrada * ( _porcentaje / 100);
