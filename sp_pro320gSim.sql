...
drop procedure sp_pro320gSim;
create procedure sp_pro320gSim(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10))
...
--SET DEBUG FILE TO "sp_pro320d.trc";
--TRACE ON;
...
select x.anos_pagador,
       ...
       x.saldo_por_unidad,
       x.cod_ramo,
       x.no_documento,x.carta_aviso_canc,x.fecha_aviso_canc,x.no_renovar,x.cod_grupo
  Into r_anos,
       _vigencia_final,
       _saldo_unidad,
	   _cod_rammo,
	   _no_documento,_carta_aviso_canc,_fecha_aviso_canc,_no_ren_pol,_cod_grupo
...
-- SD #15317 Amado 29-10-2025
if _cod_grupo = '1122' then
	let _cod_grupo = '78032';
elif _cod_grupo = '77850' then
	let _cod_grupo = '78033';
elif _cod_grupo = '77995' then
	let _cod_grupo = '78034';
end if	
...
update deivid_tmp:emipoagt_f
   set cod_agente = '03250'
 where no_poliza = v_poliza
   and cod_agente = '02904';
   
-- SD #15716 Amado 08-01-2026
if _cod_grupo = '77982' then
	update deivid_tmp:emipoagt_f
	   set cod_agente = '03254'
	 where no_poliza = v_poliza
	   and cod_agente = '02915';
end if 
...
if _ramo_sis = 1 then
	if _cod_rammo <> '024' then
		if _cod_rammo = '020' then
			...
			let _valor = sp_pro321eSimB(v_poliza_nuevo,v_poliza);
