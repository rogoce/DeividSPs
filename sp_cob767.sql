...
-- Creado     : 27/09/2010  -- Autor: Henry Giron.	-- execute procedure sp_cob767a('HGIRON')
-- SIS v.2.0 -- DEIVID, S.A.

drop procedure sp_cob767;
create procedure "informix".sp_cob767(a_user_proceso CHAR(15))
...
--set debug file to "sp_cob767.trc";
--trace on;
...
foreach	
	select no_poliza,
	 ...
	 where estatus = 'Z'
	   ...
	   and user_cancela = a_user_proceso -- estatus = "X" and no_poliza = a_no_poliza 
