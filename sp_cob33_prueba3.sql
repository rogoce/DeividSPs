...
drop procedure sp_cob33_prueba3;
CREATE PROCEDURE sp_cob33_prueba3(
a_compania     CHAR(3), 
a_sucursal     CHAR(3), 
a_no_documento CHAR(20),
a_periodo      CHAR(7),
a_fecha        DATE     
) RETURNING	dec(16,2) as Monto_recibo,char(10) as endoso, date as f_p_p_pol, date as f_p_p_end, char(10) as factura,integer as dias ,dec(16,2) as montoprimero,
  dec(16,2) as corriente,dec(16,2) as monto_30,dec(16,2) as monto_60,dec(16,2) as monto_90,smallint as no_pagos;
...
{if a_no_documento = '0116-00754-01' then
...
{IF v_saldo = 0 THEN
	RETURN  v_por_vencer,v_exigible,v_corriente,v_monto_30,v_monto_60,v_monto_90,v_saldo;
END IF}
...
return _monto_recibo,_no_endoso,_fecha_primer_pago_pol,_fecha_primer_pago,_no_factura, _dias,_monto_primero,v_corriente,v_monto_30,v_monto_60,v_monto_90,_no_pagos with resume;
		if _dias < 0 then
...
--return _monto_recibo,_no_endoso,_fecha_primer_pago_pol,_fecha_primer_pago,_no_factura, _dias,_monto_primero,v_corriente,v_monto_30,v_monto_60,v_monto_90,_no_pagos;
...
--return _monto_recibo,_no_endoso,_no_factura, _dias, 0,0,0,0,0;
