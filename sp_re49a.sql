...
--DROP PROCEDURE sp_rec49a;

CREATE PROCEDURE sp_rec49a(a_compania CHAR(3),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_fecha1 DATE ,a_sucursal CHAR(255),a_ramo CHAR(255),a_grupo CHAR(255),a_agente CHAR(255)) 
