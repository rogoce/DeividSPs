...
DROP PROCEDURE sp_rwf19b;

CREATE PROCEDURE "informix".sp_rwf19b(v_no_tranrec CHAR(10))
 RETURNING char(50), 			--v_grupo, 
		   ...
		   char(10), 			--v_tr_ant_no, 
		   DATE,				--v_tr_ant_fecha,
		   VARCHAR(100),			--v_nombre_de, 
		   VARCHAR(100),			--v_asegurado, 
		   VARCHAR(100),			--v_reclamante,
		   CHAR(50),			--v_tipo_trans,
		   CHAR(10),			--v_periodos,
		   CHAR(10),			--v_transaccion
		   CHAR(15);			
...

{
   ...
   select recrcmae.no_poliza, recrcmae.cod_reclamante, recrcmae.ajust_interno,
          ...
          recrcmae.fecha_siniestro, recrcmae.no_unidad, recrcmae.cod_asegurado
     into v_no_poliza, v_cod_reclamante, v_interno, v_externo, v_fe_audiencia,
          v_fecha, v_estado, v_siniestro, _no_unidad, v_contratante
     from recrcmae
   ...
   select emipomae.cod_grupo, emipomae.no_documento
     into v_cod_grupo, v_poliza
     from emipomae
