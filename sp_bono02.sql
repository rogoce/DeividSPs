...
CREATE PROCEDURE sp_bono02(a_compania CHAR(3), a_ano integer,a_cod_agente CHAR(5) default "*") 
RETURNING CHAR(5),         
		  CHAR(50),        
		  decimal(16,2),
          decimal(16,2),   
...
if a_ano = 2025 then
...
elif a_ano in(2018,2019,2020,2021,2022,2023,2024) then
	create temp table temp_bono(
	cod_agente			char(7),
	periodo				char(7),
	prima_suscrita		dec(16,2),
	...
	foreach
		...
		if _cod_agente = '02311' and a_ano = 2022 then --Solicitud de GS -- Román --30/03/2023
