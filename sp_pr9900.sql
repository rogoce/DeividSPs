...
-- 		PRIMA COBRADA
-- execute PROCEDURE sp_pr990 ("001","001","2009-07","2009-09","*","*","*","*",
-- "001,003;","*","*","*")
...
---------------------------------------------------------------------------------
DROP PROCEDURE sp_pr9900;
CREATE PROCEDURE sp_pr9900(a_compania CHAR(03), a_agencia CHAR(03), a_periodo1 CHAR(07), a_periodo2 CHAR(07), a_codsucursal CHAR(255) DEFAULT "*", a_codgrupo CHAR(255) DEFAULT "*", a_codagente CHAR(255) DEFAULT "*",	a_codusuario  CHAR(255) DEFAULT "*", a_codramo CHAR(255) DEFAULT "*",	a_reaseguro CHAR(255) DEFAULT "*", a_contrato    CHAR(255) DEFAULT "*",	a_serie CHAR(255) DEFAULT "*")
...
FOREACH 
	select cod_ramo,
	  ...
	  from temp_produccion
		...
		if (v_cod_ramo = "010" or v_cod_ramo = "011" or v_cod_ramo = "012" or v_cod_ramo = "013"  or v_cod_ramo = "014" or v_cod_ramo = "022" or v_cod_ramo = "001"  or v_cod_ramo = "003") then 
			LET _seleccionado = 1;
		end if
...
FOREACH
   ...
   LET v_prima50       = (v_prima * _p_50_prima)/100;
	...
	if v_cod_ramo = '010' or v_cod_ramo = '012' or v_cod_ramo = '011' or v_cod_ramo = '013' or v_cod_ramo = '014' or v_cod_ramo = '022' then
		 let v_clase = '004' ;
	end if
...
FOREACH
     ...
     order by r.serie,t.cod_ramo
		...
		if (as_cod_ramo = "010" or as_cod_ramo = "011" or as_cod_ramo = "012" or as_cod_ramo = "013"  or as_cod_ramo = "014" or as_cod_ramo = "022" or as_cod_ramo = "001"  or as_cod_ramo = "003") then
		else
			continue foreach;
		end if
