DROP PROCEDURE sp_rec14ms;
create procedure sp_rec14ms(
a_compania char(3),
a_agencia  char(3),
a_periodo1 char(7),
a_periodo2 char(7),
...
--SET DEBUG FILE TO "sp_rec14ms.trc";
--TRACE ON;
...
foreach
	select no_poliza,
	  ...
	  from tmp_siniest
	 where seleccionado = 1
	 group by no_poliza, doc_poliza, cod_ramo, cod_grupo, cod_cliente, periodo1, periodo2, vigencia_inic, vigencia_final 
