...
drop procedure sp_sis402a;
create procedure sp_sis402a(a_no_poliza char(10),a_fecha_hoy date, a_monto_pago decimal(16,2) default 0, a_no_remesa char(10) default '00000')
returning	smallint,
			varchar(120),
			decimal(16,2);
