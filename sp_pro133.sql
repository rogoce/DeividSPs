DROP procedure sp_pro133;

CREATE procedure "informix".sp_pro133(a_cia CHAR(3),a_agencia CHAR(3),a_codsucursal CHAR(255) DEFAULT "*",a_periodo DATE, a_cod_ramo CHAR(255) DEFAULT "*")
...
LET v_filtros = sp_pro133b(a_cia,a_agencia,a_periodo,_cod_ramo);
...
IF a_cod_ramo <> "*" THEN
 LET v_filtros = TRIM(v_filtros) ||"Ramo: "||TRIM(a_cod_ramo);
