-- Cobros Totales por Ramo -- comision

-- Creado    : 14/02/2003 - Autor: Amado Perez
-- Modificado: 
--
-- SIS v.2.0 - d_cobr_sp_cob08f_dw6 - DEIVID, S.A.

DROP PROCEDURE sp_cob08f;

CREATE PROCEDURE "informix".sp_cob08f(
a_compania CHAR(3), 
a_agencia  CHAR(3), 
a_periodo1 CHAR(7),
a_periodo2 CHAR(7),
