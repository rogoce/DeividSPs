...
drop procedure ap_cob232;

create procedure "informix".ap_cob232(a_no_caja char(10))
returning char(10),
          char(1),
          char(30),
          char(50),
...
--SET DEBUG FILE TO "ap_cob232.trc";
--trace on;
...
foreach
	select no_remesa,
	 ...
	 where fecha        = _fecha
	   ...
	   and no_remesa in ('1503874','1503287')
	--   and no_remesa    = '1503874'
...
*/
        if _no_remesa in ('1503659','1503287') and _renglon = 2 then
		else
