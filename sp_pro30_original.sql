...
foreach
	select no_poliza,
	 ...
	 where cod_compania   = a_compania
	   ...
	   and no_documento   not in ("1802-00086-01", "1800-00036-01", "1803-00505-01", "1813-00168-01","1812-00077-01","1812-00088-01",'1815-00205-01')

--	and no_documento   in ("1801-00046-01")
--	and no_documento   in ('1811-00282-01')
--	and no_documento   = "1810-00675-01"
--	and no_poliza      = "75419" 
