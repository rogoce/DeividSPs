...
---  Ref. Power Builder - d_prod_sp_pr999sr_dw2
...
--- Modificado por Román 22/07/2016 Unificación de la información inicial.
--------------------------------------------
--execute procedure sp_pr999sr2('001','001','2012-12','2012-12',"*","*","*","*","001,003,006;","*","*","2013,2012,2011,2010,2009,2008","*")

drop procedure sp_pr999sr2;
create procedure sp_pr999sr2(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
