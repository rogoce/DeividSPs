--***************************************************************************************
-- Procedimiento que genera el Reporte para convencion 2025 para los corredores
--***************************************************************************************
--CONVENCION HONG KONG 2025
...
let _nombre_tipo = "";
--*************************************************************************************
-- Prima neta cobrada devengada periodo convencion 2024-01 Al periodo se esta evaluando
--*************************************************************************************
...
foreach
	...
	call sp_dev06f(_no_documento,_fecha_aa,'01/01/2024',_fecha_aa) returning _valor,_mensaje,_pri_dev_aa;
...
--**********************************************************************
-- Prima Pagada periodo convencion 2024-01 Al periodo se esta evaluando
--**********************************************************************
...
foreach
	...
	foreach
		...
		select pagado,
		 ...
		 where no_requis = _no_requis
		   and fecha_impresion between '01/01/2024' and '31/12/2024';
	...
	let _valor = sp_sis101a(_no_documento,'01/01/2024','31/12/2024',my_sessionid); --se cambia a tabla fisica 05/06/2018
	foreach
		select cod_agente,
		       porcentaje
		  into _cod_agente,
...
LET _fecha_ap = '31/12/2023';   --BORRAR ESTA LINEA AL INICIAR LA PROXIMA CONVENCION
let _fecha_aa = '31/12/2024';	--BORRAR ESTA LINEA AL INICIAR LA PROXIMA CONVENCION

call sp_bo077_2('01/01/2023', _fecha_ap, _fecha_aa) returning _error, _error_desc;
...
----**********************************************************************************************
call sp_bo077_2('01/01/2024', _fecha_aa, _fecha_aa) returning _error, _error_desc;
...
foreach
	...
	elif _pri_dev_ap >= 170000 then
		let _nombre_tipo = "Rango 3";
	elif _pri_dev_ap >= 130000 then
		let _nombre_tipo = "Rango 4";
	else
		let _nombre_tipo = "Rango 5";
	end if

	if year(_date_added) = 2024 then --ES AGENTE NUEVO, LO COLOCO EN RANGO 6
