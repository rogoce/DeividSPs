...
--execute procedure sp_rec269a_jb('001','001','2020-01','*')

drop procedure sp_rec269a_JB;
create procedure 'informix'.sp_rec269a_JB(
a_compania	char(3),
a_agencia	char(3),
a_periodo	char(7),
...
call sp_rec02_JB(a_compania, a_agencia, a_periodo,'*','*','*',a_cod_ramo,'*') returning v_filtros; 
