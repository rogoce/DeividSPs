...
create procedure "informix".sp_aud44(
              ...
              if _tipo_contrato = 3 or _tipo_contrato = 2 then
				...
				if _tipo_contrato = 1 then
					...
					foreach
						...
						let _porc_partic_reas = (_porc_partic_reas / 100) * (_porc_proporcion / 100);
						let _porc_part_total  = (_porc_partic_reas / 100) * (_porc_partic_coas / 100);
