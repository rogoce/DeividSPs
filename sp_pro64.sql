...
DROP PROCEDURE sp_pro64;

CREATE PROCEDURE "informix".sp_pro64(a_compania CHAR(3),a_sucursal CHAR(3),a_periodo CHAR(7)) 
RETURNING CHAR(10), --licencia
		  CHAR(50), --corredor
		  SMALLINT, --CNT VIDA
		  SMALLINT, --CNT GENERALES
		  SMALLINT,	--CNT FIANZAS
		  CHAR(50); --CIA
