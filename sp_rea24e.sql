...
-- execute procedure sp_rea24e('001','001','2018-05',1)

drop procedure sp_rea24e;
create procedure 'informix'.sp_rea24e(a_compania char(3), a_sucursal char(3), a_periodo char(7), a_flag smallint)
returning	integer,		--1
			varchar(100);	--2
...
foreach with hold
	select distinct no_documento
	  into _doc_poliza
	  from emipomae e
	 where e.vigencia_final >= '01/07/2018'
	   and e.vigencia_inic < '01/07/2018'
	   and e.vigencia_inic >= '01/07/2017'
	...
	if _doc_poliza in ('1616-00040-01') then
		commit work;
		continue foreach;
	end if
