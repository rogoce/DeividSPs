   DROP procedure sp_pro1030;
   CREATE procedure "informix".sp_pro1030(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7), a_periodo2 CHAR(7), a_origen CHAR(3) DEFAULT '%')
