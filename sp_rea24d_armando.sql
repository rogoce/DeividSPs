...
--drop procedure sp_rea24d_armando;
create procedure sp_rea24d_armando(a_compania char(3), a_sucursal char(3), a_periodo char(7), a_flag smallint)
returning	integer,		--1
			varchar(100);	--2
...
let _fecha = sp_sis36(a_periodo);	--devuelve ultimo dia del mes
...
foreach with hold
	select no_documento,
	 ...
	 where periodo = a_periodo
	   ...
	   --select no_documento from deivid_cob:provrea_poliza)
   	   --and no_documento in('1614-00078-01','1614-00079-01','1614-00080-01')
...
select sum(saldo_pxc)
  ...
  from deivid_cob:cobmoros2
 where periodo = a_periodo
   and no_documento[1,2] not in('02','20','23');
