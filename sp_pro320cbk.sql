...
drop procedure sp_pro320cbk;

create procedure "informix".sp_pro320cbk(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10)) RETURNING INTEGER, char(100);
...
define _orden_n,_rengl  smallint;
...
--SET DEBUG FILE TO "sp_pro320cbk.trc";
--trace on;
...
if _cnt = 0 then
	return 2,'No Existe Ruta de Reaseguro para esta Vigencia';
end if
