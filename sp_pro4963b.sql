DROP procedure sp_pro4963b;
   CREATE procedure "informix".sp_pro4963b(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7), a_periodo2 CHAR(7), a_origen CHAR(3) DEFAULT '%')
   RETURNING CHAR(20) AS poliza,CHAR(3) as ramo,DECIMAL(16,2) as prima_suscrita,DECIMAL(16,2) as suma_asegurada,
             integer as cnt_prima_nva,integer as cnt_prima_ren, VARCHAR(25) as endomov, CHAR(1) as uso_auto, CHAR(1) as cobertura;
       ...
       END FOREACH 
         ...
         select nombre 
		  ...
		  where cod_endomov = _cod_endomov;
	   	 ...
	   	 return _no_documento,_cod_ramo, _suscrita_unidad,_suma_asegurada, _cnt_prima_nva, _cnt_prima_ren, _endomov, _uso_auto, _cobertura with resume; 	 
...
{FOREACH WITH HOLD
   SELECT no_documento,cod_ramo, no_unidad, suma_asegurada, cobertura
     INTO _no_documento,_cod_ramo, _no_unidad, _suma_asegurada, _cobertura
     FROM tmp_unidad	 
	 return _no_documento,_cod_ramo, _total_pri_sus,_sa_poliza with resume; 	 
END FOREACH	
...
FOREACH WITH HOLD
   SELECT orden,descripcion,auto_co_p_cant,auto_co_p_monto,auto_co_c_cant,auto_co_c_monto,auto_rc_p_cant,auto_rc_p_monto,auto_rc_c_cant,
	 ...
	 return _orden,_descripcion,_auto_co_p_cant,_auto_co_p_monto,_auto_co_c_cant,_auto_co_c_monto,_auto_rc_p_cant,_auto_rc_p_monto,_auto_rc_c_cant,
          _auto_rc_c_monto,_soda_co_p_cant,_soda_co_p_monto,_soda_co_c_cant,_soda_co_c_monto,_sub_p_tot_cant,_sub_p_tot_monto,_sub_c_tot_cant,_sub_c_tot_monto,_tot_cant,_tot_monto with resume; 
