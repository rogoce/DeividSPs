...
DROP procedure sp_pro307_dist;

CREATE procedure "informix".sp_pro307_dist(
a_compania     CHAR(03),
a_agencia      CHAR(03),
a_periodo1     CHAR(07),
a_periodo2     CHAR(07),
      ...
      FOREACH
         SELECT d.no_poliza,
           ...
           INTO v_nopoliza,
				...
				_no_remesa,
				_renglon
           FROM cobredet d, deivid_ttcorp:tmp_reaseguro_prob t
          WHERE d.no_remesa = t.no_remesa
		    and d.renglon = t.renglon
			and d.periodo      >= a_periodo1
            AND d.periodo      <= a_periodo2
			AND d.actualizado  = 1
			and d.tipo_mov     in ("P", "N")
			and t.cod_situacion = 13
		--	and no_recibo in (select id_recibo from deivid_ttcorp:tmp_reaseguro_prob where cod_situacion = 13 and id_recibo <> 'CONTA')
