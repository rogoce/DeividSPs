   DROP procedure sp_rea023;
   CREATE procedure "informix".sp_rea023(a_cia CHAR(03),a_agencia CHAR(3),a_fecha DATE,a_serie CHAR(255) DEFAULT "*",a_contrato CHAR(255) DEFAULT "*",a_subramo CHAR(255) DEFAULT "*",a_cliente CHAR(255) DEFAULT "*")
   RETURNING CHAR(45),SMALLINT,DEC(16,2),DEC(16,2),CHAR(255),CHAR(50),SMALLINT,SMALLINT,VARCHAR(30);
--------------------------------------------
---       POLIZAS VIGENTES POR RAMO      --- SOLO AFIANZADOS
...
--------------------------------------------
	...
	DEFINE _total_aseg,_fronting  smallint;
...
--  SET DEBUG FILE TO 'sp_rea023.trc';
...
--	TRACE ON;
    ...
    FOREACH WITH HOLD
	 ...
	 ORDER BY y.cod_ramo,y.cod_subramo,y.no_documento
		...
		select fronting,periodo
		  into _fronting,_periodo
		  from emipomae
