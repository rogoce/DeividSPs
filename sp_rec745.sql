...
-- Ingreso a parmailsend para ser enviado por correo 00036 Declinación de Reclamo de Salud
-- Amado Perez 05/08/2020                            00036 Aseguradora Ancón - Declinación del Reclamo
-- Deivid Gestion

--drop procedure sp_rec740;
--create procedure sp_rec740()
drop procedure sp_rec745;
create procedure sp_rec745(a_no_tranrec char(10))
