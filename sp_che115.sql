...
-- Desactivado por Orden de Demetrio, para que no afecte los calculos realizados. 
Return 0;
...
let _fecha_aa_ini   = "01/01/2012";	--para sacar cancelada o anulada en el periodo
...
{	 if _concurso = 0 then -- Excluir del Concurso
   ...
   select count(*)
    ...
    where no_poliza     = _no_poliza
      ...
      and fecha_emision >= _fecha_aa_ini
