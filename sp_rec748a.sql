...
-- execute procedure sp_rec748a('2023-01','2023-10') 
-- Procedure utilizado para la carga de información en Power Bi


DROP PROCEDURE sp_rec748a;
CREATE PROCEDURE sp_rec748a(a_periodo_desde CHAR(7),a_periodo_hasta CHAR(7)) 
...
foreach
	select	emi.no_documento,
	 ...
	 inner join cliclien ase on ase.cod_cliente = rec.cod_asegurado
	...
	if _transaccion = '01-592598' then
		let _cod_producto = '00890';
		let _nombre_producto = 'DECAPOLIS PANAMA - ASEGURADO SOLO';
	end if
