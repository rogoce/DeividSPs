...
drop procedure sp_sis421ccp;
create procedure sp_sis421ccp()
returning integer;
...
define _concurso,_unificar,_valor     smallint;
...
foreach
	select no_poliza,
	  ...
	  from endedmae
	 where actualizado  = 1
	   and periodo between '2020-01' and '2020-12'
