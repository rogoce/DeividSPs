...
drop procedure sp_cob33_prueba;
CREATE PROCEDURE sp_cob33_prueba(
a_compania     CHAR(3), 
a_sucursal     CHAR(3), 
...
return v_por_vencer,v_exigible,v_corriente,v_monto_30,v_monto_60,v_monto_90,v_saldo,_monto_recibo;
