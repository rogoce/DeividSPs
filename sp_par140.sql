...
DROP PROCEDURE sp_par140;

CREATE PROCEDURE "informix".sp_par140(
  ...
  WHERE	no_documento   = a_no_documento -- Facturas de la Poliza
	...
	-- FIN Cambio de Distribución de Morosidad por Facturas en Positivo
		...
		FOR _ciclo = 1 TO _no_pagos
			...
			ELIF _dias > 255 AND _dias <= 340 THEN
...
LET v_exigible = v_corriente + v_monto_30 + v_monto_60 + v_monto_90 + v_monto_120;
