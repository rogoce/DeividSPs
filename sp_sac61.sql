...
drop procedure sp_sac61;
create procedure sp_sac61(
a_usuario	char(8),
a_origen	smallint
) returning integer,
            char(100);
...
define _mayor_error,_mayor_error1		integer;
...
--		let _fecha = sp_sac62(_periodo);
	...
	-- Procedure para planilla
	 call sp_sac135a(a_usuario,a_origen) returning _mayor_error,_mayor_error1, _mayor_desc;
