...
--DROP PROCEDURE sp_che118b;
CREATE PROCEDURE sp_che118b(a_compania CHAR(3),a_sucursal CHAR(3),a_fecha1 DATE,a_fecha2 DATE,a_usuario CHAR(8),a_codagente CHAR(255) DEFAULT "*",a_codvend CHAR(255) DEFAULT "*",a_codsuc CHAR(255) DEFAULT "*")
