-- Procedimiento que genera las cancelaciones por saldo (proceso de avisos de cancelacion)
-- 
-- Creado     : 27/09/2010 - Autor: Armando Moreno M.
--
-- SIS v.2.0 - DEIVID, S.A.

--drop procedure sp_cob253;

create procedure sp_cob253(
a_no_poliza		char(10),
a_usuario		char(8),
a_saldo			dec(16,2)
) returning integer,
