...
drop procedure sp_sis107a;

create procedure sp_sis107a(a_no_poliza char(10))
...
foreach
	...
	let _prima_retenida = 0.00;
   	...
   	call sp_proe04d(a_no_poliza,_no_unidad,_suma_asegurada,'001') returning _valor,_error_desc;
