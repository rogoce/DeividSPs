...
drop procedure sp_proe04bcam;
create procedure "informix".sp_proe04bcam(a_poliza char(10), a_unidad char(5), a_suma dec(16,2), a_no_endoso char(5), a_cod_ruta char(5))
...
define ld_porc_prima  		DECIMAL(9,6);
define ld_porc_suma			DECIMAL(9,6);
