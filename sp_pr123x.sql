...
---------------------------------------------------------------------------------
--DROP PROCEDURE sp_pr123x;
CREATE PROCEDURE sp_pr123x(
		a_compania    CHAR(03),
		a_agencia     CHAR(03),
		a_periodo1    CHAR(07),
		a_periodo2    CHAR(07),
...
-----
{FOREACH
        SELECT cod_ramo,serie,t.cod_contrato,sum(t.pagado_neto)
		  into v_cod_ramo,_serie,v_cod_contrato,_siniestro
		  FROM tmp_sinis t, reacomae r
		 where r.cod_contrato = t.cod_contrato
		   and t.seleccionado = 1
		   and t.tipo_contrato in ('3')
