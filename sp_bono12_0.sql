...
drop procedure sp_bono12_0;
create procedure sp_bono12_0(a_compania char(3), a_sucursal char(3))
...
SET DEBUG FILE TO 'sp_bono12_0.trc';
TRACE ON;
...
let _per_ini      = '2018-10';	--PONER EN COMENTARIO CUANDO SE PONGA AUTOMATICO
...
let _per_ini = _per_ini;
let _per_fin_aa = _per_fin_aa;

let _per_ini_ap = _per_ini_ap;
let _per_fin_ap = _per_fin_ap;

let _fecha_ap_ini = _fecha_ap_ini;
let _fecha_ap = _fecha_ap;

let _fecha_aa_ini = _fecha_aa_ini;
let _fecha_aa = _fecha_aa;

let _per_fin_dic = _per_fin_dic;
