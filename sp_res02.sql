...
drop procedure sp_res02;
create procedure "informix".sp_res02(a_compania char(3), a_agencia	char(3), a_periodo1	char(7), a_periodo2	char(7), a_sucursal	char(255) default "*", a_ramo char(255) default "*")
returning	char(50),char(3),char(50),decimal(16,2),decimal(16,2),decimal(16,2),varchar(255);
...
foreach
	...
	return v_compania_nombre,_cod_ramo,v_ramo_nombre,_reserva_bruto,_pagado,_reserva_bruto_f,v_filtros with resume;
