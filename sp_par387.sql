...
Drop procedure sp_par387; 
CREATE PROCEDURE "informix".sp_par387(  
a_secuencia	INTEGER 
...
Let  _html_body1 = trim(_html_body1) || '        	FE DE ERRATAS';
...
Let  _html_body1 = trim(_html_body1) || '			Nos dirigimos a usted en relaci&oacute;n con la carta que le fue enviada recientemente con respecto al ajuste en su prima mensual. Lamentablemente, hemos identificado un error en dicha comunicaci&oacute;n que queremos corregir de inmediato.';
...
Let  _html_body1 = trim(_html_body1) || '				En la carta original, se proporcion&oacute; informaci&oacute;n incorrecta con respecto al porcentaje de siniestralidad acumulada. Nos disculpamos sinceramente por cualquier confusi&oacute;n o preocupaci&oacute;n que esto pueda haber causado.';

Let  _html_body1 = trim(_html_body1) || '</p>';

Let  _html_body1 = trim(_html_body1) || '<p>';

Let  _html_body1 = trim(_html_body1) || '				Le hacemos env&iacute;o nuevamente de la carta corrigiendo este punto.';

Let  _html_body2 = trim(_html_body2) || '</p>';

Let  _html_body2 = trim(_html_body2) || '<p>';

Let  _html_body2 = trim(_html_body2) || '				Reconocemos la importancia de proporcionar informaci&oacute;n precisa y clara a nuestros asegurados, y nos comprometemos a tomar medidas para prevenir errores similares en el futuro. Agradecemos su comprensi&oacute;n y paciencia mientras trabajamos para rectificar esta situaci&oacute;n.';

Let  _html_body2 = trim(_html_body2) || '</p>';

Let  _html_body3 = trim(_html_body3) || '<p>';

Let  _html_body3 = trim(_html_body3) || '				Por favor, no dude en ponerse en contacto con nosotros si tiene alguna pregunta o necesita m&aacute;s aclaraciones sobre este asunto. Estamos aqu&iacute; para ayudarle en todo lo que podamos.';
