...
begin
define _nom_contrato		varchar(20);
		...
		{if a_tipo = '08' then
			foreach
				select c.tipo_contrato,
				  ...
				  into _tipo_contrato,
					   _cta_tec
				  from reacoest r, reacomae c
				 where r.desc_contrato = c.cod_contrato
				   and anio         = '2014-2015'
				   and trimestre    = 3
				   and borderaux    = '08'
				...
				insert into tmp_estado (periodo1,periodo2,trimestre,ano,reasegurador,contrato,saldo_ant,remesa_rec,remesa_env,cta_tec,saldo_trim,renglon,seleccionado,remesa_otr,desc_contrato)
				values(_periodo1,_periodo3,_trim_reas,_anio_reas,s_cod_coasegur,a_tipo,_saldo_inicial,_remesa_rec,_remesa_env,_cta_tec,_saldo_final,0,1,_remesa_otr,_nom_contrato);	
...
foreach
	...
	let t_reasegurador = trim(t_reasegurador) || '	' || _nom_contrato;
