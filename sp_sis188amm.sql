...
drop procedure sp_sis188amm;
create procedure sp_sis188amm(a_no_poliza char(10))--, a_no_unidad char(5))
returning dec(16,2), char(250);
...
foreach
	...
	if _prima_total <> 0 then
		let _proporcion = (_prima_cober_reas/_prima_total) * 100;
			return _proporcion, '' with resume;
	else
