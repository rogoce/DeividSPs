-- Generacion del Archivo para Banco multi Credit Bank

-- Creado    : 22/02/2001 - Autor: Demetrio Hurtado Almanza 
-- Modificado: 15/11/2001 - Autor: Armando Moreno M. ref sp_cob44

-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_cob75;

CREATE PROCEDURE "informix".sp_cob75(
a_compania		CHAR(3),
a_sucursal		CHAR(3),
a_user			CHAR(8)
) RETURNING SMALLINT,
