-- Procedimiento que Carga los Totales de Produccion -- Solo automovil
-- en un Periodo Dado
-- 
-- Creado    : 28/12/2023 - Autor: Amado Perez 
-- Modificado: 28/12/2023 - Autor: Amado Perez
--
-- SIS v.2.0 - DEIVID, S.A.

-- copia del sp_pr26h

DROP PROCEDURE sp_pro4968b;

CREATE PROCEDURE "informix".sp_pro4968b(
		a_compania  CHAR(3),
		a_agencia   CHAR(3),
		a_periodo1  CHAR(7),
		a_periodo2  CHAR(7),
