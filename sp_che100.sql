...
DROP PROCEDURE sp_che100;

CREATE PROCEDURE sp_che100(a_compania CHAR(3), a_cod_agente CHAR(5) default '*', a_periodo char(7), a_requis smallint default 0) 
...
if a_requis = 0 or a_requis is null then
	let s_requis = " ";
end if
if a_requis = 1 then
	let s_requis = "A";
...
--     and tipo_requis matches s_requis
