...
--HGIRON---call sp_pro941b(a_periodo, a_periodo2, a_origen);
--SET DEBUG FILE TO "sp_pro94b.trc"; 
--trace on;
call sp_pro1029(a_periodo, a_periodo2, a_origen); ---
--trace off;
