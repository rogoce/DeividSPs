...
CREATE PROCEDURE sp_che95cc(a_cia CHAR(3),a_cod_agente CHAR(5) default "*",a_periodo char(7))
...
FOREACH
	...
	if _cod_agente in ('02311','01589') and _cod_tipo = '003' then --Solicitud de GS -- Román --30/03/2023
		let _pri_susc_dev_ap = _pri_susc_dev_ap - 10749.47;
		let _prima_cobrada = _prima_cobrada - 10749.47;			
		let _prima_aplica = _prima_aplica - 10749.47;			
		let _prima_aa = _prima_aa - 10749.47;			
		let _prima_exc_m90 = _prima_exc_m90 - 10749.47;			
	end if	
