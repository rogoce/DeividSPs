...
drop procedure sp_proe04_vida_am;
create procedure sp_proe04_vida_am(a_poliza char(10),a_unidad char(5),a_ruta char(5) default "",a_suma dec(16,2),a_cia char(3))
returning	integer;
...
call sp_sis264(a_poliza) returning li_return1,_mensaje,_porc_riesgo;
