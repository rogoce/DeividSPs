-- Sacar informacion para un periodo dado de los endosos de cambio de reaseguro.

-- SIS v.2.0 - DEIVID, S.A.
-- Creado    : 09/07/2012 - Autor: Armando Moreno

--execute procedure sp_rea032('001','001','2012-04','2012-06','*','*','*','*','008;','*','1')


DROP procedure sp_rea032bk;

CREATE procedure "informix".sp_rea032bk(
a_compania     CHAR(03),
a_agencia      CHAR(03),
a_periodo1     CHAR(07),
a_periodo2     CHAR(07),
