...
------------------------------------------------
--execute procedure sp_pr860_t('001','001','2023-01','2023-01',"*","*","*","*","008;","*","2023,2022,2021,2020,2019,2018,2017,2016,2015,2014,2013,2012,2011,2010,2009,2008;",'09')
drop procedure sp_pr860_tam;
create procedure sp_pr860_tam(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
