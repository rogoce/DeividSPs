...
returning	char(21)		as Poliza, 					--_no_documento,
			...
			dec(16,2)		as Endoso_Extra_Prima,			--_extra_plus_prima,
			varchar(30)		as Endoso_Extra_Limites,		--_extra_plus_limite,
			varchar(30)		as Endoso_Extra_Desc_Limites,	--_extra_plus_desc_limite,
			varchar(30)		as Endoso_Extra_Deducible,		--_extra_plus_deducible;
			dec(16,2)     	as Saldo,
			dec(16,2)		as DiezPorc,
			dec(16,2)   	as Descuento_x_Sini,
			dec(5,2)		as Incremento,
			dec(16,2)		as Nueva_Prima_Neta,
			char(1)         as Opcion,
			char(5)         as Cod_Grupo,
			varchar(50)     as Grupo,
			varchar(255)    as Notas_Relevantes,
			varchar(255)    as Notas_polizas,
			varchar(50)     as Producto_Anterior,
			smallint        as Error_Num,
...
define _extra_plus_limite			varchar(30);
define _extra_plus_desc_limite		varchar(30);
define _extra_plus_deducible		varchar(30);
...
define _extra_plus_prima         	dec(16,2);  
...
define _descuento_x_sini			dec(16,2);
define _opcion						char(1);
define _cod_grupo                	char(5);
define _grupo						varchar(50);
define _notas_relevantes			varchar(255);
define _notas_polizas				varchar(255);
...
foreach
	select no_documento,
		   ...
		   extra_plus_prima,
		   extra_plus_limite,
		   extra_plus_desc_limite,
		   extra_plus_deducible,
		   cod_formapag
	  into _no_documento,
		   _no_unidad,
		   _cod_ramo,
		   ...
		   _extra_plus_prima,
		   _extra_plus_limite,
		   _extra_plus_desc_limite,
		   _extra_plus_deducible,
		   _cod_formapag
	  from prdpreren
