...
drop procedure sp_pro496;

create procedure "informix".sp_pro496(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo CHAR(7))
returning CHAR(3),
		  varchar(50),
		  char(3),
		  varchar(50),
...
GROUP BY no_documento
    ...
    if _cod_tipoprod = _cod_tipoprod2 then	  --coas mayoritario
