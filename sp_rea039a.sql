...
RETURNING	char(20),
   ...
   BEGIN
	 ...
	 CALL sp_rea040(a_compania,a_agencia,a_periodo1,a_periodo2,a_codsucursal,a_codgrupo,
		            a_codagente,a_codusuario,a_codramo,a_reaseguro,'1',a_contrato) RETURNING v_filtros;
...
FOREACH
         ...
         FOREACH
				...
				if v_cod_contrato <> a_contrato then
					continue foreach;
				end if
