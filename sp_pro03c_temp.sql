...
--------------------------------------------
   ...
   DROP procedure sp_pro03c_t;
   CREATE procedure "informix".sp_pro03c_t(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codsucursal CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*")

   RETURNING CHAR(3),CHAR(50),CHAR(50),INT,INT,DECIMAL(16,2),DECIMAL(16,2),DATE,
             CHAR(3),CHAR(50),CHAR(255),CHAR(45),CHAR(10),CHAR(5),CHAR(5),CHAR(3),DATE,CHAR(20),CHAR(10);
    ...
    CREATE TEMP TABLE temp_perfil1(
              ...
              PRIMARY KEY(cod_ramo,cod_subramo,no_poliza,no_endoso,no_unidad)) WITH NO LOG;
...
--	   END IF
       ...
       RETURN  v_cod_subramo,v_desc_subramo,v_desc_vehic,v_cant_polizas,v_cant_unidades,
               ...
               v_cod_ramo,v_desc_ramo,v_filtros,descr_cia,_no_poliza,_no_endoso,_no_unidad,
               v_endomov,v_fecha_emision,v_documento,v_no_factura WITH RESUME;
