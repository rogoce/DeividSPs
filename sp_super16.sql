...
drop procedure sp_super16;
create procedure "informix".sp_super16(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
...
--------------------------------------------
   ...
   BEGIN
	  ...
	  define _prima_bruta,_porc_comision	 decimal(16,2);
...
--Filtro de Poliza
      ...
      {   SELECT nombre
		...
		if v_comision = 0 then
			...
			let _porc_comision = v_comision / v_prima_suscrita * 100;
		end if	

         RETURN v_cod_ramo,v_desc_ramo,v_nofactura,v_nodocumento,_vig_ini,_vig_fin,v_desc_nombre,v_suma_asegurada,_prima_bruta,v_comision,_porc_comision,v_estatus,v_sucursal,
		        _desc_nueva_renov,_fecha_emision,_nom_agente WITH RESUME;
