...
-- DROP PROCEDURE sp_che02;

CREATE PROCEDURE sp_che02(
a_compania          CHAR(3),
a_sucursal          CHAR(3),
a_fecha_desde       DATE,   
a_fecha_hasta       DATE,   
	...
	FOREACH
	 SELECT	cod_agente,
	  ...
	  WHERE	no_remesa = _no_remesa
		...
		-- Para el dia 21 de Mayo del 2007 Se solcicito que las Sobre Comisiones pueden ser tanto para las 
		-- Agencias como para los corredores
		-- Se congela la condicion siguiente  
		-- if _cod_agente <> _agente_agrupado then	-- Sobre-Comisi¢n para las Agencias
