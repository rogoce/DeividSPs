...
-- execute procedure sp_sis388a('01/07/2011',2)

drop procedure sp_sis388a;
create procedure sp_sis388a(a_fecha date, a_despues smallint)
returning date;
