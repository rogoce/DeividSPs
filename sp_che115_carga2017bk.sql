...
DROP PROCEDURE sp_che115_carga2017;
CREATE PROCEDURE sp_che115_carga2017(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
foreach
	...
	foreach			   --PRIMER EMIPOAGT
		...
		SELECT nombre,
		 ...
		 WHERE cod_agente = _cod_agente;
            ...
            {if _agente_agrupado in('01266','00547','01048','00035','00218','00874','00141') then --Codigos que pertencen a rentabilidad2
				let _bono_rent2 = 1;
			end if
			if _cod_agente in('02360','02376','02293','02377','02378','02375','00133','01746','01749','01852','02004','02075','02124') then  --Estos son codigos relacionados KAM
				let _bono_rent2 = 1;
			end if}
			...
			IF _tipo_agente <> "A" then	-- Solo agentes
				...
				exit foreach;
			END IF
			{IF _estatus_licencia <> "A" then  -- La Licencia del corredor debe estar activa. Se quita para que tome en cuenta a los inactivos para mostrarlos enele reporte, pero no se paga si esta inactivo.
			    let _flag = 4;
				exit foreach;
			END IF} 
	...
	if _flag = 8 then
		--INSERT INTO bonibita2(periodo,poliza,descripcion,tipo,cod_agente,cod_ramo,prima_suscrita) VALUES (a_periodo,_no_documento,'PARTICIPA EN RENTABILIDAD 2, NO APLICA',2,_cod_agente,_cod_ramo,_pri_susc_aa);
	 	continue foreach;
	end if	 
	if _flag = 9 then
		--INSERT INTO bonibita2(periodo,poliza,descripcion,tipo,cod_agente,cod_ramo,prima_suscrita) VALUES (a_periodo,_no_documento,'MARSH SEMUSA, NO APLICA',2,_cod_agente,_cod_ramo,_pri_susc_aa);
	 	continue foreach;
	end if
