...
drop procedure sp_rwf149;

create procedure sp_rwf149(a_no_reclamo char(10), 
                           a_incidente integer,
                           a_opcion smallint, 
						   a_monto dec(16,2), 
						   a_user_name_ajust CHAR(20), 
...
define _envio_correo        smallint;

define _anno integer;

set isolation to dirty read;

--if trim(a_no_reclamo) = '510743' then
  --set debug file to "sp_rwf149.trc";
  --trace on;
--end if
...
let a_wf_apr_jt_fh = a_wf_apr_jt_fh;

let _anno = year(a_wf_apr_jt_fh);
...
call sp_rwf37_yoseg(_no_tranrec_char) returning _resultado, _descripcion, _genera_incidente, _envio_correo;
