...
-- DROP PROCEDURE sp_che72;
CREATE PROCEDURE sp_che72(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo char(7), a_cod_agente CHAR(255))
...
returning CHAR(15),  -- Codigo de de Agente 			
		  ...
		  CHAR(3),   -- Codigo de Subramo
		  DATE,		 -- Vigencia Inicial
		  DATE,      -- Vigencia Final
		  SMALLINT;  -- Edad de la P¢liza
