...
drop procedure sp_pro374b;

create procedure "informix".sp_pro374b(a_no_poliza char(10))
returning integer,
		  smallint,
		  char(30),
          char(120);
...
if _no_documento in( '0224-05829-01','0224-05826-01','0224-05853-01','0224-05766-01','0224-05728-01','0224-05587-01','0224-05309-01') then
 return 0,0,'','';
end if

if _no_factura not like '%-%' then
	return 0,0,'','';
end if 


if _no_documento = '1024-05703-01' then
	set debug file to "sp_pro374.trc";
	trace on;
end if
...
if _return <> 0 then
	return 328,1,'Información',_desc_error;
end if
...
if _prima_suscrita > _prima_retenida then
