...
DROP PROCEDURE sp_pr99b;
CREATE PROCEDURE "informix".sp_pr99b(
        a_compania  	CHAR(3), 
        a_agencia   	CHAR(3), 
        a_periodo1  	CHAR(7),
        a_periodo2  	CHAR(7),
	...
	-- Informacion de Poliza
		...
		SELECT no_poliza,
		  ...
		  INTO _no_poliza, 
			   ...
			   _vigencia_inicial
		  FROM emipomae
		 WHERE month(vigencia_inic) = month(_fecha1) and month(vigencia_inic) = month(_fecha2) -- year(vigencia_inic) >= year(_fecha1) and year(vigencia_inic) >= year(_fecha2) AND 
