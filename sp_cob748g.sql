-- Reporte para correo certificado -- Sacado del reporte de de Aviso de Cancelacion 
...
DROP PROCEDURE sp_cob748g;
CREATE PROCEDURE "informix".sp_cob748g(a_compania CHAR(3),a_cobrador CHAR(3) DEFAULT '*',a_tipo_aviso SMALLINT,a_agente CHAR(5) DEFAULT '*',a_acreedor CHAR(5) DEFAULT '*', a_asegurado CHAR(10) DEFAULT '*',a_callcenter SMALLINT DEFAULT 0, a_referencia CHAR(15))
