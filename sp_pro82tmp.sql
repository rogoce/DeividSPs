...
drop procedure sp_pro82tmp;

create procedure "informix".sp_pro82tmp(
v_usuario 			char(8),
v_poliza 			char(10),
...
define ll_impuesto,_error	   integer;	
...
--SET DEBUG FILE TO "sp_pro82tmp.trc"; 
--trace on;
