...
foreach 
 select res1_tipo_resumen,
  ...
  where e.res_noregistro = d.res1_noregistro
    ...
    and d.res1_auxiliar  = "04361" --"BQ146"
    and d.res1_cuenta    = "2550101"
    and year(res_fechatrx) = 2022
	and month(res_fechatrx) = 6 --3
  group by 1, 2, 3, 4, 5
  order by 1, 2, 3, 4, 5
...
foreach
 select sld1_debitos,
   ...
   into _debito_sal,
		...
		_mes
   from cglsaldoaux1
   where sld1_cuenta = '2550101'
     and sld1_tercero = "04361" --'BQ146'
	 and sld1_ano = 2022
	 and sld1_periodo = 6 --3
