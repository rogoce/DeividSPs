...
--DROP PROCEDURE sp_mor03;

CREATE PROCEDURE "informix".sp_mor03()
RETURNING CHAR(18),DATE,date,DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2);
  ...
  ORDER BY cod_ramo,numrecla
   ...
   foreach
      ...
      SELECT reserva_actual
	 	...
	 	FROM recrccob
       WHERE no_reclamo    = _no_reclamo
         AND cod_cobertura = "01075" --Asistencia Medica
   ...
   foreach
      ...
      SELECT reserva_actual
	 	...
	 	FROM recrccob
       WHERE no_reclamo    = _no_reclamo
         AND cod_cobertura = "01022" --Danos a l prop.
   ...
   foreach
      ...
      SELECT reserva_actual
	 	...
	 	FROM recrccob
       WHERE no_reclamo    = _no_reclamo
         AND cod_cobertura = "01021" --Lesiones
