...
drop procedure sp_proe04_vida_1;
create procedure sp_proe04_vida_1(a_poliza char(10),a_unidad char(5),a_ruta char(5) default "",a_suma dec(16,2),a_cia char(3))
returning	integer;
