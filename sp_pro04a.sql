...
----------------------------------------------
DROP procedure sp_pro04a;
CREATE procedure "informix".sp_pro04a(a_compania CHAR(3),a_agencia CHAR(3),a_periodo DATE,a_codsucursal CHAR(3) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",	a_codtipoveh  CHAR(255) DEFAULT "*")
