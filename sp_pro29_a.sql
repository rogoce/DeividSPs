...
--DROP procedure sp_pro29_a;
CREATE procedure "informix".sp_pro29_a(a_compania CHAR(03),a_agencia CHAR(3),a_periodo1 CHAR(07),a_periodo2 CHAR(7),a_codramo CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo CHAR(255), a_codcoasegur CHAR(255),a_useradd CHAR(255) DEFAULT "*",a_reaseguro CHAR(255) DEFAULT "*", a_cod_cliente CHAR(255) DEFAULT "*", a_no_documento CHAR(255) DEFAULT "*")
