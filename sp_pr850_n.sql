...
create procedure "informix".sp_pr850_t(
			a_compania		char(03),
			a_agencia		char(03),
			a_periodo1		char(07),
			a_periodo2		char(07),
...
foreach
	select serie,cod_ramo,cod_contrato,cod_cobertura,sum(prima) 
	  ...
	  from temphg1
	 where cod_coasegur in ('036','042','050','063','076','089','128','117','134','136','141','146','147','149','153') --agregué el 153 porque es nuevo APM 12-01-2022
	   and anio      = _anio_reas
	...
	foreach 
		select distinct cod_coasegur,porc_cont_partic,porc_comision,porc_impuesto
		  ...
		  from temphg1
		 where serie          = _serie
		   and cod_coasegur   in ('050','063','076','042','036','089','128','117','134','136','141','146','147','149','153') --agregué el 153 porque es nuevo APM 12-01-2022
