...
DROP PROCEDURE sp_pro51v;

CREATE PROCEDURE "informix".sp_pro51v(a_poliza CHAR(10))
 ...
 SELECT cod_producto,
  ...
  --  and no_unidad = '01424'
	...
	ELIF _busqueda = "2" THEN   --Unica
		_ld_tarifa = 0
		If _tipo_valor = "P" Then
			_ld_tarifa = _ldv_tar_unica
		Else
			If _factor_division > 0 Then
				_ld_tarifa = _ldv_tar_unica / _factor_division
				_ld_tarifa = _ld_tarifa * _ld_suma
			End If
		End If
