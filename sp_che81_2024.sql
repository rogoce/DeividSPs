--************************************************************
-- Procedimiento que Carga las Bonificaciones de cobranza 2024
--************************************************************
...
foreach
	...
	if _cod_agente in('02442','02917','02569','02656','02111') then	--se excluyen estos corredores por instr. Analisa, correo del 09/07/2019
		continue foreach;
	end if
	...
	if _prima_cobrada >= 50000 or _retro = 1 then	--si es >= a 40000, se toma en cuenta al corredor para el pago.
	else
		continue foreach;
	end if
	...
	foreach
		...
		if _cod_ramo in('019','018','016','008','001') then	  --No va poliza de vida individual ni Salud, ni colectivas de salud ni fianzas, ni incendio
			insert into bonibita(periodo,poliza,descripcion)
