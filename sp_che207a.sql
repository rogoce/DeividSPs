...
DROP PROCEDURE sp_che207a;

CREATE PROCEDURE sp_che207a(a_compania CHAR(3))
RETURNING SMALLINT;
	 ...
	 foreach
		 ...
		 let _no_poliza = sp_sis21(_no_documento);
		   ...
		   select count(*)
		    ...
		    where no_poliza   = _no_poliza
			  and actualizado = 1
		      and cod_endomov in ('003','012')  --rehabilitacion o cambio de corredor en el periodo no va
			...
			foreach
				...
				BEGIN
					...
					INSERT INTO tmp_tropi(cod_agente,no_documento,prima,cantidad_pol,cod_ramo,categoria,nombre_vendedor,suc_prom)
				    VALUES(_cod_agente,_no_documento,_monto_p,1,_cod_ramo,_categoria,_nombre_vendedor,_suc_nom);
