...
DROP PROCEDURE sp_pro996;
CREATE PROCEDURE "informix".sp_pro996(a_sucursal char(3), a_periodo char(7), a_codramo char(255) default "*", a_codsuc char(255) default "*", a_codvend char(255) default "*")
...
delete from agtcarta;

let _fecha_hoy = current;

--set debug file to "sp_pro996.trc";	  	  	  	
--trace on;
...
foreach
   ...
   --if _cnt = 0 then
   --		insert into agtcarta values (_cod_agente);
   --end if
