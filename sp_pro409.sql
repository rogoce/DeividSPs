...
drop procedure sp_pro409;
create procedure sp_pro409(
a_no_poliza			char(10),
a_usuario			char(8),
a_suscursal     	char(3),
...
elif a_cod_agente_new in ('02667') and  a_cod_agente_old  = '02541' then  --SD#7854 ISMAEL VALLARINO 14/09/2023 HGIRON
	update endmoage
	   set porc_partic_agt = 50
	 where no_poliza = a_no_poliza
	   and no_endoso = _no_endoso
	   and cod_agente = a_cod_agente_new;
		...
		select no_poliza,
		 ...
		 where no_poliza = a_no_poliza
		   and cod_agente in (a_cod_agente_old)
		 group by no_poliza,porc_comis_agt;		 
elif a_cod_agente_new in ('03182') and  a_cod_agente_old  = '02667' then  --SD#7854 ISMAEL VALLARINO 14/09/2023 HGIRON
	update endmoage
	   set porc_partic_agt = 50
	 where no_poliza = a_no_poliza
	   and no_endoso = _no_endoso
	   and cod_agente = a_cod_agente_new;
	    ...
	    /*update endmoage
	       set porc_partic_agt = 25
		 where no_poliza = a_no_poliza 
		   and no_endoso = _no_endoso 
		   and cod_agente not in (a_cod_agente_old,a_cod_agente_new);*/
		 
		--delete from endmoage where no_poliza = a_no_poliza and no_endoso = _no_endoso and cod_agente not in (a_cod_agente_old,a_cod_agente_new);
		 
elif a_cod_agente_new in ('01163') and  a_cod_agente_old  = '02157' then  --
	update endmoage
	   set porc_partic_agt = 50
	 where no_poliza = a_no_poliza
	   and no_endoso = _no_endoso
...
elif a_cod_agente_new in ('02903') and  a_cod_agente_old  = '01789' then  --SD#7854 ISMAEL VALLARINO 14/09/2023 HGIRON
	update endmoage
	   set porc_partic_agt = 10
	 where no_poliza = a_no_poliza
	   and no_endoso = _no_endoso
	   and cod_agente = a_cod_agente_new;
...
elif a_cod_agente_new in ('02956') and  a_cod_agente_old  = '01834' then  --SD#7854 ISMAEL VALLARINO 14/09/2023 HGIRON
	update endmoage
	   set porc_partic_agt = 25
	 where no_poliza = a_no_poliza
	   and no_endoso = _no_endoso
...
elif a_cod_agente_new in ('02649','00849') and  a_cod_agente_old  = '01273' then
	update endmoage
	   set porc_partic_agt = 45
	 where no_poliza = a_no_poliza
	   and no_endoso = _no_endoso
	   and cod_agente = a_cod_agente_new;
