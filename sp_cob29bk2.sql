...
--{
--DROP PROCEDURE sp_cob29bk2;

CREATE PROCEDURE "informix".sp_cob29bk2(a_no_remesa CHAR(10), a_usuario CHAR(8))
RETURNING INTEGER,
		  CHAR(100);
--}
...
call sp_cob333(a_no_remesa) returning _error, _mensaje;
