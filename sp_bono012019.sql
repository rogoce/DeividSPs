--**********************************************************************************************************************************************************
-- Procedimiento para determinar la prima suscrita nueva de los corredores del bono de producción de Ramos Generales 2019
--***********************************************************************************************************************************************************
...
return 0; --se detuvo la corrida 10/03/2020 Armando
	...
	foreach
			 select e.no_documento,e.no_poliza
			  ...
			  where e.no_poliza         = t.no_poliza
				...
				and e.actualizado       = 1
				and e.nueva_renov       = "N"
				and e.periodo >= "2019-01"
				and e.periodo <= "2019-12"	
			...
			select count(*)
			 ...
			 where no_poliza     = _no_poliza
			   ...
			   and fecha_emision >= '01/01/2019'
			   and fecha_emision <= '31/12/2019';
	...
	foreach
			select d.no_poliza,
			 ...
			 where	d.no_remesa    = m.no_remesa
			   ...
			   and d.fecha        >= '01/01/2019'
			   and d.fecha        <= '31/12/2019'
