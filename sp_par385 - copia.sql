...
Let  _html_body2 = trim(_html_body2) ||'				pa&iacute;s que ronda el 14.95% promedio por a&ntilde;o y que desde el 2019 a la fecha ha Acumulado un 75.00% de incremento en ';
...
Let  _html_body2 = trim(_html_body2) ||'<p>';
Let  _html_body2 = trim(_html_body2) ||'				Por lo tanto, a partir del 01 de julio del presente a&ntilde;o, la prima mensual de su p&oacute;liza experimentar&aacute; un aumento del ';
...
Let  _html_body2 = trim(_html_body2) ||'				remitiendo por separado nuevas alternativas de seguro que puedan ajustarse a su presupuesto, sin desmejorar la ';

Let  _html_body2 = trim(_html_body2) ||'				calidad y protecci&oacute;n de las coberturas que hoy se le ofrecen en su plan de seguro.  Queremos asegurarle que su ';
...
Let  _html_body2 = trim(_html_body2) ||'				Agradecemos sinceramente su comprensi&oacute;n y su continuo compromiso con nuestra empresa. Esperamos seguir ';
