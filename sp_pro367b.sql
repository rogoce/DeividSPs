-- Procedimiento que Realiza la insercion a la tabla de Emision, Proceso de Emisiones Electronicas Tecnica de seguros.
-- Creado    : 29/08/2014 - Autor: Federico Coronado 

drop procedure sp_pro367b;

create procedure "informix".sp_pro367b(
v_usuario		char(8),
v_cod_agente	char(5),
v_num_carga		char(10),
...
--set debug file to "sp_pro367b.trc"; 
--trace on;
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
if a_opcion = 'C' then
	let _fecha_primer_pago = v_vigenciainic;
end if   
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	foreach
			  select no_unidad,
			   ...
			   Where cod_agente		= v_cod_agente
				...
				call sp_set_codigo(5,_no_unidad) returning _no_unidad; 
...
/**/
			...
			--call sp_proe02(v_poliza_nuevo, _no_unidad, v_codcompania) returning li_return;
	end foreach	
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
				--Cargar las Coberturas de la Unidad colectivo de vida Suntracs
				call sp_pro368b(v_cod_agente, v_num_carga, _renglon, v_poliza_nuevo,a_opcion) returning _error;
