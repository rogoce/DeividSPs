...
-----------------------------------------------------------
drop procedure sp_proe69;
create procedure sp_proe69(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
...
foreach
	...
	foreach					 -- se desglosa por tipo, buscar primero si es bouquet
		...
		if _bouquet = 1 and _serie >= 2008 then --and _cod_coasegur in ('050','063','076','042','036','089','117','128') then--Todas las compañias del contrato bq son bouquet 14/09/2015
