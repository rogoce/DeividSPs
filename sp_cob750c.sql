...
DROP PROCEDURE sp_cob750c;
CREATE PROCEDURE sp_cob750c(a_aviso CHAR(15),a_renglon smallint)
...
DEFINE _nombre_firma1    CHAR(50);
DEFINE _nombre_firma2    CHAR(50);
DEFINE _cargo1           CHAR(50);
DEFINE _cargo2           CHAR(50);
define _callcenter       INTEGER;
...
CREATE TEMP TABLE tmp_carta_750c(
