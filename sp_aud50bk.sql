...
drop procedure sp_aud50bk;		

create procedure "informix".sp_aud50bk(a_periodo_hasta char(7), _dup_reg smallint, _reg1 integer, _reg2 integer, _reg3 integer )
...
--call sp_ttc08(a_periodo_hasta,4) returning _dup_reg, _reg1,_reg2,_reg3 ;
