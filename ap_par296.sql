...
drop procedure ap_par296;
create procedure "informix".ap_par296()
returning char(10),
		  char(25),
		  dec(16,2),
		  dec(16,2),
		  ...
		  date
		  ;
--a_no_registro, _cuenta, _debito, _credito, _tipo_comp, _cod_auxiliar, _periodo, _centro_costo, _fecha
...
on exception set _error, _error_isam, _error_desc
	drop table tmp_reas;
	return _error, _error_desc, null, null, null, null, null, null, null, null, null, null, null;
end exception
...
select no_registro,
  ...
  into a_no_registro,
	   ...
	   _periodo,
	   _no_documento
  from sac999:reacomp a
 where a.periodo = '2019-03'
   and a.no_remesa is not null
   and a.no_documento[1,2] in ('02','20','23')
   and a.no_registro not in (select no_registro from sac999:reacompasie where periodo = '2019-03')
...
if _tipo_registro = 1 then -- Produccion
	...
	if _cant_reaseguro = 0     and
	   _prima_suscrita <> 0.00 Then
		...
		drop table tmp_reas;
		return 1, "No Existe Distribucion de Reaseguro Para Factura: " || _no_factura, null, null, null, null, null, null, null, null, null, null, null;
...
--				and orden		   = _orden   se quito por que generaba error para los facultativos 22/04/2010 Armando/Demetrio
	...
	foreach
		...
		if _bouquet = 1 then
			if _porc_proporcion = 0 then		
				return 1, "% Proporcion es cero para la Rem: " || _no_remesa || " Rengl: " || _renglon, null, null, null, null, null, null, null, null, null, null, null;
		 ...
		 select cod_coasegur,
	      ...
	      where cod_contrato   = _cod_contrato
			...
			if _monto <> 0.00 Then
				...
				let _cuenta = sp_sis15("PPPRXPB", '03');
				return a_no_registro, _cuenta, _debito, _credito, _tipo_comp, _cod_auxiliar, _periodo, _centro_costo, _fecha, _serie, _no_documento, _vigencia_inic, _vigencia_final with resume;
				--call sp_par297(a_no_registro, _cuenta, _debito, _credito, _tipo_comp, _periodo, _centro_costo, _fecha);
				--call sp_par298(a_no_registro, _cuenta, _debito, _credito, _tipo_comp, _cod_auxiliar, _periodo, _centro_costo, _fecha);
	...
	if _monto_reas <> _monto_reas_cob then
		...
		drop table tmp_reas;
		return 1, "Sumatoria rectrmae vs rectrcob No Cuadra, no_tranrec = " || _no_tranrec, null, null, null, null, null, null, null, null, null, null, null;
...
--				else
					...
					return 1, "No hay Distribucion de Reaseguro para la Transaccion: " || _no_tranrec || " " || _cod_cober_reas, null, null, null, null, null, null, null, null, null, null, null;
			  ...
			  where no_tranrec     = _no_tranrec
				...
				if _tipo_contrato = 3 then -- Facultativos
					...
					if _cantidad = 0 then
						...
						drop table tmp_reas;
						return 1, "No Existe Companias del Contrato: " || _cod_contrato || " Cobertura: " || _cod_cober_reas, null, null, null, null, null, null, null, null, null, null, null;
