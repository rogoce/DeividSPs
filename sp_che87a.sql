...
--DROP PROCEDURE sp_che87a;

CREATE PROCEDURE sp_che87a(a_compania CHAR(3), a_cod_agente CHAR(255) default '*', a_periodo char(7), a_tipo_pago smallint) 
