-- Procedimiento que Genera el Cheque de bonificacion de FFseguros
...
DROP PROCEDURE sp_che105;

CREATE PROCEDURE sp_che105(
a_compania       CHAR(3),
a_sucursal       CHAR(3),
a_cod_agente     CHAR(5),
a_usuario        CHAR(8),
...
-- SET DEBUG FILE TO "sp_che105.trc"; 
-- TRACE ON;                                                                

--BEGIN WORK;

let _origen_cheque = 'E';
let _error         = 0;
...
SELECT cod_origen,
 ...
 WHERE cod_banco = a_banco;
	...
	LET _descripcion = 'PAGO DE BONIFICACION DE RECLUTAMIENTO DE: ' || trim(_nombre_mes) || " DEL " || a_periodo[1,4];
	...
	call sp_par276(_no_requis, "E") returning _error, _error_desc;
