...
drop procedure sp_cas009bk;



create procedure sp_cas009bk(a_cod_pagador char(10), a_no_documento char(20), a_cod_campana char(10))
returning char(20),
          char(20),
		  date,
		  date,
...
foreach
 select r.no_reclamo,
  ...
  --	and p.cod_campana  matches a_cod_campana
