...
DROP PROCEDURE ap_perdida;

CREATE PROCEDURE "informix".ap_perdida(a_periodo1 char(7), a_periodo2 char(7))
...
FOREACH
 SELECT	no_reclamo,
  ...
  IF _deducible IS NULL THEN
	CALL sp_rwf101(_no_reclamo) returning _cod_cobertura, _deducible;
  END IF
