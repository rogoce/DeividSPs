...
returning 
	...
	CHAR(1) as punto29,
	VARCHAR(4) as ano_auto;
	--current as ind_fecha;   -- Obligatorio
...
DEFINE _ind_fecha_emi    DATETIME YEAR TO MINUTE;
...
FOREACH
  SELECT a.no_documento,
   ...
   WHERE a.cod_contratante = b.cod_cliente
	 ...
	 AND a.fecha_suscripcion >= '05-09-2018'
