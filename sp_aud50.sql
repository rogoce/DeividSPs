-- Procedure para auditoria interna - Archivo de Reclamo - SINIESTROS PENDIENTES
-- 
-- Creado    : 18/04/2013 - Autor: Amado Perez Mendoza
--
-- SIS v.2.0 - DEIVID, S.A.

drop procedure sp_aud50;		

create procedure "informix".sp_aud50(a_periodo_hasta char(7)) 
	   ...
	   where no_reclamo = _no_reclamo;
		...
		-- Reaseguro
			...
			if _cont_rea is null or _cont_rea = 0 then
				...
				if _cod_ramo = '023' And _periodo <= '2013-06' then
				...
				elif _cod_ramo = '023' And _periodo >= '2013-07' then
			...
			if _cont_rea > 0 then
				foreach
					...
					if _tipo_contrato = 3 or _tipo_contrato = 2 then
						...
						if _tipo_contrato = 1 then --RETENCION
							if _cod_ramo in('001','003','010','011','012','013','014','021','022') and _vigencia_inic <= '30/06/2014' And _no_tranrec <> '2102745' then --Condicion 50% RET MAPFRE
								let _porc_part_total  = _porc_partic_suma * (_porc_partic_coas / 100);
