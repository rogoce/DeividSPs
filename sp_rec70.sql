...
DROP PROCEDURE sp_rec70;

CREATE PROCEDURE "informix".sp_rec70(
a_compania  CHAR(3), 
a_agencia   CHAR(3), 
a_periodo1  CHAR(7), 
a_periodo2  CHAR(7), 
...
--  ORDER BY cod_ramo, periodo, numrecla
	...
	-- los contratos
	IF v_fecha_siniestro < _vigencia_inic  THEN
	   LET v_fecha_siniestro = _vigencia_inic;
	END IF
	...
	SELECT cod_contrato,
	  ...
	  FROM tmp_vigencias
	 WHERE no_poliza = _no_poliza
	   AND vigencia_inic <=	v_fecha_siniestro
	   AND vigencia_final >= v_fecha_siniestro;
