...
DROP PROCEDURE sp_che207bk;

CREATE PROCEDURE sp_che207bk(a_compania CHAR(3))
RETURNING SMALLINT;
	 ...
	 foreach
		 ...
		 let _no_poliza = sp_sis21(_no_documento);
		   ...
		   select count(*)
		    ...
		    where no_poliza   = _no_poliza
			  and actualizado = 1
		      and cod_endomov in ('003','012','002')  --rehabilitacion o cambio de corredor ni canceladas en el periodo no va
