...
--es copia del sp_cob03

DROP PROCEDURE sp_cob126e;		

CREATE PROCEDURE "informix".sp_cob126e() 
...
LET _count = 0;
let _saldo_tot = 0;
let _por_vencer_tot = 0;
let _exigible_tot = 0;
let _corriente_tot = 0;
let _monto_30_tot  = 0;
let _monto_60_tot  = 0;
let _monto_90_tot  = 0;
...
CREATE INDEX xie04_tmp_moros ON tmp_moros(cod_agente);
...
LET _ano_contable = YEAR("31/03/2004");

IF MONTH("31/03/2004") < 10 THEN
	LET _mes_contable = '0' || MONTH("31/03/2004");
ELSE
	LET _mes_contable = MONTH("31/03/2004");
END IF
...
LET _tipo = sp_sis044("*");  -- Separa los Valores del String en una tabla de codigos
