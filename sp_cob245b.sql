...
-- execute procedure sp_cob245b('001','001','1715-00006-01','2017-05','21/05/2017')
-- SIS v.2.0 - DEIVID, S.A.

drop procedure sp_cob245b;
create procedure "informix".sp_cob245b(
a_compania     char(3), 
a_sucursal     char(3), 
