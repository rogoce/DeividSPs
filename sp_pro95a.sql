...
DROP procedure sp_pro95a;
CREATE procedure sp_pro95a(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codramo CHAR(255), a_reaseguro CHAR(255)  DEFAULT "*", a_origen CHAR(3) default "%")
...
RETURNING CHAR(255);
	...
	define _cod_pagador       char(10);
	   ...
	   CREATE INDEX i_perfil6 ON temp_perfil(cod_contratante);
	   CREATE INDEX i_perfil7 ON temp_perfil(cod_pagador);
			...
			ELSE
	            INSERT INTO temp_perfil
	                VALUES(_no_poliza,
	                       ...
	                       v_suma_asegurada,
						   _tipo_produccion,
	                       1,_prima_suscrita,_cod_pagador);
			END IF
          END FOREACH
       ...
       ELSE
          FOREACH WITH HOLD
              ...
              SELECT d.no_poliza,d.no_documento,d.no_factura,d.sucursal_origen,
                     ...
                     d.user_added,d.suma_asegurada,d.prima_suscrita,d.cod_pagador
                INTO _no_poliza,_no_documento,_no_factura,v_cod_sucursal,
                     ...
                     v_usuario,v_suma_asegurada,_prima_suscrita,_cod_pagador
                 FROM emipomae d
                WHERE d.cod_compania = a_cia
			      AND d.cod_origen like a_origen
                  AND (d.vigencia_final >= a_periodo
