...
DROP PROCEDURE sp_che87bb;
CREATE PROCEDURE sp_che87bb(a_compania CHAR(3), a_cod_agente CHAR(255) default '*', a_periodo char(7), a_tipo_pago smallint) 
...
FOREACH
 SELECT	cod_agente,
   ...
   INTO	v_cod_agente,
		...
		_no_requis
   FROM	chqboni
  WHERE periodo     between '2018-01' and '2018-10'
		...
		let _comision_tot   = 0;
		   ...
		   if v_cod_agente2 <> v_cod_agente then
				...
				SELECT SUM(comision)
				  ...
				  FROM chqboni
				 WHERE cod_agente = v_cod_agente
				   and periodo    between  '2018-01' and '2018-10';
