...
DROP PROCEDURE ap_colect_endoso;
CREATE PROCEDURE ap_colect_endoso() 
RETURNING int, 
          char(25);
...
FOREACH
	select no_poliza, 
	 ...
	 into _no_poliza,
		  ...
		  _vigencia_final
	 from emipouni
	where no_poliza = '0002669253'
	  and no_unidad in (select no_unidad
	 from emipocob where no_poliza = '0002669253')	  
	   and no_unidad = '04315'
	order by no_unidad	
...
{	select no_poliza, 
	 ...
	 into _no_poliza,
		  ...
		  _vigencia_final
	 from emipouni
	where no_poliza = '2037329'
	  and no_unidad not in (select no_unidad
	 from emipocob where no_poliza = '2037329')	  
	 --  and no_unidad = '00009'
	order by no_unidad	
}
...
{	select *
	 ...
	 where no_poliza = '1785909'
	   and no_unidad = _no_unidad
	  into temp prueba;

	update prueba
	   set no_poliza = '2037329',
	       date_added = '30/06/2023',
	       date_changed = '30/06/2023',
		   subir_bo = 0
	 where no_poliza   = '1785909';
	...
	let _error = sp_proe04b(_no_poliza, _no_unidad, _suma_asegurada, '00003');
