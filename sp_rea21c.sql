...
DROP procedure sp_rea21c;
CREATE procedure "informix".sp_rea21c(a_compania CHAR(3), a_agencia  CHAR(03) DEFAULT "*", a_periodo DATE, a_codsucursal  CHAR(255) DEFAULT "*", a_codramo CHAR(255) DEFAULT "*", a_serie char(255) default "*" ) 
RETURNING DEC(16,2),
		  DEC(16,2),
		  SMALLINT,
		  DEC(16,2),
...
IF a_serie <> "*" THEN
--	LET v_filtros = TRIM(v_filtros) || "Serie " || TRIM(a_serie) || ";";	-- SE quito se valido arriba
END IF
