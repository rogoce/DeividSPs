   ...
   DROP procedure sp_super04;
   CREATE procedure sp_super04(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7), a_periodo2 CHAR(7))
...
let _prima_suscrita = 0;
let _prima_suscrita = _venta_corredor + _venta_directa;
