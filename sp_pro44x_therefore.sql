...
DROP PROCEDURE sp_pro44x_therefore;
--DROP TABLE tmp_arreglo;

CREATE PROCEDURE "informix".sp_pro44x_therefore(a_poliza CHAR(10), a_endoso CHAR(5), a_flota INT DEFAULT 0)
