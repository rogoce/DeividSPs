-- Informes de Detalle de Primas Suscritas
-- SIS v.2.0 - DEIVID, S.A.
-- Creado    : 11/08/2025 - Autor: Amado Perez

drop procedure sp_rea075;

create procedure "informix".sp_rea075(
a_compania     char(03),
a_agencia      char(03),
a_periodo1     char(07),
a_periodo2     char(07),
	...
	foreach
		select no_poliza,
		 ...
		 where periodo >= a_periodo1
		   ...
		   and actualizado = 1
		 --  and no_documento = '1925-00043-07'
