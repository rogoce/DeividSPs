...
drop procedure sp_bo077_2;
create procedure sp_bo077_2(a_fecha_ini date, a_fecha_fin date, a_fecha_cobro date default "01/01/1900")
...
foreach
	...
	--Excluir las Pólizas Nuevas en el Periodo Estudiado
