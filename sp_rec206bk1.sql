...
drop procedure sp_rec206bk1;		
create procedure "informix".sp_rec206bk1()
returning	char(3),						--1  
			char(3),						--2  
			char(3),						--3  
			char(10),						--4  
...
foreach
	...
	/*Lo solicitado para que las polizas de obarrio no las envie para workflow*/
	if _sucursal_origen = '012' then
		continue foreach;
	end if
