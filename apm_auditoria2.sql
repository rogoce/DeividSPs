...
-- pero solo tomando en cuenta las transacciones despues del cierre 2011 y 2012.
-- Esto es para Auditoria


drop procedure apm_auditoria2;

create procedure apm_auditoria2()
...
---Variacion 2012
	...
	if _pago_solo = 0 and _incurrido = 0 and _pago_solo2 = 0 and _incurrido2 = 0 then
	else
