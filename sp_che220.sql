...
-- Modificado: 17/03/2016 - Autor: Henry Giron 
-- execute procedure sp_che220("001","*","2016-12")  

DROP PROCEDURE sp_che220; 
CREATE PROCEDURE sp_che220(a_cia CHAR(3),a_cod_agente CHAR(5) default "*",a_periodo char(7)) 
RETURNING 
				CHAR(50),   -- nombre_cia
