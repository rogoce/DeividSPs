...
-- DROP PROCEDURE sp_cob206e;

CREATE PROCEDURE "informix".sp_cob206e(a_fecha date, a_fechae date) 
...
FOREACH																							 
	...
	--   AND cod_cobrador  = 	a_cod_cobrador
	  ...
	  -- Seleccionar los cobros por dia, el Nombre del Pagador y Codigo  --
      FOREACH
			   SELECT id_turno,
			          id_cliente,
			   	      id_transaccion,
		    ...
		    SELECT cod_motiv,
		     ...
		     WHERE cod_motiv = _cod_motivo_char;
  		     RETURN v_nombre_cobrador,--  1. Nombre del Cobrador de la calle
					...
					_fecha_inicio	  --  9. Fecha de Programaci¢n
  		     WITH RESUME;
    	    END FOREACH;	
END FOREACH;	   
END PROCEDURE;
