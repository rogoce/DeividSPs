...
-- Copia del sp_che67
 ...
 drop procedure sp_che126;

create procedure sp_che126(a_mail_secuencia integer)
 returning varchar(100), dec(16,2), date;
...
return _a_nombre_de, _monto_tot, _fecha_sub;
end procedure
