...
drop procedure sp_aud44a;		

create procedure "informix".sp_aud44a()
returning	integer,
			varchar(100); 
...
foreach 
	SELECT id_mov_tecnico,
	 ...
	 SELECT mon_pagado,
	   ...
	   INTO _monto,
	        _tipo_sin
	   FROM det_movim_tecnico_spr
	  WHERE id_mov_tecnico = _id_mov_tecnico;
	  
	  IF _tipo_sin = 'PEN' THEN
	     CONTINUE FOREACH;
	  END IF
...
INSERT INTO det_reaseguro_cara_spr(id_reas_caract, tip_contrato, cod_concepto, mto_concepto, id_mov_reas, fec_operacion, fec_registro, cod_usuario, id_relacionado, porc_concepto) 
	VALUES(_id_reas_caract, _tipo_cont_tt, 70, _mnto_concepto,_id_mov_rea ,_fecha_op, _fecha_reg,_user_added , 0, 0);
...
INSERT INTO informix.det_reaseguro_cara_spr(id_reas_caract, tip_contrato, cod_concepto, mto_concepto, id_mov_reas, fec_operacion, fec_registro, cod_usuario, id_relacionado, porc_concepto) 
	VALUES(_id_reas_caract, _tipo_cont_tt, 80, _mnto_concepto,_id_mov_rea ,_fecha_op, _fecha_reg,_user_added , 0, 0);
