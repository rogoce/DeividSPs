   ...
   RETURNING char(10),varchar(100),char(20),varchar(100),varchar(50),char(1),char(20),dec(16,2),date,date,dec(16,2),varchar(50),varchar(50),char(50),
...
foreach
	select r.no_tranrec,
	 ...
	 where r.no_reclamo = e.no_reclamo
	   ...
	   and t.cod_ramo not in('004','016','019','018','008')	--No incluye ramos de personas ni fianzas.
	   and t.actualizado = 1
       and r.cod_compania = a_cia
	   and r.actualizado  = 1
	   and r.cod_tipopago = '003'	--solo pago a asegurado caso 6853
       and e.actualizado = 1
	...
	return _cod_asegurado,_n_asegurado,_no_documento,_beneficiario,_nombre_producto,_tipo_persona,_numrecla,_suma_asegurada,_fecha_suscripcion,_fecha_siniestro,_monto_pagado,
