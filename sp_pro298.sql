...
-- DROP PROCEDURE sp_pro178b;   nuevo procedimiento es sp_pro303.sql
-- DROP PROCEDURE sp_pro298;

CREATE PROCEDURE "informix".sp_pro298(
        a_compania     CHAR(3), 
        a_agencia      CHAR(3), 
        a_periodo1     CHAR(7),
        a_periodo2     CHAR(7),
...
FOREACH WITH HOLD
  SELECT e.no_poliza,	
    ...
    INTO _no_poliza,		         
         ...
         _total_prima_ret
    FROM endedmae e
   WHERE e.periodo BETWEEN _periodo1 AND a_periodo2
     AND e.actualizado = 1
