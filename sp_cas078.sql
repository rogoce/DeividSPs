...
-- Creado    : 02/03/2005 - Autor: Demetrio Hurtado Almanza
-- Modificado: 02/03/2005 - Autor: Demetrio Hurtado Almanza

-- SIS v.2.0 - DEIVID, S.A.

--drop procedure sp_cas078;	  

create procedure sp_cas078(
a_compania	char(3), 
a_agencia 	char(3),
a_periodo	char(7)
) returning char(10),
