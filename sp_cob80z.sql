...
--DROP PROCEDURE sp_cob80z;

CREATE PROCEDURE "informix".sp_cob80z(
a_compania		CHAR(3),
a_sucursal		CHAR(3),
a_fecha			DATE,
a_periodo		CHAR(1),
...
FOREACH
  ...
  let _cedula = trim(_cedula);
	...
	--LET _campo = 'L' || _cedula || _char_1 || _aseg_resultado || TRIM(_monto_char) || TRIM(_ruta_char) || _no_cuenta ||
	--                   _tipo_cuenta || _tipo_transaccion || '    ';
