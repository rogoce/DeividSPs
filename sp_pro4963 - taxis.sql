DROP procedure sp_pro4963;
   CREATE procedure "informix".sp_pro4963(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7), a_periodo2 CHAR(7), a_origen CHAR(3) DEFAULT '%')
	...
	FOREACH 
		SELECT 	u.no_unidad,          		 
            ...
            INTO _no_unidad,
            	 _suma_asegurada,
                 _suscrita_unidad				 
		   FROM endeduni u, endmoaut b, emivehic c, emimodel d 
		  WHERE u.no_poliza = b.no_poliza
	        AND u.no_unidad = b.no_unidad
	        AND u.no_endoso = b.no_endoso
