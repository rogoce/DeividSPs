...
foreach
	select cod_tipo,
	  ...
	  into _cod_tipo,
		   ...
		   _grupo_trans
	  from parmailtipo
     where cod_tipo in ('00016') --envio_jango = 1
...
--	end if
	...
	foreach
		select first 10 email,
	 	 ...
	 	 where cod_tipo = _cod_tipo
		   ...
		   and date(date_added) >= '20/08/2025'
       ...
       let _email = 'aperez@asegurancon.com;jeperez@asegurancon.com;fcoronado@asegurancon.com'; --contabilidad@asegurancon.com; ;rgordon@asegurancon.com;
	...
	--   let _sender_send = 'jeperez@asegurancon.com';
		...
		elif _cod_tipo = '00042' then
            let _email =  trim(_email) || ";fianzas@asegurancon.com";
		end if

		if _cod_tipo not in ('00050','00051','00052','00053') then
