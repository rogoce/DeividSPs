...
DROP PROCEDURE sp_che115_carga2021simf;
CREATE PROCEDURE sp_che115_carga2021simf(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
foreach
	...
	update rentabilidad11
		set por_siniestro  = _siniestralidad,
