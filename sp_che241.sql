...
DROP PROCEDURE sp_che241;

CREATE PROCEDURE sp_che241(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo CHAR(7), a_verif_tipo_pago SMALLINT DEFAULT 0) 
...
INNER JOIN	cobreagt b
	 ...
	 WHERE a.actualizado      = 1
	  ...
	  -- AND year(a.fecha)      = 2019
	   AND a.fecha >= '01-01-2021'
	   AND a.fecha <= '31-05-2021'
