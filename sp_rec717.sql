			  ...
			  WHERE no_reclamo = _no_reclamo 
				...
				AND porcentaje <> 0								
					...
					RETURN v_doc_reclamo,         --1
						   ...
						   _reserva_neto,         --15
					       _incurrido_neto,		  --16
						   round(_cp_pag*_porcentaje/100,2),	     --	  _cp_pag,	  --17
						   round(_exc_pag*_porcentaje/100,2),     --	 _exc_pag,	  --18
						   round(_cp_res*_porcentaje/100,2),	     --	 _cp_res,	  --19
						   round(_exc_res*_porcentaje/100,2),	 --	 _exc_res,	  --20
						   round(_pag_ret*_porcentaje/100,2),	 --	_pag_ret,	  --21
						   round(_pag_fac*_porcentaje/100,2),	 --	_pag_fac,	  --22
						   round(_pag_cont*_porcentaje/100,2),	 --	_pag_cont,	  --23
						   round(_res_ret*_porcentaje/100,2),	 --	_res_ret,	  --24
						   round(_res_fac*_porcentaje/100,2),	 --	_res_fac,	  --25
						   round(_res_cont*_porcentaje/100,2),	 --	_res_cont,	  --26	     		     
