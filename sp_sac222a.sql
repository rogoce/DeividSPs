...
-- execute procedure sp_sac222a('01','231020203','%','RE034','2011','01','2011','01','sac') 

DROP PROCEDURE sp_sac222a;
CREATE PROCEDURE sp_sac222a(a_tipo char(2),a_cuenta char(12),a_ccosto char(3),a_aux char(5),a_anio char(4),a_mes char(2),a_anio2 char(4),a_mes2 char(2),a_db CHAR(18)) 
     ...
     WITH RESUME;}
		...
		FOREACH	
		  SELECT mostrar,
		   ...
		   group by mostrar,tipo
		   order by mostrar,tipo
