DROP procedure tipoveh2;
CREATE procedure "informix".tipoveh2()
...
---  AUTOMOVIL Y EL TIPO DE VEHICULO SEA ERRADO
--------------------------------------------
	...
	DEFINE v_subramo, v_grupo,v_desc_tipveh     CHAR(50);
  ...
  {  CREATE TEMP TABLE temp_tipoveh
    ...
    FOREACH
	   ...
	   FOREACH
	       ...
	       IF v_tipoveh IS NULL OR v_tipoveh = '' OR (v_tipoveh <> '001' AND v_tipoveh <> '002') THEN
		      CONTINUE FOREACH;
	       END IF 
