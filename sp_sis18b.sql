...
--DROP PROCEDURE sp_sis18b;		

CREATE PROCEDURE "informix".sp_sis18b(a_no_reclamo CHAR(10))
RETURNING INTEGER, CHAR(250), CHAR(2);
...
IF _ramo_sis = 1 THEN
	...
	IF _cod_asegurado IS NOT NULL THEN
		...
		IF _cedula_aseg IS NULL OR _cedula_aseg = '' THEN
			LET _mensaje = 'Al Asegurado le falta la Cedula, Por Favor Verifique ...';
			RETURN 1, _mensaje, 'CA';
		END IF;                                                                                                            
	END IF
