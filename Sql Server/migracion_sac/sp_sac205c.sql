-- Consulta de Movimientos por Rango de Periodos de Cuentas Sac x Auxiliar -- Si es cobros
-- Creado    : 21/04/2010 - Autor: Henry Giron
-- SIS v.2.0 - DEIVID, S.A.	
-- execute procedure sp_sac205c('sac','2011','07','2011','12')

DROP PROCEDURE sp_sac205c;
CREATE PROCEDURE sp_sac205c(a_db char(18),a_anio char(4),a_mes char(2), a_anio2 char(4),a_mes2 char(2))
