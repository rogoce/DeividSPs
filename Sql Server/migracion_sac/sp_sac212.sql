...
-- d_sac_sp_sac209_dw1
-- *********************************
DROP PROCEDURE sp_sac212; 
CREATE PROCEDURE sp_sac212(a_db char(18), a_fecha1 date, a_fecha2 date, a_auxiliar CHAR(5) ) -- a_notrx integer, a_comp char(8)) 
RETURNING char(3),
	        char(30),
            date,
            integer,
...
call sp_pr850("001","001","2011-07","2011-12","*","*","*","*","004,016,018,019;Ex","*")
