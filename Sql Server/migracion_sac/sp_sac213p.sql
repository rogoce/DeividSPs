...
-- execute procedure sp_sac213p('sac','01/07/2011','31/12/2011','BQ050')

DROP PROCEDURE sp_sac213p;
CREATE PROCEDURE sp_sac213p(a_db char(18), a_fecha1 date, a_fecha2 date, a_auxiliar CHAR(5))
