...
-- d_sac_sp_sac177_dw1
-- *********************************
DROP PROCEDURE sp_sac177;

CREATE PROCEDURE sp_sac177(a_db CHAR(18), a_fecha1 date, a_fecha2 date ) 
RETURNING integer,
            char(50);
	...
	FOREACH 
	  select a.res_cuenta,
	    ...
	    into s_cuenta,
	         ...
	         s_usuariocap,
	         s_usuarioact
	    from sac001:cglresumen  a ,sac001:cglresumen1 b
	   where a.res_fechatrx >= a_fecha1
	     and a.res_fechatrx <= a_fecha2
		 and a.res_noregistro = b.res1_noregistro
	order by a.res_noregistro                  
 	...
 	FOREACH 
	  select a.res_cuenta,
	    ...
	    into s_cuenta,
	         ...
	         s_usuariocap,
	         s_usuarioact
	    from sac002:cglresumen  a ,sac002:cglresumen1 b
	   where a.res_fechatrx >= a_fecha1
	     and a.res_fechatrx <= a_fecha2
		 and a.res_noregistro = b.res1_noregistro
	order by a.res_noregistro                  
 	...
 	FOREACH 
	  select a.res_cuenta,
	    ...
	    into s_cuenta,
	         ...
	         s_usuariocap,
	         s_usuarioact
	    from sac003:cglresumen  a ,sac003:cglresumen1 b
	   where a.res_fechatrx >= a_fecha1
	     and a.res_fechatrx <= a_fecha2
		 and a.res_noregistro = b.res1_noregistro
	order by a.res_noregistro                  
 	...
 	FOREACH 
	  select a.res_cuenta,
	    ...
	    into s_cuenta,
	         ...
	         s_usuariocap,
	         s_usuarioact
	    from sac004:cglresumen  a ,sac004:cglresumen1 b
	   where a.res_fechatrx >= a_fecha1
	     and a.res_fechatrx <= a_fecha2
		 and a.res_noregistro = b.res1_noregistro
	order by a.res_noregistro                  
 	...
 	FOREACH 
	  select a.res_cuenta,
	    ...
	    into s_cuenta,
	         ...
	         s_usuariocap,
	         s_usuarioact
	    from sac005:cglresumen  a ,sac005:cglresumen1 b
	   where a.res_fechatrx >= a_fecha1
	     and a.res_fechatrx <= a_fecha2
		 and a.res_noregistro = b.res1_noregistro
	order by a.res_noregistro                  
 	...
 	FOREACH 
	  select a.res_cuenta,
	    ...
	    into s_cuenta,
	         ...
	         s_usuariocap,
	         s_usuarioact
	    from sac006:cglresumen  a ,sac006:cglresumen1 b
	   where a.res_fechatrx >= a_fecha1
	     and a.res_fechatrx <= a_fecha2
		 and a.res_noregistro = b.res1_noregistro
	order by a.res_noregistro                  
 	...
 	FOREACH 
	  select a.res_cuenta,
	    ...
	    into s_cuenta,
	         ...
	         s_usuariocap,
	         s_usuarioact
	    from sac007:cglresumen  a ,sac007:cglresumen1 b
	   where a.res_fechatrx >= a_fecha1
	     and a.res_fechatrx <= a_fecha2
		 and a.res_noregistro = b.res1_noregistro
	order by a.res_noregistro                  
 	...
 	FOREACH 
	  select a.res_cuenta,
	    ...
	    into s_cuenta,
	         ...
	         s_usuariocap,
	         s_usuarioact
	    from sac008:cglresumen  a ,sac008:cglresumen1 b
	   where a.res_fechatrx >= a_fecha1
	     and a.res_fechatrx <= a_fecha2
		 and a.res_noregistro = b.res1_noregistro
	order by a.res_noregistro                  
