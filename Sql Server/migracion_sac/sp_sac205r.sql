...
-- execute procedure sp_sac205r('sac','2011','07','2011','12')

DROP PROCEDURE sp_sac205r;
CREATE PROCEDURE sp_sac205r(a_db char(18),a_anio char(4),a_mes char(2), a_anio2 char(4),a_mes2 char(2))
