-- Reporte de los Bonificacion de Rentabilidad	GLOBAL - UPDATE

-- Creado    : 19/02/2009 - Autor: Henry Giron
-- Modificado: 19/02/2009 - Autor: Henry Giron


DROP PROCEDURE sp_che97;

CREATE PROCEDURE sp_che97(a_compania CHAR(3), a_cod_agente CHAR(5) default '*', a_periodo char(7)) 
