...
drop procedure sp_aud44;		
create procedure sp_aud44(
...
--trace on;
--and no_tranrec in('1116558','1131980','1131986','1131992','1138937','1178503','1178504','1191437','1191439','1195202','1195203')
...
foreach 
	select no_reclamo,
		   ...
		   cod_sucursal,
		   cod_tipotran,
		   decode(cod_tipotran,'004','PAG','005','SAL','006','REC','007','DED','008','RPR','009','AJP')
	  into _no_reclamo,
		   _no_tranrec,
		   _periodo,
		   _fecha,
	 ...
	 where periodo >= a_periodo_desde
	   ...
	   and actualizado   = 1
	   and cod_tipotran in ("004","005","006","007","008","009")
	   and monto         <> 0
--	   and transaccion = '01-1100145'
	 order by fecha

	let _no_tranrec_int = _no_tranrec;
	let _fecha_pagado	= _fecha;
	let _cod_suc_int	= _cod_sucursal;
	...
	let _cod_subramo_int = _cod_subramo;
	...
	foreach
		...
		let _cod_tipotran_int = _cod_tipotran;
			...
			foreach
				...
				if _tipo_contrato = 3 or _tipo_contrato = 2 then
					...
					if _tipo_contrato = 1 then
						if _cod_ramo in('001','003','010','011','012','013','014','021','022') and _vigencia_inic <= '30/06/2014' then
							let _porc_part_total  = _porc_partic_suma * (_porc_partic_coas / 100);
							let _porc_part_total  = _porc_part_total  * 0.50;
							let _porc_partic_suma = _porc_partic_suma * 0.50;
							...
							values	(null,
								...
								let _tipo_cont_tt = 'B'; --cuota parte 50% Mapfre
								let _cont_2       = _cont_2 + 1; 
								...
								foreach
									select cod_contrato
									  into _cod_contrato_map
					  			      from reacomae
							 		 where ret_mapfre = 1
									   and _vigencia_inic between vigencia_inic and vigencia_final
						...
						foreach
							...
							if _contrato_xl = 1 then
								let _tipo_cont_tt = 'M';-- Capa Nueva excedente
							else
...
--*************************************************************
--Llenar tabla deivid_bo:recrespa, para PowerBI, AMM 05/12/2023

call sp_rec135a(a_periodo_desde) returning _cnt,_mensaje;
--*************************************************************
