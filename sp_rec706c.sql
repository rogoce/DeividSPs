--execute procedure sp_rec706c('001','001','2025-11','2025-11',"*","*","001,003;","2009;","*","*","*",0)
drop procedure sp_rec706c;
create procedure sp_rec706c(
a_compania	char(3),
a_agencia	char(3),
a_periodo1	char(7),
a_periodo2	char(7),
...
define _existe,_valor     smallint;
...
drop table prueba;
drop table if exists tmp_rectrrea;
end procedure;	   