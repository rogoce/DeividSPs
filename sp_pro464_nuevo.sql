...
drop procedure sp_pro464_nuevo;

create procedure "informix".sp_pro464_nuevo(v_poliza char(10), v_endoso char(5), v_unidad char(5))
...
----------------
select x.factor_vigencia into v_factor
  from endedmae x
