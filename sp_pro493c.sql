...
drop procedure sp_pro493c;
create procedure sp_pro493c(v_poliza char(10), v_endoso char(5), a_no_endoso_ant char(5))
...
--set debug file to "sp_pro493c.trc";
--trace on;
...
update e_prueba
   set suma_asegurada = suma_asegurada * -1,
       no_endoso      = v_endoso,
	   prima          = prima * -1,
...
update e_prueba
   set suma_asegurada = suma_asegurada * -1,
       no_endoso      = v_endoso,
	   prima          = prima * -1,
	   monto_comision = monto_comision  * -1,
	   monto_impuesto = monto_impuesto * -1;
