...
CREATE PROCEDURE "informix".sp_atc01(a_compania CHAR(3),a_sucursal CHAR(3),a_no_documento CHAR(20),a_ano integer, a_usuario CHAR(10), a_membrete smallint default 0)
RETURNING	CHAR(20),
			VARCHAR(100), -- PAGADOR
            DATE,  	      -- Fecha	min
			DATE,  	      -- Fecha	max
