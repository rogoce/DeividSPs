...
drop procedure sp_pro320g;
create procedure sp_pro320g(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10))
...
if _ramo_sis = 1 then
	if _cod_rammo <> '024' then
		if _cod_rammo = '020' then
			...
			let _valor = sp_pro321e(v_poliza_nuevo,v_poliza);
