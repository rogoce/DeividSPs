...
-- Se genero para comparar con sp_pro496 auxiliar 2550101

DROP PROCEDURE sp_sac167_xls;
CREATE PROCEDURE sp_sac167_xls(a_tipo char(2),a_cuenta char(12),a_aux char(5),a_anio char(4),a_mes smallint,a_db CHAR(18)) 
