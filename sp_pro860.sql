...
--- Informe de prima cobrada - CP y EXCEDENTE x reasegurador	 - HENRY
--------------------------------------------
DROP PROCEDURE sp_pro860;
CREATE PROCEDURE sp_pro860(a_compania CHAR(03),a_agencia CHAR(03),a_periodo1 CHAR(07),a_periodo2 CHAR(07),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo  CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codusuario  CHAR(255) DEFAULT "*",	a_codramo CHAR(255) DEFAULT "*",a_reaseguro  CHAR(255) DEFAULT "*")
RETURNING CHAR(03),CHAR(50),CHAR(50),CHAR(100),DECIMAL(16,2),CHAR(50),CHAR(255),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),smallint;
   BEGIN
...
--     set debug file to "sp_pro860.trc";	  	  	  	
...
FOREACH
     SELECT cod_ramo,
       ...
       INTO v_cod_ramo,
			...
			_por_pagar
         FROM temphg1
		 where serie > 2007	 and cod_coasegur in ('050','063','076','042')           -- Esto es Especifico Para tipo de contrato BOUQUET
		 and anio      = _anio_reas
		 and trimestre = _trim_reas
		 and borderaux = _borderaux 
     GROUP BY cod_ramo,  cod_contrato, desc_contrato, cod_cobertura, tipo, desc_cob
     ORDER BY cod_ramo,  cod_contrato, desc_contrato, cod_cobertura, tipo, desc_cob	


		select porc_comision, porc_impuesto, porc_cont_partic, cod_coasegur
		  into _porc_comision, _porc_impuesto, _porc_cont_partic, _cod_coasegur
		  from temphg1
		 WHERE cod_ramo      = v_cod_ramo
		   and cod_contrato  = v_cod_contrato
		   and cod_cobertura = v_cobertura
