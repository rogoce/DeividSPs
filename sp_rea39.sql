...
--------------------------------------------
drop procedure sp_rea39;
create procedure sp_rea39()
...
--set debug file to 'sp_rea39.trc';
--trace on;
...
foreach with hold
	select distinct u.no_poliza,
		   u.vigencia_inic
	  into _no_poliza,
		   _vigencia_inic
	  from emireaut u, emirerea r, reacomae c
	 where u.no_poliza = r.no_poliza
	   and u.no_unidad = r.no_unidad
	   and c.cod_contrato = r.cod_contrato
	   and c.serie <> 2017
	   and u.no_documento[1,2] in ('02','20','23')
	   and u.vigencia_inic >= '01/01/2017'
