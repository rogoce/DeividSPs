   DROP procedure sp_pro5641;
   CREATE procedure "informix".sp_pro5641(a_periodo char(7), a_periodo2 char(7), a_origen CHAR(3) DEFAULT '%' );
--------------------------------------------
---  APADEA
...
{   SELECT SUM(cant_polizas),
   ...
   ELIF	v_cod_ramo = "015" THEN
     UPDATE ramosubr
        SET prima_suscrita = _prima_suscrita, incurrido_bruto = v_incurrido_bruto, salv_rec = _salv_y_recup,
