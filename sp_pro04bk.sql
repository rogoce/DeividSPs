...
create temp table temp_cant
	...
	cant_polizas	int,
	seleccionado	smallint default 1,
primary key (no_documento, no_unidad,cod_ramo,rango_inicial)) with no log;
...
{	select prima_suscrita,
    ...
    foreach		 
		select no_unidad  --, prima_suscrita, suma_asegurada		  
		  into _no_unidad --, _prima_suscrita, _suma_aseg_end
		  from emipouni
		 where no_poliza = _no_poliza
