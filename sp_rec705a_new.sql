...
-- -- se coloco en filtro poliza, reclamo 28/6/2016 Henry
drop procedure sp_rec705a;
create procedure "informix".sp_rec705a(
a_compania	char(3),
a_agencia	char(3),
a_periodo1	char(7),
a_periodo2	char(7),
...
update tmp_sinis
 ...
 -- Se adiciono . Henry . Omar requeria filtro de poliza y reclamo
 IF a_documento <> "*" THEN
	update tmp_sinis
	   set seleccionado = 0
