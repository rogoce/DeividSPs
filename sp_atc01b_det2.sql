...
DROP PROCEDURE sp_atc01b_det2;

CREATE PROCEDURE sp_atc01b_det2(a_compania CHAR(3),a_sucursal CHAR(3), a_ano integer, a_agente VARCHAR(255))
...
FOREACH
 SELECT	a.no_poliza,
  ...
  WHERE	a.no_remesa = b.no_remesa
	...
	AND a.fecha >= 14-7-2011
	AND year(a.fecha)      between 2011 and a_ano
