...
drop procedure sp_sis171r;
create procedure "informix".sp_sis171r(a_no_remesa char(10),a_renglon integer)
...
foreach
	...
	--call sp_sis171_3en1(_no_poliza) returning _error, _mensaje;
		if _error <> 0 then
			return _error,_mensaje;
		end if
