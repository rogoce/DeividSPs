...
--------------------------------------------
drop procedure sp_pro02ibk;
create procedure "informix".sp_pro02ibk(
a_compania		char(3),
...
returning dec(16,2),	--v_rango_inicial
		  dec(16,2),	--v_rango_final
		  smallint,		--v_cant_polizas
		  dec(16,2),	--v_prima_suscrita
          dec(16,2),	--v_prima_retenida
          smallint,		--v_cant_coasegur1
          smallint,		--v_cant_coasegur2
          char(03),		--v_codramo
          char(45),		--v_desc_ramo
          date,			--a_periodo
          char(45),		--descr_cia
          ...
          dec(16,2),	--_sum_cont
          dec(16,2),	--_sum_fac
          smallint,		--_cant_unidad
          dec(16,2),	--_sum_fac_car
		  dec(16,2),	--_prima_ret_casco
		  dec(16,2);	--_sum_ret_casco
...
on exception set _error,_error_isam,_error_desc
	...
	rollback work;
 	return 0.00,0.00,_error,0.00,0.00,0,0,'','','01/01/1900','',_error_desc,0.00,0.00,0.00,0.00,0,0.00,0.00,0.00;
end exception           

create temp table temp_ubica
	(no_poliza		char(10),				--1
	no_unidad		char(5),				--2
	suma_asegurada	dec(16,2),				--3
	prima_suscrita	dec(16,2),				--4
	prima_retenida	dec(16,2),				--5
	prima_ret_casco	dec(16,2),				--6
	sum_ret			dec(16,2) default 0,	--7
	sum_ret_casco	dec(16,2) default 0,	--8
	sum_cont		dec(16,2) default 0,	--9
	sum_fac			dec(16,2) default 0,	--10
	sum_fac_car		dec(16,2) default 0,	--11
	serie			char(4),				--12
	seleccionado	smallint  default 1,	--13
...
create temp table temp_unidad
	...
	suma_asegurada	dec(16,2),				--3
	cod_ramo		char(3),				--4
	prima_suscrita	dec(16,2),				--5
	prima_retenida	dec(16,2),				--6
	prima_ret_casco	dec(16,2),				--7
	serie			char(4),				--8
	sum_ret			dec(16,2) default 0,	--9
	sum_ret_casco	dec(16,2) default 0,	--10
	sum_cont		dec(16,2) default 0,	--11
	sum_fac			dec(16,2) default 0,	--12
	sum_fac_car		dec(16,2) default 0,	--13
	seleccionado	smallint default 1,		--14
...
create temp table temp_civil
	(cod_sucursal	char(03),			--1
	cod_ramo		char(03),			--2
	rango_inicial	dec(16,2),			--3
	rango_final		dec(16,2),			--4
	cant_polizas	smallint,			--5
	prima_suscrita	dec(16,2),			--6
	prima_retenida	dec(16,2),			--7
	prima_ret_casco	dec(16,2),			--8
	cant_coasegur1	smallint,			--9
	cant_coasegur2	smallint,			--10
	seleccionado	smallint default 1,	--11
	suma_asegurada	dec(16,2),			--12
	sum_ret			dec(16,2) default 0,	--13
	sum_ret_casco	dec(16,2) default 0,	--14
	sum_cont		dec(16,2) default 0,	--15
	sum_fac			dec(16,2) default 0,	--16
	cant_unidad		smallint,				--17
	sum_fac_car		dec(16,2) default 0,	--18
...
create temp table temp_fact
	...
	seleccionado	smallint  default 1,	--4
	suma_asegurada	dec(16,2),				--5
	sum_ret			dec(16,2) default 0,	--6
	sum_ret_casco	dec(16,2) default 0,	--7
	sum_cont		dec(16,2) default 0,	--8
	sum_fac			dec(16,2) default 0,	--9
	sum_fac_car		dec(16,2) default 0,	--10
	prima_suscrita	dec(16,2),				--11
	prima_retenida	dec(16,2),				--12
	prima_ret_casco	dec(16,2),				--13
...
set debug file to "sp_pro02i.trc";
					...
					foreach
						...
						if _tipo_contrato = 1 then
							if v_codramo = '002' then
								...
								else							--Retención Casco
									let _sum_ret_casco = _sum_ret_casco + _suma_aseg_tot;
									let _prima_ret_casco = _prima_ret_casco + _prima;
								end if
							else
								let _prima_retenida  = _prima_retenida + _prima;
								let _sum_ret = _sum_ret + _suma_aseg_tot;
...
foreach with hold
	...
	begin work;
	let _suma_aseg_tot = _sum_ret + _sum_cont + _sum_fac + _sum_fac_car + _sum_ret_casco;
