...
DROP PROCEDURE sp_che94_2011;
CREATE PROCEDURE sp_che94_2011(
a_cia               CHAR(3),
a_sucursal          CHAR(3),
a_periodo           CHAR(7),  
a_usuario           CHAR(8))
...
--SET DEBUG FILE TO "sp_che94_2011.trc";
--TRACE ON;
...
{			if _cod_agente = '02311' and _cod_tipo = '003' then --Solicitud de GS -- Román --30/03/2023
				let _pri_susc_dev_ap_2 = _pri_susc_dev_ap_2 - 10749.47;
				--let _prima_cobrada = _prima_cobrada - 10749.47;			
				let _pri_susc_aa_2 = _pri_susc_aa_2 - 10749.47;			
			end if
}			
