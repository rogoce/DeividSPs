...
drop procedure sp_par2995;

create procedure "informix".sp_par2995(a_ano char(4), a_cod_vendedor char(3) )
returning integer,
          char(50);
			...
			if _ene <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _ene_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-01";
				...
				if _total_restante < _ene then
					...
					update deivid_bo:preventas
					   set ventas_renovadas 	  	= ventas_renovadas + _resultado_total_restante
					 where cod_vendedor 			= a_cod_vendedor
					   and cod_agente 				= _cod_agente
					   and cod_ramo   				= _cod_ramo
					   and periodo 					= _ano||"-01";
			...
			if _feb <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _feb_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-02";
			...
			if _mar <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _mar_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-03";
			...
			if _abr <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _abr_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-04";
			...
			if _may <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _may_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-05";
			...
			if _jun <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _jun_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-06";
				 ...
				 select sum(ventas_renovadas) 
				  ...
				  where cod_vendedor 	= a_cod_vendedor
					and cod_ramo   		= _cod_ramo
					and periodo			= _ano||"-06"
					and cod_agente not in(select cod_agente from deivid_bo:actuario_2018 where cod_vendedor = a_cod_vendedor and cod_ramo = _cod_ramo and tipo = 'R')
					and ventas_renovadas <> 0;
			...
			if _jul <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _jul_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-07";
			...
			if _ago <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _ago_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-08";
			...
			if _sep <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _sep_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-09";
			...
			if _oct <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _oct_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-10";
			...
			if _nov <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _nov_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-11";
			...
			if _dic <> 0 then	
				if _produccion = 0 then
					...
					foreach
						...
						update deivid_bo:preventas
						   set ventas_renovadas 	= ventas_renovadas + _dic_1
						 where cod_vendedor 	= a_cod_vendedor
						   and cod_agente 		= _cod_agente
						   and cod_ramo   		= _cod_ramo
						   and periodo 			= _ano||"-12";
				...
				if _cnt_agente = 0 then
					SELECT count(*)
					 ...
					 where cod_vendedor = a_cod_vendedor 
					   ...
					   and tipo_poliza 	= '4' 
					   and cod_ramo 	= _cod_ramo
					   and cod_agente in(select cod_agente from deivid_bo:actuario_2018 where cod_vendedor = a_cod_vendedor and cod_ramo = _cod_ramo and tipo = 'R')
					   and total_2009 <> 0;	
					let _produccion = 1;
				end if
	let _resultado_total_restante = 0;
