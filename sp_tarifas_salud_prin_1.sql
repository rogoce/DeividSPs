...
foreach
	...
	foreach
		...
		if _cod_dependiente is null And _opcion = 1 then	--Opcion 1, aumenta de 31.5 a 63, que corresponde al segundo aumento
			update emiunire
		...
		if _cod_dependiente is not null then
			...
			if _opcion = 1 then	--Opcion 1, aumenta de 31.5 a 63, que corresponde al segundo aumento
				update emiderec
