...
drop procedure ap_desc_cob2;

create procedure "informix".ap_desc_cob2()
...
END EXCEPTION
    ...
    foreach	
	    ...
	    if _cont1 + _cont2 + _cont3 + _cont4 = 0 then		         
			begin
			on exception in(-239)
			end exception
	...
	foreach
	 ...
	 return 0, v_documento with resume;	
