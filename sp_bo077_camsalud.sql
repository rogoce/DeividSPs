...
drop procedure sp_bo077_camsalud;
create procedure "informix".sp_bo077_camsalud(a_fecha_ini date, a_fecha_fin date, a_no_documento char(20))
returning date, date;
...
return _vigencia_ant,_vigencia_act;
end procedure