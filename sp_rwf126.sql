...
drop procedure sp_rwf126;

create procedure sp_rwf126(a_no_reclamo char(10), a_cod_evento char(3), a_user_name_ajust CHAR(20), a_cod_cobertura CHAR(5)) 
  returning integer,
            char(50),
            char(10);
...
--set debug file to "sp_rwf126.trc";
--trace on;
