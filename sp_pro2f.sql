...
DROP procedure sp_pro02f;
CREATE procedure "informix".sp_pro02f(a_compania CHAR(3),a_agencia CHAR(03) DEFAULT "*",a_periodo DATE,a_codsucursal  CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*")
   RETURNING CHAR(20),SMALLINT,DEC(16,2),DEC(16,2),
 ...
 BEGIN
    ...
    DEFINE v_codramo,v_codsucursal,v_subramo  CHAR(3);
...
--TRACE ON;
       ...
       SELECT a.no_documento,a.no_poliza,e.prima_suscrita,e.prima_retenida,
         ...
         INTO v_documento,_no_poliza,v_prima_excedente2,v_prima_retenida,
