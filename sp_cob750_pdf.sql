...
-- execute procedure sp_cod750_pdf('02000','981327','GISELA DE LEDEZMA','ENILDA DE FERNANDEZ','SUPERVISORA DE COBROS CORPORATIVOS','SUPERVISORA DE CORREDORES',0,'GISELA','ENILDA')  --933660
DROP PROCEDURE sp_cob750_pdf;
CREATE PROCEDURE sp_cob750_pdf(a_aviso CHAR(15), a_poliza CHAR(10),a_nombre_firma1 CHAR(50),a_nombre_firma2 CHAR(50),a_cargo1 CHAR(50),a_cargo2 CHAR(50),a_callcenter INTEGER,a_usuario1 CHAR(10),a_usuario2 CHAR(10))
...
DEFINE _saldo_pdf	          DEC(16,2);
DEFINE _prima_pdf	          DEC(16,2);
DEFINE _exigible_pdf          DEC(16,2);
DEFINE _fecha_pdf             DATE;
DEFINE _estatus_pdf	          CHAR(1);
let _estatus_pdf = "";
let _saldo_pdf = 0.00;
let _prima_pdf = 0.00;
let _exigible_pdf = 0.00;
...
--set debug file to "sp_cob750.trc";
--trace on; 
FOREACH
 SELECT no_poliza,
        saldo,
...
SELECT  saldo,
  ...
  WHERE no_aviso  = a_aviso
    AND no_poliza = a_poliza;
		 ...
		 let _saldo = _saldo_pdf;
		 let _prima = _prima_pdf;
		 let _exigible = _exigible_pdf;			
