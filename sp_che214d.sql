-- Reporte de las bonificaciones de 1% web por Corredor - Detallado

-- Creado    : 24/02/2015 - Autor: Armando Moreno

-- SIS v.2.0 - d_cheq_sp_che03_dw1 - DEIVID, S.A.

--DROP PROCEDURE sp_che214d;

CREATE PROCEDURE sp_che214d(a_compania CHAR(3), a_cod_agente CHAR(5) default '*', a_periodo char(7)) 
