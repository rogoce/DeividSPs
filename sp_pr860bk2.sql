...
------------------------------------------------
--DROP PROCEDURE sp_pr860bk2;
CREATE PROCEDURE sp_pr860bk2(a_compania CHAR(03),a_agencia CHAR(03),a_periodo1 CHAR(07),a_periodo2 CHAR(07),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo  CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codusuario CHAR(255) DEFAULT "*",a_codramo  CHAR(255) DEFAULT "*",a_reaseguro   CHAR(255) DEFAULT "*"	)
...
FOREACH 
	select cod_ramo,
	  ...
	  from temp_produccion
		...
		ON EXCEPTION IN(-239)
		END EXCEPTION
			INSERT INTO temp_siniestro (cod_ramo,cod_contrato,serie,monto)	
			VALUES (v_cod_ramo,v_cod_contrato,_serie,_siniestro);
		END}
