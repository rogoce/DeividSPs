drop procedure sp_actuario21_c;
create procedure sp_actuario21_c(a_id_mov_reas1 integer, a_id_mov_reas2 integer, a_id_reas_caract integer)
...
foreach --with hold
	...
	insert into deivid_ttcorp:reas_caract_pri_c(
			id_reas_caract,    
			tip_contrato,   
			cod_concepto, 
			mto_concepto,
