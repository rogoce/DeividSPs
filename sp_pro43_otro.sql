...
if _cnt > 0 and _cod_endomov not in('015','024','032','033','034','031') and a_no_poliza <> '001187729' and _no_doc <> '2321-00017-01' and _no_doc <> '2322-00027-01'
            and _no_doc <> '2318-00067-01' and _no_doc <> '2320-00036-01' and _no_doc <> '0213-04424-01' and _no_doc <> '0221-01317-01' and _no_doc <> '2319-00077-01' and _no_doc <> '0213-91790-47' then --015=endoso descriptivo
...
BEGIN
	...
	END IF
END
if _tipo_mov = 30 then
	let _error = sp_pro1017(a_no_poliza, a_no_endoso);
end if
if _tipo_mov = 31 then
	call sp_pro4956a(a_no_poliza);
end if
if _tipo_mov = 2 then
	call sp_cob310(a_no_poliza, a_no_endoso) returning _error, _mensaje;
	if _error <> 0 then 
		return _error, _mensaje;
	end if
end if
