...
drop procedure sp_che67a;

create procedure sp_che67a()
 returning char(10),
		   char(10),
		   char(100),
		   dec(16,2),
...
foreach
 select	no_requis,
  ...
  where anulado         = 0
	...
	and pagado			= 1
	and en_firma        = 2
	and fecha_impresion = "03/01/2007"
	and no_cheque 		> 10440

--	and fecha_impresion between  "25/07/2006" and "28/07/2006"

--	and fecha_impresion = "28/08/2006"

--	and no_cheque not between 5715 and 5756
	

{if _no_cheque = 5334 or _no_cheque = 5335 then
else
	update rectrmae
	   set pagado = 0
