...
DROP PROCEDURE sp_atc01c;

CREATE PROCEDURE sp_atc01c(a_compania CHAR(3),a_sucursal CHAR(3),a_ano integer, a_usuario CHAR(10), a_agente VARCHAR(255), a_membrete smallint default 0)
