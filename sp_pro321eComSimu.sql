...
drop procedure sp_pro321eComSimu;

create procedure sp_pro321eComSimu(a_no_poliza char(10), a_no_poliza_ant char(10))
returning  integer;
...
--if a_no_poliza_ant = '0002926382' then
...
--		end if
		...
		if _cod_prod = '03138' then -- 03138 - TARIFAS BASICAS PARA TAXIS (NUEVO 2016) -- Amado 30-05-2025 -- Se agregan 2 más 10461 y 10288 -- Amado 04-09-2025
			if _cnt_ren = 1  then
				let _resultado = 1;
		...
		elif _cod_prod in ('10461','10288') then -- Se agregan 2 más 10461 y 10288 -- Amado 04-09-2025
			if _cnt_ren = 1  then
				let _resultado = 1;
			elif _cnt_ren >= 2 then
				let _resultado = 3;
...
--		   and _resultado between ano_desde and ano_hasta;
		...
		-- Prueba Amado 03-04-2025
		--if _ld_porc_depr = 25 then
...
{		let _cnt_lote = 0;
		...
		foreach
            ...
            if _cod_cobertura not in ('00907','01030','01141') and _cnt_end_mu = 0 then	-- No sea asistencia vial		
			    ...
			    -- Cuando sea Asistencia Vial se busca la nueva prima para pólizas comerciales -- Amado 12-09-2024
