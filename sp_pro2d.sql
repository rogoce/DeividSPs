...
DROP procedure sp_pro02d;
CREATE procedure "informix".sp_pro02d(a_compania CHAR(3),a_agencia CHAR(03) DEFAULT "*",a_periodo DATE,a_codsucursal  CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*")
   RETURNING SMALLINT,DEC(16,2),DEC(16,2),
