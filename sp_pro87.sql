...
DROP procedure sp_pro87;
CREATE procedure "informix".sp_pro87(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codramo CHAR(255))
    ...
    IF a_codramo = "*" THEN
	   FOREACH WITH HOLD
          SELECT  d.no_poliza,d.no_documento,d.no_factura,d.sucursal_origen,
                  ...
                  d.cod_contratante,d.vigencia_inic,d.vigencia_final,d.fecha_suscripcion,
                  d.user_added,d.suma_asegurada,d.fecha_cancelacion, b.no_endoso
             INTO _no_poliza,_no_documento,_no_factura,v_cod_sucursal,
                  v_cod_grupo,v_cod_ramo,v_cod_subramo,v_cod_tipoprod,
                  v_contratante,v_vigencia_inic,v_vigencia_final,v_fecha_suscrip,
                  v_usuario,v_suma_asegurada,_fecha_cancelacion,_no_endoso
             FROM emipomae d, endedmae b
