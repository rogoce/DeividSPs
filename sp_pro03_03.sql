...
DROP procedure sp_pro03_03;
CREATE procedure "informix".sp_pro03_03(
		 a_cia 	   CHAR(03),
		 a_agencia CHAR(3),
		 a_periodo DATE,
		 a_codramo CHAR(255)
...
--              AND d.fecha_suscripcion >= "01/03/2011"
              AND d.vigencia_inic     < a_periodo
              AND d.actualizado = 1
--			  AND d.no_poliza = '540025' -- '537942'
...
{			 IF  _fecha_emision < "01/03/2011" THEN
				CONTINUE FOREACH;
			 END IF}
