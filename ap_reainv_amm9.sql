...
drop procedure ap_reainv_amm9;
create procedure ap_reainv_amm9()
returning	integer;
...
foreach
	...
	select distinct emi.no_poliza, fac.no_endoso, emi.no_documento, fac.no_endoso, rea.no_unidad, fac.periodo
	  into _no_poliza_c, _no_endoso, _no_documento, _cod_endomov, _no_unidad, _periodo
	  from emipomae emi
...
--COBROS
foreach
	select distinct emi.no_poliza, fac.no_remesa, fac.periodo, emi.no_documento, fac.renglon
	  into _no_poliza_c, _no_remesa, _periodo, _no_documento, _renglon
	  from emipomae emi
...
foreach
	select distinct emi.no_poliza, fac.no_requis, fac.periodo, emi.no_documento
	  into _no_poliza_c, _no_tranrec, _periodo, _no_documento
	  from emipomae emi
