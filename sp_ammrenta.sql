...
--DROP PROCEDURE sp_ammrenta;

CREATE PROCEDURE sp_ammrenta(
a_compania          CHAR(3),
a_sucursal          CHAR(3),
...
foreach
	SELECT cod_agente
     ...
     WHERE periodo = a_periodo
	   and cod_agente = '00873'
	 GROUP BY cod_agente
	 ORDER BY cod_agente

 	call sp_che98(a_compania,a_sucursal,_cod_agente,'ZULEYKA','001','001',a_periodo) returning _error;
