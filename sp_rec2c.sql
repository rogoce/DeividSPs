-- Reporte de Reclamos Pendientes por Grupo
-- 
...
--
-- SIS v.2.0 - d_sp_rec02c_dw3 - DEIVID, S.A.

DROP PROCEDURE sp_rec02c;

CREATE PROCEDURE "informix".sp_rec02c(a_compania CHAR(3),a_agencia CHAR(3),a_periodo CHAR(7),a_sucursal	CHAR(255) DEFAULT "*",a_ajustador CHAR(255) DEFAULT "*",a_grupo CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*", a_agente CHAR(255) DEFAULT "*") 
