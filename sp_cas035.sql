...
-- Sin Incluir el Periodo en que se Tira
-- Esto es para poder determinar las Metas del Call Center
-- 
...
drop procedure sp_cas035;

create procedure "informix".sp_cas035(
a_compania     char(3), 
a_sucursal     char(3), 
...
-- Suma las Facturas Negativas --Modificado 07/06/2017
{
LET _prima_bruta  = 0;
LET _monto        = 0;
...
-- Realiza la Aplicacion de los Recibos a los Montos Mas Viejos de las Facturas
