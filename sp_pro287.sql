   DROP procedure sp_pro287;
   CREATE procedure "informix".sp_pro287(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7))
...
--Crea tabla temp_ramo
		  -- CALL sp_pr94a(); ahorra llama al sp_pro300.sql
--		  -- CALL sp_pr94a();
...
------------CALL sp_pro178b( new procedure create
CALL sp_pro287(
a_cia,
a_agencia,
a_periodo,
