...
--DROP PROCEDURE sp_rec159;

CREATE PROCEDURE "informix".sp_rec159(a_no_documento char(20), a_no_unidad char(5), a_asegurado char(10))
...
--SET DEBUG FILE TO "sp_rec159.trc";
--trace on;
...
if a_asegurado = "*" then
	...
	let a_asegurado = _cod_asegurado;
end if
   ...
   foreach
		SELECT no_aprobacion,
		 ...
		 WHERE no_documento   = a_no_documento
		   AND cod_reclamante = a_asegurado
