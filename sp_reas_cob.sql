...
drop procedure sp_reas_cob;
create procedure "informix".sp_reas_cob(a_no_remesa char(10), a_renglon integer)
returning	integer,
			char(100);
...
let _prima_tot = _prima;
	...
	foreach
		...
		select count(*) --saber si existe para contrato y ramo cobertura de terremoto
		  into _cnt_existe
...
elif (a_no_remesa = '1246633' and a_renglon in (109)) then
	delete from tmp_reas
	 where cod_cober_reas = '021'
