...
-- *********************************
DROP PROCEDURE sp_aud18_am;
create procedure sp_aud18_am(a_db char(18), a_fecha1 date, a_fecha2 date) 
...
ELSE
	call sp_aud17_am(a_db, a_fecha1, a_fecha2 ) returning _error, _error_desc;
END IF
