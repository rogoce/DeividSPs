...
------------------------------------------------
drop procedure sp_pro1108a;
create procedure sp_pro1108a(a_periodo char(7),
...
let _cust_qry2 = "from emicartasal5 a, emipomae b, cliclien c, cligrupo d, cliclien e, genpais f, genprov g ";
...
let _cust_qry4 = " and a.no_documento like ?) and (b.estatus_poliza not in (2,4)) and (b.renovada = 0) and (d.cod_grupo MATCHES ? ) ";
...
OPEN cust_cur USING _fecha_desde, _fecha_hasta, a_imp1, a_imp2, a_envi1, a_envi2, a_envi3, a_envi4, a_poliza, a_grupo;
