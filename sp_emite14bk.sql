...
define _error					smallint;
	...
	foreach
		select emi.no_poliza,
		  ...
		  from emipomae emi
		 inner join emipouni uni on uni.no_poliza = emi.no_poliza
		 inner join tmp_productos tmp on tmp.cod_producto = uni.cod_producto
		 where emi.cod_contratante = _cod_contratante
		 order by tmp.cod_producto
		...
		update tmp_poliza_mae
		   set no_poliza = _no_poliza,
			   ...
			   cod_contratante = _cod_asegurado,
