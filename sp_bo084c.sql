...
CREATE INDEX xie03_tmp_dev1 ON tmp_dev1(cod_agente);
...
foreach
	 select no_documento,
	  ...
	  group by no_documento
		...
		let _cod_ramo = '0' || _no_documento[1,2];
	   ...
	   foreach
		...
		foreach
			...
			LET _prima_susc_agt = _pri_dev_aa / 100 * _porc_agte; 
				...
				--INSERT DE tmp_dev1
		    insert into tmp_dev1(no_documento, pri_dev_aa, no_poliza, cod_ramo, cod_subramo, cod_agente, cod_grupo,cod_tipoveh)
			values (_no_documento, _prima_susc_agt, _no_poliza, _cod_ramo, _cod_sub_ramo, _cod_agente, _cod_grupo,_cod_tipoveh);
