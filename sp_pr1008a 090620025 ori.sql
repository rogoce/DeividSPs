...
suma_ret		dec(16,2),
suma_cont_cp	dec(16,2),
suma_cont_exc	dec(16,2),
		...
		if _flag = 1 then
			...
			if _tipo_cont = 2 or _tipo_cont = 1 then
				if _tipo_cont = 1 then		--	retencion
					...
					if v_cobertura not in ('045','047','048') then
		...
		foreach
			...
			begin
				on exception in(-239)
					update tmp_tabla
					   set cant_polizas   = cant_polizas   + 1,
						   ...
						   suma_cont_cp   = _suma_cont_cp * v_porcentaje/100,
						   suma_cont_exc  = _suma_cont_exc * v_porcentaje/100,
						   suma_ret 	  = _suma_ret * v_porcentaje/100,
						   suma_facult    = _suma_facult * v_porcentaje/100,
						--   suma_cont_cp   = suma_cont_cp	+ _suma_cont_cp * v_porcentaje/100,
						--   suma_cont_exc  = suma_cont_exc	+ _suma_cont_exc * v_porcentaje/100,
						--   suma_ret 	  = suma_ret		+ _suma_ret * v_porcentaje/100,
						--   suma_facult    = suma_facult		+ _suma_facult * v_porcentaje/100,
				...
				values(	_no_documento, 
						...
						_suma_cont_cp * v_porcentaje/100,
						_suma_cont_exc * v_porcentaje/100,
						_suma_ret * v_porcentaje/100,
						_suma_facult * v_porcentaje/100,
