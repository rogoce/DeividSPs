...
drop procedure sp_actuario19c;
create procedure "informix".sp_actuario19c()
...
foreach with hold
	...
	select ramo_ttcorp
	  into _cod_ramorea
	  from deivid_ttcorp:tmp_ramorea
	...
	foreach
		...
		if _id_mov_tecnico_new is null or _id_mov_reas_new is null then
			continue foreach;
		end if
