...
--execute procedure sp_rea22b_new('001','001','2016-07','2017-03','*','*','001,003,005,006,007,009,010,012,011,013,014,015,017,021,022;','2016,2015,2014,2013,2012,2011,2010,2009,2008;','*')

drop procedure sp_rea22b_new;
create procedure 'informix'.sp_rea22b_new(
a_compania	char(3),
a_agencia	char(3),
a_periodo1	char(7),
a_periodo2	char(7),
