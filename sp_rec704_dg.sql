...
FOREACH
 SELECT a.no_reclamo,
   ...
   INTO _no_reclamo,
	    ...
	    _reserva_total,
		_no_tranrec
   FROM rectrmae a,rectitra b, recrcmae e
  WHERE a.cod_tipotran = b.cod_tipotran
    AND a.no_reclamo = e.no_reclamo
    AND a.cod_compania = a_compania
    AND a.actualizado  = 1
    AND e.no_documento = '1819-99900-01'
