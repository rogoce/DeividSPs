...
DROP PROCEDURE ap_atc01b;
CREATE PROCEDURE ap_atc01b(a_compania CHAR(3),a_sucursal CHAR(3),a_ano integer, a_usuario CHAR(10), a_agente VARCHAR(255), a_membrete SMALLINT DEFAULT 0)
...
--		    AND year(y.fecha_impresion) = a_ano 
            AND y.fecha_impresion >= '01-01-2021'
            AND y.fecha_impresion <= '31-05-2021'	   
		    AND y.pagado = 1
	     	AND y.anulado = 0  
