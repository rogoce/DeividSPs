DROP procedure sp_pro98h;

CREATE procedure "informix".sp_pro98h(a_cia CHAR(3),a_agencia CHAR(3),a_codsucursal CHAR(255) DEFAULT "*",a_periodo1 CHAR(7),a_periodo2 CHAR(7))
RETURNING CHAR(50), 	 --1 cia					 v_descr_cia,			 
		  ...
		  SMALLINT,	     --23 estatus poliza		 v_estatus,
...
--SET DEBUG FILE TO "sp_pro98h.trc"; 
--trace on;
