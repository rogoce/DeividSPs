...
drop procedure sp_rec14am;
create procedure sp_rec14am(a_compania	char(3),a_agencia	char(3),a_periodo1	char(7),a_periodo2	char(7),a_origen	char(3) default "%")
returning smallint;
...
salv_y_recup		dec(16,2) default 0 not null,
var_reserva         dec(16,2) default 0 not null,
cnt_incurrido       int       default 0) with no log;
