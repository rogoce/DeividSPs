...
create procedure sp_pr991(a_compania char(03), a_periodo1 char(07), a_periodo2	char(07), a_agente	char(255) default "*", a_tipo char(2) default "01")
returning	char(7),
			char(7),
			smallint,
			char(50),
...
if a_tipo = "01" then 
   ...
   let s_tipo =	"Auto-Casco Prima Suscrita";
elif a_tipo = "12" then
   let s_tipo =	"Vida Prima Suscrita";
end if
...
if a_tipo = "03" or a_tipo = "02" or a_tipo = "11" or a_tipo = "12" then --50%mapfre-runoff
	let s_renglon =	0 ;
	let s_debito  =	0 ;
	let s_credito =	0 ;
	...
	foreach
	  ...
	  order by cod_coasegur,
			...
			select trim(nombre),
			 ...
			 let _nom_contrato = "";
			 if s_cod_clase = '007' then
				let _nom_contrato = 'CUOTA PARTE';
			elif s_cod_clase = '016' then
