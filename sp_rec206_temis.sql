...
drop procedure sp_rec206_temis;		
create procedure "informix".sp_rec206_temis( a_no_tramite char(10))
returning	char(3),						--1  
			char(3),						--2  
			char(3),						--3  
			char(10),						--4  
...
--set debug file to "sp_rec206_temis.trc";
---trace on;
