...
--DROP PROCEDURE sp_atc01bbk;
CREATE PROCEDURE sp_atc01bbk(a_compania CHAR(3),a_sucursal CHAR(3),a_ano integer, a_usuario CHAR(10), a_agente VARCHAR(255), a_membrete SMALLINT DEFAULT 0)
	...
	FOREACH
		 SELECT	x.cuenta,
		  ...
		  WHERE x.no_requis = y.no_requis
		    ...
		    AND (y.cod_agente  in(SELECT cod_agente
	                                 FROM agtagent
 	                                 WHERE agente_agrupado = '01068')--= _codigo
