-- Modificado    : 18/02/2019 - Autor: Henry Giron , se anexa sector y tipo de fianza CASO: 30528 USER: ABMORENO 
...
returning	char(3)			as cod_ramo,
			...
			char(100)       as sector,       -- sector
			char(100)       as tipo_fianza,
			dec(16,2)       as diferencia_cedido;	 -- tipo de fianza		
...
{	if _flag = 0 then -- si hay diferencia que se muestre y así reversar el asiento de la factura con diferencia -- Amado 8-1-2021
		let _tot_prima_sus = _tot_prima_sus - _dif_cedido;
		let v_cedido = v_cedido - _dif_cedido;
