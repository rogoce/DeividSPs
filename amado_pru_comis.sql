...
returning char(10), char(5), dec(16,2), date;
--}
...
on exception set _error
	return _error, _cod_agente,0.00,current;
end exception
...
{    DELETE FROM chqchdes WHERE no_requis = _no_requis;
 ...
 {   UPDATE agtagent
  ...
  return _no_requis, _cod_agente, _monto, _fecha_ult_comis with resume;
END FOREACH
end
