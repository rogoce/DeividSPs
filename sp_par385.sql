...
Drop procedure sp_par385; 
CREATE PROCEDURE "informix".sp_par385(  
a_secuencia	INTEGER 
...
Let  _html_body2 = trim(_html_body2) ||'				los costos m&eacute;dicos-hospitalarios, hace insostenible el mantenimiento de su prima actual, y por lo cual nos vemos en la necesidad de aumentar ';
...
Let  _html_body2 = trim(_html_body2) ||'				La Red Anc&oacute;n Premier Care es una red premium de alcance nacional en todas las especialidades m&eacute;dicas y cl&iacute;nicas afiliadas, donde podr&aacute; elegir entre las ';
...
if _con_opcion = 1 then

	Let  _html_body3 = trim(_html_body3) ||'				Reconocemos que este cambio puede resultar inesperado, pero es necesario para mantener la calidad y la ';

	Let  _html_body3 = trim(_html_body3) ||'				efectividad de las coberturas contenidas en su programa de seguro. Es por ello que, pensando en Ud., le estaremos ';

	Let  _html_body3 = trim(_html_body3) ||'				remitiendo por separado a trav&eacute;s de su corredor de seguros, nuevas alternativas que puedan ajustarse a su presupuesto, sin desmejorar la ';

	Let  _html_body3 = trim(_html_body3) ||'				calidad y protecci&oacute;n de las coberturas en su plan actual.  Queremos asegurarle que su ';

	Let  _html_body3 = trim(_html_body3) ||'				lealtad y confianza son de gran valor para nosotros y en este caso, su corredor o nuestro departamento ';

	Let  _html_body3 = trim(_html_body3) ||'				de comercializaci&oacute;n con todo gusto le ampliar&aacute; los detalles que considere pertinente. ';

else

	Let  _html_body3 = trim(_html_body3) ||'				Reconocemos que este cambio puede resultar inesperado, pero resulta necesario para as&iacute; mantener la calidad y la ';

	Let  _html_body3 = trim(_html_body3) ||'				efectividad de las coberturas contenidas en su programa de seguro.  Queremos asegurarle que su ';
...
Let  _html_body3 = trim(_html_body3) ||'				Agradecemos sinceramente su comprensi&oacute;n y deseamos seguir siendo su aseguradora de confianza en materia de seguros de salud ';

Let  _html_body3 = trim(_html_body3) ||'				durante muchos a&ntilde;os m&aacute;s.  Adem&aacute;s, nos comprometemos a seguir proporcionando la mejor cobertura y respaldo para usted. ';

Let  _html_body3 = trim(_html_body3) ||'</p>';

Let  _html_body3 = trim(_html_body3) ||'<p>Para cualquier consulta adicional, quedamos a su disposici&oacute;n en los siguientes contactos: </p>';
