...
--************************************************************************************************************
--execute procedure sp_bono12_1('001','001')    -- backup estructura   bono2_comerc2

drop procedure sp_bono12_1;
create procedure sp_bono12_1(a_compania char(3), a_sucursal char(3))
...
let _per_fin_aa = '2018-12';    -- para cargar tabla bono2_comerc  del 4 trimestre  OCTUBRE - DICEIMBRE 2018
...
let _per_ini      = '2018-10';      -- para cargar tabla bono2_comerc  del 4 trimestre  OCTUBRE - DICEIMBRE 2018
...
if _per_fin_aa > '2018-12' then
	let _per_fin_aa = '2018-12';
end if
...
let _ano            = _per_fin_aa[1,4];		  --2017
let _ano            = _ano - 1;				  --2016
let _per_fin_ap     = _ano || _per_fin_aa[5,7]; --2016-01

-- Diciembre
let _per_fin_dic    = _per_fin_ap[1,4] || '-12'; --2016-12
...
let _fecha_aa     = sp_sis36(_per_fin_aa);  -- último día del periodo actual
let _fecha_ap     = sp_sis36(_per_fin_ap); --último día del periodo final del año pasado

set isolation to dirty read;

{drop table if exists t_bono2_comerc;
select *
  from bono2_comerc
  into temp t_bono2_comerc;}

delete from bono2_comerc
 where periodo between _per_ini and _per_fin_aa;
 
delete from fisc2_bono;
...
foreach
	...
	insert into fisc2_bono(no_documento, pri_pag_aa,tipo,nueva_renov,periodo)
...
foreach
	...
	insert into fisc2_bono(no_documento, pri_pag_ap,tipo,nueva_renov,periodo)
...
insert into fisc2_bono(no_documento, pri_sus_aa,nueva_renov,periodo)
...
--**********************************************************************************************
insert into fisc2_bono(no_documento, pri_sus_ap,nueva_renov,periodo)
select p.no_documento,
	   b.pbs_nueva_neto,
	   p.nueva_renov,
	   e.periodo
...
foreach
	...
	insert into fisc2_bono(no_documento, sin_pag_aa,nueva_renov,periodo)
...
foreach 
	...
	insert into fisc2_bono(no_documento, sin_pen_ap,nueva_renov)
...
foreach 
	...
	insert into fisc2_bono(no_documento, sin_pen_aa,nueva_renov)
...
foreach
	...
	let _flag = 0;
	let _error = sp_sis101a(_no_documento,'31/12/2017','31/12/2017',my_sessionid);	--Crea tabla con el corredor con_corr
