...
drop procedure sp_cob232bk2;

create procedure "informix".sp_cob232bk2(a_no_caja char(10))
returning char(10),
          char(1),
          char(30),
          char(50),
...
SET DEBUG FILE TO "sp_cob232bk2.trc";
trace on;
