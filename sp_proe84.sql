...
--   Prima Suscrita detallado por serie                  --
--   Realizado por: HENRY GIRON  15/03/2016              --
--   execute procedure sp_proe84("001","001","2012-01","2012-03","*","*","*","*","001,003;","*","*","2008,2009,2010,2011,2012;","*")
-----------------------------------------------------------
drop procedure sp_proe84;
create procedure sp_proe84(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
...
returning	char(3)		as Cod_Ramo,
			...
			dec(16,2)	as Cont_Casco,
			dec(16,2)	as Cont_otros,
			smallint    as Serie;
...
p_cont_otros		dec(16,2),
p_cont_casco	dec(16,2),
primary key (serie,cod_ramo)) with no log;
...
foreach
	...
	foreach					 -- se desglosa por tipo, buscar primero si es bouquet
		...
		let v_prima_tipo = 0;
		let v_prima2 = 0;
		let _prima_total = v_prima_1 + _ret_casco + v_prima_ot + _sum_fac_car + v_prima_bq + v_prima_3 + _cob_otros + _cont_casco + _cont_cob_otros;
	--end foreach
				...
				on exception in(-239)
				   update tmp_tabla
					  set cant_polizas   = cant_polizas   + 1,
						  ...
						  p_cont_casco    = p_cont_casco    + _cont_casco * v_porcentaje/100,
						  p_cont_otros 	 = p_cont_otros	  + _cont_cob_otros * v_porcentaje/100
