...
drop procedure sp_rec206b;		
create procedure "informix".sp_rec206b(a_no_documento varchar(21), a_no_unidad char(5), a_fecha_siniestro date, a_hora datetime hour to second, a_estado char(1))
returning	integer;
