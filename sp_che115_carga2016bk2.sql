...
--Creado 11/04/2016	Armando Moreno M.

DROP PROCEDURE sp_che115_carga2016;
CREATE PROCEDURE sp_che115_carga2016(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
foreach
	 ...
	 select cod_grupo,cod_ramo, cod_pagador, cod_contratante, cod_tipoprod, sucursal_origen, cod_subramo
 	   into _cod_grupo,_cod_ramo,_cod_pagador,_cod_contratante,_cod_tipoprod,_cod_agencia,_cod_subramo
	   from emipomae
	  where no_poliza = _no_poliza;
