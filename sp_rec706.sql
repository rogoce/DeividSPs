...
create procedure "informix".sp_rec706(
a_compania	char(3),
a_agencia	char(3),
a_periodo1	char(7),
a_periodo2	char(7),
...
foreach
	select no_reclamo,           
	  ...
	  FROM tmp_contrato1
	 WHERE seleccionado = 1
	 group by no_reclamo,transaccion,no_poliza,cod_ramo,periodo,numrecla,pagado_bruto,incurrido_bruto,serie_char,pagado_neto,incurrido_neto
