...
DROP procedure sp_pro04;
   CREATE procedure "informix".sp_pro04(a_compania CHAR(3),a_agencia CHAR(255) DEFAULT "*",a_periodo DATE,a_codsucursal CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*")
   RETURNING DEC(16,2),DEC(16,2),INT,DEC(16,2),
             DEC(16,2),INT,CHAR(03),CHAR(45),DATE,
             CHAR(45),CHAR(255),dec(16,2),dec(16,2);
...
----------------------------------------------
    ...
    DEFINE v_unidades,unidades1,unidades2          integer;
    ...
    DEFINE v_cant_polizas,tot_cant                 integer;
