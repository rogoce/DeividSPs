...
Drop procedure sp_par356; 
CREATE PROCEDURE "informix".sp_par356(  
a_secuencia	INTEGER 
...
Let  _html_body1 = trim(_html_body1) ||'             Aseguradora Anc&oacute;n S.A., le da la m&aacute;s cordial bienvenida, agradecemos la confianza que ha depositado en nosotros en';
Let  _html_body1 = trim(_html_body1) ||'             ofrecerles el mejor servicio, reiteramos nuestro compromiso en satisfacer sus necesidades de forma eficiente y oportuna,';
...
Let  _html_body3 = trim(_html_body3) ||'             <a href="https://forms.office.com/Pages/ResponsePage.aspx?id=iEoE-rfND0GbV6CST6EclUWEk2UOYpBPux2RK6IxZwJUMkYzQks5Wk5RQTFFSTJLSzE3N1lNWThTVS4u">Haz Click Aqu&iacute;</a></p>';
--Let  _html_body3 = trim(_html_body3) ||'             <p>';
