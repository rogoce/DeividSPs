DROP procedure sp_rec06d;
CREATE procedure "informix".sp_rec06d(a_compania CHAR(3),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo
CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",a_codsubramo CHAR(255) DEFAULT "*",a_codtipoveh CHAR(255) DEFAULT "*")

RETURNING CHAR(50),CHAR(5),CHAR(50),CHAR(3),CHAR(50),CHAR(3),CHAR(50),
          DECIMAL(16,2),DECIMAL(16,2),SMALLINT,SMALLINT,SMALLINT,
          CHAR(7),CHAR(7),CHAR(255),DECIMAL(16,2);

---------------------------------------------
---ANALISIS DE RECLAMOS POR GRUPO/SUBRAMO ---
---  Yinia M. Zamora - agosto 2000 - YMZM
---  Ref. Power Builder - d_sp_rec06d
---------------------------------------------
BEGIN
    ...
    DEFINE v_rec_abierto,v_rec_cerrado,no_trans,v_tranreclamo  INTEGER;
    ...
    FOREACH
      ...
      RETURN v_descr_cia,v_cod_ramo,v_desc_ramo,v_cod_subramo,
             v_desc_subramo,v_cod_tipoveh,v_desc_tipveh,
             v_incurrido_bruto,v_incurrido_neto,
             v_rec_abierto,v_rec_cerrado,v_tranreclamo,
             a_periodo1,a_periodo2,v_filtros,v_incurrido_abierto WITH RESUME;
