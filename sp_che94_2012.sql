...
--***********************************************************************************
-- Este es el procedimiento realiza el pase a charenta NEGOCIO 2012 - Realizado: 14/03/2013 Armando Moreno
-- execute procedure sp_che94_2011("001","001","2011-12","HGIRON")
-- Ultima Modificacion: 23/01/2012 - Autor: Henry Giron
-- SIS v.2.0 - DEIVID, S.A.
--DROP PROCEDURE sp_che94_2012;
CREATE PROCEDURE sp_che94_2012(
a_cia               CHAR(3),
a_sucursal          CHAR(3),
a_periodo           CHAR(7),  
a_usuario           CHAR(8))
