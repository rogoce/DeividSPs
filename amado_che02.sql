...
--DROP PROCEDURE amado_che02;

CREATE PROCEDURE amado_che02(
a_compania          CHAR(3),
a_sucursal          CHAR(3),
a_fecha_desde       DATE,   
a_fecha_hasta       DATE,   
...
FOREACH
 SELECT	d.no_poliza,
  ...
  WHERE	d.cod_compania     = a_compania
	...
	IF _incobrable = 1 OR _cod_ramo <> '018' THEN
	   CONTINUE FOREACH;
	END IF
	...
	FOREACH
	 SELECT no_poliza,
	  ...
	  WHERE no_requis = _no_requis
		...
		IF _incobrable = 1 OR _no_documento[1,2] <> "18" THEN
		   CONTINUE FOREACH;
		END IF
