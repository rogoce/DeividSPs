   DROP procedure sp_pro85;
   CREATE procedure "informix".sp_pro85(a_cia CHAR(03),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_codsucursal CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*")
...
---            POLIZAS VIGENTES          ---
---  Amado Perez - Dic 2001 - 
---  Ref. Power Builder - d_sp_pro85
--------------------------------------------
...
--    CALL sp_pro83(a_cia,a_agencia,a_periodo,a_codramo) RETURNING v_filtros;
    LET v_filtros = sp_pro26(a_cia,a_agencia,a_periodo1,a_periodo2,a_codsucursal,a_codramo);
