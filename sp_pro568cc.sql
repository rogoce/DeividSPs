...
drop procedure sp_pro568cc;
create procedure "informix".sp_pro568cc(
a_compania  	char(3), 
a_agencia   	char(3), 
a_periodo1  	char(7),
a_periodo2  	char(7),
...
a_reaseguro 	char(255) default "4;Ex",
a_agente    	char(255) default "*",
a_saldo_cero    smallint  default 3,
a_cod_cliente   char(255) default "*",
a_no_documento  char(255) default "*",
a_opcion_renovar smallint default 2,
...
-- Tabla Temporal tmp_vence
create temp table tmp_vence(
no_poliza       char(20)  not null,
nueva_renov     char(1)   not null,
...
create index iend1_tmp_vence on tmp_vence(cod_ramo);
create index iend2_tmp_vence on tmp_vence(cod_grupo);
create index iend3_tmp_vence on tmp_vence(sucursal_origen);
create index iend4_tmp_vence on tmp_vence(tipo_produccion);
create index iend5_tmp_vence on tmp_vence(cod_agente);
create index iend6_tmp_vence on tmp_vence(user_added);
...
if a_opcion_renovar	= 2 then --todas las polizas
	...
	foreach with hold
		...
		-- Insercion / Actualizacion a la tabla temporal tmp_vence
       BEGIN
          ON EXCEPTION IN(-239)
          END EXCEPTION
    		insert into tmp_vence(
                    no_poliza,
                    nueva_renov,
    				sucursal_origen,
    				cod_grupo,
