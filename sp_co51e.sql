...
DROP PROCEDURE sp_co51e;

CREATE PROCEDURE "informix".sp_co51e(
a_compania     CHAR(3),
a_sucursal     CHAR(3),
a_documento    CHAR(20),
a_fecha        DATE,
...
-- Selección de código de cliente

	LET _no_poliza_sp = sp_sis21(a_documento);

	SELECT cod_contratante
	 INTO  _cod_cliente
	FROM  emipomae
	WHERE no_poliza = _no_poliza_sp;
