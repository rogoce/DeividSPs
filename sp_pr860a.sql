...
------------------------------------------------
DROP PROCEDURE sp_pr860a;
CREATE PROCEDURE sp_pr860a(a_compania CHAR(03),a_agencia CHAR(03),a_periodo1 CHAR(07),a_periodo2 CHAR(07),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo  CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codusuario CHAR(255) DEFAULT "*",a_codramo  CHAR(255) DEFAULT "*",a_reaseguro   CHAR(255) DEFAULT "*"	)
RETURNING smallint;
...
--	 DELETE FROM temphg where anio = _anio_reas and trimestre = _trim_reas and borderaux = _borderaux ;     -- Elimina borderaux datos
    ...
    { CALL sp_pro307a(a_compania,a_agencia,a_periodo1,a_periodo2,a_codsucursal,a_codgrupo,
	...
	-- Cargar el Incurrido
     ...
     CREATE TEMP TABLE tmp_produccion1
               (cod_ramo         CHAR(3),
			    cod_subramo		 char(3),
				cod_origen		 char(3),
                cod_contrato     CHAR(5),
   ...
   {  CREATE TEMP TABLE tmp_produccion2
               (cod_ramo         CHAR(3),
			    cod_subramo		 char(3),
				cod_origen		 char(3),
                cod_contrato     CHAR(5),
...
CREATE INDEX idx1_tmp_produccion1 ON tmp_produccion1(cod_ramo);
CREATE INDEX idx2_tmp_produccion1 ON tmp_produccion1(cod_subramo);
CREATE INDEX idx3_tmp_produccion1 ON tmp_produccion1(cod_origen);
CREATE INDEX idx4_tmp_produccion1 ON tmp_produccion1(cod_contrato);
CREATE INDEX idx5_tmp_produccion1 ON tmp_produccion1(cod_cobertura);
CREATE INDEX idx6_tmp_produccion1 ON tmp_produccion1(desc_cob);
CREATE INDEX idx7_tmp_produccion1 ON tmp_produccion1(cod_coasegur);
CREATE INDEX idx8_tmp_produccion1 ON tmp_produccion1(no_poliza);
