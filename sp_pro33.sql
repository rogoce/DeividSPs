DROP procedure sp_pro33;
CREATE procedure "informix".sp_pro33(a_compania CHAR(03),a_agencia CHAR(03),a_periodo1 CHAR(07),a_periodo2 CHAR(07),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codusuario CHAR(255) DEFAULT "*",a_codcontrato CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",a_codtipoprod CHAR(255) DEFAULT "*",a_cod_cliente CHAR(255) DEFAULT "*")
...
---  MODIF: Amado Perez 9/10/2008 se adiciono la condicion que fronting = 1 ya que no estaba
--------------------------------------------
   ...
   BEGIN
      ...
      DEFINE v_prima,v_prima_cedida,_prima_suscrita           DECIMAL(16,2);
...
FOREACH WITH HOLD
         ...
         FOREACH
		   ...
		   --  Tipo de Contrato 2 (FRONTING)
            ...
            IF w_cod_contrato IS NULL OR
               trim(w_cod_contrato) = ""  THEN
               CONTINUE FOREACH;
            END IF 

--            LET v_comision =(v_prima*v_porc_comis)/100;
			FOREACH
              SELECT cod_acreedor
                INTO v_cod_acreedor
                FROM emipoacr
...
--         LET v_prima_cedida = v_prima - v_comision;
