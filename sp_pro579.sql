   DROP procedure sp_pro579;
   CREATE procedure "informix".sp_pro579(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7), a_periodo2 CHAR(7), a_origen CHAR(3) DEFAULT '%')
...
--------------------------------------------
	...
	CREATE TEMP TABLE tmp_ramosubrh(
	      cod_ramo			char(3),
		  cod_subramo		char(3),
		  orden				smallint,
		  cnt_polizas_ma	integer,
		  cnt_polizas		integer,
		  cnt_asegurados	integer,
		  prima_suscrita	dec(16,2),
		  incurrido_bruto	dec(16,2),
		  cnt_reclamo		integer,
		  salv_rec          dec(16,2),
		  pago_ded          dec(16,2),
		  var_reserva		dec(16,2),
		  casos_cerrados	integer,
		  cnt_pol_nuevas	integer,
		  cnt_pol_ren		integer,
		  cnt_pol_can_cad  	integer);
