...
Let _html_body2 = trim(_html_body2) ||'<br>3. Le invitamos acceder a nuestros canales de atenci&oacute;n:';
Let _html_body2 = trim(_html_body2) ||'<br>&nbsp;&nbsp;&nbsp;&nbsp;a.	<a target="_blank" href="https://app.asegurancon.com/">www.asegurancon.com</a> conozca nuestros productos, Valores Agregados, Talleres Autorizados, Red M&eacute;dica <br>y <a target="_blank" href="https://www.asegurancon.com/formularios-y-solicitudes/">formularios</a> de &nbsp;&nbsp;&nbsp;&nbsp;Afiliaci&oacute;n a Pago electr&oacute;nico por ACH o Tarjeta de Cr&eacute;dito.';
...
Let _html_body2 = trim(_html_body2) ||'<p>';
Let _html_body2 = trim(_html_body2) ||'<br>4. Si los datos generales que brind&oacute; al momento de adquirir su p&oacute;liza var&iacute;an o no est&aacute;n correctos, podr&aacute;<br>';  
Let _html_body2 = trim(_html_body2) ||'actualizar sus datos en el APP Ancon Clientes o puede llamar a nuestras l&iacute;neas de Atenci&oacute;n al Cliente.';
Let _html_body2 = trim(_html_body2) ||'</p>';
Let _html_body2 = trim(_html_body2) ||'</td>';
Let _html_body2 = trim(_html_body2) ||'</tr>';
Let _html_body2 = trim(_html_body2) ||'<tr>';
Let _html_body2 = trim(_html_body2) ||'<td colspan="2">';
Let _html_body2 = trim(_html_body2) ||'<p>';
Let _html_body2 = trim(_html_body2) ||'<br>5. Contamos con un programa de Asistencia Vial 24 horas:<br>'; 
Let _html_body2 = trim(_html_body2) ||'<strong>(+507) 303-2444 / 302-2444 / WhatsApp (+507) 6233-3882</strong>';
Let _html_body2 = trim(_html_body2) ||'</p>';
Let _html_body2 = trim(_html_body2) ||'</td>';
Let _html_body2 = trim(_html_body2) ||'</tr>';
Let _html_body2 = trim(_html_body2) ||'<tr>';
Let _html_body2 = trim(_html_body2) ||'<td colspan="2">';
Let _html_body2 = trim(_html_body2) ||'<p>';
Let _html_body2 = trim(_html_body2) ||'<br>6. Brindamos atenci&oacute;n permanente, para orientar y dar respuesta a sus consultas de Salud y<br>';  
Let _html_body2 = trim(_html_body2) ||'Preautorizaciones las 24 horas. <strong>(+507)210-8777 / 305-7565</strong> preautorizaciones@asegurancon.com';
Let _html_body2 = trim(_html_body2) ||'</p>';
Let _html_body2 = trim(_html_body2) ||'</td>';
Let _html_body2 = trim(_html_body2) ||'</tr>';
Let _html_body2 = trim(_html_body2) ||'<tr>';
Let _html_body2 = trim(_html_body2) ||'<td colspan="2">';
Let _html_body2 = trim(_html_body2) ||'<p>';
Let _html_body2 = trim(_html_body2) ||'<br>7. Si al momento de su renovaci&oacute;n tiene alguna duda o consulta, puede escribir al correo<br> conservacioncliente@asegurancon.com';
Let _html_body2 = trim(_html_body2) ||'</p>';
Let _html_body2 = trim(_html_body2) ||'</td>';
Let _html_body2 = trim(_html_body2) ||'</tr>';
Let _html_body2 = trim(_html_body2) ||'<tr>';
...
--Let _html_body3 = trim(_html_body3) ||'<br>8. Para descargar su p&oacute;liza presione aqu&iacute;.';
Let _html_body3 = trim(_html_body3) ||'<br>8. Para descargar su p&oacute;liza presione <a target="_blank" href="https://app.asegurancon.com/poliza_web/print_pol.php?'||v_url||'">aqu&iacute;.</a>';
...
Let _html_body3 = trim(_html_body3) ||'permitir&aacute; mejorar nuestro servicio.';
Let _html_body3 = trim(_html_body3) ||'</p>';
Let _html_body3 = trim(_html_body3) ||'</td>';
Let _html_body3 = trim(_html_body3) ||'</tr>';
Let _html_body3 = trim(_html_body3) ||'<tr>';
