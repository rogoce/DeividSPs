...
define li_cant_garantia_pago smallint;
...
FOREACH
 ...
 {	SELECT emifafac.cod_coasegur, 
	...
	if ls_ramo in('002','023') then
		SELECT SUM(emifafac.suma_asegurada)
		  INTO ld_suma_rea
	...
	if ld_prima_rea = 0 then
	    if ld_impuesto2 < 0 then
		  -- let ld_impuesto2 = ld_impuesto2 * -1;
		end if
