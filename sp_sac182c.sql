...
DROP PROCEDURE sp_sac182c;
CREATE PROCEDURE sp_sac182c(a_valor CHAR(10),a_db char(18))
		...
		FOREACH
		 select a.cod_auxiliar,
		   ...
		   into r_cod_auxiliar,
			    ...
			    r_debito,
			    r_credito
		   from sac999:reacompasiau a ,tmp_cglterceros t, tmp_reaprod r	 
		  where a.no_registro  = r.no_registro
		    and a.cuenta       = r.cuenta
