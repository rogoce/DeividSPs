...
DROP PROCEDURE sp_che207sim;

CREATE PROCEDURE sp_che207sim(a_compania CHAR(3))
RETURNING SMALLINT;
...
let _valor = sp_che216a();	--insertar corredores nuevos a tabla tropical

select * 
  from tropicals
  into temp prueba;

insert into tropical2s
select * 
  from prueba;
