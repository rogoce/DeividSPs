   ...
   CREATE procedure "informix".sp_pro118a(a_cia CHAR(03),a_agencia CHAR(3),a_fecha DATE,a_codsucursal CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_agente CHAR(255) DEFAULT "*",a_usuario CHAR(255) DEFAULT "*", a_cod_cliente CHAR(255) DEFAULT "*", a_no_documento CHAR(255) DEFAULT "*")

   RETURNING CHAR(3),CHAR(50),CHAR(20),CHAR(45),DATE,DATE,
             CHAR(40),DECIMAL(16,2),DECIMAL(16,2),
             CHAR(255),CHAR(50),CHAR(50),DECIMAL(16,2),DECIMAL(16,2),CHAR(5),CHAR(255);
...
--------------------------------------------
    ...
    CALL sp_pro118(a_cia,a_agencia,a_fecha,'008,080;') RETURNING v_filtros;
...
--Filtro de Poliza
    ...
    FOREACH WITH HOLD
       ...
       RETURN  v_cod_ramo,v_desc_ramo,no_documento,
               ...
               v_filtros,v_descr_cia,v_subramo,v_prima_pagada,_porc_comis_agt,_cod_agente,v_descripcion WITH RESUME;
    END FOREACH
