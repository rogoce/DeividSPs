-- Procedimiento que genera la informacion de las polizas nuevas para la convencion PAROS 2024
-- en un rango de fechas

drop procedure sp_bo077conv;
create procedure sp_bo077conv(a_fecha_ini date, a_fecha_fin date)
...
foreach
	...
	if _nueva_renov = "N" then
		--Se Excluye poliza con traspaso de cartera o cambio de corredor en el periodo del concurso
		select count(*)
		  into _cnt
		  from endedmae
		 where no_poliza     = _no_poliza
