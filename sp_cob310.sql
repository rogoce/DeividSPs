...
drop procedure sp_cob310;

create procedure "informix".sp_cob310(a_no_poliza char(10), a_no_endoso char(5))
returning smallint,
          char(100);
...
--set debug file to "sp_cob310.trc";
--trace on;
...
foreach
	...
	let _recibi_de = trim(_recibi_de) ||_nom_agente;
