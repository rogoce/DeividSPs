...
DROP PROCEDURE sp_rec704_cob;
CREATE PROCEDURE sp_rec704_cob(a_compania  CHAR(3),a_agencia   CHAR(3),a_periodo1  CHAR(7),a_periodo2  CHAR(7),
...
CREATE TEMP TABLE tmp_sinis(
		...
		PRIMARY KEY (no_reclamo,cod_cobertura)
		) WITH NO LOG;
