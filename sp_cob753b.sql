...
-- Creado    : 11/04/2017 - Autor: Henry Giron, corregir poliza q no reflejo cierre nocturno de pago.
-- SIS v.2.0 - DEIVID, S.A.	 execute procedure sp_cob753b()

drop procedure sp_cob753b;
create procedure sp_cob753b(a_no_documento char(20),a_fecha_pagar date)
returning integer,
          char(100);
