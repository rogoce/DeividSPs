...
foreach
	select distinct cod_ramo,cod_subramo,cod_coasegur
	  into _cod_ramo,_cod_subramo,_cod_coasegur
	from temp_produccion
	order by cod_ramo, cod_subramo, cod_coasegur	
