--************************************************************
-- Procedimiento que Carga las Bonificaciones de cobranza 2019
--************************************************************
...
drop procedure sp_che81_avila;
create procedure sp_che81_avila(
a_compania          char(3),
a_sucursal          char(3),
a_periodo		    char(7),
a_usuario           char(8))
returning char(5),dec(16,2),dec(16,2),dec(16,2),varchar(50),char(20),varchar(50);
...
foreach
	...
	return	_cod_agente,_monto_m,_monto_p,_formula_a,_nombre,_no_documento,v_nombre_clte with resume;
