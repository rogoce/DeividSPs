...
drop procedure sp_web06_newges;

create procedure "informix".sp_web06_newges(a_id_proveedor char(10),a_cod_entrada varchar(10))
...
-- busqueda por id del proveedor
	...
	if a_cod_entrada = ' ' then
		...
		foreach
			...
			if trim(_no_documento) <> '1819-99900-01' then
				continue foreach;
			end if
