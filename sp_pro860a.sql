...
CREATE PROCEDURE sp_pr860(a_compania CHAR(03),a_agencia CHAR(03),a_periodo1 CHAR(07),a_periodo2 CHAR(07),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo  CHAR(255) DEFAULT "*",a_codagente CHAR(255) DEFAULT "*",a_codusuario CHAR(255) DEFAULT "*",a_codramo  CHAR(255) DEFAULT "*",a_reaseguro   CHAR(255) DEFAULT "*"	)
...
--                if v_tipo_contrato <> 5 or v_tipo_contrato <> 7 then
--					CONTINUE FOREACH;
--				end if
...
{			SELECT sum(pagado_neto)  -- sum(reserva_neto) 	
			INTO _siniestro	
			FROM tmp_sinis 
			where cod_ramo = v_cod_ramo	
			and   serie > 2007 and seleccionado = 1 and tipo_contrato not in ('3','1') ;   }

{			SELECT sum(pagado_neto)  -- sum(reserva_neto) 	
			INTO _siniestro	
			FROM tmp_sinis 
			where cod_ramo = v_cod_ramo	
			and   serie = _serie and seleccionado = 1 and tipo_contrato not in ('3','1') ;  }
			...
			if v_cod_ramo = '010' or v_cod_ramo = '010' or v_cod_ramo = '011'  or v_cod_ramo = '014' then 
				 let v_clase = '4' ;
			end if
...
{						LET _comision70 = _comision * 0.70 ;
						LET _comision30 = _comision * 0.30 ;
						LET _impuesto70 = _impuesto * 0.70 ;
						LET _impuesto30 = _impuesto * 0.30 ;
						LET _por_pagar70 = _por_pagar * 0.70 ;
						LET _por_pagar30 = _por_pagar * 0.30 ;
						LET _siniestro70 = _siniestro * 0.70 ;
						LET _siniestro30 = _siniestro * 0.30 ;	 }
