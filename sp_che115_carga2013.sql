...
DROP PROCEDURE sp_che115_carga2013;
CREATE PROCEDURE sp_che115_carga2013(
a_compania          CHAR(3),
a_sucursal          CHAR(3)
) RETURNING SMALLINT;
...
if a_periodo > "2012-12" then
	let a_periodo = "2013-12";
end if

let _fec_aa_ini     = "01/01/2013";	--para sacar cancelada o anulada en el periodo
let _per_ini        = "2013-01";
let _per_ini_ap     = "2012-01";
let _ano            = a_periodo[1,4];
let _ano            = _ano - 1;
let _per_fin_ap     = _ano || a_periodo[5,7];

let _per_fin_dic    = "2012-12";         
 ...
 select no_documento,
  ...
  order by no_documento
	...
	select concurso
     ...
     if _cod_ramo in("001","002","020","004","016","012","014","017","010","022","013","003","006","015","005","011","021","009","007") then
	 else
		continue foreach;
     end if
