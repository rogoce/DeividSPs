...
drop procedure ap_sis448;
create procedure "informix".ap_sis448(a_secuencia integer)
returning char(3000);
...
let _html = trim('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" /></head></head><body style="font-family:Arial; font-size:11px; text-align:justify;"><table width="800"><tr><td></td></tr><tr><td><p><b>Estimado(a) Cliente: %_pagador%</b><br>Perm&iacute;tanos extenderle un cordial saludo y el agradecimiento por elegirnos.<br>Adjuntamos su comprobante correspondiente al pago del  <b>%_fecha_remesa%</b></p></td></tr><tr><td><p>Le recordamos que usted puede realizar sus pagos a trav&eacute;s de las siguientes formas de pago recurrentes:</p></td></tr><tr><td><p>TARJETA DE CREDITO: aplican tarjetas VISA, Master Card y American Express, descargando y completando el siguiente <a href="https://www.asegurancon.com/wp-content/uploads/2021/09/DEBITO-A-TARJETA-DE-CREDITO-2.pdf"> Formulario</a> y envi&iacute;ndolo a <a href="mailto:cobrostcrach@asegurancon.com">cobrostcrach@asegurancon.com</a></p></td></tr><tr><td><p>DEBITO BANCARIO ACH: aplican cuentas corrientes y de ahorro; descargando, completando y entregando en f&iacute;sico en nuestras sucursales el siguiente <a href="https://www.asegurancon.com/wp-content/uploads/2019/09/DESCUENTO_ACH.pdf"> Formulario</a>.</p></td></tr><tr><td><p><b>Otros canales de pago:</b></p></td></tr><tr><td><p>A trav&eacute;s del <a href="https://app.asegurancon.com/pago_online/"> Bot&oacute;n de Pago</a> en la p&aacute;gina web con tarjetas VISA, Master Card y Tarjeta Clave<br>Pagos a trav&eacute;s de banca en l&iacute;nea: Banco General, Global Bank, Multibank.<br>Multipagos (Supermercado Rey, S/M Romero, Farmacias MetroPlus y Mr. Precio) y Centros Western Union.</p></td></tr><tr><td><p>Para cualquier duda o consulta ll&aacute;menos al 210-8700 o escribanos a <a href="mailto:info@asegurancon.com">info@asegurancon.com</a></p></td></tr><tr><td><p><b>Importante:</b></p></td></tr><tr><td><p>Por favor no responder a esta direcci&oacute;n de correo, ya que no se encuentra habilitada para recibir mensajes.</p></td></tr><tr><td colspan="2"></td></tr></table>'); 
let _html = trim('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" /></head></head><body style="font-family:Arial; font-size:11px; text-align:justify;"><table width="800"><tr><td></td></tr><tr><td><p><b>Estimado(a) Cliente: %_pagador%</b><br>Perm&iacute;tanos extenderle un cordial saludo y el agradecimiento por elegirnos.<br>Adjuntamos su Comprobante de Pago correspondiente al pago del: <b>%_fecha_remesa%</b></p></td></tr><tr><td><p>Para cualquier duda o consulta ll&aacute;menos al 210-8700 o escr&iacute;banos a <a href="mailto:info@asegurancon.com ">info@asegurancon.com </a></p></td></tr><tr><td><p><b>Importante:</b><br>Por favor no responder a esta direcci&oacute;n de correo, ya que no se encuentra habilitada para recibir mensajes.</p></td></tr><tr><td colspan="2"></td></tr></table>');
let _exigible = 0;
