...
Drop procedure sp_par364; 
CREATE PROCEDURE "informix".sp_par364(  
a_secuencia	INTEGER 
...
Let  _html_body1 = trim(_html_body1) ||'<td><p style="margin:1px; padding:1px;">Estimado cliente, por este medio le notificamos que cuenta con pago disponible en nuestras oficinas.</p></td>';
Let  _html_body1 = trim(_html_body1) ||'</tr>';
Let  _html_body1 = trim(_html_body1) ||'<tr>';
...
FOREACH
	...
	Let  _html_body1 = trim(_html_body1) ||_no_requis;
	Let  _html_body1 = trim(_html_body1) ||'</b></td>';
--	Let  _html_body1 = trim(_html_body1) ||'<td align="right"><b id="resul">';
 --   Let  _html_body1 = trim(_html_body1) ||'<script>';
 --   Let  _html_body1 = trim(_html_body1) ||'formato('||_monto||')';
 --   Let  _html_body1 = trim(_html_body1) ||'</script>'; 
...
Let  _html_body1 = trim(_html_body1) ||'Le agradecemos contactar a nuestro servicio al cliente al No. 210-8787 para m&aacute;s detalles.';
Let  _html_body1 = trim(_html_body1) ||'</p>';
Let  _html_body1 = trim(_html_body1) ||'</td>';
Let  _html_body1 = trim(_html_body1) ||'</tr>';
Let  _html_body1 = trim(_html_body1) ||'<tr>';
