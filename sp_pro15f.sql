...
DROP procedure sp_pro15f;

CREATE procedure sp_pro15f(a_cia CHAR(3),a_agencia CHAR(03),a_codsucursal CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",
...
BEGIN
    ...
    DEFINE v_prima_suscrita,v_prima_retenida,v_reaseguro,_saldo  		DECIMAL(16,2);
