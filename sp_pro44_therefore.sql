...
DROP PROCEDURE sp_pro44_therefore;
--DROP TABLE tmp_arreglo;

CREATE PROCEDURE "informix".sp_pro44_therefore(a_poliza CHAR(10), a_endoso CHAR(5), a_flota INT DEFAULT 0)
			RETURNING   CHAR(100),			 --	v_contratante,
						...
						CHAR(15),			 --codigo super
						varCHAR(50);			 --key_therefore
...
--		LET _cod_contratante = _cod_cliente;
	...
	call sp_therefore0(_no_poliza,a_endoso,'00000',_cod_contratante,'FACT') returning _error,_key_therefore;
