-- Reporte de Siniestros Pagados Sin Reserva a un periodo xxx
-- Creado    : 11/04/2016 - Autor: Armando Moreno M.

DROP PROCEDURE sp_res03;
CREATE PROCEDURE "informix".sp_res03(
a_compania	CHAR(3),
a_agencia	CHAR(3),
a_periodo1	CHAR(7),
a_periodo2	CHAR(7),
...
RETURNING	char(50),char(18),char(5),char(20),date,date,varchar(50),char(7),char(50),char(3),char(50),char(3),char(50),decimal(16,2),decimal(16,2),decimal(16,2),varchar(255),char(7);
...
FOREACH 
	...
	return v_compania_nombre,v_doc_reclamo,_no_unidad,_no_documento,_fecha_reclamo,_fecha_siniestro,_n_evento,_periodo,_n_sucursal,_cod_ramo,v_ramo_nombre,_cod_subramo,_n_subramo,_pagado_bruto,_pagado_total,_pagado_neto,v_filtros,_periodo_eval with resume;
