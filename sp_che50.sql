...
drop procedure sp_che50;

create procedure "informix".sp_che50(
a_valor_ant       char(10),
a_valor_nvo		  char(10),
a_user			  char(10)
) RETURNING   	  INTEGER;
...
if _origen_cheque = 'M' then
	let _origen_cheque = '3';
end if

update prueba 
   set no_requis = a_valor_nvo,
       origen_cheque = _origen_cheque
 where no_requis = a_valor_ant;
...
if _numrecla[1,2] = "04" and _origen_cheque = "3" then
...
if _origen_cheque = "K" and _en_firma = 2 then --Devolucion de Prima por Poliza Cancelada
  let _autorizado = 1;
  let _en_firma   = 4;
  --Centro de costo
	...
	if _cod_banco = '001' and _cod_chequera = '006' then
		update chqchmae
		   set autorizado       = 1,
			   ...
			   pre_autorizado = 0,
			   aut_imp_tec = 0,
			   user_aut_imp_tec = null,
			   date_aut_imp_tec = null,
			   user_pre_aut = null,
			   date_pre_aut = null,
			   nota_excepcion = null
		 where no_requis        = a_valor_nvo;
