--***********************************************************************************
-- Procedimiento que genera Mini Convencion MIAMI 2018
--***********************************************************************************
-- Creado    : 09/02/2018 - Autor: Armando Moreno M.
-- Creado    : 09/02/2018 - Autor: Armando Moreno M.
...
foreach
	...
	--Se quita esta condicion segun correo de analisa 07/06/2018
	{select count(*)
	  into _cnt
	  from emipouni
	 where no_poliza = _no_poliza;
...
--**********************************************************************************************
-- PRIMA SUSCRITA AÑO PASADO TODO EL AÑO 2017	sp_sis421_mini2018				****************
--**********************************************************************************************
	INSERT INTO tmp_caribe(no_documento, pri_sus_ap, cod_agente)         -- Adicione prima 2017 en tabla TMP
...
foreach
	select no_documento,
	       cod_agente,
		   sum(pri_sus),
		   sum(pri_sus_ap)   -- lectura de prima 2017 y utilizo el campo prima_cobrada de tabla punta_cana q no se esta utilizando
	  into _no_documento,
	       _cod_agente,
		   _prima_suscrita,
		   _pri_pag
	...
	select sucursal_origen,cod_ramo
	  into _cod_agencia, _cod_ramo
	  from emipomae
	 where no_poliza = _no_poliza;
