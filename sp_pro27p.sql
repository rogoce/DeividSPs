...
DROP PROCEDURE sp_pro27p;

CREATE PROCEDURE "informix".sp_pro27p(
        a_compania CHAR(3), 
        a_agencia CHAR(3), 
        a_periodo1 CHAR(7),
        a_periodo2 CHAR(7),
...
FOREACH WITH HOLD
 SELECT  e.no_poliza,	e.no_endoso, 	e.prima_suscrita,	 e.prima_retenida
   INTO  _no_poliza,		_no_endoso, 	_total_prima_sus,	 _total_prima_ret
   FROM endedmae e
