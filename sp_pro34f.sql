...
-- Modificado: 19/04/2018 - Autor: Henry Giron -- Inclusion filtro de Zona, 049: Pueblos

drop procedure sp_pro34f;
create procedure sp_pro34f(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
...
define _tot_final_sus       dec(16,2);
...
foreach
	select no_poliza,
	 ...
	 where (periodo    >= a_periodo1
	   ...
	   --and no_factura in('01-2862086','01-2862176')
	   
	if _cod_endomov in ('024','025') then
	...
	foreach
		...
		let _tot_final_sus = _tot_final_sus + _tot_prima_sus;
	...
	let v_cant_pagos      = 0;
	let v_suma_asegurada  = 0;
	--Ajustar por diferencia de centavos, Armando 02/09/2015 
	let _prima_dif = 0;
    let _prima_dif = v_prima_suscrita - _tot_final_sus;
