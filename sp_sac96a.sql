...
-- SIS v.2.0 - DEIVID, S.A.	 d_sac_con_movcta_det
-- execute procedure sp_sac96('01','26605','%','2009','01','2009','02')

DROP PROCEDURE sp_sac96a;
CREATE PROCEDURE sp_sac96a(a_tipo char(2),a_cuenta char(12),a_ccosto char(3),a_anio char(4),a_mes char(2), a_anio2 char(4),a_mes2 char(2)) 
