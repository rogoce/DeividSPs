...
foreach
	select c.cod_campana,
	  ...
	  into _cod_campana,
		   ...
		   _cod_gestion,
		   _cod_cobrador
	  from cascampana c, cascliente a
	 where c.cod_campana = a.cod_campana
	   and c.estatus = 2
	   and c.tipo_campana = 3
	   and (a.cod_gestion is not null and a.cod_gestion <> '')
	...
	foreach
		...
		if _nueva_renov = 'N' then
			...
			call sp_par342(_no_poliza,_usuario,_prima_bruta_end,_cod_sucursal,_anula) returning _error, _error_desc,_no_endoso;
		end if
