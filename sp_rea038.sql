-- Sacar facturas que involucran un contrato especificado.

-- SIS v.2.0 - DEIVID, S.A.
-- Creado    : 07/08/2012 - Autor: Armando Moreno

--execute procedure sp_rea038('001','001','2012-04','2012-06','*','*','*','*','*','00613','1')


DROP procedure sp_rea038;

CREATE procedure "informix".sp_rea038(
a_compania     CHAR(03),
a_agencia      CHAR(03),
a_periodo1     CHAR(07),
a_periodo2     CHAR(07),
...
CREATE TEMP TABLE temp_rea
      ...
      FOREACH
         ...
         SELECT e.no_poliza,
          ...
          group by e.no_poliza,t.no_factura
          order by e.no_poliza,t.no_factura
