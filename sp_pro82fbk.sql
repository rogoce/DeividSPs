...
--drop procedure sp_pro82fbk;
create procedure "informix".sp_pro82fbk(a_poliza char(10), a_unidad char(5), a_suma dec(16,2), a_cia char(3), a_opcion integer default 0)
