...
foreach
	select serie,
	  ...
	  into _serie,
		   ...
		   v_prima 
	  from temphg
	 where cod_coasegur in ('122','153','050','063','076','042','036','089','128','117','134','136','141','146','147','149','077','034','164') --SD#6343 add 164 27/04/2023-HGIRON 
	   and anio      = _anio_reas
	   and trimestre = _trim_reas
	...
	foreach 
		select distinct cod_coasegur,
		  ...
		  from temphg
		 Where serie         = _serie
		   and cod_coasegur in  ('122','050','063','076','042','036','089','128','117','134','136','141','146','147','149','153','077','034')
