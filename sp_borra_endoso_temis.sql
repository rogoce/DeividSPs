-- Armando Moreno	03/04/2023
-- Federico Coronado 15/05/2024   se agrego el delete de emigloco, deivid_integrapol para los endosos

--Procedimiento para borrar un endoso NO actualizado.

--drop procedure sp_borra_endoso_temis;
create procedure sp_borra_endoso_temis(a_no_poliza char(10), a_no_endoso char(10)
...
foreach
 select no_poliza,
  ...
  where no_poliza = a_no_poliza
	...
	DELETE FROM emigloco WHERE no_poliza = _no_poliza AND no_endoso = _no_endoso;
	delete from deivid_integrapol where no_poliza = _no_poliza and no_endoso = _no_endoso;
