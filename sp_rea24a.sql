...
drop procedure sp_rea24a;
create procedure "informix".sp_rea24a(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo CHAR(7))
returning CHAR(3),                  
		  varchar(50),                              
		  char(20),                 
		  DEC(16,2),               
...
--SET DEBUG FILE TO "sp_rea24a.trc";
--TRACE ON ;
...
foreach
 SELECT no_documento
   INTO	_doc_poliza
   FROM emipoliza
  --where no_documento[1,2] in ('10') --no_documento = '1110-00012-01'
  --where no_documento[1,2] in ('06','10','11') --no_documento[1,2] in('10','11') or no_documento = '0603-00030-01'  ---= '0604-00127-01'--= '0603-00161-01'  --= '0602-00218-01' --[1,2] = '06'  -- "0100-00010-02" --[1,2] = '02'   "0102-00088-01" --
 ...
 */
 foreach 
	   ...
	   order by no_documento, cod_coasegur
