...
--- Informe de prima cobrada de cuota parte retencion cesion 50% MAPFRE	 - HENRY
-- execute procedure sp_pr990('001','001','2008-01','2008-03',"*","*","*","*","*","*","*","*")
--------------------------------------------
DROP PROCEDURE sp_pr990;

CREATE PROCEDURE sp_pr990(
		a_compania    CHAR(03),
		a_agencia     CHAR(03),
		a_periodo1    CHAR(07),
		a_periodo2    CHAR(07),
...
RETURNING CHAR(03),CHAR(50),CHAR(50),CHAR(100),DECIMAL(16,2),CHAR(50),CHAR(255),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),dec(16,2),smallint,CHAR(5),smallint;
...
FOREACH
     SELECT cod_ramo,
       ...
       INTO v_cod_ramo,
         ...
         FROM temp_produccion
	   where seleccionado = 1
     GROUP BY cod_ramo, cod_subramo, cod_origen, cod_contrato, desc_contrato, cod_cobertura, tipo, desc_cob, serie
     ORDER BY cod_ramo, cod_subramo, cod_origen, cod_contrato, desc_contrato, cod_cobertura, tipo, desc_cob, serie
