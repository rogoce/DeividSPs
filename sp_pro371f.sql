-- Procedimiento que carga las coberturas de los prodcutos en el Proceso de Emisiones Electronicas para Seguros Centralizados
--
-- Copia del sp_pro371a
-- Creado: 27/02/2021 - Autor: Amado Perez--
-- sis v.2.0 - deivid, s.a.

drop procedure sp_pro371f;
create procedure "informix".sp_pro371f(a_periodo char(7))
...
foreach
	select trim(no_documento),   
	 ...
	 where periodo = a_periodo
	  ...
	  and cod_agente in ('00166','01743','01744','01745','01751','01851')
