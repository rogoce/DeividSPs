...
drop procedure sp_bo043_prueba;
create procedure "informix".sp_bo043_prueba()
returning integer,date,date,date,date,char(7),date,date,date,date,char(7),char(7),date;
...
define _fecha_ini_aa,_fecha_menos_fin		date;
define _fecha_fin_aa,_fecha_menos_ini		date;
define _fecha_menos_ini_ap,_fecha_menos_fin_ap date;
...
define _no_pol_tot_aa,_dia,_mes		integer;
...
return 0, _fecha_menos_ini,_fecha_menos_fin,_fecha_menos_ini_ap,_fecha_menos_fin_ap,_per_ini_aa,_fecha_ini_aa,_fecha_fin_aa,_fecha_ini_ap,_fecha_fin_ap,_per_fin_aa,_per_fin_ap,_fecha_evaluar;
