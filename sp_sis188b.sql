...
drop procedure sp_sis188b;
create procedure sp_sis188b(a_no_poliza char(10),a_no_endoso char(5), a_no_unidad char(5))
...
create temp table tmp_dist_rea(
	...
	porc_cober_reas	dec(9,4)) with no log;
...
foreach
	...
	if _prima_total <> 0 then
		let _proporcion = round((_prima_cober_reas/_prima_total) * 100,6);
	end if
