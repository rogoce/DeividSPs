...
--DROP PROCEDURE sp_che94continental;
CREATE PROCEDURE sp_che94continental(
a_compania          CHAR(3),
a_sucursal          CHAR(3),
...
foreach
	SELECT cod_agente
	  INTO _cod_agente
	  FROM chqrenta3
     WHERE periodo = '2019-12'
	   AND cod_agente = '00006'
	 GROUP BY cod_agente
	 ORDER BY cod_agente
	 
	call sp_che98(a_compania,a_sucursal,_cod_agente,a_usuario,'001','001','2019-12') returning _error;

	if _error <> 0 then
		return _error,'Actualizacion Exitosa...Error.','2019-12';
	end if

end foreach	
end  

return 0, 'Actualizacion Exitosa...','2019-12';
