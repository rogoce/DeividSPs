drop procedure sp_actuario20_c;
create procedure sp_actuario20_c(a_id_mov_tecnico1 integer, a_id_mov_tecnico2 integer, a_id_mov_reas integer, a_id_reas_caract integer)
...
foreach --with hold
	...
	if _cod_tipoprod = '001' then
		...
		foreach
			...
			insert into deivid_ttcorp:movim_reaseguro_pr_c(
					id_mov_reas,    
					tip_contrato,   
					por_part_total, 
					por_part_reaseg,
			...
			call sp_actuario21_c(_id_mov_reas,_id_mov_reas,_id_reas_caract) returning _error,_error_desc;
			...
			if _cnt_existe = 0 then
				update deivid_ttcorp:movim_reaseguro_pr_c
				   set flag = 3
