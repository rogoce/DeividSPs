...
DROP PROCEDURE sp_cob108abk;
--DROP TABLE tmp_arreglo;
CREATE PROCEDURE "informix".sp_cob108abk(a_cobrador_vjo CHAR(3), a_cobrador_nvo CHAR(3),a_parametro integer,a_arg integer default 1)
       RETURNING	    int;
