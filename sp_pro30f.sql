...
DROP PROCEDURE sp_pro30f;
CREATE PROCEDURE sp_pro30f(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo CHAR(7)) 
RETURNING CHAR(10),
		  CHAR(5),
		  CHAR(100),
		  CHAR(1),
...
CALL sp_pro30ff(a_compania,a_sucursal,a_periodo);
