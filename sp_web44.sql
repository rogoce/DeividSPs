...
drop procedure sp_web44;

create procedure "informix".sp_web44(
a_fecha_actual	date,
...
define _ced_ruc_asegurado	varchar(50);
...
call sp_web43(a_fecha_actual,a_dias_sin_pago) returning _error, _error_desc;
--trace on;
--Filtro de grupo
IF a_grupo <> "*" THEN
...
foreach
	...
	if _cnt_uni > 1 then
		...
		select nombre, cedula
		  into _nombre_asegurado, _ced_ruc_asegurado
