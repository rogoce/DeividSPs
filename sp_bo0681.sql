...
drop procedure sp_bo0681;		

create procedure "informix".sp_bo0681()
returning integer,
		  char(100);
...
let _periodo1 = "2014-01";  --"2012-01";   --"2011-11";  --"2013-09";
let _periodo2 = "2014-12";  --"2013-10";   --"2012-10";  --"2014-08";

let _periodo3 = "2013-01";  --"2012-01";  --"2011-01";   --"2013-01";
let _periodo4 = "2013-12";  --"2012-12";  --"2011-12";   --"2013-12";
   ...
   where actualizado  = 1
	...
	if _cod_ramo = "018" then
		...
		if _nueva_renov = "N" then
			...
			let _tipo_poliza = "2";
			-- FC no tomar en cuenta en renovaciones los ramos de Montaje,Car,Soda,Transporte subramos Aereo Maritimo 20/01/2015
		...
		*/
			if _cod_ramo = "009" then	 --Transporte
				if _cod_subramo = "003" or _cod_subramo = "004" then  --Aereo Maritimo
					let _tipo_poliza = "1";
					--continue foreach;
				end if
