...
CREATE PROCEDURE "informix".sp_pr77ic(a_compania CHAR(03), a_terremoto SMALLINT, a_fecha DATE, a_fecha2 DATE) 
				...
				IF _es_terremoto = 1 THEN
					...
					BEGIN
						...
						{INSERT INTO temp_unidad
							...
							referencia,
							nombre_barrio)
					SELECT DISTINCT emipouni.no_poliza,
							emipouni.no_unidad,
						...
						FROM emipouni LEFT OUTER JOIN emiman05 ON emipouni.cod_manzana = emiman05.cod_manzana ,   emipomae
					   WHERE  emipouni.no_poliza = _no_poliza
						 ...
						 INSERT INTO temp_unidad
							...
							referencia,
							nombre_barrio)
							SELECT DISTINCT endeduni.no_poliza,
							endeduni.no_unidad,
