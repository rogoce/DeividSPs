...
--------------------------------------------
					...
					-- DROP procedure sp_pro95;

DROP procedure sp_pro286;
CREATE procedure "informix".sp_pro286(a_cia CHAR(03),a_agencia CHAR(3),a_periodo DATE,a_codramo CHAR(255), a_reaseguro CHAR(255)  DEFAULT "*")
	   ...
	   FOREACH WITH HOLD
          SELECT  d.no_poliza,
            ...
            WHERE d.cod_compania = a_cia
              AND (d.vigencia_inic  < a_periodo			 -- 2007-06
