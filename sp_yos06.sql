...
-- Copia:  23/04/2019 Modificado sp_rwf47: Federico Coronado se agrego la marca de yoseguro en rectrmae

DROP PROCEDURE sp_yos06;
CREATE PROCEDURE "informix".sp_yos06(a_no_reclamo CHAR(10), a_incidente INTEGER, a_user_name_ajust CHAR(20), a_monto DEC(16,2), a_cod_cobertura CHAR(5), a_genera_cheque SMALLINT DEFAULT 0, a_deducible DEC(16,2) DEFAULT 0.00, a_inc_padre INTEGER, a_opcion SMALLINT, a_pieza DEC(16,2) DEFAULT 0.00)
