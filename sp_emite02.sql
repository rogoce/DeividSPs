...
drop procedure sp_emite02;

create procedure sp_emite02(a_no_poliza char(10))
...
foreach
	...
	let _prima_retenida = 0.00;
   	...
   	call sp_emite03(a_no_poliza,_no_unidad,_suma_asegurada,'001') returning _valor,_error_desc;
