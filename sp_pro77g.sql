...
DROP PROCEDURE sp_pro77g;

CREATE PROCEDURE "informix".sp_pro77g(a_compania CHAR(03), a_terremoto SMALLINT, a_fecha DATE) 
  ...
  FOREACH WITH HOLD
	  ...
	  SELECT cod_ubica,
		...
		INTO _cod_ubica,
			 ...
			 v_prima
	   FROM temp_ubica
	  GROUP BY cod_ubica,tipo_incendio,no_documento
