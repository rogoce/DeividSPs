--***********************************************************************
-- Procedimiento que genera Mini Convencion SERIE DEL CARIBE MIAMI 2024
--***********************************************************************
-- Creado    : 05/09/2023 - Autor: Armando Moreno M.

DROP PROCEDURE sp_minic2024;
CREATE PROCEDURE sp_minic2024(a_compania CHAR(3),a_sucursal CHAR(3))
RETURNING SMALLINT;
...
let _fecha_aa_ini = "01/09/2023";
let _fecha_aa_fin = "31/12/2023";
let _fecha_tope   = '31/12/2023';
LET _reemplaza_pol = "";
...
foreach
	...
	let _puntos_tiene  = 0;
	let _flag          = 0;
	if _cod_ramo in('004','018','019','016','010','001','003','015','005','009') then
		let _puntos = 1.20;
	elif _cod_ramo in('017','006','008','014','022','011','013') then
		let _puntos = 1.00;
