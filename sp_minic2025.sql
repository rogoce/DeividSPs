--**************************************************************
-- Procedimiento que genera Mini Convencion DIRECTO AL PARAISO
--**************************************************************
-- Creado    :17/10/2025 - Autor: Armando Moreno M.
...
let _fecha_aa_ini = "01/10/2025";
let _fecha_aa_fin = "31/12/2025";
let _fecha_tope   = '31/12/2025';
LET _reemplaza_pol = "";
...
--Periodo de Clasificacion: Del 01 de OCTUBRE de 2025 al  31 de DICIEMBRE del 2025
--*******************
-- Polizas Nuevas
--*******************
foreach
	select no_documento
	 ...
	 where cod_compania  = a_compania
	   ...
	   and cod_ramo in('004','018','019','016','001','003')
	...
	{if _cod_tipoprod = "001" then	  --Coas. Mayoritario, solo nuestra participacion.
...
foreach
	...
	let _puntos_tiene  = 0;
	let _flag          = 0;
	if _cod_ramo in('004','018','019','016') then	--Accidentes personales,Salud,Vida Ind., Col. de Vida
		let _puntos = 1.20;
	elif _cod_ramo in('001','003') then	--Incendio y Multiriesgo
		let _puntos = 1.00;
	end if
	select nombre,
		   tipo_agente,
