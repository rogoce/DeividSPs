...
drop procedure sp_pro525a;

create procedure sp_pro525a(a_no_poliza	char(10)) 
...
CREATE TEMP TABLE tmp_calendario(
	   no_poliza   			char(7),
	   no_letra 			smallint,
	   fecha_vencimiento    date,
	   periodo_gracia		date,	
	   fecha_aviso          date,
	   cancelar_poliza      date,
	   monto_letra          dec(16,4),
	   dias_letra           smallint,
	   vigencia_inic        date,
	   vigencia_final       date
		) WITH NO LOG;

CREATE INDEX xie01_tmp_calendario ON tmp_calendario(no_poliza);
