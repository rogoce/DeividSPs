...
--drop procedure sp_rec84c;

create procedure "informix".sp_rec84c(a_compania char(3), a_no_reclamo char(20) default "*", a_no_documento char(20),a_cod_reclamante char(10) default "*")
returning char(255);
