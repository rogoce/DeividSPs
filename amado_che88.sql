...
DROP PROCEDURE amado_che88;

CREATE PROCEDURE "informix".amado_che88(a_no_requis CHAR(10) DEFAULT '*') 
RETURNING   DATE,
			CHAR(100),
		    DECIMAL(16,2), 
			CHAR(250),
...
--	  ORDER BY firma2,a_nombre_de;
   ...
   {	select tipo_firma ------------>  Esto ya no va a partir de hoy 19/09/2008 A.P.M.
	  into _tipo_firma
	  from wf_firmas
