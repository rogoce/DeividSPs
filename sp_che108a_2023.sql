...
FOREACH
	...
	if _cod_grupo in('77850',"00000","1000",'1122','77960') then --excluir estado. excluir banisi ducruet segun caso 4356 fecha mod. 25/08/2022 
		continue foreach;
    end if
	...
	FOREACH
		...
		--se quita exclusion al codigo 02825 segun correo de guillermo del 20/11/23
		if _cod_agente in('02569','02656','02111','02531','02830') then	--se excluyen estos corredores por instr. Analisa, correo del 09/07/2019
			continue foreach;
		end if
