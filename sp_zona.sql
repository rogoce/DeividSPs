...
CREATE PROCEDURE "informix".sp_zona(a_zona CHAR(03), a_fecha DATE)
...
--		return 'RESTO DEL PAIS',_n_prov,_no_poliza, _no_unidad,_no_documento,_estatus_poliza with resume;
       ...
       if _cod_provincia in('01','04','09','06','07','02') then --Provincias oeste
	       ...
	       --if _cod_provincia <> '04' then
				return 'OTRA PROV ',_n_prov ,_no_poliza, _no_unidad,_no_documento,_estatus_poliza with resume;
		   --end if
	   end if
