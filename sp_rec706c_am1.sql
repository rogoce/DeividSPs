--execute procedure sp_rec706c_am1('001','001','2025-11','2025-11',"*","*","001,003;","2009;","*","*","*",0)
drop procedure sp_rec706c_am1;
create procedure sp_rec706c_am1(
a_compania	char(3),
a_agencia	char(3),
a_periodo1	char(7),
a_periodo2	char(7),
