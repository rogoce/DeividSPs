--**************************************************************************************
-- Procedimiento que genera el Reporte para consurso a Estambul 2013 para los corredores
--**************************************************************************************
...
let _per_ini = "2012-11";

-- Periodo Final del Consurso

if a_periodo > "2013-10" then
	let a_periodo = "2013-10";
end if
  ...
  order by no_documento
   ...
   select count(*)
    ...
    where no_poliza     = _no_poliza
      ...
      and fecha_emision >= '01/11/2012'	
      and fecha_emision <= '31/10/2013';
	...
	foreach
	 select cod_agente
	  ...
	  where no_poliza = _no_poliza
        ...
        let _unificar = 0;	 --Unificar Felix Alberto Abadia Pretelt	:correo Demetrio 09/08/2013 por Leticia
	   ...
	   --3 Doulos Insurance Consultants  (DICSA)(01048,01837) ,Logos Insurance(01569,01838), Juan Carlos Sanchez(01315,01834), Chung Wai Chun(00623,01836), Katia Mariza Dam de Spagnuolo(01575,01835)
		...
		if _cod_agente IN ("00133","01746","01749","01852","02004","02075","02082","02124") then  
