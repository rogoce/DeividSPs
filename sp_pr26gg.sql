...
DROP PROCEDURE sp_pro26gg;

CREATE PROCEDURE "informix".sp_pro26gg(a_compania CHAR(3),a_agencia  CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_grupo CHAR(255) DEFAULT "*", a_usuario  CHAR(255) DEFAULT "*", a_reaseguro CHAR(255) DEFAULT "*", a_agente CHAR(255) DEFAULT "*",a_zona CHAR(255) DEFAULT "*")
		RETURNING   CHAR(50),
		            DECIMAL(16,2),
					INTEGER,
		            DECIMAL(16,2), 
...
FOREACH WITH HOLD
  ...
  SELECT cnt_polizas
   ...
   WHERE cod_ramo = _cod_ramo;
    ...
    LET v_cnt_prima_sus = _cnt_polizas + v_cnt_prima_nva - (v_cnt_prima_can + v_cnt_prima_rev);
