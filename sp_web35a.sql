-- Procedimiento que genera la informacion del sistema de revisiones para los usuarios que van a prestar el servicio de instalacion de algun accesorio
-- Creado:	23/07/2016 - Autor: Federico Coronado
-- SIS v.2.0 - DEIVID, S.A.

drop procedure sp_web35a;
 
create procedure sp_web35a(a_opcion integer, a_parametro varchar(50))
returning char(20),
          char(5),
		  char(10),
          char(50),
		...
		foreach
			select no_documento,
			 ...
			 where cedula 			= a_parametro
			   and emipomae.cod_ramo in('002','020','023')
