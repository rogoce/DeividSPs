...
--DROP PROCEDURE sp_rec14bk;

CREATE PROCEDURE "informix".sp_rec14bk(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_periodo1 CHAR(7),
a_periodo2 CHAR(7)
...
CREATE INDEX xie02_tmp_siniest ON tmp_siniest(numrecla);
...
CREATE INDEX xie02_tmp_montos ON tmp_montos(numrecla);
