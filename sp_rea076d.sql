...
-- copia del sp_pr860  Federico Coronado se agrego el no_poliza
------------------------------------------------
--execute procedure sp_rea22d('001','001','2017-07','2018-03',"*","*","*","*","017;","*","2017,2016,2015,2014,2013,2012,2011,2010,2009,2008;",'01','001,004;')

drop procedure sp_rea076d;
create procedure sp_rea076d(
	a_compania		char(03),
	a_agencia		char(03),
	a_periodo1		char(07),
	a_periodo2		char(07),
...
--set debug file to "sp_rea22d.trc";
 --trace on;
...
call sp_rea075(a_compania,a_agencia,a_periodo1,a_periodo2,a_codsucursal,a_codgrupo,   --crea tabla temp_det (temporal)
...
create index idx13_temp_produccion on temp_produccion(seleccionado,serie);
create index idx14_temp_produccion on temp_produccion(seleccionado, cod_ramo);
...
create index idx1_tmp_priret on tmp_priret(cod_ramo);
...
if a_periodo2 = '2013-09' and a_tipo_bx = '01' then
	foreach
		select cod_ramo,
		 ...
		 group by cod_ramo,cod_subramo,cod_origen,cod_cobertura,desc_cob,tipo,cod_coasegur
		 order by cod_ramo,cod_subramo,cod_origen,cod_cobertura,desc_cob,tipo,cod_coasegur
