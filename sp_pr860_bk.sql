...
RETURNING CHAR(3),CHAR(3),CHAR(5),CHAR(3),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),CHAR(50),CHAR(50), CHAR(50);
   BEGIN
	  ...
	  DEFINE trim_reas						Smallint;


     SET ISOLATION TO DIRTY READ;

	 CALL sp_rea002(a_periodo2) RETURNING _anio_reas,trim_reas; 

	 DELETE FROM reacoest where ano = _anio_reas and trimestre = trim_reas and borderaux = "01";   -- elimina borderaux de BOUQUET
	 DELETE FROM temphg;
