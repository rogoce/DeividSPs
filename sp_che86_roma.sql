...
--**********************************************************************************************
-- Prima Suscrita Anno Pasado periodo del concurso  2015-10 A 2016-09
--**********************************************************************************************
foreach
 select no_poliza,
		no_endoso,
   ...
   from endedmae
  where actualizado  = 1
	and periodo between '2015-10' And '2016-09'
...
foreach
 select no_poliza,
   ...
   from endedmae
  where actualizado  = 1
	and periodo between '2015-10' And _per_fin_ap
...
call sp_bo077('01/10/2015','30/09/2016' ) returning _error, _error_desc;	--01/10/2015   A   30/09/2016
