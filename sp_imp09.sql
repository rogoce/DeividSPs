...
-- copia del sp_pro44x para la impresion Autor: Federico Coronado
-- Adaptado para que el sistema lea desde las tablas de emision
--
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_imp09;
--DROP TABLE tmp_arreglo;

CREATE PROCEDURE "informix".sp_imp09(a_poliza CHAR(10), a_endoso CHAR(5), a_flota INT DEFAULT 0)
...
DEFINE _dia              CHAR(2);
DEFINE _ano              CHAR(4);
DEFINE _leasing,_se_imp_motor SMALLINT;
