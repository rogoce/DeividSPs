...
-- Modificado: 25/04/2019 - HGIRON CASO: 6398 Corregir Reporte Cúmulos de Auto CECHAVAR 02052023
drop procedure sp_pro04d;
create procedure sp_pro04d(a_compania char(3), a_agencia char(255) default "*", a_periodo date, a_codsucursal	char(255)	default "*",a_codramo char(255)	default "*",
                           a_fecha date, a_serie char(255) default "*")

returning	varchar(50),--1. v_rango_inicial
			integer,	--2. tot_cant
			dec(16,2),	--3. v_prima_suscrita
			dec(16,2),	--4. v_prima_retenida
			integer,	--5. v_unidades
			char(3),	--6. v_codramo
			char(45),	--7. v_desc_ramo
			date,		--8. a_periodo
			char(45),	--09. descr_cia
			char(255),	--10. v_filtros
			dec(16,2),	--11. v_suma_asegurada / v_unidades
			dec(16,2),	--12. v_suma_asegurada
			dec(16,2),	--13. _prima_cont
			dec(16,2),	--14. _sum_retencion
			dec(16,2),	--15. _suma_fac
			dec(16,2),	--16. _suma_fac_car
			dec(16,2),	--17. _sum_cont
            dec(16,2);  --18
--------------------------------------------
...
define _prima,_prima_fac			dec(16,2);
...
DEFINE n_ubicacion    varchar(50);
DEFINE n_ramo         varchar(45);
DEFINE n_cobertura    varchar(50);
...
create temp table temp_poliza 
	...
	prima_fac_casco dec(16,2) default 0.00,
	...
	n_tipo_auto     char(30),	
	n_ubicacion     varchar(50),
	n_ramo          varchar(45),
	n_cobertura     varchar(50),				
	seleccionado	smallint default 1,
	vigencia_inic	DATE,			 
	vigencia_final  DATE,					
...
LET v_filtros = sp_pro03_mod(a_compania,a_agencia,a_periodo,a_codramo);
...
--SET DEBUG FILE TO 'sp_pro04d.trc';
--TRACE ON;
...
--	   and y.no_documento = '0225-07851-09'
    ...
    foreach		 
		...
		foreach 
			...
			if v_codramo in ('002','020','023') then			
				   let _tipo_auto = 0;
				...
				on exception in(-239)
					update temp_poliza
					   set suma_asegurada	= suma_asegurada	+ v_suma_asegurada,
						   ...
						   prima_fac_casco  = prima_fac_casco   + _prima_fac
					 where no_poliza = _no_poliza
					   and no_unidad = _no_unidad;
...
foreach
	...
	return v_ubicacion,					    --1
		   ...
		   descr_cia,						--09
		   v_filtros,						--10
		   v_suma_asegurada / v_unidades,	--11
		   v_suma_asegurada,				--12
		   _prima_cont,						--13
		   _sum_retencion,					--14
		   _suma_fac,						--15
