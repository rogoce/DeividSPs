-- Informaci¢n: para Costa Rica Asistencia Ramo Salud 
-- Creado     : 11/04/2008 - Autor: Demetrio Hurtado

DROP PROCEDURE sp_pro304;

create procedure sp_pro304()
...
foreach 
	...
	if (v_monto_30 + v_monto_60 + v_monto_90) > 10.00 then
		continue foreach;
	end if
