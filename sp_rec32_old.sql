DROP PROCEDURE sp_rec32;

CREATE PROCEDURE "informix".sp_rec32(v_no_tranrec CHAR(10), v_usuario    CHAR(8))
 RETURNING char(50), char(10), char(50), char(10), date, date, char(50), char(50),
			char(50), char(50), char(50), char(50), date, char(20), decimal(16,2),
...
foreach
   ...
   END IF
	...
	LET v_incurrido_tr = v_reserva_tr + v_pagado+ v_recuperos;
