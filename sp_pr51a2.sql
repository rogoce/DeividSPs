...
drop procedure sp_pr51a2;


create procedure "informix".sp_pr51a2(
a_compania			char(3),
a_agencia			char(3),
a_periodo1			char(7),
a_periodo2			char(7),
...
returning	char(20),				
	...
	char(50),				
	char(3),				
	varchar(50),   --char(3), sd7937 JEPEREZ 28/09/2023 HG				
	char(3),				
	varchar(20),				
	varchar(10),							
	CHAR(50),				
...
a_opcion_renovar,
a_tipo_prod,
a_cod_vendedor,a_cod_no_renov,a_facultativo);
...
--	email de los corredores, contratantes y ejecutivos de comercial SD#10533 JEPEREZ 040624 HG
	select nombre, usuario
	  into _nombre_vendedor, _user_vende
	  from agtvende
	 where activo = 1
  ...
  SELECT trim(nombre)||" - "||trim(cod_no_renov)
	...
	select trim(e_mail)
	into _email_user_vende
	from insuser 
	where usuario = _user_vende;
	--and fecha_inicio >= '01/12/2015' 
	--and status = 'A' 
