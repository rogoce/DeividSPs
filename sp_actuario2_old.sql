DROP procedure sp_actuario2;

CREATE procedure "informix".sp_actuario2(a_periodo1 char(7), a_periodo2 char(7), a_serie smallint)
RETURNING integer;
...
let v_filtros = sp_rec01("001","001",a_periodo1,a_periodo2,"*","*","002;","*","*","*","*","*");
...
--If a_serie = 2008 then
--	delete from sinis07;
--if a_serie = 2010 then
	delete from sinis08;
--end if
...
foreach
   ...
   if _cnt > 1 then
	...
	if v_no_unidad is null or v_no_unidad = "" then
		foreach
