...
create procedure "informix".sp_proe59(a_compania CHAR(03),a_fecha date,a_cod_manzana char(255) DEFAULT '*', a_poliza char(20) DEFAULT '*', a_estatus_poliza smallint,a_agente char(255) DEFAULT '*',a_grupo char(255) DEFAULT '*',a_periodo1 CHAR(07),a_periodo2 CHAR(07))
...
FOREACH WITH HOLD
   SELECT a.COMPANIA, 			 
	...
	order by  a.RAMO,a.UBICACION,a.MANZANA,a.POLIZA,a.UNIDAD
