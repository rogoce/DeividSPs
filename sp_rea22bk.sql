...
drop procedure sp_rea22bk;
create procedure sp_rea22bk(
a_compania		char(3),
a_agencia		char(3),
a_periodo1		char(7),
a_periodo2		char(7),
...
--Siniestros Pagados
call sp_rea22bbk(a_compania, a_agencia, a_periodo1, a_periodo2, a_codsucursal, a_contrato, a_codramo, a_serie, a_subramo) returning v_return22b;
