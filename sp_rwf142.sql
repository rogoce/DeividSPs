-- Trae la Informacion de Incurrido de un Reclamo.
-- Creado: 27/07/2004 - Amado Perez

--DROP PROCEDURE sp_rwf34;

CREATE PROCEDURE "informix".sp_rwf142(v_no_tranrec CHAR(10), a_cod_cobertura char(5))
 RETURNING DEC(16,2); 		    --v_incurrido,
...
--	   _monto_tmp
 ...
 SELECT monto,
   ...
   INTO _monto_tmp,
        _variacion_tmp
   FROM rectrcob
  WHERE no_tranrec = _no_tranrec_tmp
