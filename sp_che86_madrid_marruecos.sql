...
--se puso a correr 14/01/2019 Armando
...
foreach 
	 ...
	 if _no_reclamo = '458103' then
		...
		let _valor = sp_sis101a(_no_documento,'01/10/2017','30/09/2018',my_sessionid);	--Crea tabla tmp_corr con el corredor
		foreach
			select cod_agente,
				   porcentaje
			  into _cod_agente,
