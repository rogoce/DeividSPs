...
--DROP PROCEDURE sp_pro82gbk;
CREATE PROCEDURE "informix".sp_pro82gbk(a_poliza CHAR(10), a_unidad CHAR(5), a_ruta CHAR(5), a_suma DECIMAL(16,2), a_cia CHAR(3))
...
FOREACH
     SELECT prdcober.cod_cober_reas, Sum(emireau2.prima_neta_o)
     ...
     FOREACH
  	    SELECT cod_contrato,   
  		  ...
  		  FROM rearucon  
	  	 WHERE cod_ruta       = a_ruta
	  	   and cod_cober_reas = ls_cober_reas   		--Armando puso esta linea
	  ORDER BY orden ASC
