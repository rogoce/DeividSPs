...
-- execute procedure sp_sac218b('2009','11',2,'sac','6000%','*')
drop procedure sp_sac218b;
create procedure "informix".sp_sac218b(
a_ano 	  char(4), 
a_mes 	  smallint,
a_nivel	  smallint,
a_db      char(18),
			...
			foreach
			 select	auxiliar,  
			   ...
			   into	_auxiliar,
					...
					_ter_cedula
			   from tmp_auxsac218a
			   where rubro = _rubro   and total <> 0
               group by 3,1,2,17			   
			  order by 3,2,1
					...
					if _cod_tipo = 0 or _cod_tipo is null or _auxiliar is null then 
					   continue foreach;
					end if
