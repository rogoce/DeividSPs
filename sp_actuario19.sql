...
create procedure sp_actuario19(a_periodo_desde char(7), a_periodo_hasta char(7))
...
foreach with hold
	...
	if abs(abs(_mto_prima_ac) - abs(_prima_neta_end )) > 1.41  then	--_prima_neta_calc
	    let _flag = 1;
		update deivid_ttcorp:movim_tec_pri_ttco
		   set flag      = _flag
