...
drop procedure sp_pro418a;
create procedure sp_pro418a(a_periodo char(7)) 
...
FOREACH with hold
	...
	call sp_pro417a(a_periodo,_no_poliza,_descuento,'033') returning _error,_no_endoso,_error_desc;
