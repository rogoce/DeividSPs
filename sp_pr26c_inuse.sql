...
DROP PROCEDURE sp_pro26c_inuse;

CREATE PROCEDURE "informix".sp_pro26c_inuse(a_compania CHAR(3),a_agencia  CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_grupo CHAR(255) DEFAULT "*", a_usuario  CHAR(255) DEFAULT "*", a_reaseguro CHAR(255) DEFAULT "*", a_agente CHAR(255) DEFAULT "*",a_zona CHAR(255) DEFAULT "*")
		RETURNING   CHAR(50),
		            DECIMAL(16,2),
					INTEGER,
		            DECIMAL(16,2), 
  ...
  WHERE	seleccionado = 1
   ...
   BEGIN
	ON EXCEPTION IN(-239)
		...
		UPDATE tmp_prod2
		   SET total_sum_sus   = total_sum_sus + v_total_suma_sus,
			   total_sum_nva   = total_sum_nva + v_total_suma_nva,
			   total_sum_ren   = total_sum_ren + v_total_suma_ren,
			   total_sum_end   = total_sum_end + v_total_suma_end,
			   total_sum_can   = total_sum_can + v_total_suma_can,
			   total_sum_rev   = total_sum_rev + v_total_suma_rev,
