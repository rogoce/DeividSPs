--**********************************************************************************************************************************************************
-- Procedimiento para determinar la prima suscrita nueva de los corredores del bono de producción de Ramos Generales 2022
--***********************************************************************************************************************************************************

-- Creado    : 29/04/2022 - Autor: Armando Moreno M.
	...
	foreach
			 select e.no_documento,e.no_poliza
			  ...
			  where e.no_poliza         = t.no_poliza
				...
				and e.actualizado       = 1
				and e.nueva_renov       = "N"
				and e.periodo >= "2022-01"
				and e.periodo <= "2022-12"
			...
			select count(*)
			 ...
			 where no_poliza     = _no_poliza
			   ...
			   and fecha_emision >= '01/01/2022'
			   and fecha_emision <= '31/12/2022';
	...
	foreach
			select d.nueva_renov,
			 ...
			 where	d.no_remesa    = m.no_remesa
			   ...
			   and d.fecha        >= '01/01/2022'
			   and d.fecha        <= '31/12/2022'
