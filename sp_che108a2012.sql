...
DROP PROCEDURE sp_che108a2012;

CREATE PROCEDURE sp_che108a2012(a_compania CHAR(3),a_sucursal CHAR(3), a_periodo char(7))
RETURNING INTEGER;
 ...
 SELECT	d.no_poliza,
  ...
  WHERE	d.cod_compania = a_compania
   ...
   let _prima_r = (_porc_coas_ancon * _prima) / 100;
   	...
   	CALL sp_cob33e(a_compania,a_sucursal,_no_documento,a_periodo,_fecha) RETURNING v_por_vencer,v_exigible,v_corriente,v_monto_30,v_monto_60,v_saldo;
