   DROP procedure sp_pro568c;
   CREATE procedure "informix".sp_pro568c(a_cia CHAR(03),a_agencia CHAR(3),a_periodo CHAR(7), a_periodo2 CHAR(7), a_origen CHAR(3) DEFAULT '%')
...
DELETE FROM ramosubrh2 WHERE periodo = a_periodo2 AND origen = _origen;
...
delete from ramootroh2 WHERE periodo = a_periodo2 AND origen = _origen;	----*******************************************----
