...
--Filtro de Poliza
      ...
      {   SELECT nombre
         ...
         RETURN v_cod_ramo,v_desc_ramo,v_nofactura,v_nodocumento,
                ...
                v_sucursal,_fecha_emision,_nom_agente,_vig_ini,_vig_fin WITH RESUME;
