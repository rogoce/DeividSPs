...
DROP PROCEDURE sp_pro77f;

CREATE PROCEDURE "informix".sp_pro77f(a_compania CHAR(03), a_terremoto SMALLINT, a_fecha DATE) 
...
if _error <> 0 then
	return _error_desc,_error,0.00,0.00,0,0.00,0,0.00,0,0.00,'',0;	
end if
