...
foreach
	select serie,cod_ramo,cod_contrato,cod_cobertura,sum(prima) 
	  ...
	  from temphg1
	 where cod_coasegur in ('036','042','050','063','076','089','128','117','134','136','141','146','147','149','077')
	   and anio      = _anio_reas
	...
	foreach 
		select distinct cod_coasegur,porc_cont_partic,porc_comision,porc_impuesto
		  ...
		  from temphg1
		 where serie          = _serie
		   and cod_coasegur   in ('050','063','076','042','036','089','128','117','134','136','141','146','147','149','077')
