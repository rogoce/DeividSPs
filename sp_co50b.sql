...
-- Creado por:     Marquelda Valdelamar
-- Modificado por: Marquelda Valdelamar
-- Modificado por: Armando Moreno M. 20/02/03 incluir filtro de reaseguro asumido

DROP PROCEDURE sp_co50b;

CREATE PROCEDURE "informix".sp_co50b(a_compania CHAR(3), a_sucursal CHAR(3), a_no_documento CHAR(20), a_fecha DATE, a_periodo CHAR(7), a_reaseg_asumido INT DEFAULT 2)
...
-- Datos de la Poliza
   IF a_reaseg_asumido = 2 THEN	--Excluye reaseg. asumido
	FOREACH
	 SELECT vigencia_inic,
	  ...
	  WHERE no_documento =  a_no_documento
	   	AND cod_tipoprod <> _cod_tipoprod -- No incluir polizas con Reaseguro Asumido
