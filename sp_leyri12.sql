...
DROP PROCEDURE sp_leyri12;

CREATE PROCEDURE "informix".sp_leyri12(
a_compania 		CHAR(3), 
a_sucursal 		CHAR(3),
...
foreach
	select fecha
	 ...
	 where no_remesa <> '660575'
	    or no_remesa is null
	 ORDER BY periodo desc, fecha desc, referencia, no_documento
