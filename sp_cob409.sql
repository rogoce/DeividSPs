...
-- execute procedure sp_cob409('001','001','2018-01','02531,02532;','124,125;')

DROP PROCEDURE sp_cob409;
CREATE PROCEDURE sp_cob409(a_compania CHAR(3), a_sucursal CHAR(3), a_periodo char(7), a_cod_agente CHAR(255) DEFAULT "*", a_cod_grupo CHAR(255) DEFAULT "*")
