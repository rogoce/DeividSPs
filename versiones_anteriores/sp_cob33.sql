...
{if a_no_documento = '2320-00008-03' then
...
--	and periodo       <= a_periodo	 	-- no incluye periodos futuros
	...
	if _estatus_poliza in (2,4)  or _cod_endomov in ('002', '019') then --Si esta cancelada o anulada se debe, todas las facturas se hacen efectivas desde la vigencia inicial de la pÃ³liza
		let _no_pagos = 1;
