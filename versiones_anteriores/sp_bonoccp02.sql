...
cod_vendedor        char(3)) with no log;
...
foreach
	...
	foreach
		...
		insert into temp_bono(cod_agente,periodo,prima_suscrita,prima_cobrada,cod_vendedor)
		values(_cod_agente,_periodo,_prima_suscrita,_prima_cobrada,_cod_vendedor);
...
foreach
	...
	return _cod_agente,_n_corredor,_n_vendedor,_prima_suscrita,_prima_sus_fal,_prima_cobrada,_prima_bono,_porc_bono with resume;
