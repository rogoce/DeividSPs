...
drop procedure hg_pro77h;
create procedure "informix".hg_pro77h(a_compania char(03), a_terremoto smallint, a_fecha date, a_fecha2 date, a_ubica CHAR(255) DEFAULT "*", a_serie char(255) default "*")
...
call hg_pr77tc(a_compania, a_terremoto, a_fecha, a_fecha2, a_ubica) returning _error, _error_desc;  
