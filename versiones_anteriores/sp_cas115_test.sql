...
drop procedure sp_cas115_test;
create procedure sp_cas115_test(a_dias_cobros smallint default 0)
...
let _fecha_actual = date('08/10/2019');
let _desc_n_r = '';
let _cnt_holgura = 0;
let _error = 0;
...
call sp_cob356_test(_fecha_inicio,10)
