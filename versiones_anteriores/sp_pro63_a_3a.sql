 ...
 DROP procedure sp0_pro63_a_3;
CREATE procedure "informix".sp0_pro63_a_3(a_cia CHAR(3),a_agencia CHAR(3),a_codsucursal CHAR(255) DEFAULT "*",a_periodo DATE, a_cod_ramo CHAR(255) DEFAULT "*", a_codcliente CHAR(255) DEFAULT "*" ,a_subramo CHAR(255) DEFAULT "*", a_no_documento CHAR(255) DEFAULT "*")
...
--LET v_filtros = sp_pro63_04(a_cia,a_agencia,a_periodo,"*",a_cod_ramo,a_periodo,"*");
--trace off;
   ...
   select nombre
	...
	FOREACH
	 SELECT	c.cod_contrato,
			c.suma_asegurada,  --e.suma_asegurada, 
			c.prima, 
			c.cod_cober_reas,
			c.orden,
			c.no_unidad,
