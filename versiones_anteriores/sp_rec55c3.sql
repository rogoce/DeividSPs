...
drop procedure spj_rec55c2;
create procedure spj_rec55c2(
a_compania			char(3), 
...
returning 	char(20) as poliza,
          	char(20) as Reclamo, 
	  date as FechaFactura,    
	  integer as AnioFactura,
	  integer as MesFactura,
	  char(10) as CodICD,
	  char(50) as Diagnostico,
	  char(10) as  cod_cpt,
