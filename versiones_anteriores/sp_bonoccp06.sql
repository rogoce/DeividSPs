...
DROP PROCEDURE sp_bonoccp06; 
CREATE PROCEDURE sp_bonoccp06( 
a_compania       CHAR(3),
a_sucursal       CHAR(3),
a_cod_agente     CHAR(5),
a_usuario        CHAR(8),
...
--SET DEBUG FILE TO "sp_bonoccp06.trc"; 
--TRACE ON;                                                                

let _origen_cheque = 'L';
let _error         = 0;
...
LET _descripcion = 'PAGO DE BONIFICACION PRIMA NVA COBRADA, PROYECTO CCP ' || a_periodo[1,4];
...
call sp_par276(_no_requis, "L") returning _error, _error_desc;
