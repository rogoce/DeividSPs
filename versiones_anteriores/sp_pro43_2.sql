...
if _cnt > 0 and _cod_endomov not in('015','024','032','033','034','031') and a_no_poliza <> '001187729' and _no_doc <> '2318-00008-06' and _no_doc <> '2320-00004-05' 
            and _no_doc <> '2318-00076-01' and _no_doc <> '2320-00036-01' and _no_doc <> '0213-04424-01' and _no_doc <> '2319-00077-01' and _no_doc <> '0119-00501-01' then --015=endoso descriptivo
	...
	BEGIN
		...
		END FOREACH
 		If _retorno = 1 Then
			...
			RETURN 1, _mensaje;
		End If
		INSERT INTO emiauto(no_poliza, no_unidad, cod_tipoveh, no_motor, uso_auto, ano_tarifa,opcion) -- JEPEREZ:14122021
...
ELIF _tipo_mov = 15 THEN		-- Cambio de Coaseguro
	BEGIN
		...
		END IF
		UPDATE emipomae
		   SET cod_tipoprod = _cod_tipoprod1  WHERE no_poliza    = a_no_poliza;
	END
...
ELIF _tipo_mov = 26 THEN		-- Cambio de Tipo de Vehic.	 Henry-16/03/2011
	CALL sp_pro4955(a_no_poliza, a_no_endoso) returning _error, _mensaje; -- 6/4/16 Henry :Se adiconó cambio Uso Auto y Tipo Vehiculo
	if _error <> 0 then
		return _error, _mensaje;
	end if
