...
-- SIS v.2.0 - DEIVID, S.A. execute procedure sp_pro588a('001','001','2019-12')
drop procedure sp_pro588a;
create procedure sp_pro588a(a_compania char(3),a_sucursal char(3), a_periodo char(7))
