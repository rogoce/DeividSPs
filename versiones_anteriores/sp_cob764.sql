...
--				   and saldo < _exigible;
		...
		if a_tab = 1 then      -- x corredores
			...
			if a_proceso = 6 then			 -- Sin Envio de Correo o Cese Automatico
				if _ejecuto not in ('1') then
					continue foreach;
				end if
				...
				--let _saldo = _saldo_sin_mora;
				--let _por_vencer = _saldo_sin_mora;
				--let _dias_120 = _saldo_sin_mora; 
			else			
