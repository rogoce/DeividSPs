...
drop procedure sp_sis122a_1;
create procedure "informix".sp_sis122a_1(a_no_remesa char(10), a_renglon integer)
returning	integer,
			char(100);
...
drop table if exists tmp_reas_1;
create temp table tmp_reas_1(
...
or  (a_no_remesa = '1064001' and a_renglon in (57,61)) then	
	...
	delete from tmp_reas_1
	 where cod_cober_reas = '022'
	   and cod_contrato = '00688';
elif a_no_remesa = '1499210' and a_renglon in(55) then
	update tmp_reas_1
