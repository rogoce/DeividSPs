...
drop procedure sp_par319_jango_testhg;

create procedure "informix".sp_par319_jango_testhg() 
...
foreach
	select cod_tipo,
	  ...
	  into _cod_tipo,
		   ...
		   _grupo_trans
	  from parmailtipo
     where cod_tipo in ('00035') and envio_jango = 1
...
--	end if
	...
	foreach
		...
		--   and enviado in (0)
		   and secuencia in (5358521)  --5352321) --5354434)--(3490156)
