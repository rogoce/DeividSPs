...
CREATE PROCEDURE "informix".sp_pro77i(a_compania CHAR(03), a_terremoto SMALLINT, a_fecha DATE, a_fecha2 DATE, a_ubica CHAR(255) DEFAULT "*", a_serie char(255) default "*")
...
call hg0_pr77tc(a_compania, a_terremoto, a_fecha, a_fecha2, a_ubica) returning _error, _error_desc; 

if _error <> 0 then
	return _error_desc,'','','',null,'',_error, 0.00,0.00,0,0.00,0,0.00,0,0.00,'','',v_filtros;		   
end if
-- HG:CASO: 31242
-- Filtro por Serie
IF a_serie <> "*" THEN
