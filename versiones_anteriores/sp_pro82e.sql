...
create procedure "informix".sp_pro82e(
v_usuario			char(8),
v_poliza			char(10),
...
begin
	...
	if _canti = 0 then
		...
		if _no_documento in("0218-00430-01","0210-01288-01","0213-03051-01",'2315-00106-01','2315-00107-01') then
			let _aplica_imp = 0;
		end if
					...
					select cod_cobertura
					 ...
					 where cod_producto = _cod_producto					 
					   and cod_cobertura in (
						   select cod_cobertura from prdcober where  upper(trim(nombre)) like 'INCENDIO'
							   OR upper(trim(nombre)) like 'ROBO'
							   OR upper(trim(nombre)) like 'COLISION Y VUELCO'
