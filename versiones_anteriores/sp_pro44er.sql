...
DROP PROCEDURE sp_pro44;



--DROP TABLE tmp_arreglo;

CREATE PROCEDURE "informix".sp_pro44(a_poliza CHAR(10), a_endoso CHAR(5), a_flota INT DEFAULT 0)
			RETURNING   CHAR(100),			 --	v_contratante,
						...
						CHAR(15),			 -- codigo_super
						CHAR(50),            -- tipo_vehiculo
						CHAR(20),             --nom_uso_auto
						char(10);            -- celular
...
DEFINE v_factura,_cod_pagador	   CHAR(10);
...
FOREACH WITH HOLD
 SELECT no_poliza,
   ...
   FROM tmp_arreglo
	...
	if v_factura = '01-2388687' then
		let _cod_cliente = '628421';
	end if

     	if v_factura = '01-2361314' then    -- 0418-00011-01 1553396  456495
		let _cod_cliente = '456511';
	end if

	if v_factura = '01-2361315' then    -- 0418-00013-01 1553395
		let _cod_cliente = '456508';
	end if

	if v_factura = '01-2361317' then    -- 0418-00014-01 1553394
		let _cod_cliente = '456509';
	end if
	...
	SELECT cod_contratante,--cod_pagador,
		   nueva_renov,
		   leasing,
		   reemplaza_poliza,
		   cod_pagador
 ...
 -- Si la poliza es leasing
    ...
    IF _leasing = 1 THEN
	    let _cod_contratante = _cod_pagador;
		SELECT direccion_1,
			   cedula,
			   telefono1,
			   telefono2,
...
--	     _tipo_mov = 5 then
   ...
   foreach
	...
	IF _cod_endomov = '014' or _cod_ramo = '018' THEN
		LET v_desc_factura = 'RENOVACION';
		LET v_vig_ini_pol = v_vig_i_end;
		LET v_vig_fin_pol = null;
	END IF;	
