drop procedure sp_cas115_1;
create procedure sp_cas115_1(a_dias_cobros smallint default 0)
...
call sp_cob356_1(_fecha_inicio,10) returning _error, _mensaje;

if _error <> 0 then
	return '','','',null,null,null,'','','','','','','','','','',0.00,'',null,'','',_error,_mensaje,0,null,null;
end if

--set debug file to "sp_cas115_1.trc";
--trace on;
...
foreach
	select b.cod_campana,
	 ...
	 where a.cod_campana = b.cod_campana
	   and a.tipo_campana = 3 -- Campa̱a Nulidad
	   and a.estatus = 2      -- Activo
          -- and b.no_documento = '0215-01014-01'
