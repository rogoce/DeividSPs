...
--CASO 4626 DRN ENVIADO 29/09/2022 
if _cod_grupo in('00068','77972','77973','77974','77978','77979','77980') or a_no_documento in ('2322-00088-01') then
	let _dias = 60;
else
	Let _dias = 30;
end if
...
--CASOSD#6807 13/06/2023 HGIRON  
if a_no_documento in ('0222-03557-01') then

	let _periodo = sp_sis39(a_fecha_calculo);	   
	call sp_cob245a("001","001",a_no_documento,_periodo,a_fecha_calculo)	 
