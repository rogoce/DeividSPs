drop procedure sp_cob399_1;
create procedure sp_cob399_1()
...
--set debug file to 'sp_cob399_1.trc';
--trace on ;
...
let _tipo_aviso = 20; -- GestiÃ³n AutomÃ¡tica
...
foreach
	execute procedure sp_cas115_1(1)
	into _no_documento,
		 _cod_contratante,
		 _nom_contratante,
		 _fecha_primer_pago,
	...
	--if _fecha_nulidad <= _fecha_hoy  and _no_documento = '0215-01014-01' then
    if _fecha_nulidad <= _fecha_hoy  then
		...
		foreach
			select cod_gestion,
			 ...
			 --  and no_documento = '0215-01014-01'
			 group by 1
