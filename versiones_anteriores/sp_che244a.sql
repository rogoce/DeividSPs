-- Reporte de Bono Incentivo1 Proyecto CCP por Corredor - Detallado
-- Creado    : 05/03/2022 - Autor: Henry Giron
-- Modificado: 05/03/2022 - Autor: Henry Giron
-- SIS v.2.0 - d_cheq_sp_che244a_dw1 - DEIVID, S.A.

DROP PROCEDURE sp_che244a;

CREATE PROCEDURE sp_che244a(a_compania CHAR(3), a_cod_agente CHAR(255) default '*', a_periodo char(7),a_tipo_pago smallint) 
...
--SET DEBUG FILE TO "\\sp_che93a.trc";
--TRACE ON;
