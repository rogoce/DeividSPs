...
-- copia del sp_pro307  donde fecha_impresion between a_fecha_desde to a_fecha_hasta HGIRON:24/08/2022

drop procedure sp_pro307f;
create procedure "informix".sp_pro307f(
a_compania		char(03),
a_agencia		char(03),
a_fecha_desde	date,
a_fecha_hasta	date,
...
--set debug file to "sp_pro307.trc";
--trace on;

-- procesos v_filtros
let v_filtros ="";
--filtro para saber ingreso por a_por_fecha
--let v_filtros = trim(v_filtros) ||" fecha_desde: "||trim(cast(a_fecha_desde as varchar(10)))||" fecha_hasta: "||trim(cast(a_fecha_hasta as varchar(10)))||" ";
		update temp_det
		   set seleccionado = 0
		 where seleccionado = 1
		   and vigencia_inic not between a_fecha_desde and a_fecha_hasta;
