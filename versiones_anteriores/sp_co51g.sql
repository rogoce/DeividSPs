-- Encabezado de los Estados de Cuenta por Ramo y Morosidad (solo con saldos)
-- Creado por :     Roman Gordon	11/01/2011
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_co51g;

CREATE PROCEDURE "informix".sp_co51g(
a_compania		CHAR(3), 
a_sucursal		CHAR(3), 
a_cod_ramo		CHAR(10),
a_fecha_desde	DATE,
a_fecha_hasta	DATE
			...
			DEC(16,2),	-- saldo
			CHAR(7),	-- periodo
			CHAR(50),	char(20);   --celular 	-- forma de pago
