...
drop procedure am_pr860;
create procedure am_pr860(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
...
drop table if exists tmp_temphg00;
create temp table tmp_temphg00 (
cod_coasegur      CHAR(3), 
cod_ramo          CHAR(3), 
cod_contrato      CHAR(5), 
...
drop table if exists tmp_reacoest00;
create temp table tmp_reacoest00 (
cod_coasegur      CHAR(3), 
cod_ramo          CHAR(3), 
cod_contrato      CHAR(5), 
cod_cobertura     CHAR(3), 
...
foreach
	select serie,
	  ...
	  into _serie,
		   ...
		   v_prima 
	  from tmp_temphg00
	 where cod_coasegur in ('153','050','063','076','042','036','089','128','117','134','136','141','146','147','149','077','034') 
	   and anio      = _anio_reas
	   and trimestre = _trim_reas
	...
	foreach 
		select distinct cod_coasegur,
		  ...
		  from tmp_temphg00
		 Where serie         = _serie
		   and cod_coasegur in  ('050','063','076','042','036','089','128','117','134','136','141','146','147','149','153','077','034')
