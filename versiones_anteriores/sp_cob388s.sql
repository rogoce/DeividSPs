...
drop procedure sp_cob388s;
create procedure 'informix'.sp_cob388s(a_no_aviso char(10), a_usuario char(8)) 
returning	smallint,
			varchar(100);
...
foreach
	select no_poliza,
	 ...
	 where no_aviso = a_no_aviso
	   and estatus = "I"  --SD#10511 NSOLIS solo procesar 'G'
...
-- Control de Polizas no presenta saldo no envie aviso. ENILDA 27052024 HG
	...
	call sp_cob245a("001","001",_no_documento,_periodo_c,_fecha_hoy)
