...
-- Creado    : 08/11/2019 - Autor: Henry Giron
--execute procedure sp_pr860c1_t('001','001','2019-09','2019-09',"*","*","*","*","001003;","*","*","2013;","*")

drop procedure sp_pr860c1_t;
create procedure sp_pr860c1_t(
	a_compania		char(03),
	a_agencia		char(03),
	a_periodo1		char(07),
	a_periodo2		char(07),
...
create index idx10_temp_produccion on temp_produccion(porc_comision);
create index idx11_temp_produccion on temp_produccion(porc_impuesto);
			...
			if _cantidad = 0 then
				...
				if _cantidad = 0 then
					...
					values(	_cod_ramo,
							...
							'999',
							_porc_comision, 
							_porc_impuesto,_porc_partic_prima,'*');
				end if
			else
				foreach
					...
					if _cantidad = 0 then
						...
						values(	_cod_ramo,
								...
								_cod_coasegur,
								_porc_comision, 
							    _porc_impuesto,_porc_cont_partic,'*');
					else
