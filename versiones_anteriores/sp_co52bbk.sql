-- Estados de Cuenta por Agente. con Morosidad total (todas las polizas)
...
DROP PROCEDURE sp_co52bbk;

CREATE PROCEDURE "informix".sp_co52bbk(
a_compania		CHAR(3), 
a_sucursal		CHAR(3), 
a_cod_agente	CHAR(5),
a_fecha_desde	DATE,
...
--set debug file to "sp_co52bbk.trc";
--trace on;
