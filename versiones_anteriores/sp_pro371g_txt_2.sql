...
drop procedure sp_pro371_1505523;
create procedure "informix".sp_pro371_1505523(a_no_poliza char(10))
returning   integer,
			char(100);   -- _error
...
set debug file to "sp_pro371_"||a_no_poliza||".trc";
trace on;
...
select cod_agente
  ...
  from emipoagt
 where no_poliza = a_no_poliza
   and cod_agente in ('00035','00166','01743','01744','01745','01751','01851','02618'); --
