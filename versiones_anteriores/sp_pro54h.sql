...
DROP PROCEDURE bo_pro54;

CREATE PROCEDURE "informix".bo_pro54(a_poliza CHAR(10), a_unidad CHAR(5),a_general INT, a_endoso CHAR(5))
...
IF a_general = 1 THEN
	...
	FOREACH
		...
		GROUP BY x.cod_descuen, y.nombre, y.orden
 		...
 		LET v_descuento = 0;
		 if _cod_ramo = '002' and _cod_descuen = '001' then --SD#10165 BOLIVAR 26042024
			continue foreach;
		 end if				
