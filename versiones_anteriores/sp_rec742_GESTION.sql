...
drop procedure sp_rec742;

create procedure sp_rec742(a_mail_secuencia integer)
...
define _nom_agente, _n_prod	varchar(50);
...
define _tipo_acumulado   varchar(15);
...
--  set debug file to "sp_rec742.trc";
-- trace on;
--end if

let _nombre_cia  = sp_sis01('001'); 
...
{			if a_todos = 0 then
			...
			if _tipo_acum_deduc = 1 then
			   let _tipo_acumulado = "Año Calendario:";
			else
			   let _tipo_acumulado = "Año Póliza:";
			end if
			 ...
			 select	facturado,
			  ...
			  where no_tranrec = _no_tranrec
				...
				return _numrecla,		   -- 1
					   ...
					   _suma_asegurada,
					   _stop_loss,
					   _bene1,_bene2,_bene3,_bene4, _transaccion					   
					   with resume;
