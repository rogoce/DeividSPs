--html	
--<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" /><link rel="stylesheet" type="text/css"  href="css/css.css"></head><body style="font-family:Arial; font-size:14px; text-align:justify;"><table width="800"><tr><td><p>Estimado(s) Señor(es): <span style="text-transform:uppercase;font-weight:bold">%_filtro%<p>Para visualizar y descargar los documentos originales, lo(s) invitamos acceder a nuestra CONSULTA WEB DE ACREEDORES <a href="https://www.asegurancon.com/" style="font-size:18px;"> http://www.asegurancon.com</a> ,permitiéndole responder consultas de saldos y movimientos durante la vigencia. </p></td></tr><tr><td></td></tr><tr><td><p><b>FAVOR CONFIRMAR DE RECIBIDO DENTRO DE LOS SIGUIENTES TRES DÍAS HÁBILES, PASADO ESTE PERÍODO SE TOMARÁ COMO RECIBIDO CONFORME LA INFORMACIÓN ENVIADA.</b></p></td></tr><tr><td><p></p></td></tr><tr><td><p>Agradecemos su preferencia, <br /><br />Aseguradora Ancón, S.A.</p></td></tr></table>	
drop procedure sp_cob356_1;
create procedure sp_cob356_1(a_fecha_desde date, a_dias_vencida smallint)
returning	integer,
			varchar(100);
...
foreach
	select l.no_documento
	 ...
	 where e.no_poliza = l.no_poliza 
	   ...
	   and l.monto_letra <> 0
	   and l.monto_pag = 0
       --and l.no_documento = '0215-01014-01'
	   and l.no_documento in (
"2019-04207-09",
"2019-04572-09",
"2019-05171-09",
"2020-13708-09",
...
"0216-02578-01"
	...
	if _cod_ramo in ('008','014') then --'004','016','018','019') Se elimina ramos personales de la exclusiÃ³n 19/01/2016
		continue foreach;
