...
define _fecha				date;
define _cod_segregar	    char(3);  
define _n_segregar          varchar(100);     
define _porc_cobertura      dec(5,2);
define _suma_asegurada_cob  dec(16,2);



define vx_no_documento	char(20);
define vx_vigencia_ini	date;
define vx_vigencia_fin	date;
define vx_suma_asegurada	dec(16,2);
define vx_cod_ramo	char(3);
define vx_desc_ramo	char(50);
define vx_cantidad	smallint;
define vx_prima	dec(16,2);
define vx_prima_1	dec(16,2);
define vx_prima_bq	dec(16,2);
define vx_prima_3	dec(16,2);
define vx_prima_ot	dec(16,2);
define vx_filtros	char(255);
define vx_descr_cia	char(50);
define vx_fac_car	dec(16,2);
define vx_no_recibo	char(10);
define vx_res_comprobante	char(15);
define vx_n_contrato	varchar(50);
define vx_asegurado	char(50);
define vx_fecha_suscripcion	date;
define vx_fecha_recibo	date;
define vx_cedula	varchar(30);  
define vx_name_subramo	varchar(50);
define vx_ret_casco	dec(16,2);
define vx_cod_manzana	char(15);
define vx_name_manzana	varchar(50);
define vx_cant	integer;
...
4-	G. MDS.    5%
	...
	foreach
	select cod_segregar,nombre,porc_cobertura
	  into _cod_segregar,_n_segregar,_porc_cobertura
	 from prdcober17
	where cod_ramo = v_cod_ramo
	order by orden	

	if trim(vx_no_documento) in ('1710-00008-01','1720-00084-01','1712-00005-01','1712-00005-01','1720-00007-01','1720-00007-01','1720-00043-01','1717-00020-01','1711-00008-01','1712-00027-01','1712-00027-01','1718-00013-01',     '1720-00026-01','1719-00023-01','1718-00020-01','1720-00083-01','1720-00031-01'  ) then      
	   if _cod_segregar in ('001') then
	       let _porc_cobertura = 90;	
       end if		   
	   if _cod_segregar in ('003','004') then
	       continue foreach;
       end if		   	   
    end if	
