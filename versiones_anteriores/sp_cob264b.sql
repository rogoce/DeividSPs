...
Drop Procedure hg_cob264;

Create Procedure "informix".hg_cob264(a_no_documento char(20), a_no_remesa char(10))
...
select cod_chequera,cod_banco
  into _cod_chequera,_cod_banco
  from cobremae
 where no_remesa = a_no_remesa;

if _cod_chequera in ('029') and  _cod_banco in ('146')  then
	return 5,_cod_chequera;
end if
