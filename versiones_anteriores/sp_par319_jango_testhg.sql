...
--	end if
	...
	foreach
		...
		--   and enviado in (0)
--		   and secuencia in (3997786) and enviado = 6
and secuencia in (5655829) and enviado = 3
       ...
       -- let _email = 'aperez@asegurancon.com;jeperez@asegurancon.com;';
