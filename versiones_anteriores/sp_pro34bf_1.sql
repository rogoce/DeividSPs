...
--------------------------------------------
   ...
   BEGIN
      ...
      DEFINE _prima_neta,v_prima_suscrita    dec(16,2);
      ...
      define _cnt                            integer;
      define _facultativo                    CHAR(3);
      define _tipo_prod_name                 varchar(50);  
...
FOREACH WITH HOLD
	 ...
	 select user_added,
	  ...
	  where no_poliza = v_nopoliza;
		  ...
		  --- CASO SD#10466 JEPEREZ
		 
	    select nombre
		  into _tipo_prod_name
		  from emitipro
