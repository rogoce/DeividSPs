-- Procedimiento para la inserción campaña de CESE
-- Creado    : 26/09/2019 - Autor: Henry Giron
-- SIS v.2.0 - d_cobr_cobros_x_dia_cte - DEIVID, S.A.
--execute procedure sp_cas085('0213-02377-09','312191','073')

drop procedure sp_cas085;
create procedure sp_cas085(a_no_documento char(20), a_cod_pagador char(10),a_cod_gestion char(3))
returning	integer,
			varchar(255);
