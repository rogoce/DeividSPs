...
-- copia del sp_pro44y para la impresion Autor: Federico Coronado
-- Adaptado para que el sistema lea desde las tablas de emision
--
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_imp10;
--DROP TABLE tmp_arreglo;

CREATE PROCEDURE "informix".sp_imp10(a_poliza CHAR(10), a_endoso CHAR(5), a_unidad CHAR(255) DEFAULT '*')
