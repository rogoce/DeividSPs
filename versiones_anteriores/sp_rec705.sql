...
DROP PROCEDURE hg_rec705;
CREATE PROCEDURE "informix".hg_rec705(
a_compania	CHAR(3),
a_agencia	CHAR(3),
a_periodo1	CHAR(7),
a_periodo2	CHAR(7),
...
LET v_filtros = hg_rec704(a_compania,a_agencia, a_periodo1,a_periodo2,a_sucursal,'*', a_ramo,'*','*','*','*',a_subramo); 
...
FOREACH
	...
	SELECT fecha_siniestro,no_unidad
	  INTO v_fecha_siniestro,_no_unidad
	  FROM recrcmae
	 WHERE no_reclamo = _no_reclamo;
