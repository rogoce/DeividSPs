...
Drop procedure hg_par358; 
CREATE PROCEDURE "informix".hg_par358(  
a_secuencia	INTEGER 
...
Let  _html_body2 = trim(_html_body2) ||'               en original el Poder Legal que encontrar&aacute; adjunto, el mismo podr&aacute; enviarlo a trav&eacute;s de su';
...
Let  _html_body2 = trim(_html_body2) ||'             <p>';
Let  _html_body2 = trim(_html_body2) ||'             Le invitamos a participar en la siguiente encuesta para ayudarnos a mejorar el servicio: ';
--Let  _html_body2 = trim(_html_body2) ||'             <a href="https://forms.office.com/Pages/ResponsePage.aspx?id=iEoE-rfND0GbV6CST6EclUWEk2UOYpBPux2RK6IxZwJUMkYzQks5Wk5RQTFFSTJLSzE3N1lNWThTVS4u">Haz Click Aqu&iacute;</a></p>';
Let  _html_body2 = trim(_html_body2) ||'             <a href="https://forms.office.com/Pages/ResponsePage.aspx?id=iEoE-rfND0GbV6CST6EclTaBzullj6dEm8AYjUcOw_1UMFRGWTc1VzM3U0dNMkxaWDRDODdUUDlaVi4u">Haz Click Aqu&iacute;</a></p>';
...
Let  _html_body3 = trim(_html_body3) ||'               descargar nuestro App M&oacute;vil "Anc&oacute;n Clientes" disponible para Android y pr&oacute;ximamente para iOs.';
Let  _html_body3 = trim(_html_body3) ||'			</p>';
--Let  _html_body3 = trim(_html_body3) ||'            <p>';
