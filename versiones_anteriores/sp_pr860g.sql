...
--- Modificado por Henry 11/11/2019 filtros requeridos por comparativo tmp_tabla
--------------------------------------------
--execute procedure sp_pr860g('001','001','2009-09','2019-09',"*","*","*","*","001,003,005;","*","2019,2018,2017,2016,2015,2014,2013,2012,2011,2010,2009,2008;","01","*")

drop procedure sp_pr860g;
create procedure sp_pr860g(
a_compania		char(03),
a_agencia		char(03),
a_periodo1		char(07),
a_periodo2		char(07),
...
if a_periodo2 >= '2013-07' then		--Proceso de Devolución de Prima
	...
	call sp_pr860c1_t(a_compania,a_agencia,_periodo1,a_periodo2,a_codsucursal,a_codgrupo,a_codagente,a_codusuario,
...
call sp_pro307_t(a_compania,a_agencia,a_periodo1,a_periodo2,a_codsucursal,a_codgrupo,
