...
DROP PROCEDURE sp_pro44d;
--DROP TABLE tmp_arreglo;

CREATE PROCEDURE "informix".sp_pro44d(a_poliza CHAR(10), a_endoso CHAR(5), a_unidad CHAR(255) DEFAULT '*')
...
DEFINE _cnt,_se_imp_motor SMALLINT;
