...
DROP PROCEDURE sp2_che87b;
CREATE PROCEDURE sp2_che87b(a_compania CHAR(3), a_cod_agente CHAR(255) default '*', a_periodo char(7), a_tipo_pago smallint) 
		...
		FOREACH
		 SELECT	cod_agente,
		  ...
		  WHERE cod_agente IN (SELECT codigo FROM tmp_codigos)
			and (periodo  = a_periodo or periodo  = '2023-03' )
			--and seleccionado = 1
