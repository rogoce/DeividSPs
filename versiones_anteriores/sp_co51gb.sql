-- Encabezado de los Estados de Cuenta por Ramo y Morosidad (Todas las Polizas)
-- Creado por :     Roman Gordon	11/01/2011
-- SIS v.2.0 - DEIVID, S.A.

DROP PROCEDURE sp_co51gb;

CREATE PROCEDURE "informix".sp_co51gb(
a_compania		CHAR(3), 
a_sucursal		CHAR(3), 
a_cod_ramo		CHAR(10),
a_fecha_desde	DATE,
