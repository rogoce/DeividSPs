...
RETURNING CHAR(20) as No_Poliza, 	
 ...
 BEGIN
   ...
   -- trace on;
	...
	CALL sp_pro03('001','001',_fecha_hoy,"018;")  RETURNING _filtros;    --vigente al dia de salud
	drop table if exists tmp_codigos;
	CALL sp_sis04('01822,01823,01824,01825,01826,01827,01828,01829,01830,01831;') returning _filtros;	
