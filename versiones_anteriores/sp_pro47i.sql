-- Unificar Datawindows subramo:009,016,007,008,018 las Facturas de Salud con ramo:018
-- Creado    : 02/07/2019 - Autor: Henry Giron
-- SIS v.2.0 - DEIVID, S.A.

--DROP PROCEDURE sp_pro47i;
--DROP TABLE tmp_arreglo;
CREATE PROCEDURE "informix".sp_pro47i(a_poliza CHAR(10), a_flota INT DEFAULT 0) 
