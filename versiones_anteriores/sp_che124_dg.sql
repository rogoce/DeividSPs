...
defime _sender_reclamo  varchar(100);
defime _sender_act      varchar(100);
...
Select Trim(email_reclamo)
  ...
  from agtagent
 where cod_agente = '00050'; -- f9:35040  CC = 'mensajeria@urenayurena.net' --  
...
{ --no va 
 ...
 --   For _contador = 1 to _adjunto
		...
		if _origen_cheque = '3' and _secuencia <> _secuencia_ctrl then	
