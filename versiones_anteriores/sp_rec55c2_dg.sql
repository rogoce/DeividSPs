...
drop procedure sp_rec55c_2;
create procedure sp_rec55c_2(
a_compania			char(3), 
...
returning char(20)  as  compute_0001,
			date  as  compute_0002,
			char(50)  as  nombre_icd,
			char(10)  as  compute_0004,
			dec(16,2)  as  compute_0005,
			dec(16,2)  as  compute_0015,
			dec(16,2)  as  compute_0006,
			dec(16,2)  as  compute_0007,
			dec(16,2)  as  ahorro,
			dec(16,2)  as  compute_0008,
			dec(16,2)  as  compute_0009,
			dec(16,2)  as  compute_0010,
			char(100)  as  compute_0014,
