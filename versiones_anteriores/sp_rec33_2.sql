...
DROP PROCEDURE sp_rec33_2;
CREATE PROCEDURE sp_rec33_2(a_reclamo CHAR(10))
			RETURNING  DEC(16,2),  --Estimado			 
					   DEC(16,2),  --Deducible				 
					   DEC(16,2),  --Reserva Inicial	           
					   DEC(16,2),  --Reserva Actual	           
	   				   DEC(16,2),  --Pagos			 
	   				   DEC(16,2),  --Recupero			 
					   DEC(16,2),  --Salvamento
					   DEC(16,2),  --Deducible Pagado
					   DEC(16,2),  --Deducible Devuelto
					   DEC(9,6),   --Porcentaje Reaseguro
					   DEC(7,4),   --Porcentaje Coaseguro
					   DEC(16,2),  --Tr. de Deducible
					   DEC(16,2),  --Incurrido reclamo
