...
-- Modificado: 27/05/2002 - Autor: Amado Perez, se cambia para quelea de "endcuend"
-- Modificado: 25/04/2019 - HGIRON CASO: 31242 
-- SIS v.2.0 - d_prod_sp_cob77_dw1 - DEIVID, S.A.
DROP PROCEDURE sp_pro77k;
CREATE PROCEDURE "informix".sp_pro77k(a_compania CHAR(03), a_terremoto SMALLINT, a_fecha DATE, a_fecha2 DATE, a_ubica CHAR(255) DEFAULT "*", a_serie char(255) default "*")
returning   char(50) as ubicacion,  -- ubicacion
			...
			CHAR(50) as tipo_incendio, char(255) as filtros;  -- tipo incendio			
...
if _error <> 0 then
	return _error_desc,_error, 0.00,0.00,0,0.00,0,0.00,0,0.00,'',0,'','',null,null,'',0,v_filtros ;		   
end if
-- HG:CASO: 31242
-- Filtro por Serie
IF a_serie <> "*" THEN
