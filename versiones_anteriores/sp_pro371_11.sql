...
drop procedure sp_pro371_11;
create procedure "informix".sp_pro371_11(a_no_poliza char(10))
returning   integer,
			char(100);   -- _error
...
define _vig_inic1				char(10);
define _vig_fin1				char(10);
...
select cod_agente
  ...
  from emipoagt
 where no_poliza = a_no_poliza
   and cod_agente in ('00035','00166','01743','01744','01745','01751','01851','02618','02904'); --
...
let _periodo =  '2022-12' ;
let _vig_inic1 = _vig_inic[1,2]||'/'||_vig_inic[4,2]||'/'||_periodo[1,4] ;
let _vig_fin1 = _vig_fin[1,2]||'/'||_vig_fin[4,2]||'/'||_periodo[1,4] ;
	...
	foreach
		...
		if _tipo_cober = 1 then --Lesiones		
			update emirenduc
			 ...
			 where no_documento = _no_documento and periodo = _periodo;
