...
drop procedure sp_pro856emh;
create procedure "informix".sp_pro856emh(a_sucursal char(350), a_estatus smallint,a_desde date,a_hasta date)
...
select *
   from emirepobk  
where fecha_selec between a_desde and a_hasta and estatus in ( a_estatus,9)
