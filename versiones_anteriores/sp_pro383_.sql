...
if trim(_no_poliza) = '1863182' then
	...
	let _cod_coasegur = _cod_coasegur;
	let _cod_contrato = _cod_contrato;
	let _no_cambio = _no_cambio;
	...
	let _dia_garantia = _dia_garantia;		
