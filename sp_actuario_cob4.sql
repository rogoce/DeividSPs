drop procedure sp_actuario_cob2;
-- copia de sp_actuario
create procedure "informix".sp_actuario_cob2(a_id_mov_reas1 integer, a_id_mov_reas2 integer)
...
on exception set _error,_error_isam,_error_desc
	let _error_desc = trim(_error_desc) || 'no_poliza: ' || _no_poliza || 'no_endoso: ' ||  _cod_contrato;
...
foreach with hold
	select id_mov_tecnico,
	 ...
	 where id_mov_reas >= a_id_mov_reas1
	   and id_mov_reas <= a_id_mov_reas2
