-- Procedimiento que genera las rehabilitaciones por saldo por lote -- 
-- Creado     : 27/02/2002 - Autor: Demetrio Hurtado Almanza
--
-- SIS v.2.0 - DEIVID, S.A.

drop procedure sp_par192;

create procedure sp_par192(
a_no_poliza	char(10),
a_usuario	char(8),
a_saldo		dec(16,2))
returning	integer,
...
--set debug file to "sp_par192.trc";

begin 
on exception set _error
	return _error, "Error al Procesar la Poliza " || a_no_poliza, "";
end exception
...
let _cod_endomov  = "003"; -- Rehabilitacion de Poliza
