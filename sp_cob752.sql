...
Drop procedure sp_cob752; 
create procedure sp_cob752(a_referencia char(15), a_tab smallint, a_proceso smallint, a_usuario char(15) )
...
LET _no_documento     = 'SOLICITAR'  ; --' '  ; --'SOLICITAR'  ; --
LET _nombre_cliente   = 'AUTORIZACION '  ; --' '  ; --'AUTORIZACION '  ; --
LET _nombre_agente    = 'A HENRY'  ; --' '  ; --'A HENRY'  ; --
LET _periodo	      = ' '  ;
LET _vigencia_inic    = ' '  ;
LET _vigencia_final	  = ' '  ;
LET _nombre_ramo	  = ' '  ;
