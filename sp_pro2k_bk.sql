...
DROP procedure sp_pro02k;

CREATE procedure "informix".sp_pro02k(a_compania CHAR(3), a_agencia  CHAR(03) DEFAULT "*", a_periodo DATE, a_codsucursal  CHAR(255) DEFAULT "*", a_codramo CHAR(255) DEFAULT "*", a_serie CHAR(4) DEFAULT "1900", a_declarativa smallint default 0)
RETURNING DEC(16,2),
		  DEC(16,2),
		  SMALLINT,
		  DEC(16,2),
 ...
 --	LET _ano_serie_fin   = a_serie;
 --	LET _ano_serie_ini   = _ano_serie_fin - 1;
		...
		FOREACH
				SELECT a.no_poliza,
			     ...
			     WHERE a.cod_compania      = a_compania
				   ...
				   AND a.declarativa       = a_declarativa
...
END FOREACH
 ...
 -- Procesos v_filtros
  ...
  IF a_declarativa = 1 THEN
     LET v_filtros = TRIM(v_filtros) ||"Solo Declarativas ";
  ELSE
     LET v_filtros = TRIM(v_filtros) ||"Sin Declarativas ";
  END IF
