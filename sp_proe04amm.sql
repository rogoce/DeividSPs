...
drop procedure sp_proe04amm;
create procedure sp_proe04amm(a_poliza char(10), a_unidad char(5), a_suma decimal(16,2), a_cia char(3))
...
define li_return,ll_rea_glo,li_tipopro		 	    integer;
define li_uno,_error,li_meses,li_orden,li_tipo_ramo	integer;
