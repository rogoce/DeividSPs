...
drop procedure sp_emite11_truck;

create procedure "informix".sp_emite11_truck() 
	...
	foreach
		select first 5 
		  ...
		  into _no_unidad_int,
			   ...
			   _prima_asistencia,
			   _subtotal
		  from deivid_tmp:carga_truckingV2
		 where procesado = 0 
		   and motivo is null
		...
		let _cod_cliente = '134282';
		let _no_poliza = '0001859686';
		...
		*/
		...
		if _ramo_sis = 1 then
			...
			if _cod_producto in ('08586') then	--LIVIANO
