...
drop procedure sp_par130b;
create procedure sp_par130b(a_no_poliza char(10), a_no_endoso_ant char(5), a_usuario char(8))
...
call sp_pro493c(a_no_poliza, _no_endoso, a_no_endoso_ant) returning _error, _descripcion;
