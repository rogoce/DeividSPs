...
DROP PROCEDURE ap_atc01b_det;
CREATE PROCEDURE ap_atc01b_det(a_compania CHAR(3),a_sucursal CHAR(3),a_ano integer, a_agente VARCHAR(255))

RETURNING   CHAR(5) as cod_agente,
			VARCHAR(100) as nombre,           
			CHAR(10) as no_requis,
			CHAR(10) as no_remesa,
			DEC(16,2) as comision_desc,
