--***********************************************************************************
-- Procedimiento que genera la tabla caribe2012 segun solicitud de Demetrio
--***********************************************************************************
...
DROP PROCEDURE sp_pro8642012;

CREATE PROCEDURE sp_pro8642012(
a_compania          CHAR(3),
a_sucursal          CHAR(3))
RETURNING SMALLINT;
...
delete from caribe2012;

let _fecha_aa_ini = "01/09/2012";
let _fecha_aa_fin = "31/12/2012";
let _prima_neta   = 0;
