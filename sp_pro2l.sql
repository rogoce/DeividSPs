--------------------------------------------
---       POLIZAS VIGENTES               ---
---  Modificado por Henry Giron Mayo 2009 Reporte perfil de carrerra - cobertura '021','022': Terremoto; Omar Wong para las reaseguradoras ---
---  Ref. Power Builder - d_sp_pro02	 ---
--------------------------------------------
DROP procedure sp_pro02l;
CREATE procedure "informix".sp_pro02l(a_compania CHAR(3), a_agencia  CHAR(03) DEFAULT "*", a_periodo DATE, a_codsucursal  CHAR(255) DEFAULT "*", a_codramo CHAR(255) DEFAULT "*", a_serie char(4) DEFAULT "1900")
RETURNING DEC(16,2),
		  DEC(16,2),
		  SMALLINT,
		  DEC(16,2),
