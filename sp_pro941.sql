   DROP procedure sp_pro941;
   CREATE procedure "informix".sp_pro941(a_periodo char(7), a_periodo2 char(7), a_origen CHAR(3) DEFAULT '%' );
--------------------------------------------
---  APADEA
