...
DROP PROCEDURE sp_pr1004;
CREATE PROCEDURE "informix".sp_pr1004(a_compania CHAR(03),a_periodo1 CHAR(07),a_periodo2 CHAR(07),a_agente CHAR(255) DEFAULT "*",a_tipo CHAR(2) DEFAULT "01")
...
BEGIN
		...
		DEFINE	m_debesal	   		DECIMAL(16,2);
		DEFINE	m_habersal			DECIMAL(16,2);
...
select usuario,descripcion,cargo
  ...
  from insuser
 where trim(cargo) = 'Sub Gerente de Reaseguro';
