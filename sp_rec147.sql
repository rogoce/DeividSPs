...
DROP PROCEDURE sp_rec147;
CREATE PROCEDURE sp_rec147(a_aprob char(10) DEFAULT '*', a_fecha date, a_fechaf date, a_estado smallint, a_reclamante char(10) default '*', a_poliza char(20) default '*')
returning char(10),					   						-- 1. N£mero de Aprovaci¢n 
		  char(10),					   					   	-- 2. Codigo del Reclamante 
		  char(100),                   						-- 3. Nombre del Reclamante 
		  char(20),					   						-- 4. P¢liza 
		  datetime year to fraction(5),						-- 5. Fecha de la Solicitud
		  datetime year to fraction(5),						-- 6. Fecha de autorizaci¢n
		  char(10),											-- 7. Autorizado por:
		  char(18),					   						-- 8. Estado 
		  char(100),                                        -- 9. Dx
		  char(100),										--10. Pct
		  char(10),
