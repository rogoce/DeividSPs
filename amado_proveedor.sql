...
DROP PROCEDURE amado_proveedor;

CREATE PROCEDURE "informix".amado_proveedor(a_no_tranrec CHAR(10), a_deducible DEC(16,2) DEFAULT 0.00, a_cotizacion VARCHAR(10) DEFAULT NULL) 
