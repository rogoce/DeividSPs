--**********************************************************************************************************************************************************
-- Procedimiento para determinar la prima suscrita nueva de los corredores del bono de producción de Ramos Generales 2024
--***********************************************************************************************************************************************************

-- Creado    : 26/01/2024 - Autor: Armando Moreno M.
	...
	foreach
			 select e.no_documento,e.no_poliza
			  ...
			  where e.no_poliza         = t.no_poliza
				...
				and e.actualizado       = 1
				and e.nueva_renov       = "N"
				and e.periodo >= "2024-01"
				and e.periodo <= "2024-12"
