...
drop procedure sp_sis122ax;
create procedure sp_sis122ax(a_no_remesa char(10), a_renglon integer)
returning	integer,
			char(100);
...
--set debug file to "sp_sis122x.trc"; 
--trace on;			
...
or  (a_no_remesa = '1064001' and a_renglon in (57,61)) then	
	...
	delete from tmp_reas
	 ...
	 (a_no_remesa = '1354508' and a_renglon in(1))then
	delete from tmp_reas
	 where cod_cober_reas = '021'
