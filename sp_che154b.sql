...
---  Amado - 21/06/2016 --
------------------------------------------------
drop procedure sp_che154b;
create procedure sp_che154b(a_origen_chk char(1) default "%")
...
define _fecha_scaneo    date;
define _fecha_reasigno  date;
define _fecha_completo  date;
...
define _por_prioridad, _por_prioridad2  smallint;
...
ORDER BY a_nombre_de
	...
	foreach
		...
		let _fecha_scaneo = null;
		let _fecha_completo = null;
		let _fecha_trx = null;
		let _fecha_reasigno = null;
