...
DROP PROCEDURE sp_che86_JB;
CREATE PROCEDURE sp_che86_JB(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
foreach
	select no_documento
	  into _no_documento
	  from emipoliza
	 where vigencia_fin >= '01/10/2019'
	   and vigencia_inic < '01/10/2019'
	   and no_documento not in(
	   select distinct doc_remesa
		 from cobredet
		where periodo     >= '2019-10'
		  and periodo     <= '2020-09'
		  and actualizado = 1
		  and tipo_mov    in ("P", "N"))
...
--************************************************************************
call sp_bo077_2('01/10/2018', _fecha_ap, _fecha_aa) returning _error, _error_desc; --01/10/2018, 31/01/2019, 31/01/2020 tomando como periodo de ejemplo 2020-01
...
----**********************************************************************************************
call sp_bo077_2('01/10/2019', _fecha_aa, _fecha_aa) returning _error, _error_desc;	--01/10/2019, 31/01/2020, 31/01/2020 tomando como periodo de ejemplo 2020-01
