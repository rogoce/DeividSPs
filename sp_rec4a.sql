...
DROP PROCEDURE sp_rec04a;

CREATE PROCEDURE "informix".sp_rec04a(a_compania CHAR(3),a_agencia CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(3) DEFAULT "*", a_ramo CHAR(3) DEFAULT "*", a_ajustador CHAR(3) DEFAULT "*") RETURNING CHAR(18),CHAR(100),CHAR(20),DATE,DATE,DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),DECIMAL(16,2),CHAR(50),CHAR(50),CHAR(10),CHAR(255);		
