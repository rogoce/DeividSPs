...
DROP PROCEDURE am_cob33;

CREATE PROCEDURE "informix".am_cob33(
a_compania     CHAR(3), 
a_sucursal     CHAR(3), 
...
create temp table t_cob(
monto_recibo dec(16,2),
...
monto60      dec(16,2),
monto90       dec(16,2),
monto_recibo2 dec(16,2),
prima_bruta2  dec(16,2)
) with no log;
...
insert into t_cob
values(_monto_recibo,_prima_bruta,v_saldo,0,0,0,0,0,0,0);
...
update t_cob
   set prima_bruta2  = _prima_bruta,
	   monto_recibo2 = _monto_recibo;
