-- Trae la Informacion de la Tranasaccion para Workflow
-- Creado: 27/07/2004 - Amado Perez

DROP PROCEDURE sp_rwf19;

CREATE PROCEDURE "informix".sp_rwf19(v_no_tranrec CHAR(10))
