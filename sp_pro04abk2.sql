...
----------------------------------------------
DROP procedure sp_pro04abk2;
CREATE procedure "informix".sp_pro04abk2(a_compania CHAR(3),a_agencia CHAR(3),a_periodo DATE,a_codsucursal CHAR(3) DEFAULT "*",a_codramo CHAR(255) DEFAULT "*",	a_codtipoveh  CHAR(255) DEFAULT "*")
...
FOREACH
	  ...
	  foreach
		   ...
		   select suma_asegurada,prima_suscrita,prima_retenida
          ...
          ORDER BY cod_ramo, rango_inicial, rango_final
		   ...
		   SELECT MIN(rango1)
			...
			RETURN v_rango_inicial,v_rango_final,v_cant_polizas,
			       ...
			       v_codramo,v_desc_ramo,a_periodo,descr_cia,v_filtros,v_suma_asegurada,v_suma_asegurada / v_unidades 
			       WITH RESUME;
END FOREACH
