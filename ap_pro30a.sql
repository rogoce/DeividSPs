...
CREATE PROCEDURE ap_pro30(a_compania CHAR(3), a_sucursal CHAR(3), a_vigencia_desde DATE, a_vigencia_hasta DATE, a_usuario CHAR(8), a_no_poliza CHAR(10)) RETURNING INTEGER,
			CHAR(100);
