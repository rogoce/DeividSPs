-- Genera Cheque ACH de Contabilidad
-- Creado    : 12/08/2023 - Autor: Amado Perez
-- SIS v.2.0 - DEIVID, S.A.	
-- execute procedure sp_che123('2',0)

DROP PROCEDURE sp_che198;
CREATE PROCEDURE sp_che198() 
...
FOREACH
	SELECT chqchmae.cod_agente,
	 ...
	 WHERE (cliclien.cod_cliente = chqchmae.cod_cliente)
	   ...
	   and ((chqchmae.origen_cheque = '1')
	   AND (chqchmae.cod_banco = '001')
	   AND (chqchmae.cod_chequera = '001')
