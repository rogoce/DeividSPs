-- Morosidad Total por Ramo sin impuestos(prima neta)
-- 
-- Creado    : 18/02/2003 - Autor: Armando Moreno M.

-- SIS v.2.0 - basado en: d_cobr_sp_cob05a_dw1 - DEIVID, S.A.

--DROP PROCEDURE sp_par78;

CREATE PROCEDURE "informix".sp_par78(
a_compania   	   CHAR(3), 
a_agencia    	   CHAR(3), 
a_periodo    	   DATE,
