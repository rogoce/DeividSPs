-- Procedimiento para actualizar los valores en endeduni
-- Creado    : 19/03/2014 - Autor: Federico Coronado
-- SIS v.2.0 - DEIVID, S.A.
-- copia del sp_proe02

DROP PROCEDURE sp_end02;
CREATE PROCEDURE "informix".sp_end02(a_poliza CHAR(10), a_unidad CHAR(5), a_cia CHAR(3), a_endoso char(5))
...
--SET DEBUG FILE TO "sp_end02.trc";      
--TRACE ON;                                                                     
...
Select SUM(endedcob.prima),
	   SUM(endedcob.descuento),
	   SUM(endedcob.recargo),  
