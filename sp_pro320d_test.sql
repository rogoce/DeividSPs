...
drop procedure sp_pro320c;

create procedure "informix".sp_pro320c(v_usuario char(8), v_poliza char(10), v_poliza_nuevo char(10))
...
select x.anos_pagador,
       ...
       x.saldo_por_unidad,
       x.cod_ramo,
       x.no_documento,x.carta_aviso_canc,x.fecha_aviso_canc	   
  Into r_anos,
       _vigencia_final,
       _saldo_unidad,
	   _cod_rammo,
	   _no_documento,_carta_aviso_canc,_fecha_aviso_canc
  from prueba x
 where x.no_poliza = v_poliza;
 
if _no_documento = '0216-01254-09' then
