...
drop procedure sp_sis248banisi;

create procedure sp_sis248banisi()
...
define _cnt_descu, _cnt_autorc, _cnt_prod_exc  smallint;
...
foreach
	...
	select count(*)
	 ...
	 where no_poliza = _no_poliza_n
	   and cod_producto in ('03812','03811','02283','02282');
