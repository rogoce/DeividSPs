-- Verificacion de Saldos, Facturas y Recibos por Dia
-- 
...
--DROP PROCEDURE sp_cob76;

CREATE PROCEDURE "informix".sp_cob76(
a_compania CHAR(3),
a_agencia  CHAR(3),
a_fecha    DATE
)
