...
--set debug file to "sph_sis245a.trc";
--trace on;
let _error = 0;
 let _nom_cobertura = '';
 let _no_poliza = '';
...
--trace on;
	...
	select aut.no_poliza,
		 ...
		 where aut.vigencia_final between _fecha_desde and _fecha_hasta  --'01/10/2023' and '31/10/2023'
		   ...
		   and aut.estatus in (1,3)
		   and aut.no_documento not in ('0223-00958-03','0221-02538-09','0223-00249-07','0223-00622-10','0223-01750-01',
										'0223-01464-01','0223-00988-03','0223-01050-03','0219-00725-03','0223-00584-05')  --and aut.no_documento <>  '0221-16528-47'  
	...
	if _cod_ramo = '002' and _cod_subramo = '001' and _vigencia_final between _fecha_desde and _fecha_hasta then
		...
		if _error = 0 then
			...
			--call sp_sis61b(_no_poliza_n) returning _error, _error_desc;	
			return	_error,	_error_isam,_no_documento||' ' ||_no_poliza || ' - ' || _nom_cobertura||'#'||trim(_error)||'@'||trim(_error_desc) with resume;
              continue foreach;
		end if		
