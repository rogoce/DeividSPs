-- Cobros por Cobrador - Totales por Ramo
...
DROP PROCEDURE sp_cob08d;

CREATE PROCEDURE "informix".sp_cob08d(
a_compania CHAR(3), 
a_agencia  CHAR(3), 
a_periodo1 CHAR(7),
a_periodo2 CHAR(7),
...
FOREACH
 SELECT	cod_cobrador,
   ...
   FROM	tmp_moros
  WHERE seleccionado = 1
GROUP BY cod_cobrador, cod_ramo
ORDER BY cod_cobrador, cod_ramo
