-- Reporte de Total de Produccion por Usuario
--
...
DROP PROCEDURE sp_pro26a;

CREATE PROCEDURE "informix".sp_pro26a(a_compania CHAR(3),a_agencia  CHAR(3),a_periodo1 CHAR(7),a_periodo2 CHAR(7),a_sucursal CHAR(255) DEFAULT "*",a_ramo CHAR(255) DEFAULT "*",a_grupo    CHAR(255) DEFAULT "*", a_usuario  CHAR(255) DEFAULT "*", a_reaseguro CHAR(255) DEFAULT "*", a_agente CHAR(255) DEFAULT "*", a_producto CHAR(255) DEFAULT "*")
		RETURNING   CHAR(8),
		            DECIMAL(16,2),
					INTEGER,
		            DECIMAL(16,2), 
...
CREATE TEMP TABLE tmp_prod2(
		...
		PRIMARY KEY (user_added)) WITH NO LOG;
