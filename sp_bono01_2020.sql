--**********************************************************************************************************************************************************
-- Procedimiento para determinar la prima suscrita nueva de los corredores del bono de producción de Ramos Generales 2020
--***********************************************************************************************************************************************************
...
if _periodo_actual[1,4] = '2021' then
	...
	foreach
			 select e.no_documento,e.no_poliza
			  ...
			  where e.no_poliza         = t.no_poliza
				...
				and e.actualizado       = 1
				and e.nueva_renov       = "N"
				and e.periodo >= "2020-01"
				and e.periodo <= "2020-12"	
	...
	foreach
			select d.no_poliza,
			 ...
			 where	d.no_remesa    = m.no_remesa
			   ...
			   and d.fecha        >= '01/01/2020'
			   and d.fecha        <= '31/12/2020'
