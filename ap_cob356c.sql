...
drop procedure ap_cob356c;
create procedure ap_cob356c(a_no_documento char(20), a_cod_pagador char(10),a_cod_gestion char(3))
returning	integer,
			varchar(255);
...
-- Solicitud RGORDON 24/08/2018 excepciones en sp_ley003, se realiza el llamado. CASO: 29066 USER: ASTANZIO Adiciona GRUPO '125','162'
