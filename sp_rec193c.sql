...
DROP PROCEDURE sp_rec193c;
CREATE PROCEDURE "informix".sp_rec193c(
		a_compania  CHAR(3),
		a_agencia   CHAR(3),
		a_periodo   CHAR(7)
		) RETURNING CHAR(255);
...
FOREACH
	   ...
	   SELECT date(a.fecha),t.no_reclamo, t.fecha,sum(t.monto)
		 INTO _fecha_entrada,_no_reclamo,_fecha_pagado,_monto_total
