--drop procedure sp_reserva_riesgo_act_tmp;
create procedure sp_reserva_riesgo_act_tmp(a_periodo char(7))
...
foreach
	select s.cod_ramo_agrupado,
      ...
      into _cod_ramo,
           _prima_suscrita	  
	  from deivid_ttcorp:reserva_riesgo_c t, prdramo s
...
foreach with hold
	...
	update deivid_ttcorp:reserva_riesgo_c
