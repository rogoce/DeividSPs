...
DROP PROCEDURE sp_che86lb;
CREATE PROCEDURE sp_che86lb(a_compania CHAR(3), a_sucursal CHAR(3))
RETURNING SMALLINT;
...
--set debug file to "sp_che86lb.trc";
--trace on;
let _nombre_tipo = '';
...
foreach
   ...
   --rehabilitada o cancelada en el periodo del concurso no va
	...
	call sp_che168lb(_cod_agente_tmp) returning _error,_cod_agente;
