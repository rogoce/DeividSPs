...
DROP PROCEDURE "informix".sp_get_detalle_reclamos;

CREATE PROCEDURE "informix".sp_get_detalle_reclamos()
		RETURNING 	CHAR(10)  as no_reclamo,      							-- No_poliza
					CHAR(60) as desc_transaccion,     							-- descripcion gestion
					smallint  as renglon      							-- tipo_aviso
      							--cod_pagador
...
foreach
	select 	a.no_reclamo,
	  ...
	  into	_no_reclamo,
			_renglon,
			_desc_transaccion
	  from migrarreclamos a inner join recrcde2 b on a.no_reclamo = b.no_reclamo
	order by 2
