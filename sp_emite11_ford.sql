...
drop procedure sp_emite11_ford;
create procedure "informix".sp_emite11_ford() 
	...
	foreach
		select first 5 
		  ...
		  into _no_unidad_int,
			   ...
			   _subtotal,
			   _capacidad
		  from deivid_tmp:carga_dist_david
		 where procesado = 0 
		   and motivo is null
		 order by no_unidad
		...
		let _cod_cliente = '159455';
		let _no_poliza = '0003290279';
		...
		*/
		update deivid_tmp:carga_dist_david
		   set procesado = 1
