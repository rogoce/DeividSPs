-- Procedimiento que cierra la reserva del reclamo para Deivid Gestion

-- Creado    : 07/09/2020 - Autor: Demetrio Hurtado Almanza 

--drop procedure sp_rec158;

create procedure sp_rec158(
