DROP PROCEDURE sp_pro18c;
CREATE PROCEDURE "informix".sp_pro18c(a_compania CHAR(3),a_agencia CHAR(3),a_codsucursal CHAR(255) DEFAULT "*",a_codsubramo CHAR(255) DEFAULT "*",a_codgrupo CHAR(255) DEFAULT "*",a_periodo_desde CHAR(7),a_periodo_hasta CHAR(7))
         RETURNING CHAR(50),CHAR(3),CHAR(50),CHAR(5),CHAR(50),DEC(16,2),
...
---  Ref. Power Builder - d_prod_sp_pro18c
--------------------------------------------
   ...
   BEGIN
	  ...
	  DEFINE _mes2 		    CHAR(2);
	  DEFINE _fecha									 DATE;
	  DEFINE _fecha_char,v_nopo,_no_poliza       CHAR(10);
	  ...
	  CALL sp_pro03(a_compania,a_agencia,_fecha,'002;') RETURNING v_filtros2;	--temp_perfil
       ...
       FOREACH
          SELECT cod_ramo,
           ...
           ORDER BY cod_grupo,cod_subramo
...
-------
       FOREACH
          SELECT y.*
           ...
           ORDER BY y.cod_grupo,y.cod_subramo
          ...
          RETURN v_descr_cia,v_cod_subramo,v_desc_subra,v_cod_grupo,
                 v_desc_grupo,v_prima_suscrita,v_cantidad,v_prima_prom1,
