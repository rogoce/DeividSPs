...
drop procedure sp_aud33bk;		

create procedure "informix".sp_aud33bk(a_periodo1 char(7), a_periodo2 char(7)) 
returning char(20),char(20),varchar(100),varchar(50),char(10),dec(16,2),varchar(50),date,
          varchar(50),date,char(10);
define _fecha			date;
