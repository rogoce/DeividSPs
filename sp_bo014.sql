...
DROP PROCEDURE sp_bo014;

create procedure "informix".sp_bo014()
returning integer,
          char(50);
...
let _error_desc = "Insertando ef_saldodet en SAC001";
let _cia_comp   = "002";
...
let _error_desc = "Insertando ef_saldodet en SAC002";
let _cia_comp   = "003";
