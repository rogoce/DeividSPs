...
drop procedure sp_web30;

create procedure "informix".sp_web30(a_no_documento varchar(20), a_cod_producto varchar(20), a_no_unidad char(5))
returning integer,
		  char(100);
...
--set debug file to "sp_web30.trc";
--trace on;
  ...
  where actualizado    = 1
	...
	select count(*)
	 ...
	 where no_poliza = _no_poliza
	   and cod_producto = a_cod_producto; --in ("02052", "02053", "02054");

	if a_no_unidad <> '00001' and a_no_unidad <> '00002' then 
		if _cantidad <> 0 then
			continue foreach;
		end if
	else
