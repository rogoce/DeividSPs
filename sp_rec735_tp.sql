...
DROP PROCEDURE sp_rec735_tp;
CREATE PROCEDURE "informix".sp_rec735_tp(
a_compania	CHAR(3),
a_agencia	CHAR(3),
a_periodo1	CHAR(7),
a_periodo2	CHAR(7),
...
LET v_filtros = sp_rec704_tp(a_compania,a_agencia, a_periodo1,a_periodo2,a_sucursal,'*', '002,023,020;','*','*','*','*',a_subramo); 
