...
-- Creado:	25/06/2018 - Autor: Federico Coronado

-- SIS v.2.0 - DEIVID, S.A.

drop procedure sp_json01bk;
 
create procedure sp_json01bk(a_tramite CHAR(10), a_cedula CHAR(30))
returning CHAR(20), VARCHAR(100), CHAR(20), CHAR(50), char(50), char(10);
...
--set debug file to "sp_json01.trc";
--trace on;
...
select count(*)
 ...
 where no_reclamo = _no_reclamo
   ...
   */
   foreach 
select cod_tercero, nombre, a.no_reclamo, numrecla, estatus_reclamo
  into _cod_cliente, _nombre, _no_reclamo, _numrecla, _estatus_reclamo
from recrcmae a inner join recterce b on a.no_reclamo = b.no_reclamo
inner join cliclien c on c.cod_cliente = b.cod_tercero
where fecha_reclamo >= '28/01/2024'
...
return _numrecla, _nombre, _doc_comp, _mensaje, _nombre_ruta, _cod_cliente WITH RESUME;
end foreach
end procedure
